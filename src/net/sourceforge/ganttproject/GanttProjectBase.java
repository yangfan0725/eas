...
abstract class GanttProjectBase extends JFrame implements IGanttProject, UIFacade {
    ...
    protected GanttProjectBase() {
        ...
        //修改实现方式,使得子类可以正确的重载 by sxhong 2009/11/14
        myUndoManager =getUndoManager();
    ...
    /* 
     * 修改实现方式,使得子类可以正确的重载 by sxhong 2009/11/14
     * @see net.sourceforge.ganttproject.gui.UIFacade#getUndoManager()
     */
    public GPUndoManager getUndoManager() {
    	GPUndoManager myUndoManager=this.myUndoManager;
