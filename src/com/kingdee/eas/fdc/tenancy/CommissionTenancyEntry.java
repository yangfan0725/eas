...
public class CommissionTenancyEntry extends CoreBillEntryBase implements ICommissionTenancyEntry
{
    public CommissionTenancyEntry()
    {
        super();
        registerInterface(ICommissionTenancyEntry.class, this);
    }
    public CommissionTenancyEntry(Context ctx)
    {
        super(ctx);
        registerInterface(ICommissionTenancyEntry.class, this);
    }
    ...
    private CommissionTenancyEntryController getController() throws BOSException
    {
        return (CommissionTenancyEntryController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getCommissionTenancyEntryInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getCommissionTenancyEntryInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getCommissionTenancyEntryInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getCommissionTenancyEntryCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getCommissionTenancyEntryCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getCommissionTenancyEntryCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
