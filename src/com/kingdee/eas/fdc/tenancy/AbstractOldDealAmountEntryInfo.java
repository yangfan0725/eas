...
public class AbstractOldDealAmountEntryInfo extends com.kingdee.eas.framework.CoreBillEntryBaseInfo implements Serializable 
{
    public AbstractOldDealAmountEntryInfo()
    {
        this("id");
    }
    protected AbstractOldDealAmountEntryInfo(String pkField)
    {
        super(pkField);
    }
    /**
     * Object:合同成交价格分录's 起始日期property 
     */
    ...
    /**
     * Object:合同成交价格分录's 结束日期property 
     */
    ...
    /**
     * Object:合同成交价格分录's 租金类型property 
     */
    ...
    /**
     * Object:合同成交价格分录's 是否手工填写property 
     */
    ...
    /**
     * Object:合同成交价格分录's 租金单价property 
     */
    ...
    /**
     * Object: 合同成交价格分录 's 租赁房间头 property 
     */
    ...
    /**
     * Object: 合同成交价格分录 's 款项类型 property 
     */
    ...
    /**
     * Object: 合同成交价格分录 's 合同变更头 property 
     */
