...
public class FeesWarrant extends FDCBill implements IFeesWarrant
{
    public FeesWarrant()
    {
        super();
        registerInterface(IFeesWarrant.class, this);
    }
    public FeesWarrant(Context ctx)
    {
        super(ctx);
        registerInterface(IFeesWarrant.class, this);
    }
    ...
    private FeesWarrantController getController() throws BOSException
    {
        return (FeesWarrantController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getFeesWarrantInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getFeesWarrantInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getFeesWarrantInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getFeesWarrantCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getFeesWarrantCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getFeesWarrantCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    /**
     *º∆À„-User defined method
     *@param tenBillOtherPayID ≤Àµ•ID
     *@return
     */
    public boolean account(BOSUuid tenBillOtherPayID) throws BOSException, EASBizException
    {
        try {
            return getController().account(getContext(), tenBillOtherPayID);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
