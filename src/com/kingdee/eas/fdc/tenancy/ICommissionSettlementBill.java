...
public interface ICommissionSettlementBill extends IFDCBill
{
    ...
    public IObjectPK addnew(CommissionSettlementBillInfo model) throws BOSException, EASBizException;
    public void addnew(IObjectPK pk, CommissionSettlementBillInfo model) throws BOSException, EASBizException;
    public void update(IObjectPK pk, CommissionSettlementBillInfo model) throws BOSException, EASBizException;
    public void updatePartial(CommissionSettlementBillInfo model, SelectorItemCollection selector) throws BOSException, EASBizException;
    public void updateBigObject(IObjectPK pk, CommissionSettlementBillInfo model) throws BOSException;
