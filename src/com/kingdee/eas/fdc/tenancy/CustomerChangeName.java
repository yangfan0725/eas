...
public class CustomerChangeName extends TenBillBase implements ICustomerChangeName
{
    public CustomerChangeName()
    {
        super();
        registerInterface(ICustomerChangeName.class, this);
    }
    public CustomerChangeName(Context ctx)
    {
        super(ctx);
        registerInterface(ICustomerChangeName.class, this);
    }
    ...
    private CustomerChangeNameController getController() throws BOSException
    {
        return (CustomerChangeNameController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getCustomerChangeNameInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getCustomerChangeNameInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getCustomerChangeNameInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getCustomerChangeNameCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getCustomerChangeNameCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getCustomerChangeNameCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
