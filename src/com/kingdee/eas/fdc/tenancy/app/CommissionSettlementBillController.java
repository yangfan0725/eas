...
public interface CommissionSettlementBillController extends FDCBillController
{
    ...
    public IObjectPK addnew(Context ctx, CommissionSettlementBillInfo model) throws BOSException, EASBizException, RemoteException;
    public void addnew(Context ctx, IObjectPK pk, CommissionSettlementBillInfo model) throws BOSException, EASBizException, RemoteException;
    public void update(Context ctx, IObjectPK pk, CommissionSettlementBillInfo model) throws BOSException, EASBizException, RemoteException;
    public void updatePartial(Context ctx, CommissionSettlementBillInfo model, SelectorItemCollection selector) throws BOSException, EASBizException, RemoteException;
    public void updateBigObject(Context ctx, IObjectPK pk, CommissionSettlementBillInfo model) throws BOSException, RemoteException;
