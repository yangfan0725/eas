 ...
 * output class name
 */
public class SincerObligateListUIHandler extends AbstractSincerObligateListUIHandler
{
	...
	protected void _handleActionCancelSincer(RequestContext request,
			ResponseContext response, Context context) throws Exception {
		
	}
	protected void _handleActionToTenancy(RequestContext request,
			ResponseContext response, Context context) throws Exception {
