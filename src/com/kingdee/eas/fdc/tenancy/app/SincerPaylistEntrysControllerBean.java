...
public class SincerPaylistEntrysControllerBean extends AbstractSincerPaylistEntrysControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.fdc.tenancy.app.SincerPaylistEntrysControllerBean");
}