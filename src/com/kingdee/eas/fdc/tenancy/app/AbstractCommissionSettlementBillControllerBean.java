...
public abstract class AbstractCommissionSettlementBillControllerBean extends FDCBillControllerBean implements CommissionSettlementBillController
{
    ...
    {
        try {
            ServiceContext svcCtx = createServiceContext(new MetaDataPK("0079c993-c89e-4b6a-a03a-04ce168cfa23"), new Object[]{ctx, pk});
    ...
    {
        try {
            ServiceContext svcCtx = createServiceContext(new MetaDataPK("a5135c67-06ba-47a7-9ced-7aca2cc117c4"), new Object[]{ctx, filter});
            invokeServiceBefore(svcCtx);
            if(!svcCtx.invokeBreak()) {
    ...
    {
        try {
            ServiceContext svcCtx = createServiceContext(new MetaDataPK("39ac73ce-7df9-44e0-9e41-ba37dcd5e20d"), new Object[]{ctx, oql});
            invokeServiceBefore(svcCtx);
            if(!svcCtx.invokeBreak()) {
    ...
    {
        try {
            ServiceContext svcCtx = createServiceContext(new MetaDataPK("089b0a94-83f5-4165-8399-0b6f8d09fb17"), new Object[]{ctx, pk});
            invokeServiceBefore(svcCtx);
            if(!svcCtx.invokeBreak()) {
    ...
    {
        try {
            ServiceContext svcCtx = createServiceContext(new MetaDataPK("6d00877c-3aa5-43ad-b350-196f54ff4761"), new Object[]{ctx, pk, selector});
            invokeServiceBefore(svcCtx);
            if(!svcCtx.invokeBreak()) {
    ...
    {
        try {
            ServiceContext svcCtx = createServiceContext(new MetaDataPK("231731a7-ee07-4a26-bd99-6163b71f277e"), new Object[]{ctx, oql});
            invokeServiceBefore(svcCtx);
            if(!svcCtx.invokeBreak()) {
    ...
    public IObjectPK addnew(Context ctx, CommissionSettlementBillInfo model) throws BOSException, EASBizException
    {
        try {
            ServiceContext svcCtx = createServiceContext(new MetaDataPK("4deb949e-21ce-453a-9425-dcc0f7000a6a"), new Object[]{ctx, model});
            invokeServiceBefore(svcCtx);
            if(!svcCtx.invokeBreak()) {
    ...
    public void addnew(Context ctx, IObjectPK pk, CommissionSettlementBillInfo model) throws BOSException, EASBizException
    {
        try {
            ServiceContext svcCtx = createServiceContext(new MetaDataPK("7738d896-10a3-4998-b15e-b4c87ed963d2"), new Object[]{ctx, pk, model});
            invokeServiceBefore(svcCtx);
            if(!svcCtx.invokeBreak()){
    ...
    public void update(Context ctx, IObjectPK pk, CommissionSettlementBillInfo model) throws BOSException, EASBizException
    {
        try {
            ServiceContext svcCtx = createServiceContext(new MetaDataPK("0550c521-603a-4449-927d-9392163c41f2"), new Object[]{ctx, pk, model});
            invokeServiceBefore(svcCtx);
            if(!svcCtx.invokeBreak()){
    ...
    public void updatePartial(Context ctx, CommissionSettlementBillInfo model, SelectorItemCollection selector) throws BOSException, EASBizException
    {
        try {
            ServiceContext svcCtx = createServiceContext(new MetaDataPK("ca65054c-5ba7-4f6e-8230-43bc4eab3ce3"), new Object[]{ctx, model, selector});
            invokeServiceBefore(svcCtx);
            if(!svcCtx.invokeBreak()){
    ...
    public void updateBigObject(Context ctx, IObjectPK pk, CommissionSettlementBillInfo model) throws BOSException
    {
        try {
            ServiceContext svcCtx = createServiceContext(new MetaDataPK("88aa5af7-0932-4dbc-b37f-a80101b309e9"), new Object[]{ctx, pk, model});
            invokeServiceBefore(svcCtx);
            if(!svcCtx.invokeBreak()){
    ...
    {
        try {
            ServiceContext svcCtx = createServiceContext(new MetaDataPK("3014ceea-d0b9-4a5a-9c66-09d831fa8fa1"), new Object[]{ctx, pk});
            invokeServiceBefore(svcCtx);
            if(!svcCtx.invokeBreak()){
            _delete(ctx, pk);
            }
    ...
    {
        try {
            ServiceContext svcCtx = createServiceContext(new MetaDataPK("d26b2517-0ce8-432f-ab3d-32ce0c5df418"), new Object[]{ctx});
            invokeServiceBefore(svcCtx);
            if(!svcCtx.invokeBreak()) {
    ...
    {
        try {
            ServiceContext svcCtx = createServiceContext(new MetaDataPK("3507d771-2aba-4dce-bfc8-acaff818851f"), new Object[]{ctx, oql});
            invokeServiceBefore(svcCtx);
            if(!svcCtx.invokeBreak()) {
    ...
    {
        try {
            ServiceContext svcCtx = createServiceContext(new MetaDataPK("c171e653-9310-4cc4-82e4-329435db7ee3"), new Object[]{ctx, filter, sorter});
            invokeServiceBefore(svcCtx);
            if(!svcCtx.invokeBreak()) {
    ...
    {
        try {
            ServiceContext svcCtx = createServiceContext(new MetaDataPK("3c2a6158-64d2-4b24-b263-bd5c505465cb"), new Object[]{ctx});
            invokeServiceBefore(svcCtx);
            if(!svcCtx.invokeBreak()) {
    ...
    {
        try {
            ServiceContext svcCtx = createServiceContext(new MetaDataPK("1d5b713c-6140-4d18-8670-813ec8c84cf7"), new Object[]{ctx, view});
            invokeServiceBefore(svcCtx);
            if(!svcCtx.invokeBreak()) {
    ...
    {
        try {
            ServiceContext svcCtx = createServiceContext(new MetaDataPK("ce8658a0-a978-4e8c-a30c-cbdef4c16645"), new Object[]{ctx, oql});
            invokeServiceBefore(svcCtx);
            if(!svcCtx.invokeBreak()) {
    ...
    {
        try {
            ServiceContext svcCtx = createServiceContext(new MetaDataPK("6a825c1a-9c42-4e2b-b17d-0056249b709a"), new Object[]{ctx, filter});
            invokeServiceBefore(svcCtx);
            if(!svcCtx.invokeBreak()) {
    ...
    {
        try {
            ServiceContext svcCtx = createServiceContext(new MetaDataPK("93ef6f1c-2a1a-4b1b-b721-ffa28b14c727"), new Object[]{ctx, oql});
            invokeServiceBefore(svcCtx);
            if(!svcCtx.invokeBreak()) {
    ...
    {
        try {
            ServiceContext svcCtx = createServiceContext(new MetaDataPK("372b9ba6-87d7-4da0-8707-4743a3e3edc7"), new Object[]{ctx, arrayPK});
            invokeServiceBefore(svcCtx);
            if(!svcCtx.invokeBreak()){
            _delete(ctx, arrayPK);
            }
