 ...
 * output class name
 */
public class TenancyModifycationListUI extends AbstractTenancyModifycationListUI
{
    private static final Logger logger = CoreUIObject.getLogger(TenancyModifycationListUI.class);
    
    /**
     * output class constructor
     */
    public TenancyModifycationListUI() throws Exception
    {
        super();
    }
