...
public class BusinessScopeControllerBean extends
		AbstractBusinessScopeControllerBean {
	private static Logger logger = Logger
			.getLogger("com.kingdee.eas.fdc.tenancy.app.BusinessScopeControllerBean");
