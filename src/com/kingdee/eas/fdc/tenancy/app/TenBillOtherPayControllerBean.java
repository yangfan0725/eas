...
public class TenBillOtherPayControllerBean extends AbstractTenBillOtherPayControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.fdc.tenancy.app.TenBillOtherPayControllerBean");
}