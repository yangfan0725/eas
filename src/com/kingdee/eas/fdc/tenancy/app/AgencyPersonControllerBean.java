...
public class AgencyPersonControllerBean extends AbstractAgencyPersonControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.fdc.tenancy.app.AgencyPersonControllerBean");
}