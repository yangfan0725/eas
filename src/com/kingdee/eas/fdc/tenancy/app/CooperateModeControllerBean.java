...
public class CooperateModeControllerBean extends
		AbstractCooperateModeControllerBean {
	private static Logger logger = Logger
			.getLogger("com.kingdee.eas.fdc.tenancy.app.CooperateModeControllerBean");
