 ...
 * output class name
 */
public abstract class AbstractRestReceivableListUIHandler extends com.kingdee.eas.framework.app.CoreBillListUIHandler

{
	...
	public void handleActionMAudit(RequestContext request,ResponseContext response, Context context) throws Exception {
		_handleActionMAudit(request,response,context);
	}
	protected void _handleActionMAudit(RequestContext request,ResponseContext response, Context context) throws Exception {
	}
