...
public abstract class AbstractMarketUnitControlControllerBean extends DataBaseControllerBean implements MarketUnitControlController
{
    ...
    {
        try {
            ServiceContext svcCtx = createServiceContext(new MetaDataPK("bdacca19-813d-4be3-a43d-cfb51ed5e307"), new Object[]{ctx, pk});
    ...
    {
        try {
            ServiceContext svcCtx = createServiceContext(new MetaDataPK("87b2a960-ef0c-4cf2-bd18-00c764940e77"), new Object[]{ctx, pk, selector});
            invokeServiceBefore(svcCtx);
    ...
    {
        try {
            ServiceContext svcCtx = createServiceContext(new MetaDataPK("4ee9cbdf-f22d-46bb-94b1-81ac4c93fd97"), new Object[]{ctx, oql});
            invokeServiceBefore(svcCtx);
    ...
    {
        try {
            ServiceContext svcCtx = createServiceContext(new MetaDataPK("369c738d-ba50-4beb-8cd4-7e6df861696b"), new Object[]{ctx});
            invokeServiceBefore(svcCtx);
    ...
    {
        try {
            ServiceContext svcCtx = createServiceContext(new MetaDataPK("e8371245-f92b-42e9-8392-bb4d90836a66"), new Object[]{ctx, view});
            invokeServiceBefore(svcCtx);
    ...
    {
        try {
            ServiceContext svcCtx = createServiceContext(new MetaDataPK("4144b55c-4656-44a6-86b1-095e911e6baf"), new Object[]{ctx, oql});
            invokeServiceBefore(svcCtx);
