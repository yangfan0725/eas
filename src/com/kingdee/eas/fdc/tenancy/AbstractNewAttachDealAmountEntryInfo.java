...
public class AbstractNewAttachDealAmountEntryInfo extends com.kingdee.eas.framework.CoreBillEntryBaseInfo implements Serializable 
{
    public AbstractNewAttachDealAmountEntryInfo()
    {
        this("id");
    }
    protected AbstractNewAttachDealAmountEntryInfo(String pkField)
    {
        super(pkField);
    }
    /**
     * Object:合同变更配套资源成交租价变更分录's 起始日期property 
     */
    ...
    /**
     * Object:合同变更配套资源成交租价变更分录's 结束日期property 
     */
    ...
    /**
     * Object:合同变更配套资源成交租价变更分录's 租金property 
     */
    ...
    /**
     * Object:合同变更配套资源成交租价变更分录's 租金类型property 
     */
    ...
    /**
     * Object:合同变更配套资源成交租价变更分录's 是否手工填写property 
     */
    ...
    /**
     * Object:合同变更配套资源成交租价变更分录's 租金单价property 
     */
    ...
    /**
     * Object: 合同变更配套资源成交租价变更分录 's 配套资源头 property 
     */
    ...
    /**
     * Object: 合同变更配套资源成交租价变更分录 's 款项类型 property 
     */
    ...
    /**
     * Object: 合同变更配套资源成交租价变更分录 's 合同变更头 property 
     */
