 ...
 * output class name
 */
public abstract class AbstractLeaseStatRptUI extends com.kingdee.eas.framework.client.ListUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractLeaseStatRptUI.class);
    /**
     * output class constructor
     */
    public AbstractLeaseStatRptUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractLeaseStatRptUI.class.getName());
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.tenancy.app.LeaseStatRptUIHandler";
	}
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.tenancy.client", "LeaseStatRptUI");
    }
