 ...
 * output class name
 */
public abstract class AbstractNatureEnterpriseListUI extends com.kingdee.eas.framework.client.TreeListUI implements KDPromptSelector
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractNatureEnterpriseListUI.class);
				private boolean isF7Use;
		private com.kingdee.eas.framework.client.F7Render f7Delegate;
		public AbstractNatureEnterpriseListUI(HashMap ctx) throws Exception {
			super();
			isF7Use = true;
     ...
     */
    public AbstractNatureEnterpriseListUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractNatureEnterpriseListUI.class.getName());
        this.setUITitle(resHelper.getString("this.title"));
        mainQueryPK = new MetaDataPK("com.kingdee.eas.fdc.tenancy.app", "NatureEnterpriseQuery");
        // CoreUI		
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.tenancy.app.NatureEnterpriseListUIHandler";
	}
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.tenancy.client", "NatureEnterpriseListUI");
    }
