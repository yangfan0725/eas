 ...
 * output class name
 */
public abstract class AbstractAttachRentAdjustEditUI extends com.kingdee.eas.fdc.tenancy.client.TenBillBaseEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractAttachRentAdjustEditUI.class);
    ...
    protected com.kingdee.bos.ctrl.kdf.table.KDTable tblAttachRentAdjust;
    ...
    protected com.kingdee.eas.fdc.tenancy.AttachRentAdjustInfo editData = null;
    /**
     * output class constructor
     */
    public AbstractAttachRentAdjustEditUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractAttachRentAdjustEditUI.class.getName());
        ...
        this.tblAttachRentAdjust = new com.kingdee.bos.ctrl.kdf.table.KDTable();
        ...
        this.tblAttachRentAdjust.setName("tblAttachRentAdjust");
        ...
        // txtSellProjectName
        // tblAttachRentAdjust		
        this.tblAttachRentAdjust.setFormatXml(resHelper.getString("tblAttachRentAdjust.formatXml"));
    ...
    public void initUIContentLayout()
    {
        ...
        this.setLayout(null);
        contCreator.setBounds(new Rectangle(12, 88, 270, 19));
        this.add(contCreator, null);
        contCreateTime.setBounds(new Rectangle(549, 88, 270, 19));
        this.add(contCreateTime, null);
        contNumber.setBounds(new Rectangle(12, 16, 270, 19));
        this.add(contNumber, null);
        contDescription.setBounds(new Rectangle(14, 137, 809, 59));
        this.add(contDescription, null);
        contName.setBounds(new Rectangle(550, 15, 270, 19));
        this.add(contName, null);
        contSellprojectNumber.setBounds(new Rectangle(11, 54, 270, 19));
        this.add(contSellprojectNumber, null);
        contSellProjectName.setBounds(new Rectangle(551, 50, 270, 19));
        this.add(contSellProjectName, null);
        tblAttachRentAdjust.setBounds(new Rectangle(13, 237, 814, 165));
        this.add(tblAttachRentAdjust, null);
        btnImportAttach.setBounds(new Rectangle(521, 210, 121, 19));
        this.add(btnImportAttach, null);
        btnDelAttach.setBounds(new Rectangle(644, 210, 74, 19));
        this.add(btnDelAttach, null);
        btnImportPrice.setBounds(new Rectangle(720, 210, 108, 19));
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.tenancy.app.AttachRentAdjustEditUIHandler";
	}
    ...
    public void setDataObject(IObjectValue dataObject)
    {
        ...
        this.editData = (com.kingdee.eas.fdc.tenancy.AttachRentAdjustInfo)ov;
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.tenancy.client", "AttachRentAdjustEditUI");
    }
