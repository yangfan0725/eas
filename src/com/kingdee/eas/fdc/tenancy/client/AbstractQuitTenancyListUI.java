 ...
 * output class name
 */
public abstract class AbstractQuitTenancyListUI extends com.kingdee.eas.fdc.tenancy.client.TenBillBaseListUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractQuitTenancyListUI.class);
     ...
     */
    public AbstractQuitTenancyListUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractQuitTenancyListUI.class.getName());
        this.setUITitle(resHelper.getString("this.title"));
        mainQueryPK = new MetaDataPK("com.kingdee.eas.fdc.tenancy.app", "QuitTenancyQuery");
        //actionAudit
        ...
        this.tblMain.setFormatXml(resHelper.getString("tblMain.formatXml"));
                this.tblMain.putBindContents("mainQuery",new String[] {"id","number","state","quitDate","quitTenancyType","deductAmount","tenancyBill.number","tenancyBill.tenRoomsDes","tenancyBill.tenCustomerDes","newQuitReason.name","quitGoing","creator.number","createTime"});
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.tenancy.app.QuitTenancyListUIHandler";
	}
    ...
    protected class ActionAudit extends ItemAction {     
        ...
        public void actionPerformed(ActionEvent e)
        {
            ...
            innerActionPerformed("eas", AbstractQuitTenancyListUI.this, "ActionAudit", "actionAudit_actionPerformed", e);
        }
    }
    ...
    protected class ActionHandleTenancy extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractQuitTenancyListUI.this, "ActionHandleTenancy", "actionHandleTenancy_actionPerformed", e);
        }
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.tenancy.client", "QuitTenancyListUI");
    }
    /**
