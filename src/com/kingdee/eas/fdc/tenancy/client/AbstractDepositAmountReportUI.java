 ...
 * output class name
 */
public abstract class AbstractDepositAmountReportUI extends com.kingdee.eas.framework.report.client.CommRptBaseUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractDepositAmountReportUI.class);
     ...
     */
    public AbstractDepositAmountReportUI() throws Exception
    {
        super();
        jbInit();
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.tenancy.app.DepositAmountReportUIHandler";
	}
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.tenancy.client", "DepositAmountReportUI");
    }
