 ...
 * output class name
 */
public abstract class AbstractTenancyRentBillListUI extends com.kingdee.eas.fdc.tenancy.client.TenBillBaseListUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractTenancyRentBillListUI.class);
    ...
    protected com.kingdee.bos.ctrl.swing.KDMenuItem menuItemExecut;
     ...
     */
    public AbstractTenancyRentBillListUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractTenancyRentBillListUI.class.getName());
        this.setUITitle(resHelper.getString("this.title"));
        mainQueryPK = new MetaDataPK("com.kingdee.eas.fdc.tenancy.app", "TenancyRentBillQuery");
        //actionRemove
        ...
        this.menuItemExecut = new com.kingdee.bos.ctrl.swing.KDMenuItem();
        ...
        // menuItemExecut
        this.menuItemExecut.setAction((IItemAction)ActionProxyFactory.getProxy(actionExecute, new Class[] { IItemAction.class }, getServiceContext()));		
        this.menuItemExecut.setText(resHelper.getString("menuItemExecut.text"));		
        this.menuItemExecut.setIcon(com.kingdee.eas.util.client.EASResource.getIcon("imgTbtn_execute"));
        // menuItemBlankOut
    ...
    {
        this.setBounds(new Rectangle(10, 10, 1150, 600));
        this.setLayout(new KDLayout());
        this.putClientProperty("OriginalBounds", new Rectangle(10, 10, 1150, 600));
        pnlMain.setBounds(new Rectangle(1, 0, 1150, 600));
        this.add(pnlMain, new KDLayout.Constraints(1, 0, 1150, 600, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_BOTTOM | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT));
        //pnlMain
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.tenancy.app.TenancyRentBillListUIHandler";
	}
    ...
    public SelectorItemCollection getSelectors()
    {
        ...
        sic.add(new SelectorItemInfo("orgUnit.isCU"));
    ...
    protected class ActionAudit extends ItemAction {     
        ...
        public void actionPerformed(ActionEvent e)
        {
            ...
            innerActionPerformed("eas", AbstractTenancyRentBillListUI.this, "ActionAudit", "actionAudit_actionPerformed", e);
        }
    }
    ...
    protected class ActionUnAudit extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractTenancyRentBillListUI.this, "ActionUnAudit", "actionUnAudit_actionPerformed", e);
        }
    }
    ...
    protected class ActionExecute extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractTenancyRentBillListUI.this, "ActionExecute", "actionExecute_actionPerformed", e);
        }
    }
    ...
    protected class ActionBlankOut extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractTenancyRentBillListUI.this, "ActionBlankOut", "actionBlankOut_actionPerformed", e);
        }
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.tenancy.client", "TenancyRentBillListUI");
    }
    /**
