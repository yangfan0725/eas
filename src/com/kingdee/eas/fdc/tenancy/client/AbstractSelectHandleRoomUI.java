 ...
 * output class name
 */
public abstract class AbstractSelectHandleRoomUI extends com.kingdee.eas.framework.client.EditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractSelectHandleRoomUI.class);
     ...
     */
    public AbstractSelectHandleRoomUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractSelectHandleRoomUI.class.getName());
    ...
    public void initUIContentLayout()
    {
        ...
        this.setLayout(null);
        pnlMain.setBounds(new Rectangle(6, 6, 564, 230));
        this.add(pnlMain, null);
        btnConfirm.setBounds(new Rectangle(204, 247, 76, 19));
        this.add(btnConfirm, null);
        btnCancel2.setBounds(new Rectangle(283, 247, 75, 19));
        this.add(btnCancel2, null);
        //pnlMain
        pnlMain.add(tblRooms, resHelper.getString("tblRooms.constraints"));
        pnlMain.add(tblAttach, resHelper.getString("tblAttach.constraints"));
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.tenancy.app.SelectHandleRoomUIHandler";
	}
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.tenancy.client", "SelectHandleRoomUI");
    }
