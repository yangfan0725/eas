 ...
 * output class name
 */
public abstract class AbstractCommissionApplyEditUI extends com.kingdee.eas.fdc.basedata.client.FDCBillEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractCommissionApplyEditUI.class);
    ...
    protected com.kingdee.bos.ctrl.swing.KDLabelContainer contCommissionAmount;
    ...
    protected com.kingdee.bos.ctrl.swing.KDFormattedTextField txtCommissionAmount;
    ...
    protected com.kingdee.eas.fdc.tenancy.CommissionApplyInfo editData = null;
    /**
     * output class constructor
     */
    public AbstractCommissionApplyEditUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractCommissionApplyEditUI.class.getName());
        ...
        this.contCommissionAmount = new com.kingdee.bos.ctrl.swing.KDLabelContainer();
        ...
        this.txtCommissionAmount = new com.kingdee.bos.ctrl.swing.KDFormattedTextField();
        ...
        this.contCommissionAmount.setName("contCommissionAmount");
        ...
        this.txtCommissionAmount.setName("txtCommissionAmount");
        ...
        // CoreUI		
        this.setBorder(null);		
        this.setPreferredSize(new Dimension(740,530));		
        ...
        this.contTotalAmount.setBoundLabelLength(120);		
        ...
        // contCommissionAmount		
        this.contCommissionAmount.setBoundLabelText(resHelper.getString("contCommissionAmount.boundLabelText"));		
        this.contCommissionAmount.setBoundLabelLength(120);		
        this.contCommissionAmount.setBoundLabelUnderline(true);
        // contProject		
        ...
        this.contRoom.setBoundLabelLength(120);		
        ...
        // txtCommissionAmount		
        this.txtCommissionAmount.setPrecision(2);		
        this.txtCommissionAmount.setRequired(true);
        this.txtCommissionAmount.addDataChangeListener(new com.kingdee.bos.ctrl.swing.event.DataChangeListener() {
            public void dataChanged(com.kingdee.bos.ctrl.swing.event.DataChangeEvent e) {
                try {
                    txtCommissionAmount_dataChanged(e);
                } catch (Exception exc) {
                    handUIException(exc);
                } finally {
                }
    ...
    {
        this.setBounds(new Rectangle(10, 10, 740, 530));
        this.setLayout(null);
        contTotalAmount.setBounds(new Rectangle(47, 326, 270, 19));
        this.add(contTotalAmount, null);
        contRate.setBounds(new Rectangle(47, 353, 270, 19));
        this.add(contRate, null);
        contAmount.setBounds(new Rectangle(401, 353, 270, 19));
        this.add(contAmount, null);
        contCommissionAmount.setBounds(new Rectangle(401, 326, 270, 19));
        this.add(contCommissionAmount, null);
        contProject.setBounds(new Rectangle(47, 299, 270, 19));
        this.add(contProject, null);
        contCreator.setBounds(new Rectangle(47, 452, 270, 19));
        this.add(contCreator, null);
        contAuditor.setBounds(new Rectangle(47, 482, 270, 19));
        this.add(contAuditor, null);
        contCreateTime.setBounds(new Rectangle(401, 452, 270, 19));
        this.add(contCreateTime, null);
        contAuditDate.setBounds(new Rectangle(401, 482, 270, 19));
        this.add(contAuditDate, null);
        contRoom.setBounds(new Rectangle(401, 299, 270, 19));
        this.add(contRoom, null);
        kDPanel1.setBounds(new Rectangle(3, 4, 734, 284));
        this.add(kDPanel1, null);
        contDescription.setBounds(new Rectangle(47, 380, 625, 64));
        ...
        //contCommissionAmount
        contCommissionAmount.setBoundEditor(txtCommissionAmount);
        //contProject
...
kDPanel1.setLayout(new BorderLayout(0, 0));        kDPanel1.add(kDScrollPane1, BorderLayout.CENTER);
	...
	private void registerBindings(){
		...
		dataBinder.registerBinding("commissionAmount", java.math.BigDecimal.class, this.txtCommissionAmount, "value");
		...
		dataBinder.registerBinding("room", com.kingdee.eas.fdc.tenancy.IntentionCustomerInfo.class, this.prmtRoom, "data");
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.tenancy.app.CommissionApplyEditUIHandler";
	}
    ...
    public void setDataObject(IObjectValue dataObject)
    {
        ...
        this.editData = (com.kingdee.eas.fdc.tenancy.CommissionApplyInfo)ov;
    }
	...
	protected void registerValidator() {
		...
		getValidateHelper().registerBindProperty("commissionAmount", ValidateHelper.ON_SAVE);    
    ...
    /**
     * output txtCommissionAmount_dataChanged method
     */
    protected void txtCommissionAmount_dataChanged(com.kingdee.bos.ctrl.swing.event.DataChangeEvent e) throws Exception
    {
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.tenancy.client", "CommissionApplyEditUI");
    }
    /**
