 ...
 * output class name
 */
public class TenancyReceiveBillListUI extends AbstractTenancyReceiveBillListUI
{
    private static final Logger logger = CoreUIObject.getLogger(TenancyReceiveBillListUI.class);
    
    /**
     * output class constructor
     */
    public TenancyReceiveBillListUI() throws Exception
    {
        super();
    }
    ...
    /**
     * output actionCreateInvoice_actionPerformed
     */
    public void actionCreateInvoice_actionPerformed(ActionEvent e) throws Exception
    {
        super.actionCreateInvoice_actionPerformed(e);
    }

    /**
     * output actionClearInvoice_actionPerformed
     */
    ...
    /**
     * output actionReceiveBillPrint_actionPerformed
     */
    ...
    /**
     * output actionReceiveBillPrintView_actionPerformed
     */
