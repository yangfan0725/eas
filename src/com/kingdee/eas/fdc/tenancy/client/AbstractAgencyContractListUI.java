 ...
 * output class name
 */
public abstract class AbstractAgencyContractListUI extends com.kingdee.eas.fdc.tenancy.client.TenBillBaseListUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractAgencyContractListUI.class);
    ...
    protected com.kingdee.bos.ctrl.swing.KDTree treeAgency;
     ...
     */
    public AbstractAgencyContractListUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractAgencyContractListUI.class.getName());
        this.setUITitle(resHelper.getString("this.title"));
        mainQueryPK = new MetaDataPK("com.kingdee.eas.fdc.tenancy.app", "AgencyContractQuery");
        //actionAudit
        ...
        this.treeAgency = new com.kingdee.bos.ctrl.swing.KDTree();
        ...
        this.treeAgency.setName("treeAgency");
        this.btnAudit.setName("btnAudit");
        this.menuItemAudit.setName("menuItemAudit");
        // CoreUI		
        this.tblMain.setFormatXml(resHelper.getString("tblMain.formatXml"));
                this.tblMain.putBindContents("mainQuery",new String[] {"id","number","name","contractState","agency.name","signer.name","commisionStandard","value","creator.name","createTime"});
        ...
        // kDTreeView2
        // treeAgency
        this.treeAgency.addTreeSelectionListener(new javax.swing.event.TreeSelectionListener() {
            public void valueChanged(javax.swing.event.TreeSelectionEvent e) {
                try {
                    treeAgency_valueChanged(e);
                } catch (Exception exc) {
                    handUIException(exc);
                } finally {
                }
    ...
    public void initUIContentLayout()
    {
        ...
        //kDTreeView1
        kDTreeView1.setTree(treeSellProject);
        //kDTreeView2
        kDTreeView2.setTree(treeAgency);
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.tenancy.app.AgencyContractListUIHandler";
	}
    ...
    /**
     * output treeAgency_valueChanged method
     */
    protected void treeAgency_valueChanged(javax.swing.event.TreeSelectionEvent e) throws Exception
    {
    }
    ...
    public SelectorItemCollection getSelectors()
    {
        ...
        sic.add(new SelectorItemInfo("contractState"));
        return sic;
    }        
    ...
    protected class ActionAudit extends ItemAction {     
        ...
        public void actionPerformed(ActionEvent e)
        {
            ...
            innerActionPerformed("eas", AbstractAgencyContractListUI.this, "ActionAudit", "actionAudit_actionPerformed", e);
        }
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.tenancy.client", "AgencyContractListUI");
    }
