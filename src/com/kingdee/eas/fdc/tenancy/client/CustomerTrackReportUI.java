...
import com.kingdee.eas.fdc.tenancy.CustomerTrackReportFacadeFactory;
 ...
 * output class name
 */
public class CustomerTrackReportUI extends AbstractCustomerTrackReportUI
{
    private static final Logger logger = CoreUIObject.getLogger(CustomerTrackReportUI.class);
    public CustomerTrackReportUI() throws Exception
    {
        super();
        tblMain.checkParsed();
	...
	protected CommRptBaseConditionUI getQueryDialogUserPanel() throws Exception {
		return new CustomerTrackReportFilterUI();
	}

	protected ICommRptBase getRemoteInstance() throws BOSException {
		return CustomerTrackReportFacadeFactory.getRemoteInstance();
	}
...
//		CRMClientHelper.changeTableNumberFormat(tblMain, new String[]{"buildArea","tenancyArea","dealTotal","dealPrice","roomPrice","appAmount","actRevAmount","bookAmount"});
		...
		tblMain.getColumn("customer").getStyleAttributes().setFontColor(Color.BLUE);
		mergerTable(tblMain,new String[]{"id"},new String[]{"type","createTime","customer","sellProject","levelt","saleMan","linkMan","phone"});
	}
...
//		this.treeMain.expandAllNodes(true, (TreeNode) this.treeMain.getModel().getRoot());
	...
	protected void tblMain_tableClicked(KDTMouseEvent e) throws Exception {
		if (e.getType() == KDTStyleConstants.BODY_ROW && e.getButton() == MouseEvent.BUTTON1 && e.getClickCount() == 2) {
			if(this.tblMain.getColumn(e.getColIndex()).getKey().equals("customer")){
				String conId=this.tblMain.getRow(e.getRowIndex()).getCell("id").getValue().toString();
