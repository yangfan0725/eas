 ...
 * output class name
 */
public abstract class AbstractRevDetailVoucherReportUI extends com.kingdee.eas.framework.report.client.CommRptBaseUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractRevDetailVoucherReportUI.class);
     ...
     */
    public AbstractRevDetailVoucherReportUI() throws Exception
    {
        super();
        jbInit();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractRevDetailVoucherReportUI.class.getName());
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.tenancy.app.RevDetailVoucherReportUIHandler";
	}
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.tenancy.client", "RevDetailVoucherReportUI");
    }
