 ...
 * output class name
 */
public abstract class AbstractLiquidatedQueryUI extends com.kingdee.eas.framework.client.ListUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractLiquidatedQueryUI.class);
    protected com.kingdee.bos.ctrl.swing.KDWorkButton btnSelect;
    protected com.kingdee.bos.ctrl.swing.KDWorkButton btnUnSelect;
    protected ActionSelect actionSelect = null;
    protected ActionUnSelect actionUnSelect = null;
    /**
     * output class constructor
     */
    public AbstractLiquidatedQueryUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractLiquidatedQueryUI.class.getName());
        ...
        this.btnUnSelect = new com.kingdee.bos.ctrl.swing.KDWorkButton();
    ...
    public void initUIContentLayout()
    {
        ...
        this.setLayout(null);
        tblMain.setBounds(new Rectangle(11, 10, 678, 428));
        this.add(tblMain, null);
        btnSelect.setBounds(new Rectangle(394, 464, 103, 19));
        this.add(btnSelect, null);
        btnUnSelect.setBounds(new Rectangle(549, 464, 103, 19));
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.tenancy.app.LiquidatedQueryUIHandler";
	}
    ...
    protected class ActionSelect extends ItemAction {     
        ...
        public void actionPerformed(ActionEvent e)
        {
            ...
            innerActionPerformed("eas", AbstractLiquidatedQueryUI.this, "ActionSelect", "actionSelect_actionPerformed", e);
        }
    }
    ...
    protected class ActionUnSelect extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractLiquidatedQueryUI.this, "ActionUnSelect", "actionUnSelect_actionPerformed", e);
        }
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.tenancy.client", "LiquidatedQueryUI");
    }
