 ...
 * output class name
 */
public abstract class AbstractFeesVoucherUI extends com.kingdee.eas.fdc.basecrm.client.FDCReceivingBillListUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractFeesVoucherUI.class);
     ...
     */
    public AbstractFeesVoucherUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractFeesVoucherUI.class.getName());
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.tenancy.app.FeesVoucherUIHandler";
	}
    ...
    protected class ActionSetAudit extends ItemAction {     
        ...
        public void actionPerformed(ActionEvent e)
        {
            ...
            innerActionPerformed("eas", AbstractFeesVoucherUI.this, "ActionSetAudit", "actionSetAudit_actionPerformed", e);
        }
    }
    ...
    protected class ActionSetUnaudit extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractFeesVoucherUI.this, "ActionSetUnaudit", "actionSetUnaudit_actionPerformed", e);
        }
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.tenancy.client", "FeesVoucherUI");
    }
