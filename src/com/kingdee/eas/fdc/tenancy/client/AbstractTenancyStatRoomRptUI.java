 ...
 * output class name
 */
public abstract class AbstractTenancyStatRoomRptUI extends com.kingdee.eas.framework.client.ListUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractTenancyStatRoomRptUI.class);
     ...
     */
    public AbstractTenancyStatRoomRptUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractTenancyStatRoomRptUI.class.getName());
        ...
        this.tblMain.setFormatXml(resHelper.getString("tblMain.formatXml"));
                this.tblMain.putBindContents("mainQuery",new String[] {"id","building.name","unit","number","floor","serialNumber","roomModel.name","buildingProperty.name","buildingArea","roomArea","apportionArea","balconyArea","guardenArea","carbarnArea","useArea","flatArea","actualBuildingArea","actualRoomArea","sellState","buildPrice","isCalByRoomArea","roomPrice","standardTotalAmount","roomJoinState","roomBookState","roomLoanState","roomCompensateState","sellProject.id","building.id","dealPrice","dealTotalAmount","direction.name","sight.name","lastPurchase.customerNames","payType.name","salesman.name","sellOrder.orderDate","baseBuildingPrice","baseRoomPrice","isBasePriceAudited","toPurchaseDate","toSignDate"});
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.tenancy.app.TenancyStatRoomRptUIHandler";
	}
    ...
    protected class ActionViewPurchase extends ItemAction
    {
        ...
        public void actionPerformed(ActionEvent e)
        {
            ...
            innerActionPerformed("eas", AbstractTenancyStatRoomRptUI.this, "ActionViewPurchase", "actionViewPurchase_actionPerformed", e);
        }
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.tenancy.client", "TenancyStatRoomRptUI");
    }
