 ...
 * output class name
 */
public abstract class AbstractRoomRentBillListUI extends com.kingdee.eas.framework.client.BillListUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractRoomRentBillListUI.class);
     ...
     */
    public AbstractRoomRentBillListUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractRoomRentBillListUI.class.getName());
        this.setUITitle(resHelper.getString("this.title"));
        mainQueryPK = new MetaDataPK("com.kingdee.eas.fdc.tenancy.app", "RoomRentBillQuery");
        //actionRemove
        ...
        this.tblMain.setFormatXml(resHelper.getString("tblMain.formatXml"));
                this.tblMain.putBindContents("mainQuery",new String[] {"number","bizDate","description","hasEffected","sourceBillId","sourceFunction","createTime","lastUpdateTime","entrys.seq","handler.name","auditor.auditor","creator.creator","lastUpdateUser.lastUpdateUser","company.name","company.number","id","entrys.id"});
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.tenancy.app.RoomRentBillListUIHandler";
	}
    ...
    protected class ActionTDPrint extends ItemAction
    {
        ...
        public void actionPerformed(ActionEvent e)
        {
            ...
            innerActionPerformed("eas", AbstractRoomRentBillListUI.this, "ActionTDPrint", "actionTDPrint_actionPerformed", e);
        }
    }
    ...
    protected class ActionTDPrintPreview extends ItemAction
    {
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractRoomRentBillListUI.this, "ActionTDPrintPreview", "actionTDPrintPreview_actionPerformed", e);
        }
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.tenancy.client", "RoomRentBillListUI");
    }
    /**
    ...
    {
        return com.kingdee.eas.fdc.tenancy.client.RoomRentBillEditUI.class.getName();
    }



	protected String getTDFileName() {
    	return "/bim/fdc/tenancy/RoomRentBill";
	}
    protected IMetaDataPK getTDQueryPK() {
    	return new MetaDataPK("com.kingdee.eas.fdc.tenancy.app.RoomRentBillQuery");
	}
