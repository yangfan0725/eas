 ...
 * output class name
 */
public class RoomRentBillListUI extends AbstractRoomRentBillListUI
{
    private static final Logger logger = CoreUIObject.getLogger(RoomRentBillListUI.class);
    
    /**
     * output class constructor
     */
    public RoomRentBillListUI() throws Exception
    {
        super();
    }
