 ...
 * output class name
 */
public class CooperateModeEditUI extends AbstractCooperateModeEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(CooperateModeEditUI.class);
    
    /**
     * output class constructor
     */
    public CooperateModeEditUI() throws Exception
    {
        super();
    }
    ...
    {
    	CooperateModeInfo thisInfo = (CooperateModeInfo)this.editData;
		if(thisInfo!=null&&thisInfo.getId()!=null) {
			FilterInfo filter = new FilterInfo();
			filter.getFilterItems().add(new FilterItemInfo("cooperateMode.id",thisInfo.getId().toString()));
