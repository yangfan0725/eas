 ...
 * output class name
 */
public abstract class AbstractAttachResTypeEditUI extends com.kingdee.eas.framework.client.EditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractAttachResTypeEditUI.class);
    ...
    protected com.kingdee.eas.fdc.tenancy.AttachResTypeInfo editData = null;
    /**
     * output class constructor
     */
    public AbstractAttachResTypeEditUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractAttachResTypeEditUI.class.getName());
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.tenancy.app.AttachResTypeEditUIHandler";
	}
    ...
    public void setDataObject(IObjectValue dataObject)
    {
        ...
        this.editData = (com.kingdee.eas.fdc.tenancy.AttachResTypeInfo)ov;
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.tenancy.client", "AttachResTypeEditUI");
    }
