 ...
 * output class name
 */
public class CustomerRentalListFilterUI extends AbstractCustomerRentalListFilterUI
{
    private static final Logger logger = CoreUIObject.getLogger(CustomerRentalListFilterUI.class);
     ...
     */
    public CustomerRentalListFilterUI() throws Exception
    {
        super();
    }
