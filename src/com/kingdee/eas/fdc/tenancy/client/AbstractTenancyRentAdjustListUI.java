 ...
 * output class name
 */
public abstract class AbstractTenancyRentAdjustListUI extends com.kingdee.eas.fdc.tenancy.client.TenBillBaseListUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractTenancyRentAdjustListUI.class);
     ...
     */
    public AbstractTenancyRentAdjustListUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractTenancyRentAdjustListUI.class.getName());
        this.setUITitle(resHelper.getString("this.title"));
        mainQueryPK = new MetaDataPK("com.kingdee.eas.fdc.tenancy.app", "TenancyRentAdjustQuery");
        //actionRemove
        ...
        this.tblMain.setFormatXml(resHelper.getString("tblMain.formatXml"));
                this.tblMain.putBindContents("mainQuery",new String[] {"id","state","number","name","orgUnit.name","creator.name","creator.createTime","auditor.name","auditTime","isExecuted","executedTime","description"});
    ...
    {
        this.setBounds(new Rectangle(10, 10, 1156, 600));
        this.setLayout(new KDLayout());
        this.putClientProperty("OriginalBounds", new Rectangle(10, 10, 1156, 600));
        pnlMain.setBounds(new Rectangle(0, 1, 1156, 600));
        this.add(pnlMain, new KDLayout.Constraints(0, 1, 1156, 600, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_BOTTOM | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT));
        //pnlMain
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.tenancy.app.TenancyRentAdjustListUIHandler";
	}
    ...
    public SelectorItemCollection getSelectors()
    {
        ...
        sic.add(new SelectorItemInfo("creator.createTime"));
        sic.add(new SelectorItemInfo("orgUnit.name"));
        sic.add(new SelectorItemInfo("auditor.name"));
        sic.add(new SelectorItemInfo("auditor.createTime"));
    ...
    protected class ActionAudit extends ItemAction {     
        ...
        public void actionPerformed(ActionEvent e)
        {
            ...
            innerActionPerformed("eas", AbstractTenancyRentAdjustListUI.this, "ActionAudit", "actionAudit_actionPerformed", e);
        }
    }
    ...
    protected class ActionUnAudit extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractTenancyRentAdjustListUI.this, "ActionUnAudit", "actionUnAudit_actionPerformed", e);
        }
    }
    ...
    protected class ActionExecute extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractTenancyRentAdjustListUI.this, "ActionExecute", "actionExecute_actionPerformed", e);
        }
    }
    ...
    protected class ActionBlankOut extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractTenancyRentAdjustListUI.this, "ActionBlankOut", "actionBlankOut_actionPerformed", e);
        }
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.tenancy.client", "TenancyRentAdjustListUI");
    }
    /**
