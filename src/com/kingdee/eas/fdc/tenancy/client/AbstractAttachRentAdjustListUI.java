 ...
 * output class name
 */
public abstract class AbstractAttachRentAdjustListUI extends com.kingdee.eas.fdc.tenancy.client.TenBillBaseListUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractAttachRentAdjustListUI.class);
     ...
     */
    public AbstractAttachRentAdjustListUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractAttachRentAdjustListUI.class.getName());
        this.setUITitle(resHelper.getString("this.title"));
        mainQueryPK = new MetaDataPK("com.kingdee.eas.fdc.tenancy.app", "AttachRentAdjustQuery");
        //actionAudit
    ...
    public void initUIContentLayout()
    {
        ...
        pnlMain.setBounds(new Rectangle(4, 11, 1012, 586));
        this.add(pnlMain, new KDLayout.Constraints(4, 11, 1012, 586, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_BOTTOM | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT));
        //pnlMain
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.tenancy.app.AttachRentAdjustListUIHandler";
	}
    ...
    protected class ActionAudit extends ItemAction
    {
        ...
        public void actionPerformed(ActionEvent e)
        {
            ...
            innerActionPerformed("eas", AbstractAttachRentAdjustListUI.this, "ActionAudit", "actionAudit_actionPerformed", e);
        }
    }
    ...
    protected class ActionUnAudit extends ItemAction
    {
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractAttachRentAdjustListUI.this, "ActionUnAudit", "actionUnAudit_actionPerformed", e);
        }
    }
    ...
    protected class ActionExecute extends ItemAction
    {
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractAttachRentAdjustListUI.this, "ActionExecute", "actionExecute_actionPerformed", e);
        }
    }
    ...
    protected class ActionBlankOut extends ItemAction
    {
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractAttachRentAdjustListUI.this, "ActionBlankOut", "actionBlankOut_actionPerformed", e);
        }
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.tenancy.client", "AttachRentAdjustListUI");
    }
