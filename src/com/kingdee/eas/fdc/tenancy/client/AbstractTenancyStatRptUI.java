 ...
 * output class name
 */
public abstract class AbstractTenancyStatRptUI extends com.kingdee.eas.framework.client.ListUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractTenancyStatRptUI.class);
    /**
     * output class constructor
     */
    public AbstractTenancyStatRptUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractTenancyStatRptUI.class.getName());
    ...
    public void initUIContentLayout()
    {
        ...
        tblMain.setBounds(new Rectangle(-2, 4, 994, 614));
        this.add(tblMain, new KDLayout.Constraints(-2, 4, 994, 614, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_BOTTOM | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT));
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.tenancy.app.TenancyStatRptUIHandler";
	}
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.tenancy.client", "TenancyStatRptUI");
    }
