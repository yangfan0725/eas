 ...
 * output class name
 */
public class CustomerRentalOtherPayFilterUI extends AbstractCustomerRentalOtherPayFilterUI
{
    private static final Logger logger = CoreUIObject.getLogger(CustomerRentalOtherPayFilterUI.class);
	...
	public static final String KEY_MoneyDefine="moneyDefine";
     ...
     */
    public CustomerRentalOtherPayFilterUI() throws Exception
    {
        super();
    }
    ...
    public void onLoad() throws Exception {
		...
		filter1.getFilterItems().add(new FilterItemInfo("sysType",MoneySysTypeEnum.TENANCYSYS_VALUE));
		view1.setFilter(filter1);
		moneyDefine.setEntityViewInfo(view1);
	...
	public FilterInfo getFilterInfo() {
		...
		String moneyDefineid=para.getString(KEY_MoneyDefine);
		if (moneyDefineid != null) {
			filter.getFilterItems().add(new FilterItemInfo("moneyDefine", moneyDefineid, CompareType.EQUALS));
		}else{
			filter.getFilterItems().add(new FilterItemInfo("moneyDefine", null));
		}
	...
	public CustomerParams getCustomerParams() {
		...
		if (this.moneyDefine.getValue() != null) {
			param.add(KEY_MoneyDefine, ((MoneyDefineInfo) this.moneyDefine
					.getValue()).getId().toString());
		}
	...
	public void setCustomerParams(CustomerParams cp) {
		...
		if (moneyDefineId != null) {
			try {
				MoneyDefineInfo info = MoneyDefineFactory.getRemoteInstance()
						.getMoneyDefineInfo(
								new ObjectUuidPK(BOSUuid.read(moneyDefineId)));
				this.moneyDefine.setValue(info);
			} catch (Exception e) {
				e.printStackTrace();
			}
		}	
	...
	public Map getParam() {
		...
		if (this.moneyDefine.getValue() != null) {
			param.put(KEY_MoneyDefine, ((MoneyDefineInfo) this.moneyDefine
					.getValue()).getId().toString());
		}
