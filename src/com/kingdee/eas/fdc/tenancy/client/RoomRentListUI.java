 ...
 * output class name
 */
public class RoomRentListUI extends AbstractRoomRentListUI
{
    private static final Logger logger = CoreUIObject.getLogger(RoomRentListUI.class);
    
    /**
     * output class constructor
     */
    public RoomRentListUI() throws Exception
    {
        super();
    }
    ...
    /**
     * output actionSchemePrice_actionPerformed
     */
    public void actionSchemePrice_actionPerformed(ActionEvent e) throws Exception
    {
        super.actionSchemePrice_actionPerformed(e);
    }
