 ...
 * output class name
 */
public abstract class AbstractFeesWarrantFeeListFilterUI extends com.kingdee.eas.base.commonquery.client.CustomerQueryPanel
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractFeesWarrantFeeListFilterUI.class);
     ...
     */
    public AbstractFeesWarrantFeeListFilterUI() throws Exception
    {
        super();
        jbInit();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractFeesWarrantFeeListFilterUI.class.getName());
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.tenancy.app.FeesWarrantFeeListFilterUIHandler";
	}
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.tenancy.client", "FeesWarrantFeeListFilterUI");
    }
