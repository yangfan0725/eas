 ...
 * output class name
 */
public abstract class AbstractReturnTenancyFilterUI extends com.kingdee.eas.framework.report.client.CommRptBaseConditionUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractReturnTenancyFilterUI.class);
     ...
     */
    public AbstractReturnTenancyFilterUI() throws Exception
    {
        super();
        jbInit();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractReturnTenancyFilterUI.class.getName());
    ...
    public void initUIContentLayout()
    {
        ...
        this.setLayout(null);
        contStartDate.setBounds(new Rectangle(47, 62, 521, 19));
        this.add(contStartDate, null);
        contEndDate.setBounds(new Rectangle(47, 102, 521, 19));
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.tenancy.app.ReturnTenancyFilterUIHandler";
	}
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.tenancy.client", "ReturnTenancyFilterUI");
    }
