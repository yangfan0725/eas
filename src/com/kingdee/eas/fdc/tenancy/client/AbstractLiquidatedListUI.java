 ...
 * output class name
 */
public abstract class AbstractLiquidatedListUI extends com.kingdee.eas.framework.client.TreeListUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractLiquidatedListUI.class);
    protected com.kingdee.bos.ctrl.swing.KDWorkButton btnImport;
    protected ActionImport actionImport = null;
    /**
     * output class constructor
     */
    public AbstractLiquidatedListUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractLiquidatedListUI.class.getName());
        this.setUITitle(resHelper.getString("this.title"));
        mainQueryPK = new MetaDataPK("com.kingdee.eas.fdc.tenancy.app", "LiquidatedQuery");
        //actionImport
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.tenancy.app.LiquidatedListUIHandler";
	}
    ...
    protected class ActionImport extends ItemAction {     
        ...
        public void actionPerformed(ActionEvent e)
        {
            ...
            innerActionPerformed("eas", AbstractLiquidatedListUI.this, "ActionImport", "actionImport_actionPerformed", e);
        }
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.tenancy.client", "LiquidatedListUI");
    }
