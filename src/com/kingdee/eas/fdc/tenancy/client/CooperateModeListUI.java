 ...
 * output class name
 */
public class CooperateModeListUI extends AbstractCooperateModeListUI
{
    private static final Logger logger = CoreUIObject.getLogger(CooperateModeListUI.class);
    
    /**
     * output class constructor
     */
    public CooperateModeListUI() throws Exception
    {
        super();
    }
...
//        }
    ...
    public void actionAddNew_actionPerformed(ActionEvent e) throws Exception
    {
		...
		if(idStr!=null) {
			...
			filter.getFilterItems().add(new FilterItemInfo("cooperateMode.id",idStr));
