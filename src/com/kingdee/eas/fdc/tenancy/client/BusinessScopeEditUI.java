 ...
 * output class name
 */
public class BusinessScopeEditUI extends AbstractBusinessScopeEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(BusinessScopeEditUI.class);
    
    /**
     * output class constructor
     */
    public BusinessScopeEditUI() throws Exception
    {
        super();
    }
    ...
    {
    	BusinessScopeInfo thisInfo = (BusinessScopeInfo)this.editData;
		if(thisInfo!=null&&thisInfo.getId()!=null) {
			FilterInfo filter = new FilterInfo();
			filter.getFilterItems().add(new FilterItemInfo("businessScope.id",thisInfo.getId().toString()));
