 ...
 * output class name
 */
public class BrandCategoryEditUI extends AbstractBrandCategoryEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(BrandCategoryEditUI.class);
    
    /**
     * output class constructor
     */
    public BrandCategoryEditUI() throws Exception
    {
        super();
    }
    ...
    public void onLoad() throws Exception {
    	...
    	super.onLoad();
    	this.chkEnabled.setVisible(false);
    }
	...
	protected IObjectValue createNewData() {
		...
		BrandCategoryInfo parent = (BrandCategoryInfo) uiContext.get("parent");
