 ...
 * output class name
 */
public abstract class AbstractCustomerTenancyAreaChangeUIFilter extends com.kingdee.eas.base.commonquery.client.CustomerQueryPanel
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractCustomerTenancyAreaChangeUIFilter.class);
     ...
     */
    public AbstractCustomerTenancyAreaChangeUIFilter() throws Exception
    {
        super();
        jbInit();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractCustomerTenancyAreaChangeUIFilter.class.getName());
        ...
        // kDComboBox1		
        this.kDComboBox1.addItems(EnumUtils.getEnumList("com.kingdee.eas.fdc.tenancy.MoreorleStateEnum").toArray());
        // kDLabelContainer2		
        this.kDLabelContainer2.setBoundLabelText(resHelper.getString("kDLabelContainer2.boundLabelText"));		
        this.kDLabelContainer2.setBoundLabelLength(100);		
        this.kDLabelContainer2.setBoundLabelUnderline(true);
        // kDBizPromptBox1		
        this.kDBizPromptBox1.setQueryInfo("com.kingdee.eas.fdc.sellhouse.app.CustomerQuery");
        // chkIsShowAll		
        this.chkIsShowAll.setText(resHelper.getString("chkIsShowAll.text"));		
        this.chkIsShowAll.setEnabled(false);		
    ...
    public void initUIContentLayout()
    {
        ...
        plDateType.setBounds(new Rectangle(6, 64, 283, 55));
        ...
        kDLabelContainer1.setBounds(new Rectangle(10, 121, 270, 19));
        this.add(kDLabelContainer1, null);
        kDLabelContainer2.setBounds(new Rectangle(10, 144, 270, 19));
        ...
        radioByMonth.setBounds(new Rectangle(73, 19, 61, 19));
        plDateType.add(radioByMonth, null);
        radioByQuarter.setBounds(new Rectangle(137, 19, 61, 19));
        plDateType.add(radioByQuarter, null);
        radioByYear.setBounds(new Rectangle(209, 19, 61, 19));
        plDateType.add(radioByYear, null);
        chkIsShowAll.setBounds(new Rectangle(91, -4, 190, 19));
        plDateType.add(chkIsShowAll, null);
        //contYearTo
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.tenancy.app.CustomerTenancyAreaChangeUIFilterHandler";
	}
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.tenancy.client", "CustomerTenancyAreaChangeUIFilter");
    }
