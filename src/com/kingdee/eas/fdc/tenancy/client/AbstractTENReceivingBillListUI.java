 ...
 * output class name
 */
public abstract class AbstractTENReceivingBillListUI extends com.kingdee.eas.fdc.basecrm.client.FDCReceivingBillListUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractTENReceivingBillListUI.class);
     ...
     */
    public AbstractTENReceivingBillListUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractTENReceivingBillListUI.class.getName());
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.tenancy.app.TENReceivingBillListUIHandler";
	}
    ...
    protected class ActionTDPrint extends ItemAction {     
        ...
        public void actionPerformed(ActionEvent e)
        {
            ...
            innerActionPerformed("eas", AbstractTENReceivingBillListUI.this, "ActionTDPrint", "actionTDPrint_actionPerformed", e);
        }
    }
    ...
    protected class ActionTDPrintPreview extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractTENReceivingBillListUI.this, "ActionTDPrintPreview", "actionTDPrintPreview_actionPerformed", e);
        }
    }
    ...
    protected class ActionUpdateSubject extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractTENReceivingBillListUI.this, "ActionUpdateSubject", "actionUpdateSubject_actionPerformed", e);
        }
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.tenancy.client", "TENReceivingBillListUI");
    }
    /**
