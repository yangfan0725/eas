 ...
 * output class name
 */
public abstract class AbstractTenancyContractDetailReportFilterUI extends com.kingdee.eas.framework.report.client.CommRptBaseConditionUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractTenancyContractDetailReportFilterUI.class);
     ...
     */
    public AbstractTenancyContractDetailReportFilterUI() throws Exception
    {
        super();
        jbInit();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractTenancyContractDetailReportFilterUI.class.getName());
        ...
        this.chkIsNeedTotal.setVisible(false);
        // prmtTanancyBill		
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.tenancy.app.TenancyContractDetailReportFilterUIHandler";
	}
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.tenancy.client", "TenancyContractDetailReportFilterUI");
    }
