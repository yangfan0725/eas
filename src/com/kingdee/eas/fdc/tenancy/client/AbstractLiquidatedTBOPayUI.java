 ...
 * output class name
 */
public abstract class AbstractLiquidatedTBOPayUI extends com.kingdee.eas.framework.client.ListUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractLiquidatedTBOPayUI.class);
    protected com.kingdee.bos.ctrl.swing.KDWorkButton btnSelect;
    protected ActionSelect actionSelect = null;
    /**
     * output class constructor
     */
    public AbstractLiquidatedTBOPayUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractLiquidatedTBOPayUI.class.getName());
    ...
    public void initUIContentLayout()
    {
        ...
        this.setLayout(null);
        tblMain.setBounds(new Rectangle(8, 7, 996, 552));
        this.add(tblMain, null);
        btnSelect.setBounds(new Rectangle(738, 581, 103, 19));
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.tenancy.app.LiquidatedTBOPayUIHandler";
	}
    ...
    protected class ActionSelect extends ItemAction {     
        ...
        public void actionPerformed(ActionEvent e)
        {
            ...
            innerActionPerformed("eas", AbstractLiquidatedTBOPayUI.this, "ActionSelect", "actionSelect_actionPerformed", e);
        }
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.tenancy.client", "LiquidatedTBOPayUI");
    }
