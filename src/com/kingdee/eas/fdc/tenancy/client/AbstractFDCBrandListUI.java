 ...
 * output class name
 */
public abstract class AbstractFDCBrandListUI extends com.kingdee.eas.framework.client.TreeDetailListUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractFDCBrandListUI.class);
    /**
     * output class constructor
     */
    public AbstractFDCBrandListUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractFDCBrandListUI.class.getName());
        this.setUITitle(resHelper.getString("this.title"));
        mainQueryPK = new MetaDataPK("com.kingdee.eas.fdc.tenancy.app", "FDCBrandListQuery");
        // CoreUI		
...
pnlTable.setLayout(new BorderLayout(0, 0));        pnlTable.add(tblMain, BorderLayout.CENTER);
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.tenancy.app.FDCBrandListUIHandler";
	}
    ...
    public SelectorItemCollection getSelectors()
    {
        ...
        sic.add(new SelectorItemInfo("enName"));
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.tenancy.client", "FDCBrandListUI");
    }
