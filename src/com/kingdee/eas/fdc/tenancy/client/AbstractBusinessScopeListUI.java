 ...
 * output class name
 */
public abstract class AbstractBusinessScopeListUI extends com.kingdee.eas.framework.client.TreeListUI implements KDPromptSelector
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractBusinessScopeListUI.class);
				private boolean isF7Use;
		private com.kingdee.eas.framework.client.F7Render f7Delegate;
		public AbstractBusinessScopeListUI(HashMap ctx) throws Exception {
			super();
			isF7Use = true;
     ...
     */
    public AbstractBusinessScopeListUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractBusinessScopeListUI.class.getName());
        this.setUITitle(resHelper.getString("this.title"));
        mainQueryPK = new MetaDataPK("com.kingdee.eas.fdc.tenancy.app", "BusinessScopeQuery");
        // CoreUI		
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.tenancy.app.BusinessScopeListUIHandler";
	}
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.tenancy.client", "BusinessScopeListUI");
    }
