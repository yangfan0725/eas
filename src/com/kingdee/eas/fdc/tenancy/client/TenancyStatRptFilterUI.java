 ...
 * output class name
 */
public class TenancyStatRptFilterUI extends AbstractTenancyStatRptFilterUI
{
    private static final Logger logger = CoreUIObject.getLogger(TenancyStatRptFilterUI.class);
     ...
     */
    public TenancyStatRptFilterUI(ListUI listUI, ItemAction actionListOnLoad) throws Exception
    {
    	super();
		this.listUI = listUI;
