 ...
 * output class name
 */
public abstract class AbstractLeaseStatRptFilterUI extends com.kingdee.eas.base.commonquery.client.CustomerQueryPanel
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractLeaseStatRptFilterUI.class);
     ...
     */
    public AbstractLeaseStatRptFilterUI() throws Exception
    {
        super();
        jbInit();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractLeaseStatRptFilterUI.class.getName());
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.tenancy.app.LeaseStatRptFilterUIHandler";
	}
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.tenancy.client", "LeaseStatRptFilterUI");
    }
