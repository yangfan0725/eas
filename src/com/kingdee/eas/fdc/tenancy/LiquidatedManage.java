...
public class LiquidatedManage extends FDCDataBase implements ILiquidatedManage
{
    public LiquidatedManage()
    {
        super();
        registerInterface(ILiquidatedManage.class, this);
    }
    public LiquidatedManage(Context ctx)
    {
        super(ctx);
        registerInterface(ILiquidatedManage.class, this);
    }
    ...
    private LiquidatedManageController getController() throws BOSException
    {
        return (LiquidatedManageController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getLiquidatedManageInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getLiquidatedManageInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getLiquidatedManageInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getLiquidatedManageCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getLiquidatedManageCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getLiquidatedManageCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    /**
     *批量计算-User defined method
     *@param sellProject 租售项目ID
     *@return
     */
    public int batchAccount(BOSUuid sellProject) throws BOSException, EASBizException
    {
        try {
            return getController().batchAccount(getContext(), sellProject);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().genTenBillOtherPay(getContext(), id);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
