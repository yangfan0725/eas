 ...
 * output class name
 */
public abstract class AbstractQuestionPaperAnswerListUI extends com.kingdee.eas.framework.client.BillListUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractQuestionPaperAnswerListUI.class);
     ...
     */
    public AbstractQuestionPaperAnswerListUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractQuestionPaperAnswerListUI.class.getName());
        this.setUITitle(resHelper.getString("this.title"));
        mainQueryPK = new MetaDataPK("com.kingdee.eas.fdc.market.app", "QuestionPaperAnswerQuery");
        //actionRemove
        ...
        this.tblMain.setFormatXml(resHelper.getString("tblMain.formatXml"));
                this.tblMain.putBindContents("mainQuery",new String[] {"id","number","inputDate","bizDate","purchase.name","commerceChance.name","questionPaper.topric","sellProject.name","customer.name","creator.name","createTime","lastUpdateUser.name","lastUpdateTime","commerceChance.id","purchase.id"});
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.market.app.QuestionPaperAnswerListUIHandler";
	}
    ...
    public SelectorItemCollection getSelectors()
    {
        ...
        sic.add(new SelectorItemInfo("questionPaper.topric"));
        ...
        sic.add(new SelectorItemInfo("purchase.name"));
    ...
    protected class ActionTDPrint extends ItemAction {     
        ...
        public void actionPerformed(ActionEvent e)
        {
            ...
            innerActionPerformed("eas", AbstractQuestionPaperAnswerListUI.this, "ActionTDPrint", "actionTDPrint_actionPerformed", e);
        }
    }
    ...
    protected class ActionTDPrintPreview extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractQuestionPaperAnswerListUI.this, "ActionTDPrintPreview", "actionTDPrintPreview_actionPerformed", e);
        }
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.market.client", "QuestionPaperAnswerListUI");
    }
    /**
    ...
    {
        return new String[] {"id","number","inputDate","bizDate","purchase.name","commerceChance.name","questionPaper.topric","sellProject.name","customer.name","creator.name","createTime","lastUpdateUser.name","lastUpdateTime","commerceChance.id","purchase.id"};
    }
