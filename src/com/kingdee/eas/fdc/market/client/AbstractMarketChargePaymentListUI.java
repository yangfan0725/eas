 ...
 * output class name
 */
public abstract class AbstractMarketChargePaymentListUI extends com.kingdee.eas.framework.client.EditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractMarketChargePaymentListUI.class);
     ...
     */
    public AbstractMarketChargePaymentListUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractMarketChargePaymentListUI.class.getName());
    ...
    {
        this.setBounds(new Rectangle(10, 10, 650, 260));
        this.setLayout(null);
        btnConfirm.setBounds(new Rectangle(413, 230, 73, 21));
        this.add(btnConfirm, null);
        btnExit.setBounds(new Rectangle(565, 230, 73, 21));
        this.add(btnExit, null);
        tblMain.setBounds(new Rectangle(10, 10, 628, 214));
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.market.app.MarketChargePaymentListUIHandler";
	}
    ...
    protected class ActionConfirm extends ItemAction
    {
        ...
        public void actionPerformed(ActionEvent e)
        {
            ...
            innerActionPerformed("eas", AbstractMarketChargePaymentListUI.this, "ActionConfirm", "actionConfirm_actionPerformed", e);
        }
    }
    ...
    protected class ActionExit extends ItemAction
    {
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractMarketChargePaymentListUI.this, "ActionExit", "actionExit_actionPerformed", e);
        }
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.market.client", "MarketChargePaymentListUI");
    }
