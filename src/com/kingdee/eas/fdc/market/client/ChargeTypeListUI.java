 ...
 * output class name
 */
public class ChargeTypeListUI extends AbstractChargeTypeListUI {
	private static final Logger logger = CoreUIObject.getLogger(ChargeTypeListUI.class);

	/**
	 * output class constructor
	 */
	public ChargeTypeListUI() throws Exception {
		super();
	}
	...
	protected void treeMain_valueChanged(TreeSelectionEvent e) throws Exception {
		...
		if (orgNode.getUserObject() != null && orgNode.getUserObject() instanceof ChargeTypeInfo) {
			ChargeTypeInfo chargeTypeInfo = (ChargeTypeInfo) orgNode.getUserObject();
			if (chargeTypeInfo != null) {
				getUIContext().put("chargeType", chargeTypeInfo);
			}
		}
	}
	/**
