 ...
 * output class name
 */
public abstract class AbstractRptBarginOnAnalyseBIUI extends com.kingdee.eas.framework.bireport.client.BireportBaseMainUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractRptBarginOnAnalyseBIUI.class);
    protected com.kingdee.bos.ctrl.kdf.table.KDTable tblMain;
    /**
     * output class constructor
     */
    public AbstractRptBarginOnAnalyseBIUI() throws Exception
    {
        super();
        jbInit();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractRptBarginOnAnalyseBIUI.class.getName());
    ...
    public void initUIContentLayout()
    {
        ...
        tblMain.setBounds(new Rectangle(7, 8, 999, 613));
        this.add(tblMain, new KDLayout.Constraints(7, 8, 999, 613, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_BOTTOM | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT));
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.market.app.RptBarginOnAnalyseBIUIHandler";
	}
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.market.client", "RptBarginOnAnalyseBIUI");
    }
