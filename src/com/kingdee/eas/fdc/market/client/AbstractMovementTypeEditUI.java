 ...
 * output class name
 */
public abstract class AbstractMovementTypeEditUI extends com.kingdee.eas.fdc.basedata.client.FDCBaseDataEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractMovementTypeEditUI.class);
    ...
    protected com.kingdee.bos.ctrl.swing.KDLabelContainer contpopularizeType;
    protected com.kingdee.bos.ctrl.extendcontrols.KDBizPromptBox prmtpopularizeType;
    protected com.kingdee.eas.fdc.market.MovementTypeInfo editData = null;
    /**
     * output class constructor
     */
    public AbstractMovementTypeEditUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractMovementTypeEditUI.class.getName());
        ...
        this.contpopularizeType = new com.kingdee.bos.ctrl.swing.KDLabelContainer();
        this.prmtpopularizeType = new com.kingdee.bos.ctrl.extendcontrols.KDBizPromptBox();
        ...
        this.contpopularizeType.setName("contpopularizeType");
        this.prmtpopularizeType.setName("prmtpopularizeType");
        // CoreUI
        ...
        // contpopularizeType		
        this.contpopularizeType.setBoundLabelText(resHelper.getString("contpopularizeType.boundLabelText"));		
        this.contpopularizeType.setBoundLabelLength(100);		
        this.contpopularizeType.setBoundLabelUnderline(true);		
        this.contpopularizeType.setVisible(true);		
        this.contpopularizeType.setForeground(new java.awt.Color(0,0,0));		
        this.contpopularizeType.setBoundLabelAlignment(7);
        // prmtpopularizeType		
        this.prmtpopularizeType.setQueryInfo("com.kingdee.eas.fdc.market.app.MarketTypeQuery");		
        this.prmtpopularizeType.setVisible(true);		
        this.prmtpopularizeType.setEditable(true);		
        this.prmtpopularizeType.setForeground(new java.awt.Color(0,0,0));		
        this.prmtpopularizeType.setDisplayFormat("$name$ $number$");		
        this.prmtpopularizeType.setEditFormat("$number$");		
        this.prmtpopularizeType.setCommitFormat("$number$");		
        this.prmtpopularizeType.setRequired(false);		
        this.prmtpopularizeType.setEnabled(true);
        this.setFocusTraversalPolicy(new com.kingdee.bos.ui.UIFocusTraversalPolicy(new java.awt.Component[] {txtshortName,prmtpopularizeType}));
    ...
    {
        this.setBounds(new Rectangle(0, 0, 290, 250));
        this.setLayout(null);
        contName.setBounds(new Rectangle(10, 40, 270, 19));
        this.add(contName, null);
        contNumber.setBounds(new Rectangle(10, 10, 270, 19));
        this.add(contNumber, null);
        chkIsEnabled.setBounds(new Rectangle(235, 137, 140, 19));
        this.add(chkIsEnabled, null);
        bizDescription.setBounds(new Rectangle(10, 167, 270, 70));
        this.add(bizDescription, null);
        kDLabel1.setBounds(new Rectangle(10, 137, 100, 19));
        this.add(kDLabel1, null);
        contshortName.setBounds(new Rectangle(10, 74, 270, 19));
        this.add(contshortName, null);
        contpopularizeType.setBounds(new Rectangle(10, 107, 270, 19));
        this.add(contpopularizeType, null);
        //contName
        ...
        //contpopularizeType
        contpopularizeType.setBoundEditor(prmtpopularizeType);
	...
	private void registerBindings(){
		...
		dataBinder.registerBinding("popularizeType", com.kingdee.eas.fdc.market.MarketTypeInfo.class, this.prmtpopularizeType, "data");		
	}
	//Regiester UI State
    ...
    public void setDataObject(IObjectValue dataObject)
    {
        ...
        this.editData = (com.kingdee.eas.fdc.market.MovementTypeInfo)ov;
    }
	...
	protected void registerValidator() {
		...
		getValidateHelper().registerBindProperty("popularizeType", ValidateHelper.ON_SAVE);    		
	}
            ...
            if (com.kingdee.bos.ui.face.UIRuleUtil.isNull(bizName.getDefaultLangItemData())) 
{
    ...
    public SelectorItemCollection getSelectors()
    {
        ...
        sic.add(new SelectorItemInfo("popularizeType.*"));
        return sic;
    }        
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.market.client", "MovementTypeEditUI");
    }
    /**
    ...
    {
        return com.kingdee.eas.fdc.market.client.MovementTypeEditUI.class.getName();
    }
    ...
    {
        return com.kingdee.eas.fdc.market.MovementTypeFactory.getRemoteInstance();
    }
    ...
    {
        com.kingdee.eas.fdc.market.MovementTypeInfo objectValue = new com.kingdee.eas.fdc.market.MovementTypeInfo();
