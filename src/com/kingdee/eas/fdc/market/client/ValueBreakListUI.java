 ...
 * output class name
 */
public class ValueBreakListUI extends AbstractValueBreakListUI
{
    private static final Logger logger = CoreUIObject.getLogger(ValueBreakListUI.class);
    
    /**
     * output class constructor
     */
    public ValueBreakListUI() throws Exception
    {
        super();
    }
    ...
    protected String getEditUIName() {
    	return ValueBreakEditUI.class.getName();
    }
    ...
    public void actionAddNew_actionPerformed(ActionEvent e) throws Exception {
    	if(sourceTreeNode!=null){
    		...
    		MsgBox.showWarning("请选择一个销售项目新增货值测算！");
    	}
    }
