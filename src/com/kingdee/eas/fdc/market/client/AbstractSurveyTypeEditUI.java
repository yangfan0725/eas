 ...
 * output class name
 */
public abstract class AbstractSurveyTypeEditUI extends com.kingdee.eas.fdc.basedata.client.FDCBaseDataEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractSurveyTypeEditUI.class);
    ...
    protected com.kingdee.eas.fdc.market.SurveyTypeInfo editData = null;
    /**
     * output class constructor
     */
    public AbstractSurveyTypeEditUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractSurveyTypeEditUI.class.getName());
        ...
        this.setFocusTraversalPolicy(new com.kingdee.bos.ui.UIFocusTraversalPolicy(new java.awt.Component[] {bizDescription,txtNumber,bizName,chkIsEnabled,txtshortName}));
    ...
    public void initUIContentLayout()
    {
        ...
        chkIsEnabled.setBounds(new Rectangle(231, 102, 140, 19));
        this.add(chkIsEnabled, null);
        bizDescription.setBounds(new Rectangle(10, 138, 270, 70));
        this.add(bizDescription, null);
        kDLabel1.setBounds(new Rectangle(10, 102, 100, 19));
        this.add(kDLabel1, null);
        contshortName.setBounds(new Rectangle(10, 71, 270, 19));
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.market.app.SurveyTypeEditUIHandler";
	}
    ...
    public void setDataObject(IObjectValue dataObject)
    {
        ...
        this.editData = (com.kingdee.eas.fdc.market.SurveyTypeInfo)ov;
    }
            ...
            if (com.kingdee.bos.ui.face.UIRuleUtil.isNull(bizName.getDefaultLangItemData())) 
{
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.market.client", "SurveyTypeEditUI");
    }
    /**
    ...
    {
        return com.kingdee.eas.fdc.market.client.SurveyTypeEditUI.class.getName();
    }
    ...
    {
        return com.kingdee.eas.fdc.market.SurveyTypeFactory.getRemoteInstance();
    }
    ...
    {
        com.kingdee.eas.fdc.market.SurveyTypeInfo objectValue = new com.kingdee.eas.fdc.market.SurveyTypeInfo();
