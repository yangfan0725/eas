 ...
 * output class name
 */
public abstract class AbstractBoutiqueRoomTypeListUI extends com.kingdee.eas.framework.client.TreeDetailListUI implements KDPromptSelector
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractBoutiqueRoomTypeListUI.class);
				private boolean isF7Use;
		private com.kingdee.eas.framework.client.F7Render f7Delegate;
		public AbstractBoutiqueRoomTypeListUI(HashMap ctx) throws Exception {
			super();
			isF7Use = true;
     ...
     */
    public AbstractBoutiqueRoomTypeListUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractBoutiqueRoomTypeListUI.class.getName());
        this.setUITitle(resHelper.getString("this.title"));
        mainQueryPK = new MetaDataPK("com.kingdee.eas.fdc.market.app", "BoutiqueRoomTypeQuery");
        // CoreUI		
        this.tblMain.setFormatXml(resHelper.getString("tblMain.formatXml"));
                this.tblMain.putBindContents("mainQuery",new String[] {"id","treeid.name","name","number","simpleName","flatLayerType.name","developer.name","architectArea","roomArea","roomType","roomStyle","price","direction","wideSide","buildTime","roomTypeExplain","roomTypeReview","description","createTime","creator.name","lastUpdateTime","lastUpdateUser.name","treeid.id"});
...
pnlTable.setLayout(new BorderLayout(0, 0));        pnlTable.add(tblMain, BorderLayout.CENTER);
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.market.app.BoutiqueRoomTypeListUIHandler";
	}
    ...
    public SelectorItemCollection getSelectors()
    {
        ...
        sic.add(new SelectorItemInfo("flatLayerType.name"));
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.market.client", "BoutiqueRoomTypeListUI");
    }
