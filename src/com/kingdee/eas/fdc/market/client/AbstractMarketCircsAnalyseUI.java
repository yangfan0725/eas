 ...
 * output class name
 */
public abstract class AbstractMarketCircsAnalyseUI extends com.kingdee.eas.framework.bireport.client.BireportBaseMainUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractMarketCircsAnalyseUI.class);
    protected com.kingdee.bos.ctrl.kdf.table.KDTable kDTable1;
    /**
     * output class constructor
     */
    public AbstractMarketCircsAnalyseUI() throws Exception
    {
        super();
        jbInit();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractMarketCircsAnalyseUI.class.getName());
    ...
    public void initUIContentLayout()
    {
        ...
        kDTable1.setBounds(new Rectangle(15, 41, 981, 573));
        this.add(kDTable1, new KDLayout.Constraints(15, 41, 981, 573, 0));
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.market.app.MarketCircsAnalyseUIHandler";
	}
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.market.client", "MarketCircsAnalyseUI");
    }
