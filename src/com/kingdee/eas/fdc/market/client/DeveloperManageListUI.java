 ...
 * output class name
 */
public class DeveloperManageListUI extends AbstractDeveloperManageListUI
{
    private static final Logger logger = CoreUIObject.getLogger(DeveloperManageListUI.class);
...
//    		this.btnRemove.setEnabled(false);
     ...
     */
    public DeveloperManageListUI() throws Exception
    {
        super();
    }
...
//	}
	...
	protected FDCDataBaseInfo getBaseDataInfo() {
		...
		return new DeveloperManageInfo();
	}
