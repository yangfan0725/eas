 ...
 * output class name
 */
public abstract class AbstractMediaListUI extends com.kingdee.eas.framework.client.CoreBillListUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractMediaListUI.class);
    ...
    protected com.kingdee.bos.ctrl.swing.KDTree mediaTypeTree;
    /**
     * output class constructor
     */
    public AbstractMediaListUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractMediaListUI.class.getName());
        this.setUITitle(resHelper.getString("this.title"));
        mainQueryPK = new MetaDataPK("com.kingdee.eas.fdc.market.app", "MediaQuery");
        //actionPageSetup
        ...
        this.mediaTypeTree = new com.kingdee.bos.ctrl.swing.KDTree();
        ...
        this.mediaTypeTree.setName("mediaTypeTree");
        // CoreUI
        ...
        this.tblMain.setFormatXml(resHelper.getString("tblMain.formatXml"));
                this.tblMain.putBindContents("mainQuery",new String[] {"number","name","isEnabled","description","id","CU.id","shortName","synopsis","preferentialMsg","contractMan","sellProject.id","mediaType.id"});
        ...
        // mediaTypeTree
        this.mediaTypeTree.addTreeSelectionListener(new javax.swing.event.TreeSelectionListener() {
            public void valueChanged(javax.swing.event.TreeSelectionEvent e) {
                try {
                    mediaTypeTree_valueChanged(e);
                } catch (Exception exc) {
                    handUIException(exc);
                } finally {
                }
    ...
    public void initUIContentLayout()
    {
        ...
        kDContainer3.setBounds(new Rectangle(264, 13, 740, 603));
        this.add(kDContainer3, new KDLayout.Constraints(264, 13, 740, 603, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_BOTTOM | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT));
        //kDSplitPane1
...
kDContainer2.getContentPane().setLayout(new BorderLayout(0, 0));        kDContainer2.getContentPane().add(kDScrollPane2, BorderLayout.CENTER);
        //kDScrollPane2
        kDScrollPane2.getViewport().add(mediaTypeTree, null);
        //kDContainer3
kDContainer3.getContentPane().setLayout(new BorderLayout(0, 0));        kDContainer3.getContentPane().add(tblMain, BorderLayout.CENTER);
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.market.app.MediaListUIHandler";
	}
    ...
    /**
     * output mediaTypeTree_valueChanged method
     */
    ...
    public SelectorItemCollection getSelectors()
    {
        ...
        sic.add(new SelectorItemInfo("mediaType.id"));
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.market.client", "MediaListUI");
    }
