 ...
 * output class name
 */
public class ChargeEffectAnalyseFilterUI extends AbstractChargeEffectAnalyseFilterUI {
	private static final Logger logger = CoreUIObject.getLogger(ChargeEffectAnalyseFilterUI.class);
	 ...
	 */
	public ChargeEffectAnalyseFilterUI() throws Exception {
		super();
//		this.listUI = listUI;
//		this.actionListOnLoad = actionListOnLoad;
	}

	public ChargeEffectAnalyseFilterUI(ListUI listUI, ItemAction actionListOnLoad) throws Exception {
		super();
		this.listUI = listUI;
		this.actionListOnLoad = actionListOnLoad;
	}
