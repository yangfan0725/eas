 ...
 * output class name
 */
public class ActionEvaluateListUI extends AbstractActionEvaluateListUI
{
    private static final Logger logger = CoreUIObject.getLogger(ActionEvaluateListUI.class);
//    int groupModel = 0;
    /**
     * output class constructor
     */
    public ActionEvaluateListUI() throws Exception
    {
        super();
    }
...
//        filter.getFilterItems().add(new FilterItemInfo("actionid",getUIContext().get("actionid").toString()));
        ...
        this.tblMain.getColumn("actionid").getStyleAttributes().setHided(true);        
    }
    /**
