 ...
 * output class name
 */
public class CompeteItemListUI extends AbstractCompeteItemListUI
{
    private static final Logger logger = CoreUIObject.getLogger(CompeteItemListUI.class);
    
    public boolean isPrepareActionAttachment() {
    	// TODO Auto-generated method stub
    	return super.isPrepareActionAttachment();
    }
     ...
     */
    public CompeteItemListUI() throws Exception
    {
        super();
    }
