 ...
 * output class name
 */
public abstract class AbstractJudgeQuestionListUI extends com.kingdee.eas.framework.client.ListUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractJudgeQuestionListUI.class);
    /**
     * output class constructor
     */
    public AbstractJudgeQuestionListUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractJudgeQuestionListUI.class.getName());
        ...
        this.tblMain.setFormatXml(resHelper.getString("tblMain.formatXml"));
                this.tblMain.putBindContents("mainQuery",new String[] {"number","name","simpleName","description","createTime","lastUpdateTime","creator.number","creator.name","lastUpdateUser.number","lastUpdateUser.name","id","questionStyle"});
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.market.app.JudgeQuestionListUIHandler";
	}
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.market.client", "JudgeQuestionListUI");
    }
