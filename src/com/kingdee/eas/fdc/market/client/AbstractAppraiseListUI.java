 ...
 * output class name
 */
public abstract class AbstractAppraiseListUI extends com.kingdee.eas.fdc.basedata.client.FDCBaseDataListUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractAppraiseListUI.class);
    /**
     * output class constructor
     */
    public AbstractAppraiseListUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractAppraiseListUI.class.getName());
        this.setUITitle(resHelper.getString("this.title"));
        mainQueryPK = new MetaDataPK("com.kingdee.eas.fdc.market.app", "AppraiseQuery");
        //actionPageSetup
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.market.app.AppraiseListUIHandler";
	}
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.market.client", "AppraiseListUI");
    }
