 ...
 * output class name
 */
public abstract class AbstractSurveyTypeListUI extends com.kingdee.eas.fdc.basedata.client.FDCBaseDataListUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractSurveyTypeListUI.class);
    /**
     * output class constructor
     */
    public AbstractSurveyTypeListUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractSurveyTypeListUI.class.getName());
        this.setUITitle(resHelper.getString("this.title"));
        mainQueryPK = new MetaDataPK("com.kingdee.eas.fdc.market.app", "SurveyTypeQuery");
        //actionPageSetup
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.market.app.SurveyTypeListUIHandler";
	}
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.market.client", "SurveyTypeListUI");
    }
