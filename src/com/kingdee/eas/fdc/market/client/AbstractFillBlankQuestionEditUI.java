 ...
 * output class name
 */
public abstract class AbstractFillBlankQuestionEditUI extends com.kingdee.eas.framework.client.EditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractFillBlankQuestionEditUI.class);
    ...
    protected com.kingdee.eas.fdc.market.FillBlankQuestionInfo editData = null;
    /**
     * output class constructor
     */
    public AbstractFillBlankQuestionEditUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractFillBlankQuestionEditUI.class.getName());
    ...
    {
        this.setBounds(new Rectangle(0, 0, 520, 200));
        this.setLayout(null);
        kDLabelContainer5.setBounds(new Rectangle(10, 10, 489, 19));
        this.add(kDLabelContainer5, null);
        kDLabelContainer1.setBounds(new Rectangle(10, 40, 492, 144));
        this.add(kDLabelContainer1, null);
        //kDLabelContainer5
        kDLabelContainer5.setBoundEditor(cmbQuestion);
        //kDLabelContainer1
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.market.app.FillBlankQuestionEditUIHandler";
	}
    ...
    public void setDataObject(IObjectValue dataObject)
    {
        ...
        this.editData = (com.kingdee.eas.fdc.market.FillBlankQuestionInfo)ov;
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.market.client", "FillBlankQuestionEditUI");
    }
