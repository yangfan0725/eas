 ...
 * output class name
 */
public abstract class AbstractPolicyManageListUI extends com.kingdee.eas.framework.client.CoreBillListUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractPolicyManageListUI.class);
     ...
     */
    public AbstractPolicyManageListUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractPolicyManageListUI.class.getName());
        this.setUITitle(resHelper.getString("this.title"));
        mainQueryPK = new MetaDataPK("com.kingdee.eas.fdc.market.app", "PolicyManageQuery");
        //actionRemove
        ...
        this.tblMain.setFormatXml(resHelper.getString("tblMain.formatXml"));
                this.tblMain.putBindContents("mainQuery",new String[] {"id","number","bizDate","description","createTime","lastUpdateTime","auditor.number","auditor.name","creator.number","creator.name","lastUpdateUser.number","lastUpdateUser.name","entrys.id","handler.number","handler.name","entrys.seq","policyName","country.name","province.name","city.name","policyRange","publishDep","keyWord","remark"});
    ...
    public void initUIContentLayout()
    {
        ...
        pnlMain.setBounds(new Rectangle(1, 1, 1002, 627));
        this.add(pnlMain, new KDLayout.Constraints(1, 1, 1002, 627, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_BOTTOM | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT));
        //pnlMain
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.market.app.PolicyManageListUIHandler";
	}
    ...
    protected class ActionTDPrint extends ItemAction
    {
        ...
        public void actionPerformed(ActionEvent e)
        {
            ...
            innerActionPerformed("eas", AbstractPolicyManageListUI.this, "ActionTDPrint", "actionTDPrint_actionPerformed", e);
        }
    }
    ...
    protected class ActionTDPrintPreview extends ItemAction
    {
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractPolicyManageListUI.this, "ActionTDPrintPreview", "actionTDPrintPreview_actionPerformed", e);
        }
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.market.client", "PolicyManageListUI");
    }
    /**
    ...
    {
        return new String[] {"id","number","bizDate","description","createTime","lastUpdateTime","auditor.number","auditor.name","creator.number","creator.name","lastUpdateUser.number","lastUpdateUser.name","handler.number","handler.name","policyName","country.name","province.name","region.name","policyRange","publishDep","keyWord","remark"};
    }
