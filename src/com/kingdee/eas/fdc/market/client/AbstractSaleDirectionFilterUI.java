 ...
 * output class name
 */
public abstract class AbstractSaleDirectionFilterUI extends com.kingdee.eas.base.commonquery.client.CustomerQueryPanel
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractSaleDirectionFilterUI.class);
    ...
    protected com.kingdee.bos.ctrl.swing.KDCheckBox chkIsShowPre;
    ...
    protected com.kingdee.bos.ctrl.swing.KDCheckBox chkIsSpecialBiz;
    /**
     * output class constructor
     */
    public AbstractSaleDirectionFilterUI() throws Exception
    {
        super();
        jbInit();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractSaleDirectionFilterUI.class.getName());
        ...
        this.chkIsShowPre = new com.kingdee.bos.ctrl.swing.KDCheckBox();
        ...
        this.chkIsSpecialBiz = new com.kingdee.bos.ctrl.swing.KDCheckBox();
        ...
        this.chkIsShowPre.setName("chkIsShowPre");
        this.radioByQuarter.setName("radioByQuarter");
        this.radioByYear.setName("radioByYear");
        this.chkIsSpecialBiz.setName("chkIsSpecialBiz");
        // CustomerQueryPanel
        // contDateFrom		
        ...
        // chkIsShowPre		
        this.chkIsShowPre.setText(resHelper.getString("chkIsShowPre.text"));
        this.chkIsShowPre.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent e) {
                beforeActionPerformed(e);
                try {
                    chkIsShowPre_actionPerformed(e);
                } catch (Exception exc) {
                    handUIException(exc);
                } finally {
                    afterActionPerformed(e);
        ...
        this.radioByQuarter.setVisible(false);
        ...
        this.radioByYear.setVisible(false);
        ...
        // chkIsSpecialBiz		
        this.chkIsSpecialBiz.setText(resHelper.getString("chkIsSpecialBiz.text"));
    ...
    public void initUIContentLayout()
    {
        ...
        plDateType.setBounds(new Rectangle(7, 68, 167, 80));
        ...
        chkIsShowPre.setBounds(new Rectangle(13, 157, 208, 19));
        this.add(chkIsShowPre, null);
        radioByQuarter.setBounds(new Rectangle(292, 76, 61, 19));
        this.add(radioByQuarter, null);
        radioByYear.setBounds(new Rectangle(290, 99, 61, 19));
        this.add(radioByYear, null);
        chkIsSpecialBiz.setBounds(new Rectangle(13, 179, 220, 19));
        this.add(chkIsSpecialBiz, null);
        //contDateFrom
        contDateFrom.setBoundEditor(pkDateFrom);
        //contDateTo
        contDateTo.setBoundEditor(pkDateTo);
        //plDateType
        plDateType.setLayout(null);        radioByDay.setBounds(new Rectangle(32, 41, 61, 19));
        plDateType.add(radioByDay, null);
        radioByMonth.setBounds(new Rectangle(32, 16, 61, 19));
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.market.app.SaleDirectionFilterUIHandler";
	}
    ...
    /**
     * output chkIsShowPre_actionPerformed method
     */
    protected void chkIsShowPre_actionPerformed(java.awt.event.ActionEvent e) throws Exception
    {
        //write your code here
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.market.client", "SaleDirectionFilterUI");
    }
