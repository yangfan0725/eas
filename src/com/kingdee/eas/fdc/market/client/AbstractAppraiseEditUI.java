 ...
 * output class name
 */
public abstract class AbstractAppraiseEditUI extends com.kingdee.eas.fdc.basedata.client.FDCBaseDataEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractAppraiseEditUI.class);
    ...
    protected com.kingdee.eas.fdc.market.AppraiseInfo editData = null;
    /**
     * output class constructor
     */
    public AbstractAppraiseEditUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractAppraiseEditUI.class.getName());
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.market.app.AppraiseEditUIHandler";
	}
    ...
    public void setDataObject(IObjectValue dataObject)
    {
        ...
        this.editData = (com.kingdee.eas.fdc.market.AppraiseInfo)ov;
    }
            ...
            if (com.kingdee.bos.ui.face.UIRuleUtil.isNull(txtNumber.getText())) 
{
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.market.client", "AppraiseEditUI");
    }
    /**
    ...
    {
        return com.kingdee.eas.fdc.market.client.AppraiseEditUI.class.getName();
    }
    ...
    {
        return com.kingdee.eas.fdc.market.AppraiseFactory.getRemoteInstance();
    }
    ...
    {
        com.kingdee.eas.fdc.market.AppraiseInfo objectValue = new com.kingdee.eas.fdc.market.AppraiseInfo();
