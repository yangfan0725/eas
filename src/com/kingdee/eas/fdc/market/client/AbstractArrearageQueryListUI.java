 ...
 * output class name
 */
public abstract class AbstractArrearageQueryListUI extends com.kingdee.eas.framework.client.TreeListUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractArrearageQueryListUI.class);
    /**
     * output class constructor
     */
    public AbstractArrearageQueryListUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractArrearageQueryListUI.class.getName());
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.market.app.ArrearageQueryListUIHandler";
	}
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.market.client", "ArrearageQueryListUI");
    }
