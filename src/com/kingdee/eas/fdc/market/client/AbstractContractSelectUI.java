 ...
 * output class name
 */
public abstract class AbstractContractSelectUI extends com.kingdee.eas.framework.client.CoreUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractContractSelectUI.class);
    ...
    protected com.kingdee.bos.ctrl.kdf.table.KDTable tblContractWH;
    ...
    protected EntityViewInfo queryContractWithoutTextQuery = null;
    protected IMetaDataPK queryContractWithoutTextQueryPK;
    /**
     * output class constructor
     */
    public AbstractContractSelectUI() throws Exception
    {
        super();
        this.defaultObjectName = "queryContractBillQuery";
        jbInit();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractContractSelectUI.class.getName());
        this.setUITitle(resHelper.getString("this.title"));
        queryContractBillQueryPK = new MetaDataPK("com.kingdee.eas.fdc.contract.app", "ContractBillQuery");
        queryContractWithoutTextQueryPK = new MetaDataPK("com.kingdee.eas.fdc.contract.app", "ContractWithoutTextQuery");
        ...
        this.tblContractWH = new com.kingdee.bos.ctrl.kdf.table.KDTable();
        ...
        this.tblContractWH.setName("tblContractWH");
        ...
        // tblContractWH
		String tblContractWHStrXML = "<?xml version=\"1.0\" encoding=\"UTF-8\"?> <DocRoot xmlns:c=\"http://www.kingdee.com/Common\" xmlns:f=\"http://www.kingdee.com/Form\" xmlns:t=\"http://www.kingdee.com/Table\" xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" xsi:schemaLocation=\"http://www.kingdee.com/KDF KDFSchema.xsd\" version=\"0.0\"><Styles><c:Style id=\"sCol0\"><c:Protection hidden=\"true\" /></c:Style></Styles><Table id=\"KDTable\"><t:Sheet name=\"sheet1\"><t:Table t:selectMode=\"15\" t:mergeMode=\"0\" t:dataRequestMode=\"0\" t:pageRowCount=\"100\"><t:ColumnGroup><t:Column t:key=\"id\" t:width=\"-1\" t:mergeable=\"true\" t:resizeable=\"true\" t:moveable=\"true\" t:group=\"false\" t:required=\"false\" t:index=\"-1\" t:styleID=\"sCol0\" /><t:Column t:key=\"number\" t:width=\"-1\" t:mergeable=\"true\" t:resizeable=\"true\" t:moveable=\"true\" t:group=\"false\" t:required=\"false\" t:index=\"-1\" /><t:Column t:key=\"billName\" t:width=\"-1\" t:mergeable=\"true\" t:resizeable=\"true\" t:moveable=\"true\" t:group=\"false\" t:required=\"false\" t:index=\"-1\" /><t:Column t:key=\"originalAmount\" t:width=\"-1\" t:mergeable=\"true\" t:resizeable=\"true\" t:moveable=\"true\" t:group=\"false\" t:required=\"false\" t:index=\"-1\" /><t:Column t:key=\"amount\" t:width=\"-1\" t:mergeable=\"true\" t:resizeable=\"true\" t:moveable=\"true\" t:group=\"false\" t:required=\"false\" t:index=\"-1\" /><t:Column t:key=\"partB\" t:width=\"-1\" t:mergeable=\"true\" t:resizeable=\"true\" t:moveable=\"true\" t:group=\"false\" t:required=\"false\" t:index=\"-1\" /><t:Column t:key=\"bizDate\" t:width=\"-1\" t:mergeable=\"true\" t:resizeable=\"true\" t:moveable=\"true\" t:group=\"false\" t:required=\"false\" t:index=\"-1\" /></t:ColumnGroup><t:Head><t:Row t:name=\"header1\" t:height=\"-1\" t:mergeable=\"true\" t:resizeable=\"true\"><t:Cell>$Resource{id}</t:Cell><t:Cell>$Resource{number}</t:Cell><t:Cell>$Resource{billName}</t:Cell><t:Cell>$Resource{originalAmount}</t:Cell><t:Cell>$Resource{amount}</t:Cell><t:Cell>$Resource{partB}</t:Cell><t:Cell>$Resource{bizDate}</t:Cell></t:Row></t:Head></t:Table><t:SheetOptions><t:MergeBlocks><t:Head /></t:MergeBlocks></t:SheetOptions></t:Sheet></Table></DocRoot> ";
		
        this.tblContractWH.setFormatXml(resHelper.translateString("tblContractWH",tblContractWHStrXML));
        this.tblContractWH.addKDTMouseListener(new com.kingdee.bos.ctrl.kdf.table.event.KDTMouseListener() {
            public void tableClicked(com.kingdee.bos.ctrl.kdf.table.event.KDTMouseEvent e) {
                try {
                    tblContractWH_tableClicked(e);
                } catch (Exception exc) {
                    handUIException(exc);
                } finally {
                }
    ...
    public void initUIContentLayout()
    {
        ...
        this.setLayout(null);
        kDTabbedPane1.setBounds(new Rectangle(6, 60, 690, 535));
        this.add(kDTabbedPane1, null);
        contNumber.setBounds(new Rectangle(6, 7, 270, 19));
        this.add(contNumber, null);
        contName.setBounds(new Rectangle(364, 7, 270, 19));
        this.add(contName, null);
        contPartB.setBounds(new Rectangle(6, 29, 270, 19));
        this.add(contPartB, null);
        btnQuery.setBounds(new Rectangle(525, 29, 109, 19));
        this.add(btnQuery, null);
        //kDTabbedPane1
        kDTabbedPane1.add(kDPanel1, resHelper.getString("kDPanel1.constraints"));
        kDTabbedPane1.add(kDPanel2, resHelper.getString("kDPanel2.constraints"));
        //kDPanel1
        kDPanel1.setLayout(null);        tblContract.setBounds(new Rectangle(5, 5, 675, 491));
        kDPanel1.add(tblContract, null);
        //kDPanel2
        kDPanel2.setLayout(null);        tblContractWH.setBounds(new Rectangle(5, 5, 675, 494));
        kDPanel2.add(tblContractWH, null);
        //contNumber
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.market.app.ContractSelectUIHandler";
	}
    ...
    public void setDataObject(IObjectValue dataObject)
    {
        ...
        this.queryContractBillQuery = (EntityViewInfo)ov;
    }
    ...
    public void setDataObject(String key, IObjectValue dataObject)
    {
        ...
        else if (key.equalsIgnoreCase("queryContractWithoutTextQuery")) {
            this.queryContractWithoutTextQuery = (EntityViewInfo)dataObject;
		}
	}
    ...
    /**
     * output tblContractWH_tableClicked method
     */
    protected void tblContractWH_tableClicked(com.kingdee.bos.ctrl.kdf.table.event.KDTMouseEvent e) throws Exception
    {
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.market.client", "ContractSelectUI");
    }
