 ...
 * output class name
 */
public abstract class AbstractChargeEffectAnalyseFilterUI extends com.kingdee.eas.base.commonquery.client.CustomerQueryPanel
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractChargeEffectAnalyseFilterUI.class);
     ...
     */
    public AbstractChargeEffectAnalyseFilterUI() throws Exception
    {
        super();
        jbInit();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractChargeEffectAnalyseFilterUI.class.getName());
        ...
        // spiMonthTo
        // spiYearFrom		
        this.spiYearFrom.setToolTipText(resHelper.getString("spiYearFrom.toolTipText"));
        // lblQuarterFrom		
        ...
        this.lblYearTo.setToolTipText(resHelper.getString("lblYearTo.toolTipText"));
        // chkIsShowAll		
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.market.app.ChargeEffectAnalyseFilterUIHandler";
	}
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.market.client", "ChargeEffectAnalyseFilterUI");
    }
