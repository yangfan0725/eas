 ...
 * output class name
 */
public abstract class AbstractPlanTypeListUI extends com.kingdee.eas.framework.client.TreeListUI implements KDPromptSelector
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractPlanTypeListUI.class);
		...
		public AbstractPlanTypeListUI(HashMap ctx) throws Exception {
			super();
			isF7Use = true;
    ...
    private void jbInit() throws Exception
    {
        ...
        mainQueryPK = new MetaDataPK("com.kingdee.eas.fdc.market.app", "PlanTypeQuery");
        // CoreUI		
        this.tblMain.setFormatXml(resHelper.getString("tblMain.formatXml"));
                this.tblMain.putBindContents("mainQuery",new String[] {"number","longNumber","name","simpleName","description","isLeaf","level","createTime","lastUpdateTime","creator.number","creator.name","lastUpdateUser.number","lastUpdateUser.name","id","isEnabled"});
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.market.app.PlanTypeListUIHandler";
	}
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.market.client", "PlanTypeListUI");
    }
