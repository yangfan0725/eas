 ...
 * output class name
 */
public class PerformTypeListUI extends AbstractPerformTypeListUI
{
    private static final Logger logger = CoreUIObject.getLogger(PerformTypeListUI.class);
    
    /**
     * output class constructor
     */
    public PerformTypeListUI() throws Exception
    {
        super();
    }
