 ...
 * output class name
 */
public abstract class AbstractMovementTypeListUI extends com.kingdee.eas.fdc.basedata.client.FDCBaseDataListUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractMovementTypeListUI.class);
    /**
     * output class constructor
     */
    public AbstractMovementTypeListUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractMovementTypeListUI.class.getName());
        this.setUITitle(resHelper.getString("this.title"));
        mainQueryPK = new MetaDataPK("com.kingdee.eas.fdc.market.app", "MovementTypeQuery");
        //actionPageSetup
        ...
        this.tblMain.addKDTSelectListener(new com.kingdee.bos.ctrl.kdf.table.event.KDTSelectListener() {
            public void tableSelectChanged(com.kingdee.bos.ctrl.kdf.table.event.KDTSelectEvent e) {
                ...
                this.tblMain.putBindContents("mainQuery",new String[] {"number","name","isEnabled","description","id","CU.id","shortName","popularizeType.name"});
    ...
    public SelectorItemCollection getSelectors()
    {
        ...
        sic.add(new SelectorItemInfo("popularizeType.name"));
        return sic;
    }        
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.market.client", "MovementTypeListUI");
    }
