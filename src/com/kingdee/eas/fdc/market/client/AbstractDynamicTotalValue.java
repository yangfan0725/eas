 ...
 * output class name
 */
public abstract class AbstractDynamicTotalValue extends com.kingdee.eas.framework.report.client.CommRptBaseUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractDynamicTotalValue.class);
     ...
     */
    public AbstractDynamicTotalValue() throws Exception
    {
        super();
        jbInit();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractDynamicTotalValue.class.getName());
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.market.app.DynamicTotalValueHandler";
	}
    ...
    protected class ActionQuickPic extends ItemAction {     
        ...
        public void actionPerformed(ActionEvent e)
        {
            ...
            innerActionPerformed("eas", AbstractDynamicTotalValue.this, "ActionQuickPic", "actionQuickPic_actionPerformed", e);
        }
    }
    ...
    protected class ActionHistory extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractDynamicTotalValue.this, "ActionHistory", "actionHistory_actionPerformed", e);
        }
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.market.client", "DynamicTotalValue");
    }
