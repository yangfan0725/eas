 ...
 * output class name
 */
public abstract class AbstractSelectQuestionListUI extends com.kingdee.eas.framework.client.ListUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractSelectQuestionListUI.class);
    /**
     * output class constructor
     */
    public AbstractSelectQuestionListUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractSelectQuestionListUI.class.getName());
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.market.app.SelectQuestionListUIHandler";
	}
    ...
    public SelectorItemCollection getSelectors()
    {
        ...
        sic.add(new SelectorItemInfo("Item.name0"));
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.market.client", "SelectQuestionListUI");
    }
