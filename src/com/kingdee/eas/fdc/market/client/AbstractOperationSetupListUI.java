 ...
 * output class name
 */
public abstract class AbstractOperationSetupListUI extends com.kingdee.eas.fdc.basedata.client.FDCBaseDataListUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractOperationSetupListUI.class);
    /**
     * output class constructor
     */
    public AbstractOperationSetupListUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractOperationSetupListUI.class.getName());
        this.setUITitle(resHelper.getString("this.title"));
        mainQueryPK = new MetaDataPK("com.kingdee.eas.fdc.market.app", "OperationSetupQuery");
        //actionPageSetup
        ...
        this.tblMain.addKDTSelectListener(new com.kingdee.bos.ctrl.kdf.table.event.KDTSelectListener() {
            public void tableSelectChanged(com.kingdee.bos.ctrl.kdf.table.event.KDTSelectEvent e) {
                ...
                this.tblMain.putBindContents("mainQuery",new String[] {"number","name","isEnabled","description","id","CU.id","shortName","setupValue"});
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.market.app.OperationSetupListUIHandler";
	}
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.market.client", "OperationSetupListUI");
    }
