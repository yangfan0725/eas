 ...
 * output class name
 */
public abstract class AbstractMarketSurveyListUI extends com.kingdee.eas.framework.client.CoreBillListUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractMarketSurveyListUI.class);
     ...
     */
    public AbstractMarketSurveyListUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractMarketSurveyListUI.class.getName());
        this.setUITitle(resHelper.getString("this.title"));
        mainQueryPK = new MetaDataPK("com.kingdee.eas.fdc.market.app", "MarketSurveyQuery");
        //actionRemove
        ...
        this.tblMain.setFormatXml(resHelper.getString("tblMain.formatXml"));
                this.tblMain.putBindContents("mainQuery",new String[] {"id","number","bizDate","surveyName","surveyPerson.name","surveyYear","surveyMonth","province.name","area.name","description"});
    ...
    public void initUIContentLayout()
    {
        ...
        pnlMain.setBounds(new Rectangle(8, 9, 993, 609));
        this.add(pnlMain, new KDLayout.Constraints(8, 9, 993, 609, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_BOTTOM | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT));
        //pnlMain
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.market.app.MarketSurveyListUIHandler";
	}
    ...
    public SelectorItemCollection getSelectors()
    {
        ...
        sic.add(new SelectorItemInfo("surveyPerson.name"));
        return sic;
    }        
    ...
    protected class ActionTDPrint extends ItemAction {     
        ...
        public void actionPerformed(ActionEvent e)
        {
            ...
            innerActionPerformed("eas", AbstractMarketSurveyListUI.this, "ActionTDPrint", "actionTDPrint_actionPerformed", e);
        }
    }
    ...
    protected class ActionTDPrintPreview extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractMarketSurveyListUI.this, "ActionTDPrintPreview", "actionTDPrintPreview_actionPerformed", e);
        }
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.market.client", "MarketSurveyListUI");
    }
    /**
    ...
    {
        return new String[] {"id","number","bizDate","surveyName","surveyPerson.number","surveyYear","surveyMonth","province.name","area.name","description"};
    }
