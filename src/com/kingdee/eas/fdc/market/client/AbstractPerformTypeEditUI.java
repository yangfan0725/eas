 ...
 * output class name
 */
public abstract class AbstractPerformTypeEditUI extends com.kingdee.eas.fdc.basedata.client.FDCBaseDataEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractPerformTypeEditUI.class);
    ...
    protected com.kingdee.eas.fdc.market.PerformTypeInfo editData = null;
    /**
     * output class constructor
     */
    public AbstractPerformTypeEditUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractPerformTypeEditUI.class.getName());
        ...
        this.setFocusTraversalPolicy(new com.kingdee.bos.ui.UIFocusTraversalPolicy(new java.awt.Component[] {bizDescription,txtNumber,bizName,chkIsEnabled,txtshortName,kDLabel1}));
    ...
    {
        this.setBounds(new Rectangle(0, 0, 290, 211));
        this.setLayout(null);
        contName.setBounds(new Rectangle(10, 40, 270, 19));
        this.add(contName, null);
        contNumber.setBounds(new Rectangle(10, 10, 270, 19));
        this.add(contNumber, null);
        chkIsEnabled.setBounds(new Rectangle(235, 97, 140, 19));
        this.add(chkIsEnabled, null);
        bizDescription.setBounds(new Rectangle(10, 127, 270, 70));
        this.add(bizDescription, null);
        kDLabel1.setBounds(new Rectangle(10, 97, 100, 19));
        this.add(kDLabel1, null);
        contshortName.setBounds(new Rectangle(10, 70, 270, 19));
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.market.app.PerformTypeEditUIHandler";
	}
    ...
    public void setDataObject(IObjectValue dataObject)
    {
        ...
        this.editData = (com.kingdee.eas.fdc.market.PerformTypeInfo)ov;
    }
            ...
            if (com.kingdee.bos.ui.face.UIRuleUtil.isNull(bizName.getDefaultLangItemData())) 
{
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.market.client", "PerformTypeEditUI");
    }
    /**
