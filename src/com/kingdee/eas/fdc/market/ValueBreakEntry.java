...
public class ValueBreakEntry extends CoreBase implements IValueBreakEntry
{
    public ValueBreakEntry()
    {
        super();
        registerInterface(IValueBreakEntry.class, this);
    }
    public ValueBreakEntry(Context ctx)
    {
        super(ctx);
        registerInterface(IValueBreakEntry.class, this);
    }
    ...
    private ValueBreakEntryController getController() throws BOSException
    {
        return (ValueBreakEntryController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getValueBreakEntryInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getValueBreakEntryInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getValueBreakEntryInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getValueBreakEntryCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getValueBreakEntryCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getValueBreakEntryCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
