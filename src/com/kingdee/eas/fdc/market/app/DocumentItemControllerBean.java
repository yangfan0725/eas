...
public class DocumentItemControllerBean extends AbstractDocumentItemControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.fdc.market.app.DocumentItemControllerBean");
}