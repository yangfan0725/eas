...
public class MarketTypeControllerBean extends AbstractMarketTypeControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.fdc.market.app.MarketTypeControllerBean");
    protected IObjectPK _submit(Context ctx, IObjectValue model) throws BOSException, EASBizException {
    	handleIntermitNumber(ctx, (MarketTypeInfo) model);
    ...
    private static void handleIntermitNumber(Context ctx, MarketTypeInfo info) throws BOSException, CodingRuleException, EASBizException {
