...
public class MarketManageEntryControllerBean extends AbstractMarketManageEntryControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.fdc.market.app.MarketManageEntryControllerBean");
}