...
public class MarketSurveyControllerBean extends AbstractMarketSurveyControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.fdc.market.app.MarketSurveyControllerBean");
    
    protected IObjectPK _submit(Context ctx, IObjectValue model) throws BOSException, EASBizException {
    	handleIntermitNumber(ctx, (MarketSurveyInfo) model);
    ...
    private static void handleIntermitNumber(Context ctx, MarketSurveyInfo info) throws BOSException, CodingRuleException, EASBizException {
