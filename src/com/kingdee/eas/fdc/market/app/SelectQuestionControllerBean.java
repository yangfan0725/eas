...
public class SelectQuestionControllerBean extends AbstractSelectQuestionControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.fdc.market.app.SelectQuestionControllerBean");
}