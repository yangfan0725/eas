...
public class MovementPlanE6ControllerBean extends AbstractMovementPlanE6ControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.fdc.market.app.MovementPlanE6ControllerBean");
}