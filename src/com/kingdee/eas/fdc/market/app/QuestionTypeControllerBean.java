...
public class QuestionTypeControllerBean extends AbstractQuestionTypeControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.fdc.market.app.QuestionTypeControllerBean");
    protected IObjectPK _submit(Context ctx, IObjectValue model) throws BOSException, EASBizException {
    	handleIntermitNumber(ctx, (QuestionTypeInfo) model);
    ...
    private static void handleIntermitNumber(Context ctx, QuestionTypeInfo info) throws BOSException, CodingRuleException, EASBizException {
