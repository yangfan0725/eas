...
public class MarketManageEffectControllerBean extends AbstractMarketManageEffectControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.fdc.market.app.MarketManageEffectControllerBean");
}