...
public class QuestionBaseControllerBean extends AbstractQuestionBaseControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.fdc.market.app.QuestionBaseControllerBean");
