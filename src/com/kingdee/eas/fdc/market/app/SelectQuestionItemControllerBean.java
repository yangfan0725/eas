...
public class SelectQuestionItemControllerBean extends AbstractSelectQuestionItemControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.fdc.market.app.SelectQuestionItemControllerBean");
}