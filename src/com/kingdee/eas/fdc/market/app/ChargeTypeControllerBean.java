...
public class ChargeTypeControllerBean extends AbstractChargeTypeControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.fdc.market.app.ChargeTypeControllerBean");
