...
public class FillBlankQuestionControllerBean extends AbstractFillBlankQuestionControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.fdc.market.app.FillBlankQuestionControllerBean");
}