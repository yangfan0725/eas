...
public class StoreSubjectClassControllerBean extends AbstractStoreSubjectClassControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.fdc.market.app.StoreSubjectClassControllerBean");
    protected IObjectPK _submit(Context ctx, IObjectValue model) throws BOSException, EASBizException {
    	handleIntermitNumber(ctx, (StoreSubjectClassInfo) model);
    ...
    private static void handleIntermitNumber(Context ctx, StoreSubjectClassInfo info) throws BOSException, CodingRuleException, EASBizException {
