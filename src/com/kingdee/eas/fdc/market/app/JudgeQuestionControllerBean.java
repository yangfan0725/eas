...
public class JudgeQuestionControllerBean extends AbstractJudgeQuestionControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.fdc.market.app.JudgeQuestionControllerBean");
}