...
public class QuestionPaperAnswerEntryControllerBean extends AbstractQuestionPaperAnswerEntryControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.fdc.market.app.QuestionPaperAnswerEntryControllerBean");
}