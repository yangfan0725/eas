...
public class CompetePriceRecordControllerBean extends AbstractCompetePriceRecordControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.fdc.market.app.CompetePriceRecordControllerBean");
}