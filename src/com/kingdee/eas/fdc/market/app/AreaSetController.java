...
import com.kingdee.eas.fdc.market.AreaSetCollection;
import com.kingdee.bos.util.*;
...
public interface AreaSetController extends FDCDataBaseController
{
    ...
    public IObjectPK addnew(Context ctx, AreaSetInfo model) throws BOSException, EASBizException, RemoteException;
    public void addnew(Context ctx, IObjectPK pk, AreaSetInfo model) throws BOSException, EASBizException, RemoteException;
    public void update(Context ctx, IObjectPK pk, AreaSetInfo model) throws BOSException, EASBizException, RemoteException;
    public void updatePartial(Context ctx, AreaSetInfo model, SelectorItemCollection selector) throws BOSException, EASBizException, RemoteException;
    public void updateBigObject(Context ctx, IObjectPK pk, AreaSetInfo model) throws BOSException, RemoteException;
