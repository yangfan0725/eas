...
public class MovementPlanE2ControllerBean extends AbstractMovementPlanE2ControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.fdc.market.app.MovementPlanE2ControllerBean");
}