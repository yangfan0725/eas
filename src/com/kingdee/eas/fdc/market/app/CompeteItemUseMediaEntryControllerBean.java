...
public class CompeteItemUseMediaEntryControllerBean extends AbstractCompeteItemUseMediaEntryControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.fdc.market.app.CompeteItemUseMediaEntryControllerBean");
}