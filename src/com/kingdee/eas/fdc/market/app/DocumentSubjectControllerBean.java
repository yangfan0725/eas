...
public class DocumentSubjectControllerBean extends AbstractDocumentSubjectControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.fdc.market.app.DocumentSubjectControllerBean");
}