...
public class MarketManageCustomerControllerBean extends AbstractMarketManageCustomerControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.fdc.market.app.MarketManageCustomerControllerBean");
}