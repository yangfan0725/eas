...
public class MovementPlanE5ControllerBean extends AbstractMovementPlanE5ControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.fdc.market.app.MovementPlanE5ControllerBean");
}