...
public class PlanEntrysSecControllerBean extends AbstractPlanEntrysSecControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.fdc.market.app.PlanEntrysSecControllerBean");
}