...
public class MarketManageCharge extends BillEntryBase implements IMarketManageCharge
{
    public MarketManageCharge()
    {
        super();
        registerInterface(IMarketManageCharge.class, this);
    }
    public MarketManageCharge(Context ctx)
    {
        super(ctx);
        registerInterface(IMarketManageCharge.class, this);
    }
    ...
    private MarketManageChargeController getController() throws BOSException
    {
        return (MarketManageChargeController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getMarketManageChargeInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getMarketManageChargeInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getMarketManageChargeInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getMarketManageChargeCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getMarketManageChargeCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getMarketManageChargeCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
