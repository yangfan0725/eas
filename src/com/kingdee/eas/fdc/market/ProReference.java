...
public class ProReference extends CoreBillEntryBase implements IProReference
{
    public ProReference()
    {
        super();
        registerInterface(IProReference.class, this);
    }
    public ProReference(Context ctx)
    {
        super(ctx);
        registerInterface(IProReference.class, this);
    }
    ...
    private ProReferenceController getController() throws BOSException
    {
        return (ProReferenceController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getProReferenceInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getProReferenceInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getProReferenceInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getProReferenceCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getProReferenceCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getProReferenceCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
