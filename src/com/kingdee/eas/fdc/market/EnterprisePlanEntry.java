...
public class EnterprisePlanEntry extends CoreBillEntryBase implements IEnterprisePlanEntry
{
    public EnterprisePlanEntry()
    {
        super();
        registerInterface(IEnterprisePlanEntry.class, this);
    }
    public EnterprisePlanEntry(Context ctx)
    {
        super(ctx);
        registerInterface(IEnterprisePlanEntry.class, this);
    }
    ...
    private EnterprisePlanEntryController getController() throws BOSException
    {
        return (EnterprisePlanEntryController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getEnterprisePlanEntryInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getEnterprisePlanEntryInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getEnterprisePlanEntryInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getEnterprisePlanEntryCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getEnterprisePlanEntryCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getEnterprisePlanEntryCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
