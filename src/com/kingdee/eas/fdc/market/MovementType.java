...
public class MovementType extends FDCDataBase implements IMovementType
{
    public MovementType()
    {
        super();
        registerInterface(IMovementType.class, this);
    }
    public MovementType(Context ctx)
    {
        super(ctx);
        registerInterface(IMovementType.class, this);
    }
    ...
    private MovementTypeController getController() throws BOSException
    {
        return (MovementTypeController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getMovementTypeInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getMovementTypeInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getMovementTypeInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getMovementTypeCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getMovementTypeCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getMovementTypeCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
