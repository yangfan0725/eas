...
public class ValuePlan extends FDCBill implements IValuePlan
{
    public ValuePlan()
    {
        super();
        registerInterface(IValuePlan.class, this);
    }
    public ValuePlan(Context ctx)
    {
        super(ctx);
        registerInterface(IValuePlan.class, this);
    }
    ...
    private ValuePlanController getController() throws BOSException
    {
        return (ValuePlanController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getValuePlanInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getValuePlanInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getValuePlanInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getValuePlanCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getValuePlanCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getValuePlanCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
