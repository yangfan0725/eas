...
public class MeasurePlanTarget extends FDCBill implements IMeasurePlanTarget
{
    public MeasurePlanTarget()
    {
        super();
        registerInterface(IMeasurePlanTarget.class, this);
    }
    public MeasurePlanTarget(Context ctx)
    {
        super(ctx);
        registerInterface(IMeasurePlanTarget.class, this);
    }
    ...
    private MeasurePlanTargetController getController() throws BOSException
    {
        return (MeasurePlanTargetController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getMeasurePlanTargetInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getMeasurePlanTargetInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getMeasurePlanTargetInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getMeasurePlanTargetCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getMeasurePlanTargetCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getMeasurePlanTargetCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
