...
public class MarketManageCustomer extends BillEntryBase implements IMarketManageCustomer
{
    public MarketManageCustomer()
    {
        super();
        registerInterface(IMarketManageCustomer.class, this);
    }
    public MarketManageCustomer(Context ctx)
    {
        super(ctx);
        registerInterface(IMarketManageCustomer.class, this);
    }
    ...
    private MarketManageCustomerController getController() throws BOSException
    {
        return (MarketManageCustomerController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getMarketManageCustomerInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getMarketManageCustomerInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getMarketManageCustomerInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getMarketManageCustomerCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getMarketManageCustomerCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getMarketManageCustomerCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
