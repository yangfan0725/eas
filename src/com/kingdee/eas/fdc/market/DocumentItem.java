...
public class DocumentItem extends BillBase implements IDocumentItem
{
    public DocumentItem()
    {
        super();
        registerInterface(IDocumentItem.class, this);
    }
    public DocumentItem(Context ctx)
    {
        super(ctx);
        registerInterface(IDocumentItem.class, this);
    }
    ...
    private DocumentItemController getController() throws BOSException
    {
        return (DocumentItemController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getDocumentItemInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getDocumentItemInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getDocumentItemInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getDocumentItemCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getDocumentItemCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getDocumentItemCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
