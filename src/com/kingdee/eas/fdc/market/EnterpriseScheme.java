...
public class EnterpriseScheme extends FDCBill implements IEnterpriseScheme
{
    public EnterpriseScheme()
    {
        super();
        registerInterface(IEnterpriseScheme.class, this);
    }
    public EnterpriseScheme(Context ctx)
    {
        super(ctx);
        registerInterface(IEnterpriseScheme.class, this);
    }
    ...
    private EnterpriseSchemeController getController() throws BOSException
    {
        return (EnterpriseSchemeController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getEnterpriseSchemeInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getEnterpriseSchemeInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getEnterpriseSchemeInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getEnterpriseSchemeCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getEnterpriseSchemeCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getEnterpriseSchemeCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
