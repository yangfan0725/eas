...
public class PlanEntrysSec extends BillEntryBase implements IPlanEntrysSec
{
    public PlanEntrysSec()
    {
        super();
        registerInterface(IPlanEntrysSec.class, this);
    }
    public PlanEntrysSec(Context ctx)
    {
        super(ctx);
        registerInterface(IPlanEntrysSec.class, this);
    }
    ...
    private PlanEntrysSecController getController() throws BOSException
    {
        return (PlanEntrysSecController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getPlanEntrysSecInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getPlanEntrysSecInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getPlanEntrysSecInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getPlanEntrysSecCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getPlanEntrysSecCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getPlanEntrysSecCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
