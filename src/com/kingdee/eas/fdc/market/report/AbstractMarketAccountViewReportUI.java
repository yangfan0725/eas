 ...
 * output class name
 */
public abstract class AbstractMarketAccountViewReportUI extends com.kingdee.eas.framework.report.client.CommRptBaseUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractMarketAccountViewReportUI.class);
     ...
     */
    public AbstractMarketAccountViewReportUI() throws Exception
    {
        super();
        jbInit();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractMarketAccountViewReportUI.class.getName());
    ...
    public void initUIContentLayout()
    {
        ...
        kDSplitPane1.setBounds(new Rectangle(14, 12, 990, 575));
        this.add(kDSplitPane1, new KDLayout.Constraints(14, 12, 990, 575, KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT));
        //kDSplitPane1
...
kDPanel1.setLayout(new BorderLayout(0, 0));        kDPanel1.add(tblMain, BorderLayout.CENTER);
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.market.report.MarketAccountViewReportUIHandler";
	}
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.market.report", "MarketAccountViewReportUI");
    }
