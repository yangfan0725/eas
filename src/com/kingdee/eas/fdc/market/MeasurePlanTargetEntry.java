...
public class MeasurePlanTargetEntry extends CoreBillEntryBase implements IMeasurePlanTargetEntry
{
    public MeasurePlanTargetEntry()
    {
        super();
        registerInterface(IMeasurePlanTargetEntry.class, this);
    }
    public MeasurePlanTargetEntry(Context ctx)
    {
        super(ctx);
        registerInterface(IMeasurePlanTargetEntry.class, this);
    }
    ...
    private MeasurePlanTargetEntryController getController() throws BOSException
    {
        return (MeasurePlanTargetEntryController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getMeasurePlanTargetEntryInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getMeasurePlanTargetEntryInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getMeasurePlanTargetEntryInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getMeasurePlanTargetEntryCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getMeasurePlanTargetEntryCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getMeasurePlanTargetEntryCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
