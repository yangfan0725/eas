...
public class DocumentAnswer extends BillBase implements IDocumentAnswer
{
    public DocumentAnswer()
    {
        super();
        registerInterface(IDocumentAnswer.class, this);
    }
    public DocumentAnswer(Context ctx)
    {
        super(ctx);
        registerInterface(IDocumentAnswer.class, this);
    }
    ...
    private DocumentAnswerController getController() throws BOSException
    {
        return (DocumentAnswerController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getDocumentAnswerInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getDocumentAnswerInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getDocumentAnswerInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getDocumentAnswerCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getDocumentAnswerCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getDocumentAnswerCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
