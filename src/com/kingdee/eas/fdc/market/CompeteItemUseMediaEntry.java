...
public class CompeteItemUseMediaEntry extends BillEntryBase implements ICompeteItemUseMediaEntry
{
    public CompeteItemUseMediaEntry()
    {
        super();
        registerInterface(ICompeteItemUseMediaEntry.class, this);
    }
    public CompeteItemUseMediaEntry(Context ctx)
    {
        super(ctx);
        registerInterface(ICompeteItemUseMediaEntry.class, this);
    }
    ...
    private CompeteItemUseMediaEntryController getController() throws BOSException
    {
        return (CompeteItemUseMediaEntryController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getCompeteItemUseMediaEntryInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getCompeteItemUseMediaEntryInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getCompeteItemUseMediaEntryInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getCompeteItemUseMediaEntryCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getCompeteItemUseMediaEntryCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getCompeteItemUseMediaEntryCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
