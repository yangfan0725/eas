...
public class DocumentOption extends BillBase implements IDocumentOption
{
    public DocumentOption()
    {
        super();
        registerInterface(IDocumentOption.class, this);
    }
    public DocumentOption(Context ctx)
    {
        super(ctx);
        registerInterface(IDocumentOption.class, this);
    }
    ...
    private DocumentOptionController getController() throws BOSException
    {
        return (DocumentOptionController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getDocumentOptionInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getDocumentOptionInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getDocumentOptionInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getDocumentOptionCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getDocumentOptionCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getDocumentOptionCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
