...
public class StoreOption extends BillBase implements IStoreOption
{
    public StoreOption()
    {
        super();
        registerInterface(IStoreOption.class, this);
    }
    public StoreOption(Context ctx)
    {
        super(ctx);
        registerInterface(IStoreOption.class, this);
    }
    ...
    private StoreOptionController getController() throws BOSException
    {
        return (StoreOptionController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getStoreOptionInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getStoreOptionInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getStoreOptionInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getStoreOptionCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getStoreOptionCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getStoreOptionCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
