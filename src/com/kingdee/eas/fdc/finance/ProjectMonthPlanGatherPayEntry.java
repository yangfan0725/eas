...
public class ProjectMonthPlanGatherPayEntry extends CoreBillEntryBase implements IProjectMonthPlanGatherPayEntry
{
    public ProjectMonthPlanGatherPayEntry()
    {
        super();
        registerInterface(IProjectMonthPlanGatherPayEntry.class, this);
    }
    public ProjectMonthPlanGatherPayEntry(Context ctx)
    {
        super(ctx);
        registerInterface(IProjectMonthPlanGatherPayEntry.class, this);
    }
    ...
    private ProjectMonthPlanGatherPayEntryController getController() throws BOSException
    {
        return (ProjectMonthPlanGatherPayEntryController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getProjectMonthPlanGatherPayEntryInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getProjectMonthPlanGatherPayEntryInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getProjectMonthPlanGatherPayEntryInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getProjectMonthPlanGatherPayEntryCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getProjectMonthPlanGatherPayEntryCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getProjectMonthPlanGatherPayEntryCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
