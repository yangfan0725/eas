...
public class ConPayPlanSplit extends FDCSplitBill implements IConPayPlanSplit
{
    public ConPayPlanSplit()
    {
        super();
        registerInterface(IConPayPlanSplit.class, this);
    }
    public ConPayPlanSplit(Context ctx)
    {
        super(ctx);
        registerInterface(IConPayPlanSplit.class, this);
    }
    ...
    private ConPayPlanSplitController getController() throws BOSException
    {
        return (ConPayPlanSplitController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getConPayPlanSplitInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getConPayPlanSplitInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getConPayPlanSplitInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getConPayPlanSplitCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getConPayPlanSplitCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getConPayPlanSplitCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    /**
     *得到月度科目的执行计划-User defined method
     *@param prjId 项目ID
     *@param date 计划日期
     *@return
     */
    ...
    {
        try {
            return getController().getCostAcctPlan(getContext(), prjId, date);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
