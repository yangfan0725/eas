...
public class OrgUnitMonthPlanGather extends FDCBill implements IOrgUnitMonthPlanGather
{
    public OrgUnitMonthPlanGather()
    {
        super();
        registerInterface(IOrgUnitMonthPlanGather.class, this);
    }
    public OrgUnitMonthPlanGather(Context ctx)
    {
        super(ctx);
        registerInterface(IOrgUnitMonthPlanGather.class, this);
    }
    ...
    private OrgUnitMonthPlanGatherController getController() throws BOSException
    {
        return (OrgUnitMonthPlanGatherController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getOrgUnitMonthPlanGatherInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getOrgUnitMonthPlanGatherInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getOrgUnitMonthPlanGatherInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getOrgUnitMonthPlanGatherCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getOrgUnitMonthPlanGatherCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getOrgUnitMonthPlanGatherCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
