...
public class FdcRealCaculator implements ICalculator, IMethodBatchQuery {
	...
	public boolean batchQuery(Map methods) {
		...
		SortedParameterArray params = (SortedParameterArray)methods.get("fdc_real");
		if(params!=null){
			...
			periodBeginNumber = (String)((Variant)obj[3]).getValue();
			periodEndNumber = (String)((Variant)obj[4]).getValue();
		
		
		try {
			BigDecimal amount = fdc_real(null, fdcProjectNumber,paymentTypeNumber, periodBeginNumber,periodEndNumber);
