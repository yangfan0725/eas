...
public class FdcAcctHasPaidCostCaculator implements IMethodBatchQuery,
		ICalculator {
	...
	public boolean batchQuery(Map methods) {
		//获得从界面传递过来的相关参数
		SortedParameterArray params = (SortedParameterArray) methods.get("fdc_acct_hasPaid_cost");
		if (params != null) {
			for (int i = 0; i < params.size(); i++) {
				...
				try {
					//通过计算公式计算，返回结果
					BigDecimal amount = this.fdc_acct_hasPaid_cost(
	 ...
	 * @throws SQLException
	 */
	public BigDecimal fdc_acct_hasPaid_cost(String fdcCompanyNumber,String prjNumber,String acctLongNumber,String month, String conNumber) throws ParseException, BOSException, SQLException
	{
