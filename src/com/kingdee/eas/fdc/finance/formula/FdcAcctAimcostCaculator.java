 ...
 */
public class FdcAcctAimcostCaculator implements ICalculator, IMethodBatchQuery 
{
	...
	public FdcAcctAimcostCaculator()
	{
	...
	{
		SortedParameterArray params = (SortedParameterArray) methods.get("fdc_acct_aimcost");
		if (params != null)
		{
		...
		try
		{
			BigDecimal amount = this.fdc_acct_aimcost(fdcCompanyNumber, prjNumber,acctLongNumber, month);
	 ...
	 * @throws SQLException 
	 */
	public BigDecimal fdc_acct_aimcost(String fdcCompanyNumber,String prjNumber,String acctLongNumber,String month) throws ParseException, BOSException, SQLException
	{
