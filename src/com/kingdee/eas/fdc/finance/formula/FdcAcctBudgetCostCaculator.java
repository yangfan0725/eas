 ...
 */
public class FdcAcctBudgetCostCaculator implements ICalculator, IMethodBatchQuery 
{
	...
	public FdcAcctBudgetCostCaculator()
	{
	...
	{
		SortedParameterArray params = (SortedParameterArray) methods.get("fdc_acct_budget_cost");
		if (params != null)
		{
		...
		try
		{
			BigDecimal amount = this.fdc_acct_budget_cost(fdcCompanyNumber, prjNumber,acctLongNumber, month);
	 ...
	 * @throws SQLException 
	 */
	public BigDecimal fdc_acct_budget_cost(String fdcCompanyNumber,String prjNumber,String acctLongNumber,String month) throws BOSException, ParseException, SQLException
	{
		...
		{
			builder.appendSql(" select sum(item.FCost) as FCost  from T_FNC_FDCYearBudgetAcctEntry  entry ");
