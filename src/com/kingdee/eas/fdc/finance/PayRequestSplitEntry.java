...
public class PayRequestSplitEntry extends FDCSplitBillEntry implements IPayRequestSplitEntry
{
    public PayRequestSplitEntry()
    {
        super();
        registerInterface(IPayRequestSplitEntry.class, this);
    }
    public PayRequestSplitEntry(Context ctx)
    {
        super(ctx);
        registerInterface(IPayRequestSplitEntry.class, this);
    }
    ...
    private PayRequestSplitEntryController getController() throws BOSException
    {
        return (PayRequestSplitEntryController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getPayRequestSplitEntryInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getPayRequestSplitEntryInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getPayRequestSplitEntryInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getPayRequestSplitEntryCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getPayRequestSplitEntryCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getPayRequestSplitEntryCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
