 ...
 * output class name
 */
public abstract class AbstractProjectYearPlanEditUI extends com.kingdee.eas.fdc.basedata.client.FDCBillEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractProjectYearPlanEditUI.class);
    ...
    protected com.kingdee.bos.ctrl.kdf.table.KDTable kdtAmount;
    protected com.kingdee.bos.ctrl.kdf.table.KDTable kdtDate;
     ...
     */
    public AbstractProjectYearPlanEditUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractProjectYearPlanEditUI.class.getName());
        ...
        this.kdtAmount = new com.kingdee.bos.ctrl.kdf.table.KDTable();
        this.kdtDate = new com.kingdee.bos.ctrl.kdf.table.KDTable();
        ...
        this.kdtAmount.setName("kdtAmount");
        this.kdtDate.setName("kdtDate");
        ...
        // kdtAmount
		String kdtAmountStrXML = "<?xml version=\"1.0\" encoding=\"UTF-8\"?> <DocRoot xmlns:c=\"http://www.kingdee.com/Common\" xmlns:f=\"http://www.kingdee.com/Form\" xmlns:t=\"http://www.kingdee.com/Table\" xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" xsi:schemaLocation=\"http://www.kingdee.com/KDF KDFSchema.xsd\" version=\"0.0\"><Styles /><Table id=\"KDTable\"><t:Sheet name=\"sheet1\"><t:Table t:selectMode=\"15\" t:mergeMode=\"0\" t:dataRequestMode=\"0\" t:pageRowCount=\"100\"><t:ColumnGroup><t:Column t:key=\"year\" t:width=\"-1\" t:mergeable=\"true\" t:resizeable=\"true\" t:moveable=\"true\" t:group=\"false\" t:required=\"false\" t:index=\"-1\" /><t:Column t:key=\"total\" t:width=\"-1\" t:mergeable=\"true\" t:resizeable=\"true\" t:moveable=\"true\" t:group=\"false\" t:required=\"false\" t:index=\"-1\" /></t:ColumnGroup><t:Head><t:Row t:name=\"header1\" t:height=\"-1\" t:mergeable=\"true\" t:resizeable=\"true\"><t:Cell>$Resource{year}</t:Cell><t:Cell>$Resource{total}</t:Cell></t:Row></t:Head></t:Table><t:SheetOptions><t:MergeBlocks><t:Head /></t:MergeBlocks></t:SheetOptions></t:Sheet></Table></DocRoot> ";
		
        this.kdtAmount.setFormatXml(resHelper.translateString("kdtAmount",kdtAmountStrXML));

                this.kdtAmount.putBindContents("editData",new String[] {"year","amount"});


        // kdtDate
		String kdtDateStrXML = "<?xml version=\"1.0\" encoding=\"UTF-8\"?> <DocRoot xmlns:c=\"http://www.kingdee.com/Common\" xmlns:f=\"http://www.kingdee.com/Form\" xmlns:t=\"http://www.kingdee.com/Table\" xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" xsi:schemaLocation=\"http://www.kingdee.com/KDF KDFSchema.xsd\" version=\"0.0\"><Styles /><Table id=\"KDTable\"><t:Sheet name=\"sheet1\"><t:Table t:selectMode=\"15\" t:mergeMode=\"0\" t:dataRequestMode=\"0\" t:pageRowCount=\"100\"><t:ColumnGroup><t:Column t:key=\"year\" t:width=\"-1\" t:mergeable=\"true\" t:resizeable=\"true\" t:moveable=\"true\" t:group=\"false\" t:required=\"false\" t:index=\"-1\" /><t:Column t:key=\"bgItem\" t:width=\"-1\" t:mergeable=\"true\" t:resizeable=\"true\" t:moveable=\"true\" t:group=\"false\" t:required=\"false\" t:index=\"-1\" /><t:Column t:key=\"total\" t:width=\"-1\" t:mergeable=\"true\" t:resizeable=\"true\" t:moveable=\"true\" t:group=\"false\" t:required=\"false\" t:index=\"-1\" /></t:ColumnGroup><t:Head><t:Row t:name=\"header1\" t:height=\"-1\" t:mergeable=\"true\" t:resizeable=\"true\"><t:Cell>$Resource{year}</t:Cell><t:Cell>$Resource{bgItem}</t:Cell><t:Cell>$Resource{total}</t:Cell></t:Row></t:Head></t:Table><t:SheetOptions><t:MergeBlocks><t:Head /></t:MergeBlocks></t:SheetOptions></t:Sheet></Table></DocRoot> ";
		
        this.kdtDate.setFormatXml(resHelper.translateString("kdtDate",kdtDateStrXML));

                this.kdtDate.putBindContents("editData",new String[] {"year","bgItem","amount"});
    ...
    public void initUIContentLayout()
    {
        ...
        contDescription.setBounds(new Rectangle(10, 74, 270, 114));
        this.add(contDescription, new KDLayout.Constraints(10, 74, 270, 114, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        ...
        pnlBig.setBounds(new Rectangle(10, 221, 991, 345));
        this.add(pnlBig, new KDLayout.Constraints(10, 221, 991, 345, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_BOTTOM_SCALE | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT));
        ...
        btnGet.setBounds(new Rectangle(883, 191, 119, 25));
        this.add(btnGet, new KDLayout.Constraints(883, 191, 119, 25, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT));
        kDPanel1.setBounds(new Rectangle(371, 30, 270, 157));
        this.add(kDPanel1, new KDLayout.Constraints(371, 30, 270, 157, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        kDPanel2.setBounds(new Rectangle(732, 30, 270, 157));
        this.add(kDPanel2, new KDLayout.Constraints(732, 30, 270, 157, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT));
        contYear.setBounds(new Rectangle(10, 52, 189, 19));
        this.add(contYear, new KDLayout.Constraints(10, 52, 189, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        kDLabel1.setBounds(new Rectangle(204, 52, 15, 19));
        this.add(kDLabel1, new KDLayout.Constraints(204, 52, 15, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        spMonth.setBounds(new Rectangle(224, 52, 40, 19));
        this.add(spMonth, new KDLayout.Constraints(224, 52, 40, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        kDLabel2.setBounds(new Rectangle(268, 52, 15, 19));
        this.add(kDLabel2, new KDLayout.Constraints(268, 52, 15, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        //contNumber
        ...
        //kDPanel1
kDPanel1.setLayout(new BorderLayout(0, 0));        kDPanel1.add(kdtAmount, BorderLayout.CENTER);
        //kDPanel2
kDPanel2.setLayout(new BorderLayout(0, 0));        kDPanel2.add(kdtDate, BorderLayout.CENTER);
        //contYear
	...
	private void registerBindings(){
		...
		dataBinder.registerBinding("totalEntry", com.kingdee.eas.fdc.finance.ProjectYearPlanTotalEntryInfo.class, this.kdtAmount, "userObject");
		dataBinder.registerBinding("totalEntry.year", int.class, this.kdtAmount, "year.text");
		dataBinder.registerBinding("totalEntry.amount", java.math.BigDecimal.class, this.kdtAmount, "total.text");
		dataBinder.registerBinding("totalBgEntry.year", int.class, this.kdtDate, "year.text");
		dataBinder.registerBinding("totalBgEntry.bgItem", com.kingdee.eas.ma.budget.BgItemInfo.class, this.kdtDate, "bgItem.text");
		dataBinder.registerBinding("totalBgEntry.amount", java.math.BigDecimal.class, this.kdtDate, "total.text");
		dataBinder.registerBinding("totalBgEntry", com.kingdee.eas.fdc.finance.ProjectYearPlanTotalBgItemEntryInfo.class, this.kdtDate, "userObject");		
	}
	//Regiester UI State
	private void registerUIState(){		
	}
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.finance.app.ProjectYearPlanEditUIHandler";
	}
	...
	protected void registerValidator() {
		...
		getValidateHelper().registerBindProperty("totalEntry", ValidateHelper.ON_SAVE);    
		getValidateHelper().registerBindProperty("totalEntry.year", ValidateHelper.ON_SAVE);    
		getValidateHelper().registerBindProperty("totalEntry.amount", ValidateHelper.ON_SAVE);    
		getValidateHelper().registerBindProperty("totalBgEntry.year", ValidateHelper.ON_SAVE);    
		getValidateHelper().registerBindProperty("totalBgEntry.bgItem", ValidateHelper.ON_SAVE);    
		getValidateHelper().registerBindProperty("totalBgEntry.amount", ValidateHelper.ON_SAVE);    
		getValidateHelper().registerBindProperty("totalBgEntry", ValidateHelper.ON_SAVE);    		
	}
    ...
    public SelectorItemCollection getSelectors()
    {
        ...
        sic.add(new SelectorItemInfo("totalEntry.*"));
//        sic.add(new SelectorItemInfo("totalEntry.number"));
    sic.add(new SelectorItemInfo("totalEntry.year"));
    sic.add(new SelectorItemInfo("totalEntry.amount"));
    sic.add(new SelectorItemInfo("totalBgEntry.year"));
        sic.add(new SelectorItemInfo("totalBgEntry.bgItem.*"));
//        sic.add(new SelectorItemInfo("totalBgEntry.bgItem.number"));
    sic.add(new SelectorItemInfo("totalBgEntry.amount"));
        sic.add(new SelectorItemInfo("totalBgEntry.*"));
//        sic.add(new SelectorItemInfo("totalBgEntry.number"));
        return sic;
    }        
    ...
    protected class ActionALine extends ItemAction {     
        ...
        public void actionPerformed(ActionEvent e)
        {
            ...
            innerActionPerformed("eas", AbstractProjectYearPlanEditUI.this, "ActionALine", "actionALine_actionPerformed", e);
        }
    }
    ...
    protected class ActionILine extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractProjectYearPlanEditUI.this, "ActionILine", "actionILine_actionPerformed", e);
        }
    }
    ...
    protected class ActionRLine extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractProjectYearPlanEditUI.this, "ActionRLine", "actionRLine_actionPerformed", e);
        }
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.finance.client", "ProjectYearPlanEditUI");
    }
