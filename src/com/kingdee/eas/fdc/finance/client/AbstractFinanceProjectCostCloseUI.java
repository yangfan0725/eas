...
public abstract class AbstractFinanceProjectCostCloseUI extends com.kingdee.eas.framework.client.CoreUI
{
	...
	public RequestContext prepareAcionAddAll(IItemAction itemAction) throws Exception {
			RequestContext request = new RequestContext();		
		if (request != null) {
    		request.setClassName(getUIHandlerClassName());
		}
	...
	public boolean isPrepareAcionAddAll() {
    	return false;
    }
	public RequestContext prepareAcionDelAll(IItemAction itemAction) throws Exception {
			RequestContext request = new RequestContext();		
		if (request != null) {
    		request.setClassName(getUIHandlerClassName());
		}
	...
	public boolean isPrepareAcionDelAll() {
    	return false;
    }
