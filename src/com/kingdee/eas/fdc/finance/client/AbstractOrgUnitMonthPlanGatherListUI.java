 ...
 * output class name
 */
public abstract class AbstractOrgUnitMonthPlanGatherListUI extends com.kingdee.eas.fdc.basedata.client.FDCBillListUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractOrgUnitMonthPlanGatherListUI.class);
     ...
     */
    public AbstractOrgUnitMonthPlanGatherListUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractOrgUnitMonthPlanGatherListUI.class.getName());
        this.setUITitle(resHelper.getString("this.title"));
        mainQueryPK = new MetaDataPK("com.kingdee.eas.fdc.finance.app", "OrgUnitMonthPlanGatherQuery");
        //actionRemove
...
kDContainer1.getContentPane().setLayout(new BorderLayout(0, 0));        kDContainer1.getContentPane().add(tblMain, BorderLayout.CENTER);
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.finance.app.OrgUnitMonthPlanGatherListUIHandler";
	}
    ...
    protected class ActionModify extends ItemAction {     
        ...
        public void actionPerformed(ActionEvent e)
        {
            ...
            innerActionPerformed("eas", AbstractOrgUnitMonthPlanGatherListUI.this, "ActionModify", "actionModify_actionPerformed", e);
        }
    }
    ...
    protected class ActionAudit extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractOrgUnitMonthPlanGatherListUI.this, "ActionAudit", "actionAudit_actionPerformed", e);
        }
    }
    ...
    protected class ActionUnAudit extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractOrgUnitMonthPlanGatherListUI.this, "ActionUnAudit", "actionUnAudit_actionPerformed", e);
        }
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.finance.client", "OrgUnitMonthPlanGatherListUI");
    }
    /**
