 ...
 * output class name
 */
public abstract class AbstractContractBillPayPlanReportUI extends com.kingdee.eas.framework.report.client.CommRptBaseUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractContractBillPayPlanReportUI.class);
     ...
     */
    public AbstractContractBillPayPlanReportUI() throws Exception
    {
        super();
        jbInit();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractContractBillPayPlanReportUI.class.getName());
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.finance.app.ContractBillPayPlanReportUIHandler";
	}
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.finance.client", "ContractBillPayPlanReportUI");
    }
