...
public abstract class AbstractProjectMonthPlanGatherEditUI extends com.kingdee.eas.fdc.basedata.client.FDCBillEditUI
{
    ...
    public void initUIContentLayout()
    {
        ...
        pnlBig.setBounds(new Rectangle(10, 160, 991, 406));
        this.add(pnlBig, new KDLayout.Constraints(10, 160, 991, 406, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_BOTTOM_SCALE | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT));
        ...
        btnGet.setBounds(new Rectangle(882, 130, 119, 25));
        this.add(btnGet, new KDLayout.Constraints(882, 130, 119, 25, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT));
        ...
        btnExport.setBounds(new Rectangle(757, 130, 119, 25));
        this.add(btnExport, new KDLayout.Constraints(757, 130, 119, 25, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        kDLabel3.setBounds(new Rectangle(732, 97, 209, 19));
        this.add(kDLabel3, new KDLayout.Constraints(732, 97, 209, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT));
        //contNumber
