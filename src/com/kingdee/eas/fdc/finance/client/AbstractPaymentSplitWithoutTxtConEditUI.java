...
public abstract class AbstractPaymentSplitWithoutTxtConEditUI extends com.kingdee.eas.fdc.basedata.client.FDCSplitBillEditUI
{
    ...
    private void jbInit() throws Exception
    {
        ...
        this.kdtEntrys.addKDTEditListener(new com.kingdee.bos.ctrl.kdf.table.event.KDTEditAdapter() {
                ...
                this.kdtEntrys.putBindContents("editData",new String[] {"id","","","","","","","","","","amount","payedAmt","","product","costAccount.curProject.id","costAccount.id","level","splitType","apportionType","apportionValue","directAmount","apportionValueTotal","directAmountTotal","otherRatioTotal"});
...
//        sic.add(new SelectorItemInfo("entrys.apportionType.number"));
    ...
    protected class ActionProgrAcctSelect extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractPaymentSplitWithoutTxtConEditUI.this, "ActionProgrAcctSelect", "actionProgrAcctSelect_actionPerformed", e);
        }
    }
