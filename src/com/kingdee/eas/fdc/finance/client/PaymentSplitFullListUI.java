 ...
 * output class name
 */
public class PaymentSplitFullListUI extends AbstractPaymentSplitFullListUI
{
    private static final Logger logger = CoreUIObject.getLogger(PaymentSplitFullListUI.class);
    
    /**
     * output class constructor
     */
    public PaymentSplitFullListUI() throws Exception
    {
        super();
    }
