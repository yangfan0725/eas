 ...
 * output class name
 */
public abstract class AbstractMonthPlanExcuteUI extends com.kingdee.eas.framework.report.client.CommRptBaseUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractMonthPlanExcuteUI.class);
     ...
     */
    public AbstractMonthPlanExcuteUI() throws Exception
    {
        super();
        jbInit();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractMonthPlanExcuteUI.class.getName());
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.finance.app.MonthPlanExcuteUIHandler";
	}
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.finance.client", "MonthPlanExcuteUI");
    }
