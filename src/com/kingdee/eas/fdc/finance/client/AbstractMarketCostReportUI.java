 ...
 * output class name
 */
public abstract class AbstractMarketCostReportUI extends com.kingdee.eas.framework.report.client.CommRptBaseUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractMarketCostReportUI.class);
    ...
    protected com.kingdee.bos.ctrl.swing.KDWorkButton btnShowContract;
    protected com.kingdee.bos.ctrl.swing.KDWorkButton btnShowPay;
    protected com.kingdee.bos.ctrl.swing.KDWorkButton btnShowAll;
    /**
     * output class constructor
     */
    public AbstractMarketCostReportUI() throws Exception
    {
        super();
        jbInit();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractMarketCostReportUI.class.getName());
        ...
        this.btnShowContract = new com.kingdee.bos.ctrl.swing.KDWorkButton();
        this.btnShowPay = new com.kingdee.bos.ctrl.swing.KDWorkButton();
        this.btnShowAll = new com.kingdee.bos.ctrl.swing.KDWorkButton();
        this.kDSplitPane1.setName("kDSplitPane1");
        this.tblMain.setName("tblMain");
        this.kDTreeView1.setName("kDTreeView1");
        this.treeMain.setName("treeMain");
        this.btnShowContract.setName("btnShowContract");
        this.btnShowPay.setName("btnShowPay");
        ...
        // btnShowContract		
        this.btnShowContract.setText(resHelper.getString("btnShowContract.text"));
        this.btnShowContract.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent e) {
                beforeActionPerformed(e);
                try {
                    btnShowContract_actionPerformed(e);
                } catch (Exception exc) {
                    handUIException(exc);
                } finally {
        ...
        // btnShowPay		
        this.btnShowPay.setText(resHelper.getString("btnShowPay.text"));
        this.btnShowPay.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent e) {
                beforeActionPerformed(e);
                try {
                    btnShowPay_actionPerformed(e);
                } catch (Exception exc) {
                    handUIException(exc);
                } finally {
                    afterActionPerformed(e);
    ...
    public void initUIToolBarLayout()
    {
        ...
        this.toolBar.add(btnShowContract);
        this.toolBar.add(btnShowPay);
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.finance.app.MarketCostReportUIHandler";
	}
    ...
    /**
     * output btnShowContract_actionPerformed method
     */
    protected void btnShowContract_actionPerformed(java.awt.event.ActionEvent e) throws Exception
    {
    }

    /**
     * output btnShowPay_actionPerformed method
     */
    protected void btnShowPay_actionPerformed(java.awt.event.ActionEvent e) throws Exception
    {
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.finance.client", "MarketCostReportUI");
    }
