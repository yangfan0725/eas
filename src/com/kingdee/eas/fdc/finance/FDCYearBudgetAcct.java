...
public class FDCYearBudgetAcct extends FDCBudgetAcct implements IFDCYearBudgetAcct
{
    public FDCYearBudgetAcct()
    {
        super();
        registerInterface(IFDCYearBudgetAcct.class, this);
    }
    public FDCYearBudgetAcct(Context ctx)
    {
        super(ctx);
        registerInterface(IFDCYearBudgetAcct.class, this);
    }
    ...
    private FDCYearBudgetAcctController getController() throws BOSException
    {
        return (FDCYearBudgetAcctController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getFDCYearBudgetAcctInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getFDCYearBudgetAcctInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getFDCYearBudgetAcctInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getFDCYearBudgetAcctCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getFDCYearBudgetAcctCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getFDCYearBudgetAcctCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
