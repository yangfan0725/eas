...
public class OrgUnitMonthPlanGatherEntry extends CoreBillEntryBase implements IOrgUnitMonthPlanGatherEntry
{
    public OrgUnitMonthPlanGatherEntry()
    {
        super();
        registerInterface(IOrgUnitMonthPlanGatherEntry.class, this);
    }
    public OrgUnitMonthPlanGatherEntry(Context ctx)
    {
        super(ctx);
        registerInterface(IOrgUnitMonthPlanGatherEntry.class, this);
    }
    ...
    private OrgUnitMonthPlanGatherEntryController getController() throws BOSException
    {
        return (OrgUnitMonthPlanGatherEntryController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getOrgUnitMonthPlanGatherEntryInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getOrgUnitMonthPlanGatherEntryInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getOrgUnitMonthPlanGatherEntryInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getOrgUnitMonthPlanGatherEntryCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getOrgUnitMonthPlanGatherEntryCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getOrgUnitMonthPlanGatherEntryCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
