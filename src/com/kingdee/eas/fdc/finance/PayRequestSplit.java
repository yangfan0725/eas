...
public class PayRequestSplit extends FDCSplitBillEntry implements IPayRequestSplit
{
    public PayRequestSplit()
    {
        super();
        registerInterface(IPayRequestSplit.class, this);
    }
    public PayRequestSplit(Context ctx)
    {
        super(ctx);
        registerInterface(IPayRequestSplit.class, this);
    }
    ...
    private PayRequestSplitController getController() throws BOSException
    {
        return (PayRequestSplitController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getPayRequestSplitInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getPayRequestSplitInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getPayRequestSplitInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getPayRequestSplitCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getPayRequestSplitCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getPayRequestSplitCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            getController().autoSplit(getContext(), billId);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
