...
public class AbstractPaySplit4VoucherInfo extends com.kingdee.eas.framework.BillEntryBaseInfo implements Serializable 
{
    public AbstractPaySplit4VoucherInfo()
    {
        this("id");
    }
    protected AbstractPaySplit4VoucherInfo(String pkField)
    {
        super(pkField);
    }
    /**
