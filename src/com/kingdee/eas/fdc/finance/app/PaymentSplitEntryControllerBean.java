...
public class PaymentSplitEntryControllerBean extends AbstractPaymentSplitEntryControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.fdc.finance.app.PaymentSplitEntryControllerBean");
}