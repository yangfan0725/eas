...
public class PaymentNoCostSplitEntryControllerBean extends AbstractPaymentNoCostSplitEntryControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.fdc.finance.app.PaymentNoCostSplitEntryControllerBean");
}