...
public class PayRequestSplitEntryControllerBean extends AbstractPayRequestSplitEntryControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.fdc.finance.app.PayRequestSplitEntryControllerBean");
}