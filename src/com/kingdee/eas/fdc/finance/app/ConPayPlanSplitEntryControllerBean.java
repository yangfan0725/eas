...
public class ConPayPlanSplitEntryControllerBean extends AbstractConPayPlanSplitEntryControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.fdc.finance.app.ConPayPlanSplitEntryControllerBean");
}