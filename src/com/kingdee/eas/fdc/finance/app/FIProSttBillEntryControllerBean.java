...
public class FIProSttBillEntryControllerBean extends AbstractFIProSttBillEntryControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.fdc.finance.app.FIProSttBillEntryControllerBean");
}