...
public class FDCYearBudgetAcctEntryControllerBean extends AbstractFDCYearBudgetAcctEntryControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.fdc.finance.app.FDCYearBudgetAcctEntryControllerBean");
}