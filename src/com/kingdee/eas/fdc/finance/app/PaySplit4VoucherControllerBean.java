...
public class PaySplit4VoucherControllerBean extends AbstractPaySplit4VoucherControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.fdc.finance.app.PaySplit4VoucherControllerBean");
}