...
public class PayNoCostSplit4VoucherControllerBean extends AbstractPayNoCostSplit4VoucherControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.fdc.finance.app.PayNoCostSplit4VoucherControllerBean");
}