...
public class FDCMonthBudgetAcctEntryControllerBean extends AbstractFDCMonthBudgetAcctEntryControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.fdc.finance.app.FDCMonthBudgetAcctEntryControllerBean");
}