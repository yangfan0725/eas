...
public class WorkLoadConfirmBillEntryControllerBean extends AbstractWorkLoadConfirmBillEntryControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.fdc.finance.app.WorkLoadConfirmBillEntryControllerBean");
}