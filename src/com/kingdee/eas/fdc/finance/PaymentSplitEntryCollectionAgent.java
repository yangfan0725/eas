...
public class PaymentSplitEntryCollectionAgent extends PaymentSplitEntryCollection implements IObjectCollectionAgent {
	private final IObjectCollectionAgent agent;
	
    public PaymentSplitEntryCollectionAgent() {
        super();
