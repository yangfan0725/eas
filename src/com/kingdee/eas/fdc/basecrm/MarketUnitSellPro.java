...
public class MarketUnitSellPro extends AbstractBizCtrl implements IMarketUnitSellPro
{
    public MarketUnitSellPro()
    {
        super();
        registerInterface(IMarketUnitSellPro.class, this);
    }
    public MarketUnitSellPro(Context ctx)
    {
        super(ctx);
        registerInterface(IMarketUnitSellPro.class, this);
    }
    ...
    private MarketUnitSellProController getController() throws BOSException
    {
        return (MarketUnitSellProController)getBizController();
    }
    /**
