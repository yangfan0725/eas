...
public class OrgCustomerLinkManControllerBean extends AbstractOrgCustomerLinkManControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.fdc.basecrm.app.OrgCustomerLinkManControllerBean");
}