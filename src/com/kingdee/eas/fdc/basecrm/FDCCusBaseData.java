...
public class FDCCusBaseData extends FDCDataBase implements IFDCCusBaseData
{
    public FDCCusBaseData()
    {
        super();
        registerInterface(IFDCCusBaseData.class, this);
    }
    public FDCCusBaseData(Context ctx)
    {
        super(ctx);
        registerInterface(IFDCCusBaseData.class, this);
    }
    ...
    private FDCCusBaseDataController getController() throws BOSException
    {
        return (FDCCusBaseDataController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getFDCCusBaseDataInfo(getContext(), pk);
        }
    ...
    {
        try {
            return getController().getFDCCusBaseDataInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getFDCCusBaseDataInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getFDCCusBaseDataCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getFDCCusBaseDataCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getFDCCusBaseDataCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
