...
public class SHERevbillTwoEntry extends CoreBillEntryBase implements ISHERevbillTwoEntry
{
    public SHERevbillTwoEntry()
    {
        super();
        registerInterface(ISHERevbillTwoEntry.class, this);
    }
    public SHERevbillTwoEntry(Context ctx)
    {
        super(ctx);
        registerInterface(ISHERevbillTwoEntry.class, this);
    }
    ...
    private SHERevbillTwoEntryController getController() throws BOSException
    {
        return (SHERevbillTwoEntryController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getSHERevbillTwoEntryInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getSHERevbillTwoEntryInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getSHERevbillTwoEntryInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getSHERevbillTwoEntryCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getSHERevbillTwoEntryCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getSHERevbillTwoEntryCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
