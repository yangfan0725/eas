...
public class MarketUnitSaleMan extends AbstractBizCtrl implements IMarketUnitSaleMan
{
    public MarketUnitSaleMan()
    {
        super();
        registerInterface(IMarketUnitSaleMan.class, this);
    }
    public MarketUnitSaleMan(Context ctx)
    {
        super(ctx);
        registerInterface(IMarketUnitSaleMan.class, this);
    }
    ...
    private MarketUnitSaleManController getController() throws BOSException
    {
        return (MarketUnitSaleManController)getBizController();
    }
    /**
