...
public class InviteDocumentsPoints extends CoreBillEntryBase implements IInviteDocumentsPoints
{
    public InviteDocumentsPoints()
    {
        super();
        registerInterface(IInviteDocumentsPoints.class, this);
    }
    public InviteDocumentsPoints(Context ctx)
    {
        super(ctx);
        registerInterface(IInviteDocumentsPoints.class, this);
    }
    ...
    private InviteDocumentsPointsController getController() throws BOSException
    {
        return (InviteDocumentsPointsController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getInviteDocumentsPointsInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getInviteDocumentsPointsInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getInviteDocumentsPointsInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getInviteDocumentsPointsCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getInviteDocumentsPointsCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getInviteDocumentsPointsCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
