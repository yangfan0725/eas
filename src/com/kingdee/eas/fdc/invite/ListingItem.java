...
public class ListingItem extends FDCBill implements IListingItem
{
    ...
    /**
     *取所有上级组织中，某一个表头类型中的清单子目，用于判断子目名称是否相同-User defined method
     *@param currentOrgId 当前组织id
     *@param headTypeId 表头类型id
     *@return
     */
    ...
    /**
     *取所有下级组织中，某一个表头类型中的清单子目，用于判断子目名称是否相同-User defined method
     *@param currentOrgId 当前组织id
     *@param headTypeId 表头类型id
     *@return
     */
    ...
    /**
     *取所有当前组织中，某一个表头类型中的清单子目，用于判断子目名称是否相同-User defined method
     *@param currentOrgId 当前组织id
     *@param headTypeId 表头类型Id
     *@return
     */
