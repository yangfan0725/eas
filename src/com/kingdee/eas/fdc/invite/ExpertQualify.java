...
public class ExpertQualify extends FDCBill implements IExpertQualify
{
    public ExpertQualify()
    {
        super();
        registerInterface(IExpertQualify.class, this);
    }
    public ExpertQualify(Context ctx)
    {
        super(ctx);
        registerInterface(IExpertQualify.class, this);
    }
    ...
    private ExpertQualifyController getController() throws BOSException
    {
        return (ExpertQualifyController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getExpertQualifyInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getExpertQualifyInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getExpertQualifyInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getExpertQualifyCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getExpertQualifyCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getExpertQualifyCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
