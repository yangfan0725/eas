...
public class InviteClarifyEntry extends BaseInviteEntry implements IInviteClarifyEntry
{
    public InviteClarifyEntry()
    {
        super();
        registerInterface(IInviteClarifyEntry.class, this);
    }
    public InviteClarifyEntry(Context ctx)
    {
        super(ctx);
        registerInterface(IInviteClarifyEntry.class, this);
    }
    ...
    private InviteClarifyEntryController getController() throws BOSException
    {
        return (InviteClarifyEntryController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getInviteClarifyEntryInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getInviteClarifyEntryInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getInviteClarifyEntryInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getInviteClarifyEntryCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getInviteClarifyEntryCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getInviteClarifyEntryCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
