...
public class TemplateFile extends FDCBill implements ITemplateFile
{
    public TemplateFile()
    {
        super();
        registerInterface(ITemplateFile.class, this);
    }
    public TemplateFile(Context ctx)
    {
        super(ctx);
        registerInterface(ITemplateFile.class, this);
    }
    ...
    private TemplateFileController getController() throws BOSException
    {
        return (TemplateFileController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getTemplateFileInfo(getContext(), pk);
        }
    ...
    {
        try {
            return getController().getTemplateFileInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getTemplateFileInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getTemplateFileCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getTemplateFileCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getTemplateFileCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
