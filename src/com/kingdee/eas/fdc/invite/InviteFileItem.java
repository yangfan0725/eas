...
public class InviteFileItem extends FDCBill implements IInviteFileItem
{
    public InviteFileItem()
    {
        super();
        registerInterface(IInviteFileItem.class, this);
    }
    public InviteFileItem(Context ctx)
    {
        super(ctx);
        registerInterface(IInviteFileItem.class, this);
    }
    ...
    private InviteFileItemController getController() throws BOSException
    {
        return (InviteFileItemController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getInviteFileItemInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getInviteFileItemInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getInviteFileItemInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getInviteFileItemCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getInviteFileItemCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getInviteFileItemCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            getController().aduit(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            getController().unAduit(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
