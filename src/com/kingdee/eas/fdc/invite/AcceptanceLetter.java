...
public class AcceptanceLetter extends FDCBill implements IAcceptanceLetter
{
    public AcceptanceLetter()
    {
        super();
        registerInterface(IAcceptanceLetter.class, this);
    }
    public AcceptanceLetter(Context ctx)
    {
        super(ctx);
        registerInterface(IAcceptanceLetter.class, this);
    }
    ...
    private AcceptanceLetterController getController() throws BOSException
    {
        return (AcceptanceLetterController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getAcceptanceLetterInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getAcceptanceLetterInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getAcceptanceLetterInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getAcceptanceLetterCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getAcceptanceLetterCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getAcceptanceLetterCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().revise(getContext(), billId);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
