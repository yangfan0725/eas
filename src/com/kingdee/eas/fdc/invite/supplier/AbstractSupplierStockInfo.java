...
public class AbstractSupplierStockInfo extends com.kingdee.eas.fdc.basedata.FDCDataBaseInfo implements Serializable 
{
    ...
    protected AbstractSupplierStockInfo(String pkField)
    {
        ...
        put("inviteListTypeEntry", new com.kingdee.eas.fdc.invite.supplier.SupplierInviteListTypeEntryCollection());
        ...
        put("contractEntry", new com.kingdee.eas.fdc.invite.supplier.SupplierStockContractEntryCollection());
        ...
        put("quaLevelEntry", new com.kingdee.eas.fdc.invite.supplier.SupplierQuaLevelEntryCollection());
    ...
    /**
     * Object: 供应商档案登记 's 企业近三年的主要业绩 property 
     */
    public com.kingdee.eas.fdc.invite.supplier.SupplierStockContractEntryCollection getContractEntry()
    {
        return (com.kingdee.eas.fdc.invite.supplier.SupplierStockContractEntryCollection)get("contractEntry");
    }
    /**
     * Object: 供应商档案登记 's 资质等级分录 property 
     */
    public com.kingdee.eas.fdc.invite.supplier.SupplierQuaLevelEntryCollection getQuaLevelEntry()
    {
        return (com.kingdee.eas.fdc.invite.supplier.SupplierQuaLevelEntryCollection)get("quaLevelEntry");
    }
    /**
     * Object: 供应商档案登记 's 采购类别明细 property 
     */
    public com.kingdee.eas.fdc.invite.supplier.SupplierInviteListTypeEntryCollection getInviteListTypeEntry()
    {
        return (com.kingdee.eas.fdc.invite.supplier.SupplierInviteListTypeEntryCollection)get("inviteListTypeEntry");
    }
    /**
     * Object:供应商档案登记's 采购类别明细property 
     */
    public String getInviteListTypeStr()
    {
        return getString("inviteListTypeStr");
    }
    public void setInviteListTypeStr(String item)
    {
        setString("inviteListTypeStr", item);
    }
    /**
     * Object:供应商档案登记's 纳税人资质property 
     */
    ...
    {
        return getString("supplierDescription");
    }
    public void setSupplierDescription(String item)
    {
        setString("supplierDescription", item);
    }
    /**
     * Object:供应商档案登记's 联行号property 
     */
    public String getLxNumber()
    {
        return getString("lxNumber");
    }
    public void setLxNumber(String item)
    {
        setString("lxNumber", item);
    }
