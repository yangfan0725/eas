...
public class SupplierAppraiseType extends TreeBase implements ISupplierAppraiseType
{
    public SupplierAppraiseType()
    {
        super();
        registerInterface(ISupplierAppraiseType.class, this);
    }
    public SupplierAppraiseType(Context ctx)
    {
        super(ctx);
        registerInterface(ISupplierAppraiseType.class, this);
    }
    ...
    private SupplierAppraiseTypeController getController() throws BOSException
    {
        return (SupplierAppraiseTypeController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getSupplierAppraiseTypeInfo(getContext(), pk);
        }
    ...
    {
        try {
            return getController().getSupplierAppraiseTypeInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getSupplierAppraiseTypeInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getSupplierAppraiseTypeCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getSupplierAppraiseTypeCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getSupplierAppraiseTypeCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
