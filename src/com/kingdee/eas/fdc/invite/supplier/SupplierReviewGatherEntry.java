...
public class SupplierReviewGatherEntry extends CoreBillEntryBase implements ISupplierReviewGatherEntry
{
    public SupplierReviewGatherEntry()
    {
        super();
        registerInterface(ISupplierReviewGatherEntry.class, this);
    }
    public SupplierReviewGatherEntry(Context ctx)
    {
        super(ctx);
        registerInterface(ISupplierReviewGatherEntry.class, this);
    }
    ...
    private SupplierReviewGatherEntryController getController() throws BOSException
    {
        return (SupplierReviewGatherEntryController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getSupplierReviewGatherEntryInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getSupplierReviewGatherEntryInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getSupplierReviewGatherEntryInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getSupplierReviewGatherEntryCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getSupplierReviewGatherEntryCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getSupplierReviewGatherEntryCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
