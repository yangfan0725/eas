 ...
 * output class name
 */
public abstract class AbstractSupplierStockReportUI extends com.kingdee.eas.framework.report.client.CommRptBaseUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractSupplierStockReportUI.class);
     ...
     */
    public AbstractSupplierStockReportUI() throws Exception
    {
        super();
        jbInit();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractSupplierStockReportUI.class.getName());
...
contSupplierType.getContentPane().setLayout(new BorderLayout(0, 0));        contSupplierType.getContentPane().add(kDScrollPane2, BorderLayout.CENTER);
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.invite.supplier.report.SupplierStockReportUIHandler";
	}
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.invite.supplier.report", "SupplierStockReportUI");
    }
