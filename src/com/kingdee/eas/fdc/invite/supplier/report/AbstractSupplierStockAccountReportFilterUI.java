 ...
 * output class name
 */
public abstract class AbstractSupplierStockAccountReportFilterUI extends com.kingdee.eas.framework.report.client.CommRptBaseConditionUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractSupplierStockAccountReportFilterUI.class);
     ...
     */
    public AbstractSupplierStockAccountReportFilterUI() throws Exception
    {
        super();
        jbInit();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractSupplierStockAccountReportFilterUI.class.getName());
    ...
    public void initUIContentLayout()
    {
        ...
        this.setLayout(null);
        contFromDate.setBounds(new Rectangle(18, 57, 270, 19));
        this.add(contFromDate, null);
        contToDate.setBounds(new Rectangle(318, 57, 270, 19));
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.invite.supplier.report.SupplierStockAccountReportFilterUIHandler";
	}
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.invite.supplier.report", "SupplierStockAccountReportFilterUI");
    }
