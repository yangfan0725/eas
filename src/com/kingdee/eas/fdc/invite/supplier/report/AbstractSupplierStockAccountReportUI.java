 ...
 * output class name
 */
public abstract class AbstractSupplierStockAccountReportUI extends com.kingdee.eas.framework.report.client.CommRptBaseUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractSupplierStockAccountReportUI.class);
     ...
     */
    public AbstractSupplierStockAccountReportUI() throws Exception
    {
        super();
        jbInit();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractSupplierStockAccountReportUI.class.getName());
    ...
    public void initUIContentLayout()
    {
        ...
        kDSplitPane1.setBounds(new Rectangle(6, 6, 1001, 589));
        this.add(kDSplitPane1, new KDLayout.Constraints(6, 6, 1001, 589, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_BOTTOM | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT));
        //kDSplitPane1
...
contOrg.getContentPane().setLayout(new BorderLayout(0, 0));        contOrg.getContentPane().add(kDScrollPane1, BorderLayout.CENTER);
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.invite.supplier.report.SupplierStockAccountReportUIHandler";
	}
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.invite.supplier.report", "SupplierStockAccountReportUI");
    }
