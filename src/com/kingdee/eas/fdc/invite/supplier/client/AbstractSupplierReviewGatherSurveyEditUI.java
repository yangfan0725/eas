 ...
 * output class name
 */
public abstract class AbstractSupplierReviewGatherSurveyEditUI extends com.kingdee.eas.fdc.basedata.client.FDCBaseDataEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractSupplierReviewGatherSurveyEditUI.class);
    ...
    protected com.kingdee.eas.fdc.invite.supplier.SupplierReviewGatherSurveyInfo editData = null;
    /**
     * output class constructor
     */
    public AbstractSupplierReviewGatherSurveyEditUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractSupplierReviewGatherSurveyEditUI.class.getName());
    ...
    public void initUIContentLayout()
    {
        ...
        this.setLayout(null);
        contTemplate.setBounds(new Rectangle(10, 22, 270, 19));
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.invite.supplier.app.SupplierReviewGatherSurveyEditUIHandler";
	}
    ...
    public void setDataObject(IObjectValue dataObject)
    {
        ...
        this.editData = (com.kingdee.eas.fdc.invite.supplier.SupplierReviewGatherSurveyInfo)ov;
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.invite.supplier.client", "SupplierReviewGatherSurveyEditUI");
    }
