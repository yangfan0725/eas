 ...
 * output class name
 */
public class SupplierAttachListListUI extends AbstractSupplierAttachListListUI
{
    private static final Logger logger = CoreUIObject.getLogger(SupplierAttachListListUI.class);
    private SupplierFileTypeInfo supplierFileType=null;
    public SupplierAttachListListUI() throws Exception
    {
        super();
    }
    protected FDCDataBaseInfo getBaseDataInfo() {
		return new SupplierAttachListInfo();
	}
	protected ICoreBase getBizInterface() throws Exception {
		return SupplierAttachListFactory.getRemoteInstance();
	}
	protected String getEditUIName() {
		return SupplierAttachListEditUI.class.getName();
	}
