 ...
 * output class name
 */
public class InviteListTypeEditUI extends AbstractInviteListTypeEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(InviteListTypeEditUI.class);
    public InviteListTypeEditUI() throws Exception
    {
        super();
    }
    private InviteListTypeInfo parentInfo;
	...
	public void loadFields() {
		super.loadFields();
		parentInfo = (InviteListTypeInfo) getUIContext().get(UIContext.PARENTNODE);
...
//			FDCBaseTypeValidator.validate(((InviteListTypeListUI) getUIContext().get(UIContext.OWNER)).getMainTable(), txtLongNumber, bizName, getSelectBOID());
	...
	public void onLoad() throws Exception {
		...
		txtLongNumber.addKeyListener(new KeyListener() {
			...
			public void keyReleased(KeyEvent e) {
				InviteListTypeInfo parent = (InviteListTypeInfo) getUIContext().get(UIContext.PARENTNODE);
	...
	protected void initOldData(IObjectValue dataObject) {
		...
		if (getUIContext().get(UIContext.PARENTNODE) != null) {
			if ((STATUS_ADDNEW.equals(getOprtState()))) {// 新增状态
				...
				strTemp = strTemp.replace('!', '.');
				((InviteListTypeInfo) dataObject).setLongNumber(strTemp + ".");
			} else if (STATUS_EDIT.equals(getOprtState())) {
				String strTemp = ((InviteListTypeInfo) dataObject).getLongNumber();
				strTemp = strTemp.replace('!', '.');
				((InviteListTypeInfo) dataObject).setLongNumber(strTemp);
			}
		}
	...
	public void actionCancel_actionPerformed(ActionEvent e) throws Exception {
		if (this.editData != null && this.editData.getId() != null) {
			...
			if (((IInviteListType) getBizInterface()).disEnabled(pk)) {
	...
	public void actionCancelCancel_actionPerformed(ActionEvent e) throws Exception {
		if (this.editData != null && this.editData.getId() != null) {
			IObjectPK pk = new ObjectStringPK(this.editData.getId().toString());
			if (((IInviteListType) getBizInterface()).enabled(pk)) {
