 ...
 * output class name
 */
public abstract class AbstractInviteListTypeEditUI extends com.kingdee.eas.framework.client.TreeEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractInviteListTypeEditUI.class);
    ...
    protected com.kingdee.eas.fdc.invite.supplier.InviteListTypeInfo editData = null;
    /**
     * output class constructor
     */
    public AbstractInviteListTypeEditUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractInviteListTypeEditUI.class.getName());
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.invite.supplier.app.InviteListTypeEditUIHandler";
	}
    ...
    public void setDataObject(IObjectValue dataObject)
    {
        ...
        this.editData = (com.kingdee.eas.fdc.invite.supplier.InviteListTypeInfo)ov;
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.invite.supplier.client", "InviteListTypeEditUI");
    }
