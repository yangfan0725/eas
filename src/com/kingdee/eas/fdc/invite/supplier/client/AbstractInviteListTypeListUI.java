 ...
 * output class name
 */
public abstract class AbstractInviteListTypeListUI extends com.kingdee.eas.framework.client.TreeListUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractInviteListTypeListUI.class);
     ...
     */
    public AbstractInviteListTypeListUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractInviteListTypeListUI.class.getName());
        this.setUITitle(resHelper.getString("this.title"));
        mainQueryPK = new MetaDataPK("com.kingdee.eas.fdc.invite.supplier.app", "InviteListTypeQuery");
        //actionMoveTree
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.invite.supplier.app.InviteListTypeListUIHandler";
	}
    ...
    protected class ActionEnabled extends ItemAction {     
        ...
        public void actionPerformed(ActionEvent e)
        {
            ...
            innerActionPerformed("eas", AbstractInviteListTypeListUI.this, "ActionEnabled", "actionEnabled_actionPerformed", e);
        }
    }
    ...
    protected class ActionDisEnabled extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractInviteListTypeListUI.this, "ActionDisEnabled", "actionDisEnabled_actionPerformed", e);
        }
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.invite.supplier.client", "InviteListTypeListUI");
    }
