 ...
 * output class name
 */
public abstract class AbstractSupplierAppraiseTemplateListUI extends com.kingdee.eas.framework.client.TreeDetailListUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractSupplierAppraiseTemplateListUI.class);
    protected com.kingdee.bos.ctrl.swing.KDContainer contContener;
     ...
     */
    public AbstractSupplierAppraiseTemplateListUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractSupplierAppraiseTemplateListUI.class.getName());
        this.setUITitle(resHelper.getString("this.title"));
        mainQueryPK = new MetaDataPK("com.kingdee.eas.fdc.invite.supplier.app", "SupplierAppraiseTemplateQuery");
        //actionAudit
        ...
        this.contContener = new com.kingdee.bos.ctrl.swing.KDContainer();
        ...
        this.contContener.setName("contContener");
        ...
        // kDMenuItem1
        this.kDMenuItem1.setAction((IItemAction)ActionProxyFactory.getProxy(actionAudit, new Class[] { IItemAction.class }, getServiceContext()));		
        ...
        this.menuItemAudit.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent e) {
                beforeActionPerformed(e);
                try {
                    menuItemAudit_actionPerformed(e);
                } catch (Exception exc) {
                    handUIException(exc);
                } finally {
    ...
    public void initUIContentLayout()
    {
        ...
        pnlMain.setBounds(new Rectangle(1, 5, 1011, 623));
        this.add(pnlMain, new KDLayout.Constraints(1, 5, 1011, 623, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_BOTTOM | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT));
        //pnlMain
        ...
        //pnlTable
pnlTable.setLayout(new BorderLayout(0, 0));        pnlTable.add(contContener, BorderLayout.CENTER);
        //contContener
contContener.getContentPane().setLayout(new BorderLayout(0, 0));        contContener.getContentPane().add(tblMain, BorderLayout.CENTER);
        contContener.getContentPane().add(chkIncludeChild, BorderLayout.SOUTH);
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.invite.supplier.app.SupplierAppraiseTemplateListUIHandler";
	}
    ...
    /**
     * output menuItemAudit_actionPerformed method
     */
    protected void menuItemAudit_actionPerformed(java.awt.event.ActionEvent e) throws Exception
    {
    }
    ...
    protected class ActionAudit extends ItemAction {     
        ...
        public void actionPerformed(ActionEvent e)
        {
            ...
            innerActionPerformed("eas", AbstractSupplierAppraiseTemplateListUI.this, "ActionAudit", "actionAudit_actionPerformed", e);
        }
    }
    ...
    protected class ActionUnAudit extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractSupplierAppraiseTemplateListUI.this, "ActionUnAudit", "actionUnAudit_actionPerformed", e);
        }
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.invite.supplier.client", "SupplierAppraiseTemplateListUI");
    }
