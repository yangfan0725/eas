 ...
 * output class name
 */
public abstract class AbstractSupplierAttachListEditUI extends com.kingdee.eas.fdc.basedata.client.FDCBaseDataEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractSupplierAttachListEditUI.class);
    ...
    protected com.kingdee.eas.fdc.invite.supplier.SupplierAttachListInfo editData = null;
    /**
     * output class constructor
     */
    public AbstractSupplierAttachListEditUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractSupplierAttachListEditUI.class.getName());
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.invite.supplier.app.SupplierAttachListEditUIHandler";
	}
    ...
    public void setDataObject(IObjectValue dataObject)
    {
        ...
        this.editData = (com.kingdee.eas.fdc.invite.supplier.SupplierAttachListInfo)ov;
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.invite.supplier.client", "SupplierAttachListEditUI");
    }
