 ...
 * output class name
 */
public abstract class AbstractSupplierPersonEditUI extends com.kingdee.eas.fdc.basedata.client.FDCBaseDataEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractSupplierPersonEditUI.class);
    ...
    protected com.kingdee.eas.fdc.invite.supplier.SupplierPersonInfo editData = null;
    /**
     * output class constructor
     */
    public AbstractSupplierPersonEditUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractSupplierPersonEditUI.class.getName());
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.invite.supplier.app.SupplierPersonEditUIHandler";
	}
    ...
    public void setDataObject(IObjectValue dataObject)
    {
        ...
        this.editData = (com.kingdee.eas.fdc.invite.supplier.SupplierPersonInfo)ov;
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.invite.supplier.client", "SupplierPersonEditUI");
    }
