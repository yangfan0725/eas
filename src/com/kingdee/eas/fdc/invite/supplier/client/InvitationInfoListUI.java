 ...
 * output class name
 */
public class InvitationInfoListUI extends AbstractInvitationInfoListUI
{
    private static final Logger logger = CoreUIObject.getLogger(InvitationInfoListUI.class);
     ...
     */
    public InvitationInfoListUI() throws Exception
    {
        super();
    }
    ...
    public void actionAddNew_actionPerformed(ActionEvent e) throws Exception
    {
    	...
    	filter.getFilterItems().add(new FilterItemInfo("inviteProject.id",getTblMainSelectedKeyValue()));
    ...
    /**
     * output actionPublish_actionPerformed
     */
    public void actionPublish_actionPerformed(ActionEvent e) throws Exception
    {
        ...
        InvitationInfoFactory.getRemoteInstance().publish(BOSUuid.read(id));
    ...
    /**
     * output actionUnPublish_actionPerformed
     */
    public void actionUnPublish_actionPerformed(ActionEvent e) throws Exception
    {
        ...
        int rowIndex = this.tblBaseInvite.getSelectManager().getActiveRowIndex();
        String id = this.tblBaseInvite.getCell(rowIndex, "id").getValue()+"";
        InvitationInfoFactory.getRemoteInstance().unPublish(BOSUuid.read(id));
	...
	protected void refreshBillListTable(String paramId) throws BOSException {
		...
		InvitationInfoCollection cols = InvitationInfoFactory.getRemoteInstance().getInvitationInfoCollection(view);
	...
	private void loadInvitationInfo(InvitationInfoCollection cols) {
		// TODO Auto-generated method stub
		KDTable t = getBillListTable();
		t.removeRows();
		
		int size = cols.size();
		InvitationInfoInfo info = null;
		IRow row = null;
	...
	private void bindDataToRow(InvitationInfoInfo info, IRow row) {
		// TODO Auto-generated method stub
		row.setUserObject(info);
		row.getCell("number").setValue(info.getNumber());
		row.getCell("id").setValue(info.getId());
		row.getCell("respDept").setValue(info.getOwnerDept());
		row.getCell("creator").setValue(info.getCreator().getName());
		row.getCell("inviteProjectName").setValue(info.getInviteProjectName());
		row.getCell("project").setValue(info.getProject());
		row.getCell("inviteDate").setValue(info.getInviteDate());
		row.getCell("linkman").setValue(info.getLinkman());
		row.getCell("linkphone").setValue(info.getLinkphone());
		row.getCell("invitefax").setValue(info.getLinkfax());
		...
		row.getCell("publishState").setValue(info.getPublishState()!=null && info.getPublishState().equals("1")?"已发布":"未发布");
		row.getCell("tenderEndDate").setValue(info.getTenderEndDate());
	}
	
	@Override
	protected String getEditUIName() {
		// TODO Auto-generated method stub
		return InvitationInfoEditUI.class.getName();
	}
