 ...
 * output class name
 */
public abstract class AbstractGradeSetUpEditUI extends com.kingdee.eas.fdc.basedata.client.FDCBaseDataEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractGradeSetUpEditUI.class);
    ...
    protected com.kingdee.eas.fdc.invite.supplier.GradeSetUpInfo editData = null;
    /**
     * output class constructor
     */
    public AbstractGradeSetUpEditUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractGradeSetUpEditUI.class.getName());
    ...
    public void initUIContentLayout()
    {
        ...
        contIsPass.setBounds(new Rectangle(10, 100, 270, 19));
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.invite.supplier.app.GradeSetUpEditUIHandler";
	}
    ...
    public void setDataObject(IObjectValue dataObject)
    {
        ...
        this.editData = (com.kingdee.eas.fdc.invite.supplier.GradeSetUpInfo)ov;
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.invite.supplier.client", "GradeSetUpEditUI");
    }
