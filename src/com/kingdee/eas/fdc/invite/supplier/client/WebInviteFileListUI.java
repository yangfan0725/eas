 ...
 * output class name
 */
public class WebInviteFileListUI extends AbstractWebInviteFileListUI
{
    private static final Logger logger = CoreUIObject.getLogger(WebInviteFileListUI.class);
    
    /**
     * output class constructor
     */
    public WebInviteFileListUI() throws Exception
    {
        super();
    }
    ...
    public void actionAudit_actionPerformed(ActionEvent e) throws Exception
    {
    	...
    	WebInviteFileFactory.getRemoteInstance().audit(getSelectedID());
    ...
    public void actionUnAudit_actionPerformed(ActionEvent e) throws Exception
    {
       // super.actionUnAudit_actionPerformed(e);
    	WebInviteFileFactory.getRemoteInstance().unAudit(getSelectedID());
        FDCMsgBox.showInfo("操作成功");
		this.tblMain.removeRows();
        this.tblBaseInvite.refresh();
    }
	...
	protected void refreshBillListTable(String paramId) throws BOSException {
		...
		WebInviteFileCollection cols = WebInviteFileFactory.getRemoteInstance().getWebInviteFileCollection(view);
		
		Iterator<WebInviteFileInfo> it = cols.iterator();
		
		IRow r = null;
		WebInviteFileInfo fileInfo = null;
		for(;it.hasNext();){
			fileInfo = it.next();
			r = this.tblBaseInvite.addRow();
			r.getCell("id").setValue(fileInfo.getId());
			r.getCell("state").setValue(fileInfo.getState());
			r.getCell("number").setValue(fileInfo.getNumber());
			r.getCell("creator").setValue(fileInfo.getCreator() == null?null:fileInfo.getCreator().getName());
			r.getCell("auditor").setValue(fileInfo.getAuditor() == null?null:fileInfo.getAuditor().getName());
			r.getCell("createDate").setValue(fileInfo.getCreateTime());
			r.getCell("auditDate").setValue(fileInfo.getAuditTime());
		}
	...
	protected String getEditUIName() {
		// TODO Auto-generated method stub
		return WebInviteFileEditUI.class.getName();
	}
