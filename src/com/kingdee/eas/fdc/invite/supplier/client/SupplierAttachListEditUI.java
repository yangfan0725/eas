 ...
 * output class name
 */
public class SupplierAttachListEditUI extends AbstractSupplierAttachListEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(SupplierAttachListEditUI.class);
    public SupplierAttachListEditUI() throws Exception
    {
        super();
    }
	...
	protected IObjectValue createNewData() {
		SupplierAttachListInfo info=new SupplierAttachListInfo();
