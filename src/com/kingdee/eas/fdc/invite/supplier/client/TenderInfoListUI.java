 ...
 * output class name
 */
public class TenderInfoListUI extends AbstractTenderInfoListUI
{
    private static final Logger logger = CoreUIObject.getLogger(TenderInfoListUI.class);
    
    /**
     * output class constructor
     */
    public TenderInfoListUI() throws Exception
    {
        super();
    }
	...
	protected void refreshBillListTable(String paramId) throws BOSException {
		...
		sic.add("invitation.*");
		sic.add("supplier.*");
		sic.add("supplier.inviteType.id");
		sic.add("supplier.inviteType.name");
		sic.add("supplier.inviteType.number");
		...
		TenderInfoCollection cols =  TenderInfoFactory.getRemoteInstance().getTenderInfoCollection(view);
	...
	private void loadInvitationInfo(TenderInfoCollection cols) {
		// TODO Auto-generated method stub
	...
	private void bindDataToRow(TenderInfoInfo info, IRow row) {
		// TODO Auto-generated method stub
	    ...
	    row.getCell("projectManager").setValue(info.getProjectManager());
	    row.getCell("phone").setValue(info.getPhone());
	    row.getCell("invitationName").setValue(info.getInvitation()!=null?info.getInvitation().getInviteProjectName():null);
	    row.getCell("supplierName").setValue(info.getSupplier()!=null?info.getSupplier().getName():null);
		row.getCell("state").setValue(info.getState());
		row.getCell("tenderState").setValue(getTenderState(info.getTenderState()));
		...
		if(info.getSupplier()!= null && info.getSupplier().getInviteType() != null)
		   row.getCell("inviteType").setValue(info.getSupplier().getInviteType().getName());
	}
	
	private String getTenderState(String state){
		String result = null;
		if(state == null){
			state = "1";
		}
	...
	protected ICoreBase getBizInterface() throws Exception {
		// TODO Auto-generated method stub
		return TenderInfoFactory.getRemoteInstance();
	}
	
	@Override
	protected String getEditUIName() {
		// TODO Auto-generated method stub
		return TenderInfoEditUI.class.getName();
	}
