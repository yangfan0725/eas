...
public class SupplierAttachListEntry extends CoreBillEntryBase implements ISupplierAttachListEntry
{
    public SupplierAttachListEntry()
    {
        super();
        registerInterface(ISupplierAttachListEntry.class, this);
    }
    public SupplierAttachListEntry(Context ctx)
    {
        super(ctx);
        registerInterface(ISupplierAttachListEntry.class, this);
    }
    ...
    private SupplierAttachListEntryController getController() throws BOSException
    {
        return (SupplierAttachListEntryController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getSupplierAttachListEntryInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getSupplierAttachListEntryInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getSupplierAttachListEntryInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getSupplierAttachListEntryCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getSupplierAttachListEntryCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getSupplierAttachListEntryCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
