...
public class SupplierStorageNumber extends FDCBill implements ISupplierStorageNumber
{
    public SupplierStorageNumber()
    {
        super();
        registerInterface(ISupplierStorageNumber.class, this);
    }
    public SupplierStorageNumber(Context ctx)
    {
        super(ctx);
        registerInterface(ISupplierStorageNumber.class, this);
    }
    ...
    private SupplierStorageNumberController getController() throws BOSException
    {
        return (SupplierStorageNumberController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getSupplierStorageNumberInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getSupplierStorageNumberInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getSupplierStorageNumberInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getSupplierStorageNumberCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getSupplierStorageNumberCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getSupplierStorageNumberCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
