...
public class SupplierReviewGatherSurveyControllerBean extends AbstractSupplierReviewGatherSurveyControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.fdc.invite.supplier.app.SupplierReviewGatherSurveyControllerBean");
    
    protected void _checkNumberDup(Context ctx, IObjectValue model) throws BOSException, EASBizException {
    	SupplierReviewGatherSurveyInfo info = (SupplierReviewGatherSurveyInfo) model;
		...
		if(info.getTemplate()!=null){
			filter.getFilterItems().add(new FilterItemInfo("template.id", info.getTemplate().getId()));
		}
