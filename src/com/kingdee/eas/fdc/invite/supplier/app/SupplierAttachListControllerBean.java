...
public class SupplierAttachListControllerBean extends AbstractSupplierAttachListControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.fdc.invite.supplier.app.SupplierAttachListControllerBean");
    
    protected void _checkNumberDup(Context ctx, IObjectValue model) throws BOSException, EASBizException {
		SupplierAttachListInfo info = (SupplierAttachListInfo) model;
