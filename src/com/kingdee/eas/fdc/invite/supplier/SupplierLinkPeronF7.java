...
public class SupplierLinkPeronF7 extends FDCDataBase implements ISupplierLinkPeronF7
{
    public SupplierLinkPeronF7()
    {
        super();
        registerInterface(ISupplierLinkPeronF7.class, this);
    }
    public SupplierLinkPeronF7(Context ctx)
    {
        super(ctx);
        registerInterface(ISupplierLinkPeronF7.class, this);
    }
    ...
    private SupplierLinkPeronF7Controller getController() throws BOSException
    {
        return (SupplierLinkPeronF7Controller)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getSupplierLinkPeronF7Info(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getSupplierLinkPeronF7Info(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getSupplierLinkPeronF7Info(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getSupplierLinkPeronF7Collection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getSupplierLinkPeronF7Collection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getSupplierLinkPeronF7Collection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
