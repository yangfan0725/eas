...
public class SupplierSplAreaEntry extends CoreBase implements ISupplierSplAreaEntry
{
    public SupplierSplAreaEntry()
    {
        super();
        registerInterface(ISupplierSplAreaEntry.class, this);
    }
    public SupplierSplAreaEntry(Context ctx)
    {
        super(ctx);
        registerInterface(ISupplierSplAreaEntry.class, this);
    }
    ...
    private SupplierSplAreaEntryController getController() throws BOSException
    {
        return (SupplierSplAreaEntryController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getSupplierSplAreaEntryInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getSupplierSplAreaEntryInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getSupplierSplAreaEntryInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getSupplierSplAreaEntryCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getSupplierSplAreaEntryCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getSupplierSplAreaEntryCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
