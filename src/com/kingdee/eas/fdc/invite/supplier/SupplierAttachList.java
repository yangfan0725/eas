...
public class SupplierAttachList extends FDCDataBase implements ISupplierAttachList
{
    public SupplierAttachList()
    {
        super();
        registerInterface(ISupplierAttachList.class, this);
    }
    public SupplierAttachList(Context ctx)
    {
        super(ctx);
        registerInterface(ISupplierAttachList.class, this);
    }
    ...
    private SupplierAttachListController getController() throws BOSException
    {
        return (SupplierAttachListController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getSupplierAttachListInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getSupplierAttachListInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getSupplierAttachListInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getSupplierAttachListCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getSupplierAttachListCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getSupplierAttachListCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
