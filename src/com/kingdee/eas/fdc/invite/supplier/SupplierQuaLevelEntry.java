...
public class SupplierQuaLevelEntry extends CoreBase implements ISupplierQuaLevelEntry
{
    public SupplierQuaLevelEntry()
    {
        super();
        registerInterface(ISupplierQuaLevelEntry.class, this);
    }
    public SupplierQuaLevelEntry(Context ctx)
    {
        super(ctx);
        registerInterface(ISupplierQuaLevelEntry.class, this);
    }
    ...
    private SupplierQuaLevelEntryController getController() throws BOSException
    {
        return (SupplierQuaLevelEntryController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getSupplierQuaLevelEntryInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getSupplierQuaLevelEntryInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getSupplierQuaLevelEntryInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getSupplierQuaLevelEntryCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getSupplierQuaLevelEntryCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getSupplierQuaLevelEntryCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
