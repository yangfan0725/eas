...
public class SupplierReviewGatherSurvey extends FDCDataBase implements ISupplierReviewGatherSurvey
{
    public SupplierReviewGatherSurvey()
    {
        super();
        registerInterface(ISupplierReviewGatherSurvey.class, this);
    }
    public SupplierReviewGatherSurvey(Context ctx)
    {
        super(ctx);
        registerInterface(ISupplierReviewGatherSurvey.class, this);
    }
    ...
    private SupplierReviewGatherSurveyController getController() throws BOSException
    {
        return (SupplierReviewGatherSurveyController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getSupplierReviewGatherSurveyInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getSupplierReviewGatherSurveyInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getSupplierReviewGatherSurveyInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getSupplierReviewGatherSurveyCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getSupplierReviewGatherSurveyCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getSupplierReviewGatherSurveyCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
