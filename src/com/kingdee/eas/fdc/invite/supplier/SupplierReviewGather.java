...
public class SupplierReviewGather extends FDCBill implements ISupplierReviewGather
{
    public SupplierReviewGather()
    {
        super();
        registerInterface(ISupplierReviewGather.class, this);
    }
    public SupplierReviewGather(Context ctx)
    {
        super(ctx);
        registerInterface(ISupplierReviewGather.class, this);
    }
    ...
    private SupplierReviewGatherController getController() throws BOSException
    {
        return (SupplierReviewGatherController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getSupplierReviewGatherInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getSupplierReviewGatherInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getSupplierReviewGatherInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getSupplierReviewGatherCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getSupplierReviewGatherCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getSupplierReviewGatherCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
