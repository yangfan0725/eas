...
public class InviteFixHead extends BaseInvite implements IInviteFixHead
{
    public InviteFixHead()
    {
        super();
        registerInterface(IInviteFixHead.class, this);
    }
    public InviteFixHead(Context ctx)
    {
        super(ctx);
        registerInterface(IInviteFixHead.class, this);
    }
    ...
    private InviteFixHeadController getController() throws BOSException
    {
        return (InviteFixHeadController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getInviteFixHeadInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getInviteFixHeadInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getInviteFixHeadInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getInviteFixHeadCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getInviteFixHeadCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getInviteFixHeadCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
