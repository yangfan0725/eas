...
public class InviteDocumentsEntry extends CoreBillEntryBase implements IInviteDocumentsEntry
{
    public InviteDocumentsEntry()
    {
        super();
        registerInterface(IInviteDocumentsEntry.class, this);
    }
    public InviteDocumentsEntry(Context ctx)
    {
        super(ctx);
        registerInterface(IInviteDocumentsEntry.class, this);
    }
    ...
    private InviteDocumentsEntryController getController() throws BOSException
    {
        return (InviteDocumentsEntryController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getInviteDocumentsEntryInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getInviteDocumentsEntryInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getInviteDocumentsEntryInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getInviteDocumentsEntryCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getInviteDocumentsEntryCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getInviteDocumentsEntryCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
