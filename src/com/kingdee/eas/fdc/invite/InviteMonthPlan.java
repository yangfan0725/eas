...
public class InviteMonthPlan extends FDCBill implements IInviteMonthPlan
{
    public InviteMonthPlan()
    {
        super();
        registerInterface(IInviteMonthPlan.class, this);
    }
    public InviteMonthPlan(Context ctx)
    {
        super(ctx);
        registerInterface(IInviteMonthPlan.class, this);
    }
    ...
    private InviteMonthPlanController getController() throws BOSException
    {
        return (InviteMonthPlanController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getInviteMonthPlanInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getInviteMonthPlanInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getInviteMonthPlanInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getInviteMonthPlanCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getInviteMonthPlanCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getInviteMonthPlanCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().checkLeaf(getContext(), billId);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
