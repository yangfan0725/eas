...
public class AppraiseResult extends FDCBill implements IAppraiseResult
{
    public AppraiseResult()
    {
        super();
        registerInterface(IAppraiseResult.class, this);
    }
    public AppraiseResult(Context ctx)
    {
        super(ctx);
        registerInterface(IAppraiseResult.class, this);
    }
    ...
    private AppraiseResultController getController() throws BOSException
    {
        return (AppraiseResultController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getAppraiseResultInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getAppraiseResultInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getAppraiseResultInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getAppraiseResultCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getAppraiseResultCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getAppraiseResultCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    /**
     *获取已审核单据的招标立项ID集合，供招标文件管理中的单据选择招标立项时添加过滤条件。-User defined method
     *@return
     */
    public Set getInviteProjectId() throws BOSException, EASBizException
    {
        try {
            return getController().getInviteProjectId(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
