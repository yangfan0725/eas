...
public class InviteChangeFormEntry extends CoreBillEntryBase implements IInviteChangeFormEntry
{
    public InviteChangeFormEntry()
    {
        super();
        registerInterface(IInviteChangeFormEntry.class, this);
    }
    public InviteChangeFormEntry(Context ctx)
    {
        super(ctx);
        registerInterface(IInviteChangeFormEntry.class, this);
    }
    ...
    private InviteChangeFormEntryController getController() throws BOSException
    {
        return (InviteChangeFormEntryController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getInviteChangeFormEntryInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getInviteChangeFormEntryInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getInviteChangeFormEntryInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getInviteChangeFormEntryCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getInviteChangeFormEntryCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getInviteChangeFormEntryCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
