...
public class InviteProjectEntries extends CoreBillEntryBase implements IInviteProjectEntries
{
    public InviteProjectEntries()
    {
        super();
        registerInterface(IInviteProjectEntries.class, this);
    }
    public InviteProjectEntries(Context ctx)
    {
        super(ctx);
        registerInterface(IInviteProjectEntries.class, this);
    }
    ...
    private InviteProjectEntriesController getController() throws BOSException
    {
        return (InviteProjectEntriesController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getInviteProjectEntriesInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getInviteProjectEntriesInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getInviteProjectEntriesInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getInviteProjectEntriesCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getInviteProjectEntriesCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getInviteProjectEntriesCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
