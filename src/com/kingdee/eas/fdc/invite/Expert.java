...
public class Expert extends DataBase implements IExpert
{
    public Expert()
    {
        super();
        registerInterface(IExpert.class, this);
    }
    public Expert(Context ctx)
    {
        super(ctx);
        registerInterface(IExpert.class, this);
    }
    ...
    private ExpertController getController() throws BOSException
    {
        return (ExpertController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getExpertInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getExpertInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getExpertInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getExpertCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getExpertCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getExpertCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
