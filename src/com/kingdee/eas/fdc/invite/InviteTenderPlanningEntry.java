...
public class InviteTenderPlanningEntry extends BaseInviteEntry implements IInviteTenderPlanningEntry
{
    public InviteTenderPlanningEntry()
    {
        super();
        registerInterface(IInviteTenderPlanningEntry.class, this);
    }
    public InviteTenderPlanningEntry(Context ctx)
    {
        super(ctx);
        registerInterface(IInviteTenderPlanningEntry.class, this);
    }
    ...
    private InviteTenderPlanningEntryController getController() throws BOSException
    {
        return (InviteTenderPlanningEntryController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getInviteTenderPlanningEntryInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getInviteTenderPlanningEntryInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getInviteTenderPlanningEntryInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getInviteTenderPlanningEntryCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getInviteTenderPlanningEntryCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getInviteTenderPlanningEntryCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
