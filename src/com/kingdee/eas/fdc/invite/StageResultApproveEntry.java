...
public class StageResultApproveEntry extends BaseInviteEntry implements IStageResultApproveEntry
{
    public StageResultApproveEntry()
    {
        super();
        registerInterface(IStageResultApproveEntry.class, this);
    }
    public StageResultApproveEntry(Context ctx)
    {
        super(ctx);
        registerInterface(IStageResultApproveEntry.class, this);
    }
    ...
    private StageResultApproveEntryController getController() throws BOSException
    {
        return (StageResultApproveEntryController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getStageResultApproveEntryInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getStageResultApproveEntryInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getStageResultApproveEntryInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getStageResultApproveEntryCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getStageResultApproveEntryCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getStageResultApproveEntryCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
