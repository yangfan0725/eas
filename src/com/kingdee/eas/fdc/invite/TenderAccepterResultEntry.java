...
public class TenderAccepterResultEntry extends CoreBillEntryBase implements ITenderAccepterResultEntry
{
    public TenderAccepterResultEntry()
    {
        super();
        registerInterface(ITenderAccepterResultEntry.class, this);
    }
    public TenderAccepterResultEntry(Context ctx)
    {
        super(ctx);
        registerInterface(ITenderAccepterResultEntry.class, this);
    }
    ...
    private TenderAccepterResultEntryController getController() throws BOSException
    {
        return (TenderAccepterResultEntryController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getTenderAccepterResultEntryInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getTenderAccepterResultEntryInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getTenderAccepterResultEntryInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getTenderAccepterResultEntryCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getTenderAccepterResultEntryCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getTenderAccepterResultEntryCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
