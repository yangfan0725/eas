...
public class InviteProject extends FDCBill implements IInviteProject
{
    public InviteProject()
    {
        super();
        registerInterface(IInviteProject.class, this);
    }
    public InviteProject(Context ctx)
    {
        super(ctx);
        registerInterface(IInviteProject.class, this);
    }
    ...
    private InviteProjectController getController() throws BOSException
    {
        return (InviteProjectController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getInviteProjectInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getInviteProjectInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getInviteProjectInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getInviteProjectCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getInviteProjectCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getInviteProjectCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    /**
     *获取能做招标立项的合约规划-User defined method
     *@param purchasePlan 选择的采购计划分录
     *@return
     */
    ...
    {
        try {
            return getController().getValidProgrammingContract(getContext(), purchasePlan);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
