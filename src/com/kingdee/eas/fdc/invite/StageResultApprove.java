...
public class StageResultApprove extends BaseInvite implements IStageResultApprove
{
    public StageResultApprove()
    {
        super();
        registerInterface(IStageResultApprove.class, this);
    }
    public StageResultApprove(Context ctx)
    {
        super(ctx);
        registerInterface(IStageResultApprove.class, this);
    }
    ...
    private StageResultApproveController getController() throws BOSException
    {
        return (StageResultApproveController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getStageResultApproveInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getStageResultApproveInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getStageResultApproveInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getStageResultApproveCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getStageResultApproveCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getStageResultApproveCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
