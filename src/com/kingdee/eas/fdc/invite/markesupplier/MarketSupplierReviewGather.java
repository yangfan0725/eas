...
public class MarketSupplierReviewGather extends FDCBill implements IMarketSupplierReviewGather
{
     ...
     *@return
     */
    public IObjectPK addnew(MarketSupplierReviewGatherInfo model) throws BOSException, EASBizException
    {
        try {
     ...
     *@param model model
     */
    public void addnew(IObjectPK pk, MarketSupplierReviewGatherInfo model) throws BOSException, EASBizException
    {
        try {
     ...
     *@param model model
     */
    public void update(IObjectPK pk, MarketSupplierReviewGatherInfo model) throws BOSException, EASBizException
    {
        try {
     ...
     *@param selector selector
     */
    public void updatePartial(MarketSupplierReviewGatherInfo model, SelectorItemCollection selector) throws BOSException, EASBizException
    {
        try {
     ...
     *@param model model
     */
    public void updateBigObject(IObjectPK pk, MarketSupplierReviewGatherInfo model) throws BOSException
    {
        try {
