...
public abstract class AbstractSupplierStockAccountReportUI extends com.kingdee.eas.framework.report.client.CommRptBaseUI
{
    ...
    public void initUIContentLayout()
    {
        ...
        kDSplitPane1.setBounds(new Rectangle(5, 5, 1001, 589));
        this.add(kDSplitPane1, new KDLayout.Constraints(5, 5, 1001, 589, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_BOTTOM | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT));
        //kDSplitPane1
...
kDContainer1.getContentPane().setLayout(new BorderLayout(0, 0));        kDContainer1.getContentPane().add(kDScrollPane1, BorderLayout.CENTER);
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.invite.markesupplier.rpt.SupplierStockAccountReportUIHandler";
	}
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.invite.markesupplier.rpt", "SupplierStockAccountReportUI");
    }
