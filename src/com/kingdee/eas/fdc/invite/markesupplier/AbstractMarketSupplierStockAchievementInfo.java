...
public class AbstractMarketSupplierStockAchievementInfo extends com.kingdee.eas.framework.CoreBillEntryBaseInfo implements Serializable 
{
    public AbstractMarketSupplierStockAchievementInfo()
    {
        this("id");
    }
    protected AbstractMarketSupplierStockAchievementInfo(String pkField)
    {
        super(pkField);
    }
    /**
