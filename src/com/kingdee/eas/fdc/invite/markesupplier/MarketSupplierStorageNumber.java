...
import com.kingdee.eas.fdc.invite.supplier.SupplierStorageNumber;
...
public class MarketSupplierStorageNumber extends SupplierStorageNumber implements IMarketSupplierStorageNumber
{
    public MarketSupplierStorageNumber()
    {
        super();
        registerInterface(IMarketSupplierStorageNumber.class, this);
    }
    public MarketSupplierStorageNumber(Context ctx)
    {
        super(ctx);
        registerInterface(IMarketSupplierStorageNumber.class, this);
    }
    ...
    private MarketSupplierStorageNumberController getController() throws BOSException
    {
        return (MarketSupplierStorageNumberController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getMarketSupplierStorageNumberInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getMarketSupplierStorageNumberInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getMarketSupplierStorageNumberInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getMarketSupplierStorageNumberCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getMarketSupplierStorageNumberCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getMarketSupplierStorageNumberCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
