 ...
 * output class name
 */
public abstract class AbstractMarketSupplierReviewGatherListUI extends com.kingdee.eas.fdc.basedata.client.FDCBillListUI
{
    ...
    private void jbInit() throws Exception
    {
        ...
        mainQueryPK = new MetaDataPK("com.kingdee.eas.fdc.invite.markesupplier.app", "MarketSupplierReviewGatherQuery");
        //actionAudit
...
contSupplierType.getContentPane().setLayout(new BorderLayout(0, 0));        contSupplierType.getContentPane().add(kDScrollPane2, BorderLayout.CENTER);
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.invite.markesupplier.app.MarketSupplierReviewGatherListUIHandler";
	}
    ...
    protected void supplierTypeTreeTree_valueChanged(javax.swing.event.TreeSelectionEvent e) throws Exception
    {
			...
			sic.add(new SelectorItemInfo("entry.auditTemplate.*"));
			...
			sic.add(new SelectorItemInfo("evaluationEntry.*"));
			sic.add(new SelectorItemInfo("evaluationEntry.supplierEvaluation.*"));
			...
			sic.add(new SelectorItemInfo("contractEntry.unit.*"));
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.invite.markesupplier.client", "MarketSupplierReviewGatherListUI");
    }
    ...
    {
        return new String[] {"supplier.number","supplier.name","evaluationType.name","template.name","number","bizDate","amount","isPass","state","id","createTime","creator.name","lastUpdateTime","lastUpdateUser.name","auditTime","auditor.name"};
    }
