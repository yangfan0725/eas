...
public interface IMarketSupplierBusinessMode extends IFDCDataBase
{
    ...
    public IObjectPK addnew(MarketSupplierBusinessModeInfo model) throws BOSException, EASBizException;
    public void addnew(IObjectPK pk, MarketSupplierBusinessModeInfo model) throws BOSException, EASBizException;
    public void update(IObjectPK pk, MarketSupplierBusinessModeInfo model) throws BOSException, EASBizException;
    public void updatePartial(MarketSupplierBusinessModeInfo model, SelectorItemCollection selector) throws BOSException, EASBizException;
    public void updateBigObject(IObjectPK pk, MarketSupplierBusinessModeInfo model) throws BOSException;
