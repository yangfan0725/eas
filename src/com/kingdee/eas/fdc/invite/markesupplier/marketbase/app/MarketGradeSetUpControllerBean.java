...
public class MarketGradeSetUpControllerBean extends AbstractMarketGradeSetUpControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.fdc.invite.markesupplier.marketbase.app.MarketGradeSetUpControllerBean");
    protected void _isNdelete(Context ctx, String gradeName)throws BOSException, EASBizException
    {
    }
}