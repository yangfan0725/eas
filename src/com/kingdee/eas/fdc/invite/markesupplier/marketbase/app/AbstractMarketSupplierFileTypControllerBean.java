...
public abstract class AbstractMarketSupplierFileTypControllerBean extends FDCDataBaseControllerBean implements MarketSupplierFileTypController
{
    ...
    {
        try {
            ServiceContext svcCtx = createServiceContext(new MetaDataPK("cbc6d21e-b1fa-4542-897b-f2ad32017e19"), new Object[]{ctx, pk});
    ...
    {
        try {
            ServiceContext svcCtx = createServiceContext(new MetaDataPK("17bcbbe1-e9b6-4d16-9bc8-32b494d9c034"), new Object[]{ctx, filter});
            invokeServiceBefore(svcCtx);
    ...
    {
        try {
            ServiceContext svcCtx = createServiceContext(new MetaDataPK("891b3f46-e4e0-4a2f-b4d8-52f186e417d2"), new Object[]{ctx, oql});
            invokeServiceBefore(svcCtx);
    ...
    {
        try {
            ServiceContext svcCtx = createServiceContext(new MetaDataPK("076553fc-638a-4fcd-b604-0089abb19c0c"), new Object[]{ctx, pk});
            invokeServiceBefore(svcCtx);
    ...
    {
        try {
            ServiceContext svcCtx = createServiceContext(new MetaDataPK("456c60d8-3bb7-4d7d-a242-45b61b43d1ef"), new Object[]{ctx, pk, selector});
            invokeServiceBefore(svcCtx);
    ...
    {
        try {
            ServiceContext svcCtx = createServiceContext(new MetaDataPK("f3c3afa7-4699-4e8f-9d2f-fd90eae33092"), new Object[]{ctx, oql});
            invokeServiceBefore(svcCtx);
    ...
    public IObjectPK addnew(Context ctx, MarketSupplierFileTypInfo model) throws BOSException, EASBizException
    {
        try {
            ServiceContext svcCtx = createServiceContext(new MetaDataPK("bb5897df-867c-4f7e-90cd-107148510ffb"), new Object[]{ctx, model});
            invokeServiceBefore(svcCtx);
    ...
    public void addnew(Context ctx, IObjectPK pk, MarketSupplierFileTypInfo model) throws BOSException, EASBizException
    {
        try {
            ServiceContext svcCtx = createServiceContext(new MetaDataPK("2c4a0c4c-f7a5-4405-9c67-d46bc8fef728"), new Object[]{ctx, pk, model});
            invokeServiceBefore(svcCtx);
    ...
    public void update(Context ctx, IObjectPK pk, MarketSupplierFileTypInfo model) throws BOSException, EASBizException
    {
        try {
            ServiceContext svcCtx = createServiceContext(new MetaDataPK("a632bc6a-06df-4855-b791-68fe4ea76fb6"), new Object[]{ctx, pk, model});
            invokeServiceBefore(svcCtx);
    ...
    public void updatePartial(Context ctx, MarketSupplierFileTypInfo model, SelectorItemCollection selector) throws BOSException, EASBizException
    {
        try {
            ServiceContext svcCtx = createServiceContext(new MetaDataPK("f0109c36-3fdf-4e7d-9dcb-0c6065c6b41c"), new Object[]{ctx, model, selector});
            invokeServiceBefore(svcCtx);
    ...
    public void updateBigObject(Context ctx, IObjectPK pk, MarketSupplierFileTypInfo model) throws BOSException
    {
        try {
            ServiceContext svcCtx = createServiceContext(new MetaDataPK("1c0dce12-dd1e-46dd-abfc-727521bc459d"), new Object[]{ctx, pk, model});
            invokeServiceBefore(svcCtx);
    ...
    {
        try {
            ServiceContext svcCtx = createServiceContext(new MetaDataPK("4f3d9ada-4979-4bfd-a436-3dcf7eed0ec0"), new Object[]{ctx, pk});
            invokeServiceBefore(svcCtx);
            _delete(ctx, pk);
            invokeServiceAfter(svcCtx);
        } catch (BOSException ex) {
    ...
    {
        try {
            ServiceContext svcCtx = createServiceContext(new MetaDataPK("a1ce34bf-b616-4647-a3ff-751d7a31e077"), new Object[]{ctx});
            invokeServiceBefore(svcCtx);
    ...
    {
        try {
            ServiceContext svcCtx = createServiceContext(new MetaDataPK("eacec868-8575-49c4-a521-474a86c62671"), new Object[]{ctx, oql});
            invokeServiceBefore(svcCtx);
    ...
    {
        try {
            ServiceContext svcCtx = createServiceContext(new MetaDataPK("06ef4488-c6f1-4a4a-a8a9-01ccb6aba29f"), new Object[]{ctx, filter, sorter});
            invokeServiceBefore(svcCtx);
    ...
    {
        try {
            ServiceContext svcCtx = createServiceContext(new MetaDataPK("9281cc45-7825-431e-b5d0-c78099737eb2"), new Object[]{ctx});
            invokeServiceBefore(svcCtx);
    ...
    {
        try {
            ServiceContext svcCtx = createServiceContext(new MetaDataPK("a676de3d-62aa-49a1-b6ce-c86cb90fa753"), new Object[]{ctx, view});
            invokeServiceBefore(svcCtx);
    ...
    {
        try {
            ServiceContext svcCtx = createServiceContext(new MetaDataPK("d18c9586-a023-47a8-957c-dc09e9c8da64"), new Object[]{ctx, oql});
            invokeServiceBefore(svcCtx);
    ...
    {
        try {
            ServiceContext svcCtx = createServiceContext(new MetaDataPK("097bcff5-67ec-43cc-9ee3-9b7fb6eb05bd"), new Object[]{ctx, filter});
            invokeServiceBefore(svcCtx);
    ...
    {
        try {
            ServiceContext svcCtx = createServiceContext(new MetaDataPK("7c63b4b7-9d38-4e0c-bf6a-353a582022da"), new Object[]{ctx, oql});
            invokeServiceBefore(svcCtx);
    ...
    {
        try {
            ServiceContext svcCtx = createServiceContext(new MetaDataPK("d9217fc6-1a93-43ae-b6d9-66ebd4f5c077"), new Object[]{ctx, arrayPK});
            invokeServiceBefore(svcCtx);
            _delete(ctx, arrayPK);
            invokeServiceAfter(svcCtx);
        } catch (BOSException ex) {
    ...
    {
    	return (FDCDataBaseCollection)(getMarketSupplierFileTypCollection(ctx).cast(FDCDataBaseCollection.class));
    }
    public FDCDataBaseCollection getFDCDataBaseCollection (Context ctx, EntityViewInfo view) throws BOSException
    {
    	return (FDCDataBaseCollection)(getMarketSupplierFileTypCollection(ctx, view).cast(FDCDataBaseCollection.class));
    }
    public FDCDataBaseCollection getFDCDataBaseCollection (Context ctx, String oql) throws BOSException
    {
    	return (FDCDataBaseCollection)(getMarketSupplierFileTypCollection(ctx, oql).cast(FDCDataBaseCollection.class));
    }
