...
public interface MarketSupplierAttachListController extends FDCDataBaseController
{
    ...
    public IObjectPK addnew(Context ctx, MarketSupplierAttachListInfo model) throws BOSException, EASBizException, RemoteException;
    public void addnew(Context ctx, IObjectPK pk, MarketSupplierAttachListInfo model) throws BOSException, EASBizException, RemoteException;
    public void update(Context ctx, IObjectPK pk, MarketSupplierAttachListInfo model) throws BOSException, EASBizException, RemoteException;
    public void updatePartial(Context ctx, MarketSupplierAttachListInfo model, SelectorItemCollection selector) throws BOSException, EASBizException, RemoteException;
    public void updateBigObject(Context ctx, IObjectPK pk, MarketSupplierAttachListInfo model) throws BOSException, RemoteException;
