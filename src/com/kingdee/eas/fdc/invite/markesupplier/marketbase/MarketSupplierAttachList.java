...
public class MarketSupplierAttachList extends FDCDataBase implements IMarketSupplierAttachList
{
     ...
     *@return
     */
    public IObjectPK addnew(MarketSupplierAttachListInfo model) throws BOSException, EASBizException
    {
        try {
     ...
     *@param model model
     */
    public void addnew(IObjectPK pk, MarketSupplierAttachListInfo model) throws BOSException, EASBizException
    {
        try {
     ...
     *@param model model
     */
    public void update(IObjectPK pk, MarketSupplierAttachListInfo model) throws BOSException, EASBizException
    {
        try {
     ...
     *@param selector selector
     */
    public void updatePartial(MarketSupplierAttachListInfo model, SelectorItemCollection selector) throws BOSException, EASBizException
    {
        try {
     ...
     *@param model model
     */
    public void updateBigObject(IObjectPK pk, MarketSupplierAttachListInfo model) throws BOSException
    {
        try {
