...
import com.kingdee.eas.fdc.invite.markesupplier.marketbase.MarketLevelSetUpCollection;
import com.kingdee.eas.framework.DataBaseCollection;

public class MarketLevelSetUpControllerBean extends AbstractMarketLevelSetUpControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.fdc.invite.markesupplier.marketbase.app.MarketLevelSetUpControllerBean");
}