...
public class MarketSupplierStockSupplierAttachListEntry extends CoreBillEntryBase implements IMarketSupplierStockSupplierAttachListEntry
{
    public MarketSupplierStockSupplierAttachListEntry()
    {
        super();
        registerInterface(IMarketSupplierStockSupplierAttachListEntry.class, this);
    }
    public MarketSupplierStockSupplierAttachListEntry(Context ctx)
    {
        super(ctx);
        registerInterface(IMarketSupplierStockSupplierAttachListEntry.class, this);
    }
    ...
    private MarketSupplierStockSupplierAttachListEntryController getController() throws BOSException
    {
        return (MarketSupplierStockSupplierAttachListEntryController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getMarketSupplierStockSupplierAttachListEntryInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getMarketSupplierStockSupplierAttachListEntryInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getMarketSupplierStockSupplierAttachListEntryInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getMarketSupplierStockSupplierAttachListEntryCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getMarketSupplierStockSupplierAttachListEntryCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getMarketSupplierStockSupplierAttachListEntryCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
