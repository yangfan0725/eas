...
public class AbstractMarketSupplierStockAptitudeFileInfo extends com.kingdee.eas.framework.CoreBillEntryBaseInfo implements Serializable 
{
    public AbstractMarketSupplierStockAptitudeFileInfo()
    {
        this("id");
    }
    protected AbstractMarketSupplierStockAptitudeFileInfo(String pkField)
    {
        super(pkField);
    }
    /**
