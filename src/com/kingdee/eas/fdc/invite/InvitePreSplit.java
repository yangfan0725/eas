...
public class InvitePreSplit extends FDCBill implements IInvitePreSplit
{
    public InvitePreSplit()
    {
        super();
        registerInterface(IInvitePreSplit.class, this);
    }
    public InvitePreSplit(Context ctx)
    {
        super(ctx);
        registerInterface(IInvitePreSplit.class, this);
    }
    ...
    private InvitePreSplitController getController() throws BOSException
    {
        return (InvitePreSplitController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getInvitePreSplitInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getInvitePreSplitInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getInvitePreSplitInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getInvitePreSplitCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getInvitePreSplitCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getInvitePreSplitCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    /**
     *设置是否生成合同-User defined method
     *@param billId billId
     *@param paramIsCreate paramIsCreate
     */
    public void setCreateContract(String billId, boolean paramIsCreate) throws BOSException, EASBizException
    {
        try {
            getController().setCreateContract(getContext(), billId, paramIsCreate);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    /**
     *设置合同拆分-User defined method
     *@param billId billId
     *@param paramIsSplit paramIsSplit
     */
    public void setContractSplit(String billId, boolean paramIsSplit) throws BOSException, EASBizException
    {
        try {
            getController().setContractSplit(getContext(), billId, paramIsSplit);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
