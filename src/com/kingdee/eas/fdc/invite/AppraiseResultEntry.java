...
public class AppraiseResultEntry extends CoreBillEntryBase implements IAppraiseResultEntry
{
    public AppraiseResultEntry()
    {
        super();
        registerInterface(IAppraiseResultEntry.class, this);
    }
    public AppraiseResultEntry(Context ctx)
    {
        super(ctx);
        registerInterface(IAppraiseResultEntry.class, this);
    }
    ...
    private AppraiseResultEntryController getController() throws BOSException
    {
        return (AppraiseResultEntryController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getAppraiseResultEntryInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getAppraiseResultEntryInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getAppraiseResultEntryInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getAppraiseResultEntryCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getAppraiseResultEntryCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getAppraiseResultEntryCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
