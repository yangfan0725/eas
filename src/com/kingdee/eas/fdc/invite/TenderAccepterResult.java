...
public class TenderAccepterResult extends BaseInvite implements ITenderAccepterResult
{
    public TenderAccepterResult()
    {
        super();
        registerInterface(ITenderAccepterResult.class, this);
    }
    public TenderAccepterResult(Context ctx)
    {
        super(ctx);
        registerInterface(ITenderAccepterResult.class, this);
    }
    ...
    private TenderAccepterResultController getController() throws BOSException
    {
        return (TenderAccepterResultController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getTenderAccepterResultInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getTenderAccepterResultInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getTenderAccepterResultInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getTenderAccepterResultCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getTenderAccepterResultCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getTenderAccepterResultCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    /**
     *获取修正系数-User defined method
     *@param inviteProjectId inviteProjectId
     *@return
     */
    public HashMap getFixMap(BOSUuid inviteProjectId) throws BOSException, EASBizException
    {
        try {
            return getController().getFixMap(getContext(), inviteProjectId);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
