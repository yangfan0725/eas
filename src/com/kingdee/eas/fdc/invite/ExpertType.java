...
public class ExpertType extends TreeBase implements IExpertType
{
    public ExpertType()
    {
        super();
        registerInterface(IExpertType.class, this);
    }
    public ExpertType(Context ctx)
    {
        super(ctx);
        registerInterface(IExpertType.class, this);
    }
    ...
    private ExpertTypeController getController() throws BOSException
    {
        return (ExpertTypeController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getExpertTypeInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getExpertTypeInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getExpertTypeInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getExpertTypeCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getExpertTypeCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getExpertTypeCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
