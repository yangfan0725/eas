...
public class ExpertAppraiseEntry extends CoreBillEntryBase implements IExpertAppraiseEntry
{
    public ExpertAppraiseEntry()
    {
        super();
        registerInterface(IExpertAppraiseEntry.class, this);
    }
    public ExpertAppraiseEntry(Context ctx)
    {
        super(ctx);
        registerInterface(IExpertAppraiseEntry.class, this);
    }
    ...
    private ExpertAppraiseEntryController getController() throws BOSException
    {
        return (ExpertAppraiseEntryController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getExpertAppraiseEntryInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getExpertAppraiseEntryInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getExpertAppraiseEntryInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getExpertAppraiseEntryCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getExpertAppraiseEntryCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getExpertAppraiseEntryCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
