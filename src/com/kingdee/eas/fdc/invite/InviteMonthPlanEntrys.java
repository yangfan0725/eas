...
public class InviteMonthPlanEntrys extends CoreBillEntryBase implements IInviteMonthPlanEntrys
{
    public InviteMonthPlanEntrys()
    {
        super();
        registerInterface(IInviteMonthPlanEntrys.class, this);
    }
    public InviteMonthPlanEntrys(Context ctx)
    {
        super(ctx);
        registerInterface(IInviteMonthPlanEntrys.class, this);
    }
    ...
    private InviteMonthPlanEntrysController getController() throws BOSException
    {
        return (InviteMonthPlanEntrysController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getInviteMonthPlanEntrysInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getInviteMonthPlanEntrysInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getInviteMonthPlanEntrysInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getInviteMonthPlanEntrysCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getInviteMonthPlanEntrysCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getInviteMonthPlanEntrysCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
