...
public class InviteFormControllerBean extends AbstractInviteFormControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.fdc.invite.app.InviteFormControllerBean");
