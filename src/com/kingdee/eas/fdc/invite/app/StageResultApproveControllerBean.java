...
public class StageResultApproveControllerBean extends AbstractStageResultApproveControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.fdc.invite.app.StageResultApproveControllerBean");
    
    protected void _delete(Context ctx, IObjectPK pk) throws BOSException, EASBizException {
    	StageResultApproveInfo info=this.getStageResultApproveInfo(ctx, pk);
