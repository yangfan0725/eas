...
public class InviteContractFrameControllerBean extends AbstractInviteContractFrameControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.fdc.invite.app.InviteContractFrameControllerBean");
