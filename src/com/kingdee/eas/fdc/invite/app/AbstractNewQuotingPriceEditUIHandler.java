 ...
 * output class name
 */
public abstract class AbstractNewQuotingPriceEditUIHandler extends com.kingdee.eas.framework.app.EditUIHandler

{
	...
	public void handleActionExportQuotingExcel(RequestContext request,ResponseContext response, Context context) throws Exception {
		_handleActionExportQuotingExcel(request,response,context);
	}
	protected void _handleActionExportQuotingExcel(RequestContext request,ResponseContext response, Context context) throws Exception {
	}
}