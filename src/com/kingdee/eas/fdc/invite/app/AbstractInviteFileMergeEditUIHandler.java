 ...
 * output class name
 */
public abstract class AbstractInviteFileMergeEditUIHandler extends com.kingdee.eas.fdc.basedata.app.FDCBillEditUIHandler

{
	...
	public void handleActionViewPrepareApparise(RequestContext request,ResponseContext response, Context context) throws Exception {
		_handleActionViewPrepareApparise(request,response,context);
	}
	protected void _handleActionViewPrepareApparise(RequestContext request,ResponseContext response, Context context) throws Exception {
	}
}