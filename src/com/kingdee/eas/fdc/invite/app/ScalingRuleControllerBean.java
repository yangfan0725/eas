...
public class ScalingRuleControllerBean extends AbstractScalingRuleControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.fdc.invite.app.ScalingRuleControllerBean");
