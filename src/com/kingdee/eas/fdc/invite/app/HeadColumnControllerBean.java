...
public class HeadColumnControllerBean extends AbstractHeadColumnControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.fdc.invite.app.HeadColumnControllerBean");
