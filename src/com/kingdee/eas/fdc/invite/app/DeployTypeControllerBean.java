...
public class DeployTypeControllerBean extends AbstractDeployTypeControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.fdc.invite.app.DeployTypeControllerBean");
