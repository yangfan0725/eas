...
public class InviteContentControllerBean extends AbstractInviteContentControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.fdc.invite.app.InviteContentControllerBean");
}