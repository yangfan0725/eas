...
public class DrawingDepthControllerBean extends AbstractDrawingDepthControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.fdc.invite.app.DrawingDepthControllerBean");
