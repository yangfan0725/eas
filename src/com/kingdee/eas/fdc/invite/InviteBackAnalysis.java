...
public class InviteBackAnalysis extends BaseInvite implements IInviteBackAnalysis
{
    public InviteBackAnalysis()
    {
        super();
        registerInterface(IInviteBackAnalysis.class, this);
    }
    public InviteBackAnalysis(Context ctx)
    {
        super(ctx);
        registerInterface(IInviteBackAnalysis.class, this);
    }
    ...
    private InviteBackAnalysisController getController() throws BOSException
    {
        return (InviteBackAnalysisController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getInviteBackAnalysisInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getInviteBackAnalysisInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getInviteBackAnalysisInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getInviteBackAnalysisCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getInviteBackAnalysisCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getInviteBackAnalysisCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
