...
public class AuthorizedPerson extends BillEntryBase implements IAuthorizedPerson
{
    public AuthorizedPerson()
    {
        super();
        registerInterface(IAuthorizedPerson.class, this);
    }
    public AuthorizedPerson(Context ctx)
    {
        super(ctx);
        registerInterface(IAuthorizedPerson.class, this);
    }
    ...
    private AuthorizedPersonController getController() throws BOSException
    {
        return (AuthorizedPersonController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getAuthorizedPersonInfo(getContext(), pk);
        }
    ...
    {
        try {
            return getController().getAuthorizedPersonInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getAuthorizedPersonInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getAuthorizedPersonCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getAuthorizedPersonCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getAuthorizedPersonCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
