...
public class InviteBackAnalysisEntrys extends BaseInviteEntry implements IInviteBackAnalysisEntrys
{
    public InviteBackAnalysisEntrys()
    {
        super();
        registerInterface(IInviteBackAnalysisEntrys.class, this);
    }
    public InviteBackAnalysisEntrys(Context ctx)
    {
        super(ctx);
        registerInterface(IInviteBackAnalysisEntrys.class, this);
    }
    ...
    private InviteBackAnalysisEntrysController getController() throws BOSException
    {
        return (InviteBackAnalysisEntrysController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getInviteBackAnalysisEntrysInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getInviteBackAnalysisEntrysInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getInviteBackAnalysisEntrysInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getInviteBackAnalysisEntrysCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getInviteBackAnalysisEntrysCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getInviteBackAnalysisEntrysCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
