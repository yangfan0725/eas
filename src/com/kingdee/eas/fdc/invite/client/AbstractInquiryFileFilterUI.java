 ...
 * output class name
 */
public abstract class AbstractInquiryFileFilterUI extends com.kingdee.eas.base.commonquery.client.CustomerQueryPanel
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractInquiryFileFilterUI.class);
     ...
     */
    public AbstractInquiryFileFilterUI() throws Exception
    {
        super();
        jbInit();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractInquiryFileFilterUI.class.getName());
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.invite.app.InquiryFileFilterUIHandler";
	}
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.invite.client", "InquiryFileFilterUI");
    }
