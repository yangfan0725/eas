 ...
 * output class name
 */
public abstract class AbstractInviteFileMergeListUI extends com.kingdee.eas.fdc.invite.client.InviteListBaseUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractInviteFileMergeListUI.class);
     ...
     */
    public AbstractInviteFileMergeListUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractInviteFileMergeListUI.class.getName());
        this.setUITitle(resHelper.getString("this.title"));
        mainQueryPK = new MetaDataPK("com.kingdee.eas.fdc.invite.app", "InviteFileMergeQuery");
        //actionAttachment
        ...
        this.btnInviteAllInformation.setToolTipText(resHelper.getString("btnInviteAllInformation.toolTipText"));
        // menuItemViewFile
...
contBill.getContentPane().setLayout(new BorderLayout(0, 0));        contBill.getContentPane().add(tblMain, BorderLayout.CENTER);
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.invite.app.InviteFileMergeListUIHandler";
	}
    ...
    protected class ActionAudit extends ItemAction {     
        ...
        public void actionPerformed(ActionEvent e)
        {
            ...
            innerActionPerformed("eas", AbstractInviteFileMergeListUI.this, "ActionAudit", "actionAudit_actionPerformed", e);
        }
    }
    ...
    protected class ActionUnAudit extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractInviteFileMergeListUI.this, "ActionUnAudit", "actionUnAudit_actionPerformed", e);
        }
    }
    ...
    protected class ActionUpLoadFile extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractInviteFileMergeListUI.this, "ActionUpLoadFile", "actionUpLoadFile_actionPerformed", e);
        }
    }
    ...
    protected class ActionViewFile extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractInviteFileMergeListUI.this, "ActionViewFile", "actionViewFile_actionPerformed", e);
        }
    }
    ...
    protected class ActionInviteAllInformation extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractInviteFileMergeListUI.this, "ActionInviteAllInformation", "actionInviteAllInformation_actionPerformed", e);
        }
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.invite.client", "InviteFileMergeListUI");
    }
