 ...
 * output class name
 */
public class InviteBidEvaluationListUI extends AbstractInviteBidEvaluationListUI
{
    private static final Logger logger = CoreUIObject.getLogger(InviteBidEvaluationListUI.class);
    public InviteBidEvaluationListUI() throws Exception
    {
        super();
    }
    protected void refreshBillListTable(String paramId) throws BOSException {
		...
		InviteBidEvaluationCollection recordCols = getBillList(paramId);
		if (recordCols != null) {
			Iterator iter = recordCols.iterator();
			while (iter.hasNext()) {
				InviteBidEvaluationInfo info = (InviteBidEvaluationInfo) iter.next();
	...
	static InviteBidEvaluationCollection getBillList(String paramId)throws BOSException {
		...
		InviteBidEvaluationCollection clarifyCol = InviteBidEvaluationFactory.getRemoteInstance().getInviteBidEvaluationCollection(view);
	...
	protected String getEditUIName() {
		return InviteBidEvaluationEditUI.class.getName();
	}
