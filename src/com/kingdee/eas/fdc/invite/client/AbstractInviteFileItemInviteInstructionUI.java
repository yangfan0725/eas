 ...
 * output class name
 */
public abstract class AbstractInviteFileItemInviteInstructionUI extends com.kingdee.eas.fdc.invite.client.InviteFileItemListUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractInviteFileItemInviteInstructionUI.class);
    /**
     * output class constructor
     */
    public AbstractInviteFileItemInviteInstructionUI() throws Exception
    {
        super();
...
contBill.getContentPane().setLayout(new BorderLayout(0, 0));        contBill.getContentPane().add(tblMain, BorderLayout.CENTER);
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.invite.app.InviteFileItemInviteInstructionUIHandler";
	}
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.invite.client", "InviteFileItemInviteInstructionUI");
    }
