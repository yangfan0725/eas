 ...
 * output class name
 */
public abstract class AbstractInviteBidEvaluationEditUI extends com.kingdee.eas.fdc.invite.client.BaseInviteEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractInviteBidEvaluationEditUI.class);
    protected com.kingdee.eas.fdc.invite.InviteBidEvaluationInfo editData = null;
    protected ShowProjects showProjects = null;
    /**
     * output class constructor
     */
    public AbstractInviteBidEvaluationEditUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractInviteBidEvaluationEditUI.class.getName());
    ...
    public void initUIContentLayout()
    {
        ...
        contNumber.setBounds(new Rectangle(920, 17, 270, 19));
        this.add(contNumber, new KDLayout.Constraints(920, 17, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        ...
        contEntry.setBounds(new Rectangle(10, 53, 959, 489));
        this.add(contEntry, new KDLayout.Constraints(10, 53, 959, 489, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT));
...
contEntry.getContentPane().setLayout(new BorderLayout(0, 0));        contEntry.getContentPane().add(kdtEntry, BorderLayout.CENTER);
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.invite.app.InviteBidEvaluationEditUIHandler";
	}
    ...
    public void setDataObject(IObjectValue dataObject)
    {
        ...
        this.editData = (com.kingdee.eas.fdc.invite.InviteBidEvaluationInfo)ov;
    }
    ...
    protected class ShowProjects extends ItemAction {     
        ...
        public void actionPerformed(ActionEvent e)
        {
            ...
            innerActionPerformed("eas", AbstractInviteBidEvaluationEditUI.this, "ShowProjects", "showProjects_actionPerformed", e);
        }
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.invite.client", "InviteBidEvaluationEditUI");
    }
    /**
