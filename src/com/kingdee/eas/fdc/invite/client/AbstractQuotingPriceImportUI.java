 ...
 * output class name
 */
public abstract class AbstractQuotingPriceImportUI extends com.kingdee.eas.framework.client.CoreUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractQuotingPriceImportUI.class);
     ...
     */
    public AbstractQuotingPriceImportUI() throws Exception
    {
        super();
        jbInit();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractQuotingPriceImportUI.class.getName());
        ...
        this.btnExportErrorInfo.setIcon(com.kingdee.eas.util.client.EASResource.getIcon("imgTbtn_output"));
        this.btnExportErrorInfo.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent e) {
                beforeActionPerformed(e);
                try {
                    btnExportErrorInfo_actionPerformed(e);
                } catch (Exception exc) {
                    handUIException(exc);
                } finally {
                    afterActionPerformed(e);
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.invite.app.QuotingPriceImportUIHandler";
	}
    ...
    /**
     * output btnExportErrorInfo_actionPerformed method
     */
    protected void btnExportErrorInfo_actionPerformed(java.awt.event.ActionEvent e) throws Exception
    {
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.invite.client", "QuotingPriceImportUI");
    }
