 ...
 * output class name
 */
public abstract class AbstractStageResultApproveListUI extends com.kingdee.eas.fdc.invite.client.BaseInviteListUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractStageResultApproveListUI.class);
    /**
     * output class constructor
     */
    public AbstractStageResultApproveListUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractStageResultApproveListUI.class.getName());
...
contBaseInvite.getContentPane().setLayout(new BorderLayout(0, 0));        contBaseInvite.getContentPane().add(tblBaseInvite, BorderLayout.CENTER);
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.invite.app.StageResultApproveListUIHandler";
	}
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.invite.client", "StageResultApproveListUI");
    }
