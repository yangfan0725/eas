 ...
 * output class name
 */
public class InviteFileItemBluePrintUI extends AbstractInviteFileItemBluePrintUI
{
    private static final Logger logger = CoreUIObject.getLogger(InviteFileItemBluePrintUI.class);
    
    /**
     * output class constructor
     */
    public InviteFileItemBluePrintUI() throws Exception
    {
        super();
    }
...
//		super.onLoad();
//		getUIContext().put("billType", InviteFileItemTypeEnum.BLUEPRINTCONTENT_VALUE);
//	}
//	
