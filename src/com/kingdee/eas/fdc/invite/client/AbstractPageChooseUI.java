 ...
 * output class name
 */
public abstract class AbstractPageChooseUI extends com.kingdee.eas.framework.client.CoreUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractPageChooseUI.class);
     ...
     */
    public AbstractPageChooseUI() throws Exception
    {
        super();
        jbInit();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractPageChooseUI.class.getName());
    ...
    public void initUIContentLayout()
    {
        ...
        tblMain.setBounds(new Rectangle(10, 10, 536, 310));
        this.add(tblMain, new KDLayout.Constraints(10, 10, 536, 310, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_BOTTOM | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT));
        btnConfirm.setBounds(new Rectangle(367, 330, 73, 21));
        this.add(btnConfirm, new KDLayout.Constraints(367, 330, 73, 21, KDLayout.Constraints.ANCHOR_BOTTOM | KDLayout.Constraints.ANCHOR_RIGHT));
        btnCancel2.setBounds(new Rectangle(461, 330, 73, 21));
        this.add(btnCancel2, new KDLayout.Constraints(461, 330, 73, 21, KDLayout.Constraints.ANCHOR_BOTTOM | KDLayout.Constraints.ANCHOR_RIGHT));
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.invite.app.PageChooseUIHandler";
	}
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.invite.client", "PageChooseUI");
    }
