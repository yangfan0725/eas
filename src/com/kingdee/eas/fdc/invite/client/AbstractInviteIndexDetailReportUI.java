 ...
 * output class name
 */
public abstract class AbstractInviteIndexDetailReportUI extends com.kingdee.eas.framework.report.client.CommRptBaseUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractInviteIndexDetailReportUI.class);
     ...
     */
    public AbstractInviteIndexDetailReportUI() throws Exception
    {
        super();
        jbInit();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractInviteIndexDetailReportUI.class.getName());
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.invite.app.InviteIndexDetailReportUIHandler";
	}
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.invite.client", "InviteIndexDetailReportUI");
    }
