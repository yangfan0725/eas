 ...
 * output class name
 */
public class ListingColumnSettingUI extends AbstractListingColumnSettingUI
{
    private static final Logger logger = CoreUIObject.getLogger(ListingColumnSettingUI.class);
    
    /**
     * output class constructor
     */
    public ListingColumnSettingUI() throws Exception
    {
        super();
    }
    ...
    {
        super.btnAddRoot_actionPerformed(e);
    }
    ...
    {
        super.btnAddLeaf_actionPerformed(e);
    }
    ...
    {
        super.btnRemoveNode_actionPerformed(e);
    }
