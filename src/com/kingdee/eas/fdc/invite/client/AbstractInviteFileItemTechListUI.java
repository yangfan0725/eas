 ...
 * output class name
 */
public abstract class AbstractInviteFileItemTechListUI extends com.kingdee.eas.fdc.invite.client.InviteFileItemListUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractInviteFileItemTechListUI.class);
    /**
     * output class constructor
     */
    public AbstractInviteFileItemTechListUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractInviteFileItemTechListUI.class.getName());
...
contBill.getContentPane().setLayout(new BorderLayout(0, 0));        contBill.getContentPane().add(tblMain, BorderLayout.CENTER);
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.invite.app.InviteFileItemTechListUIHandler";
	}
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.invite.client", "InviteFileItemTechListUI");
    }
