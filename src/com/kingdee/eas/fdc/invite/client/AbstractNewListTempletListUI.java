 ...
 * output class name
 */
public abstract class AbstractNewListTempletListUI extends com.kingdee.eas.fdc.invite.client.InviteListBaseUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractNewListTempletListUI.class);
    protected com.kingdee.bos.ctrl.swing.KDWorkButton btnDistribute;
    protected ActionDistribute actionDistribute = null;
    /**
     * output class constructor
     */
    public AbstractNewListTempletListUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractNewListTempletListUI.class.getName());
...
contBill.getContentPane().setLayout(new BorderLayout(0, 0));        contBill.getContentPane().add(tblMain, BorderLayout.CENTER);
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.invite.app.NewListTempletListUIHandler";
	}
    ...
    protected class ActionDistribute extends ItemAction {     
        ...
        public void actionPerformed(ActionEvent e)
        {
            ...
            innerActionPerformed("eas", AbstractNewListTempletListUI.this, "ActionDistribute", "actionDistribute_actionPerformed", e);
        }
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.invite.client", "NewListTempletListUI");
    }
