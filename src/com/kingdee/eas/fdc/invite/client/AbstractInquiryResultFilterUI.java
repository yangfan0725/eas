 ...
 * output class name
 */
public abstract class AbstractInquiryResultFilterUI extends com.kingdee.eas.base.commonquery.client.CustomerQueryPanel
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractInquiryResultFilterUI.class);
     ...
     */
    public AbstractInquiryResultFilterUI() throws Exception
    {
        super();
        jbInit();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractInquiryResultFilterUI.class.getName());
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.invite.app.InquiryResultFilterUIHandler";
	}
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.invite.client", "InquiryResultFilterUI");
    }
