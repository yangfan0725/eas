 ...
 * output class name
 */
public abstract class AbstractInviteContentUI extends com.kingdee.eas.framework.client.CoreUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractInviteContentUI.class);
     ...
     */
    public AbstractInviteContentUI() throws Exception
    {
        super();
        jbInit();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractInviteContentUI.class.getName());
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.invite.app.InviteContentUIHandler";
	}
    ...
    protected class ActionView extends ItemAction {     
        ...
        public void actionPerformed(ActionEvent e)
        {
            ...
            innerActionPerformed("eas", AbstractInviteContentUI.this, "ActionView", "actionView_actionPerformed", e);
        }
    }
    ...
    protected class ActionDelete extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractInviteContentUI.this, "ActionDelete", "actionDelete_actionPerformed", e);
        }
    }
    ...
    protected class ActionEdit extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractInviteContentUI.this, "ActionEdit", "actionEdit_actionPerformed", e);
        }
    }
    ...
    protected class ActionAdd extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractInviteContentUI.this, "ActionAdd", "actionAdd_actionPerformed", e);
        }
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.invite.client", "InviteContentUI");
    }
