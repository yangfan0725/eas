 ...
 * output class name
 */
public class InquiryResultFilterUI extends AbstractInquiryResultFilterUI
{
private static final Logger logger = CoreUIObject.getLogger(InquiryResultFilterUI.class);
    ...
    public InquiryResultFilterUI() throws Exception
    {
        super();
    }

   
	public InquiryResultFilterUI(ListUI listUI, ItemAction actionListOnLoad) throws Exception {
