 ...
 * output class name
 */
public abstract class AbstractInviteBackAnalysisEditUI extends com.kingdee.eas.fdc.invite.client.BaseInviteEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractInviteBackAnalysisEditUI.class);
    protected com.kingdee.bos.ctrl.swing.KDPanel inviteProjectPanel;
    protected com.kingdee.eas.fdc.invite.InviteBackAnalysisInfo editData = null;
    /**
     * output class constructor
     */
    public AbstractInviteBackAnalysisEditUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractInviteBackAnalysisEditUI.class.getName());
    ...
    public void initUIContentLayout()
    {
        ...
        this.add(contName, new KDLayout.Constraints(365, 9, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT));
        ...
        contEntry.setBounds(new Rectangle(10, 276, 980, 266));
        this.add(contEntry, new KDLayout.Constraints(10, 276, 980, 266, 0));
...
contEntry.getContentPane().setLayout(new BorderLayout(0, 0));        contEntry.getContentPane().add(kdtEntry, BorderLayout.CENTER);
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.invite.app.InviteBackAnalysisEditUIHandler";
	}
    ...
    public void setDataObject(IObjectValue dataObject)
    {
        ...
        this.editData = (com.kingdee.eas.fdc.invite.InviteBackAnalysisInfo)ov;
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.invite.client", "InviteBackAnalysisEditUI");
    }
    /**
