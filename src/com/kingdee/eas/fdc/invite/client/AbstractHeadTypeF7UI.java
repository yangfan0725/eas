 ...
 * output class name
 */
public abstract class AbstractHeadTypeF7UI extends com.kingdee.eas.fdc.invite.client.HeadTypeListUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractHeadTypeF7UI.class);
    protected com.kingdee.bos.ctrl.swing.KDSeparator kDSeparator3;
    protected com.kingdee.bos.ctrl.swing.KDButton btnConfirm;
    protected com.kingdee.bos.ctrl.swing.KDButton btnCan;
    /**
     * output class constructor
     */
    public AbstractHeadTypeF7UI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractHeadTypeF7UI.class.getName());
        this.setUITitle(resHelper.getString("this.title"));
        mainQueryPK = new MetaDataPK("com.kingdee.eas.fdc.invite.app", "HeadTypeQuery");
        //actionMoveTree
        ...
        this.btnCan = new com.kingdee.bos.ctrl.swing.KDButton();
    ...
    public void initUIContentLayout()
    {
        ...
        btnConfirm.setBounds(new Rectangle(461, 362, 75, 25));
        this.add(btnConfirm, new KDLayout.Constraints(461, 362, 75, 25, KDLayout.Constraints.ANCHOR_TOP_SCALE | KDLayout.Constraints.ANCHOR_BOTTOM | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT));
        btnCan.setBounds(new Rectangle(552, 361, 75, 25));
        this.add(btnCan, new KDLayout.Constraints(552, 361, 75, 25, KDLayout.Constraints.ANCHOR_TOP_SCALE | KDLayout.Constraints.ANCHOR_BOTTOM | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT));
        //pnlMain
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.invite.app.HeadTypeF7UIHandler";
	}
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.invite.client", "HeadTypeF7UI");
    }
