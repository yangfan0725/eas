...
public class InviteTenderPlanningPrintDataProvider extends FDCBillDataProvider{
	private static final Logger logger = Logger.getLogger(InviteTenderPlanningPrintDataProvider.class);
	private HashMap map = null;
	
	public InviteTenderPlanningPrintDataProvider(String billId, IMetaDataPK mainQuery) {
		super(billId, mainQuery);
		// TODO Auto-generated constructor stub
	}
	
	public InviteTenderPlanningPrintDataProvider(String billId,IMetaDataPK mainQuery,HashMap map)
	{
		super(billId, mainQuery);
		this.map = map;
	}
