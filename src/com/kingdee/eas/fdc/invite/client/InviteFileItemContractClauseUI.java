 ...
 * output class name
 */
public class InviteFileItemContractClauseUI extends AbstractInviteFileItemContractClauseUI
{
    private static final Logger logger = CoreUIObject.getLogger(InviteFileItemContractClauseUI.class);
    
    /**
     * output class constructor
     */
    public InviteFileItemContractClauseUI() throws Exception
    {
        super();
    }
	...
	public void onLoad() throws Exception {
		...
		super.onLoad();
		getUIContext().put("billType", InviteFileItemTypeEnum.CONTRACTCLAUSE_VALUE);
