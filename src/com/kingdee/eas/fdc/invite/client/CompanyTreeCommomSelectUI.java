 ...
 * output class name
 */
public class CompanyTreeCommomSelectUI extends AbstractCompanyTreeSelectUI {
	private static final Logger logger = CoreUIObject
			.getLogger(CompanyTreeCommomSelectUI.class);
	...
	private TreeModel orgTreeModel = null;
	...
	private void setTreeModel(TreeModel orgTreeModel ){
	...
	public CompanyTreeCommomSelectUI() throws Exception {
		super();
	...
	public CompanyTreeCommomSelectUI(TreeModel orgTreeModel) throws Exception {
		super();
		...
		if (orgTreeModel == null)
			return; // can't go here
		treeOrigin.setModel(orgTreeModel);
		DefaultKingdeeTreeNode root = (DefaultKingdeeTreeNode) treeOrigin
		.getModel().getRoot();
		treeOrigin.expandAllNodes(true, root);
