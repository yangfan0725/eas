 ...
 * output class name
 */
public abstract class AbstractListingItemListUI extends com.kingdee.eas.fdc.invite.client.HeadListBaseUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractListingItemListUI.class);
     ...
     */
    public AbstractListingItemListUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractListingItemListUI.class.getName());
...
contBill.getContentPane().setLayout(new BorderLayout(0, 0));        contBill.getContentPane().add(tblMain, BorderLayout.CENTER);
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.invite.app.ListingItemListUIHandler";
	}
    ...
    protected class ActionImportPrice extends ItemAction {     
        ...
        public void actionPerformed(ActionEvent e)
        {
            ...
            innerActionPerformed("eas", AbstractListingItemListUI.this, "ActionImportPrice", "actionImportPrice_actionPerformed", e);
        }
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.invite.client", "ListingItemListUI");
    }
