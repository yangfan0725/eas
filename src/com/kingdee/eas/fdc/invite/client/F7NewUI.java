 ...
 * output class name
 */
public class F7NewUI extends AbstractF7NewUI implements IF7Provider,TreeSelectionListener
{
    private static final Logger logger = CoreUIObject.getLogger(F7NewUI.class);
     ...
     */
    public F7NewUI() throws Exception
    {
        super();
    }
