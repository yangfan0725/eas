 ...
 * output class name
 */
public abstract class AbstractMaterialSampleEditUI extends com.kingdee.eas.fdc.invite.client.BaseInviteEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractMaterialSampleEditUI.class);
    protected com.kingdee.eas.fdc.invite.MaterialSampleInfo editData = null;
    protected ShowProjects showProjects = null;
    /**
     * output class constructor
     */
    public AbstractMaterialSampleEditUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractMaterialSampleEditUI.class.getName());
    ...
    public void initUIContentLayout()
    {
        ...
        contNumber.setBounds(new Rectangle(938, 11, 270, 19));
        this.add(contNumber, new KDLayout.Constraints(938, 11, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        ...
        contEntry.setBounds(new Rectangle(10, 39, 959, 503));
        this.add(contEntry, new KDLayout.Constraints(10, 39, 959, 503, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT));
...
contEntry.getContentPane().setLayout(new BorderLayout(0, 0));        contEntry.getContentPane().add(kdtEntry, BorderLayout.CENTER);
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.invite.app.MaterialSampleEditUIHandler";
	}
    ...
    public void setDataObject(IObjectValue dataObject)
    {
        ...
        this.editData = (com.kingdee.eas.fdc.invite.MaterialSampleInfo)ov;
    }
    ...
    protected class ShowProjects extends ItemAction {     
        ...
        public void actionPerformed(ActionEvent e)
        {
            ...
            innerActionPerformed("eas", AbstractMaterialSampleEditUI.this, "ShowProjects", "showProjects_actionPerformed", e);
        }
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.invite.client", "MaterialSampleEditUI");
    }
    /**
