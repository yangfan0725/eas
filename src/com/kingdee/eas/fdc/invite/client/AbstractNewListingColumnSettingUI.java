 ...
 * output class name
 */
public abstract class AbstractNewListingColumnSettingUI extends CoreUIObject
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractNewListingColumnSettingUI.class);
    ...
    protected com.kingdee.bos.ctrl.swing.KDCheckBox ckbIsQuoting;
    /**
     * output class constructor
     */
    public AbstractNewListingColumnSettingUI() throws Exception
    {
        super();
        jbInit();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractNewListingColumnSettingUI.class.getName());
        ...
        this.ckbIsQuoting = new com.kingdee.bos.ctrl.swing.KDCheckBox();
        ...
        this.ckbIsQuoting.setName("ckbIsQuoting");
        ...
        // ckbIsQuoting		
        this.ckbIsQuoting.setText(resHelper.getString("ckbIsQuoting.text"));
    ...
    public void initUIContentLayout()
    {
        ...
        ckbIsQuoting.setBounds(new Rectangle(341, 10, 270, 19));
        this.add(ckbIsQuoting, new KDLayout.Constraints(341, 10, 270, 19, 0));
        //contName
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.invite.app.NewListingColumnSettingUIHandler";
	}
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.invite.client", "NewListingColumnSettingUI");
    }
