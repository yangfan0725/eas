 ...
 * output class name
 */
public abstract class AbstractListingColumnSettingUI extends CoreUIObject
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractListingColumnSettingUI.class);
     ...
     */
    public AbstractListingColumnSettingUI() throws Exception
    {
        super();
        jbInit();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractListingColumnSettingUI.class.getName());
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.invite.app.ListingColumnSettingUIHandler";
	}
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.invite.client", "ListingColumnSettingUI");
    }
