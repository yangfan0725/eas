 ...
 * output class name
 */
public abstract class AbstractNewListColumnSettingUI extends CoreUIObject
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractNewListColumnSettingUI.class);
     ...
     */
    public AbstractNewListColumnSettingUI() throws Exception
    {
        super();
        jbInit();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractNewListColumnSettingUI.class.getName());
    ...
    public void initUIContentLayout()
    {
        ...
        btnConfirm.setBounds(new Rectangle(374, 398, 96, 21));
        this.add(btnConfirm, new KDLayout.Constraints(374, 398, 96, 21, KDLayout.Constraints.ANCHOR_BOTTOM | KDLayout.Constraints.ANCHOR_RIGHT));
        btnCancel.setBounds(new Rectangle(494, 398, 96, 21));
        this.add(btnCancel, new KDLayout.Constraints(494, 398, 96, 21, KDLayout.Constraints.ANCHOR_BOTTOM | KDLayout.Constraints.ANCHOR_RIGHT));
        kDScrollPane1.setBounds(new Rectangle(10, 40, 470, 350));
        this.add(kDScrollPane1, new KDLayout.Constraints(10, 40, 470, 350, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_BOTTOM | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT));
        //contName
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.invite.app.NewListColumnSettingUIHandler";
	}
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.invite.client", "NewListColumnSettingUI");
    }
