 ...
 * output class name
 */
public abstract class AbstractRefPriceChooseUI extends CoreUIObject
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractRefPriceChooseUI.class);
    protected ResourceBundleHelper resHelper = null;
    protected com.kingdee.bos.ctrl.swing.KDToolBar RefPriceChooseUI_toolbar;
     ...
     */
    public AbstractRefPriceChooseUI() throws Exception
    {
        super();
        jbInit();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractRefPriceChooseUI.class.getName());
    ...
    public void initUIContentLayout()
    {
        ...
        tblMain.setBounds(new Rectangle(10, 13, 581, 337));
        this.add(tblMain, new KDLayout.Constraints(10, 13, 581, 337, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_BOTTOM | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT));
        btnYes.setBounds(new Rectangle(349, 362, 95, 25));
        this.add(btnYes, new KDLayout.Constraints(349, 362, 95, 25, KDLayout.Constraints.ANCHOR_BOTTOM | KDLayout.Constraints.ANCHOR_RIGHT));
        btnNo.setBounds(new Rectangle(466, 362, 95, 25));
        this.add(btnNo, new KDLayout.Constraints(466, 362, 95, 25, KDLayout.Constraints.ANCHOR_BOTTOM | KDLayout.Constraints.ANCHOR_RIGHT));
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.invite.app.RefPriceChooseUIHandler";
	}
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.invite.client", "RefPriceChooseUI");
    }
