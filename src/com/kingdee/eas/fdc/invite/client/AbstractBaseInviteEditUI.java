 ...
 * output class name
 */
public abstract class AbstractBaseInviteEditUI extends com.kingdee.eas.fdc.basedata.client.FDCBillEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractBaseInviteEditUI.class);
    ...
    protected com.kingdee.bos.ctrl.swing.KDButtonGroup btnSR;
    protected com.kingdee.bos.ctrl.swing.KDWorkButton btnShowProject;
    ...
    protected com.kingdee.eas.fdc.invite.BaseInviteInfo editData = null;
     ...
     */
    public AbstractBaseInviteEditUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractBaseInviteEditUI.class.getName());
        ...
        this.btnSR = new com.kingdee.bos.ctrl.swing.KDButtonGroup();
        this.btnShowProject = new com.kingdee.bos.ctrl.swing.KDWorkButton();
        ...
        this.btnShowProject.setName("btnShowProject");
        ...
        // btnSR
        // btnShowProject		
        this.btnShowProject.setText(resHelper.getString("btnShowProject.text"));
        this.btnShowProject.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent e) {
                beforeActionPerformed(e);
                try {
                    btnShowProject_actionPerformed(e);
                } catch (Exception exc) {
                    handUIException(exc);
                } finally {
    ...
    public void initUIContentLayout()
    {
        ...
        contNumber.setBounds(new Rectangle(879, 14, 270, 19));
        this.add(contNumber, new KDLayout.Constraints(879, 14, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        ...
        contEntry.setBounds(new Rectangle(10, 247, 980, 295));
        this.add(contEntry, new KDLayout.Constraints(10, 247, 980, 295, 0));
...
contEntry.getContentPane().setLayout(new BorderLayout(0, 0));        contEntry.getContentPane().add(kdtEntry, BorderLayout.CENTER);
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.invite.app.BaseInviteEditUIHandler";
	}
    ...
    public void setDataObject(IObjectValue dataObject)
    {
        ...
        this.editData = (com.kingdee.eas.fdc.invite.BaseInviteInfo)ov;
    }
    ...
    /**
     * output btnShowProject_actionPerformed method
     */
    protected void btnShowProject_actionPerformed(java.awt.event.ActionEvent e) throws Exception
    {
    }
    ...
    protected class ActionALine extends ItemAction {     
        ...
        public void actionPerformed(ActionEvent e)
        {
            ...
            innerActionPerformed("eas", AbstractBaseInviteEditUI.this, "ActionALine", "actionALine_actionPerformed", e);
        }
    }
    ...
    protected class ActionILine extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractBaseInviteEditUI.this, "ActionILine", "actionILine_actionPerformed", e);
        }
    }
    ...
    protected class ActionRLine extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractBaseInviteEditUI.this, "ActionRLine", "actionRLine_actionPerformed", e);
        }
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.invite.client", "BaseInviteEditUI");
    }
    /**
