 ...
 * output class name
 */
public abstract class AbstractInviteDocumentsListUI extends com.kingdee.eas.fdc.invite.client.BaseInviteListUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractInviteDocumentsListUI.class);
    /**
     * output class constructor
     */
    public AbstractInviteDocumentsListUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractInviteDocumentsListUI.class.getName());
        ...
        this.contBaseInvite.setTitle(resHelper.getString("contBaseInvite.title"));
...
contBaseInvite.getContentPane().setLayout(new BorderLayout(0, 0));        contBaseInvite.getContentPane().add(tblBaseInvite, BorderLayout.CENTER);
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.invite.app.InviteDocumentsListUIHandler";
	}
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.invite.client", "InviteDocumentsListUI");
    }
