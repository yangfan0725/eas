 ...
 * @version EAS5.3
 */
public class InviteTypePromptSelector implements KDPromptSelector {

	protected IUIWindow f7UI;

	protected CoreUIObject ui;

	public InviteTypePromptSelector(CoreUIObject ui) {
		super();
		this.ui = ui;
	}
	...
	public void show() {
		...
		try {
			...
			f7UI = uiFactory.create(InviteTypeF7UI.class.getName(), context,
					null, OprtState.VIEW);
			f7UI.show();
	...
	public boolean isCanceled() {
		InviteTypeF7UI f7UIObject = (InviteTypeF7UI) f7UI.getUIObject();
