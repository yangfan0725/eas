 ...
 * output class name
 */
public abstract class AbstractAttachReportEditUI extends com.kingdee.eas.fdc.basedata.client.FDCBillEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractAttachReportEditUI.class);
    ...
    protected com.kingdee.eas.fdc.invite.AttachReportInfo editData = null;
     ...
     */
    public AbstractAttachReportEditUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractAttachReportEditUI.class.getName());
    ...
    public void initUIContentLayout()
    {
        ...
        contName.setBounds(new Rectangle(365, 9, 270, 19));
        this.add(contName, new KDLayout.Constraints(365, 9, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contEntry.setBounds(new Rectangle(10, 39, 980, 503));
        this.add(contEntry, new KDLayout.Constraints(10, 39, 980, 503, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_BOTTOM_SCALE | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT));
        //contCreator
...
contEntry.getContentPane().setLayout(new BorderLayout(0, 0));        contEntry.getContentPane().add(kdtEntry, BorderLayout.CENTER);
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.invite.app.AttachReportEditUIHandler";
	}
    ...
    public void setDataObject(IObjectValue dataObject)
    {
        ...
        this.editData = (com.kingdee.eas.fdc.invite.AttachReportInfo)ov;
    }
    ...
    protected class ActionALine extends ItemAction {     
        ...
        public void actionPerformed(ActionEvent e)
        {
            ...
            innerActionPerformed("eas", AbstractAttachReportEditUI.this, "ActionALine", "actionALine_actionPerformed", e);
        }
    }
    ...
    protected class ActionILine extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractAttachReportEditUI.this, "ActionILine", "actionILine_actionPerformed", e);
        }
    }
    ...
    protected class ActionRLine extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractAttachReportEditUI.this, "ActionRLine", "actionRLine_actionPerformed", e);
        }
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.invite.client", "AttachReportEditUI");
    }
    /**
