 ...
 * output class name
 */
public class SetAppraiseTemplateListUI extends AbstractSetAppraiseTemplateListUI
{
    private static final Logger logger = CoreUIObject.getLogger(SetAppraiseTemplateListUI.class);
     ...
     */
    public SetAppraiseTemplateListUI() throws Exception
    {
        super();
    }
