 ...
 * output class name
 */
public abstract class AbstractNewListingExportListUI extends com.kingdee.eas.fdc.invite.client.QuotingPriceListUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractNewListingExportListUI.class);
    /**
     * output class constructor
     */
    public AbstractNewListingExportListUI() throws Exception
    {
        super();
...
contDetalBill.getContentPane().setLayout(new BorderLayout(0, 0));        contDetalBill.getContentPane().add(tblDetail, BorderLayout.CENTER);
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.invite.app.NewListingExportListUIHandler";
	}
	...
	public RequestContext prepareActionInviteExecuteInfo(IItemAction itemAction) throws Exception {
			RequestContext request = super.prepareActionInviteExecuteInfo(itemAction);		
		if (request != null) {
    		request.setClassName(getUIHandlerClassName());
		}
		return request;
