 ...
 * output class name
 */
public abstract class AbstractInviteChangeFormListUI extends com.kingdee.eas.fdc.basedata.client.FDCBillListUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractInviteChangeFormListUI.class);
     ...
     */
    public AbstractInviteChangeFormListUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractInviteChangeFormListUI.class.getName());
        this.setUITitle(resHelper.getString("this.title"));
        mainQueryPK = new MetaDataPK("com.kingdee.eas.fdc.invite.app", "InviteChangeFormQuery");
        //actionAudit
    ...
    public void initUIContentLayout()
    {
        ...
        kDSplitPane1.setBounds(new Rectangle(5, 7, 1001, 615));
        this.add(kDSplitPane1, new KDLayout.Constraints(5, 7, 1001, 615, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_BOTTOM | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT));
        //kDSplitPane1
        kDSplitPane1.add(contOrg, "left");
        kDSplitPane1.add(contMain, "right");
        //contOrg
...
contMain.getContentPane().setLayout(new BorderLayout(0, 0));        contMain.getContentPane().add(tblMain, BorderLayout.CENTER);
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.invite.app.InviteChangeFormListUIHandler";
	}
    ...
    protected class ActionAudit extends ItemAction {     
        ...
        public void actionPerformed(ActionEvent e)
        {
            ...
            innerActionPerformed("eas", AbstractInviteChangeFormListUI.this, "ActionAudit", "actionAudit_actionPerformed", e);
        }
    }
    ...
    protected class ActionUnAudit extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractInviteChangeFormListUI.this, "ActionUnAudit", "actionUnAudit_actionPerformed", e);
        }
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.invite.client", "InviteChangeFormListUI");
    }
