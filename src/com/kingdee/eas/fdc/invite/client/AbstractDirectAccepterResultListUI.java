 ...
 * output class name
 */
public abstract class AbstractDirectAccepterResultListUI extends com.kingdee.eas.fdc.invite.client.BaseInviteListUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractDirectAccepterResultListUI.class);
    /**
     * output class constructor
     */
    public AbstractDirectAccepterResultListUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractDirectAccepterResultListUI.class.getName());
...
contBaseInvite.getContentPane().setLayout(new BorderLayout(0, 0));        contBaseInvite.getContentPane().add(tblBaseInvite, BorderLayout.CENTER);
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.invite.app.DirectAccepterResultListUIHandler";
	}
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.invite.client", "DirectAccepterResultListUI");
    }
