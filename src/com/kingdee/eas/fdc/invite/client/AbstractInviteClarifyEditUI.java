 ...
 * output class name
 */
public abstract class AbstractInviteClarifyEditUI extends com.kingdee.eas.fdc.invite.client.BaseInviteEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractInviteClarifyEditUI.class);
    protected com.kingdee.eas.fdc.invite.InviteClarifyInfo editData = null;
    protected ShowProjects showProjects = null;
    /**
     * output class constructor
     */
    public AbstractInviteClarifyEditUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractInviteClarifyEditUI.class.getName());
    ...
    public void initUIContentLayout()
    {
        ...
        contNumber.setBounds(new Rectangle(898, 11, 270, 19));
        this.add(contNumber, new KDLayout.Constraints(898, 11, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        ...
        contEntry.setBounds(new Rectangle(10, 36, 1008, 504));
        this.add(contEntry, new KDLayout.Constraints(10, 36, 1008, 504, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT));
...
contEntry.getContentPane().setLayout(new BorderLayout(0, 0));        contEntry.getContentPane().add(kdtEntry, BorderLayout.CENTER);
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.invite.app.InviteClarifyEditUIHandler";
	}
    ...
    public void setDataObject(IObjectValue dataObject)
    {
        ...
        this.editData = (com.kingdee.eas.fdc.invite.InviteClarifyInfo)ov;
    }
    ...
    protected class ShowProjects extends ItemAction {     
        ...
        public void actionPerformed(ActionEvent e)
        {
            ...
            innerActionPerformed("eas", AbstractInviteClarifyEditUI.this, "ShowProjects", "showProjects_actionPerformed", e);
        }
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.invite.client", "InviteClarifyEditUI");
    }
    /**
