...
public class DirectAccepterResult extends BaseInvite implements IDirectAccepterResult
{
    public DirectAccepterResult()
    {
        super();
        registerInterface(IDirectAccepterResult.class, this);
    }
    public DirectAccepterResult(Context ctx)
    {
        super(ctx);
        registerInterface(IDirectAccepterResult.class, this);
    }
    ...
    private DirectAccepterResultController getController() throws BOSException
    {
        return (DirectAccepterResultController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getDirectAccepterResultInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getDirectAccepterResultInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getDirectAccepterResultInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getDirectAccepterResultCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getDirectAccepterResultCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getDirectAccepterResultCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
