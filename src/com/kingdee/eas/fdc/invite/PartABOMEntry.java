...
public class PartABOMEntry extends BOMEntry implements IPartABOMEntry
{
    public PartABOMEntry()
    {
        super();
        registerInterface(IPartABOMEntry.class, this);
    }
    public PartABOMEntry(Context ctx)
    {
        super(ctx);
        registerInterface(IPartABOMEntry.class, this);
    }
    ...
    private PartABOMEntryController getController() throws BOSException
    {
        return (PartABOMEntryController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getPartABOMEntryInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getPartABOMEntryInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getPartABOMEntryInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getPartABOMEntryCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getPartABOMEntryCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getPartABOMEntryCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
