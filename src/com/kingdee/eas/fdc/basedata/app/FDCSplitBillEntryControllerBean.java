...
public class FDCSplitBillEntryControllerBean extends AbstractFDCSplitBillEntryControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.fdc.basedata.app.FDCSplitBillEntryControllerBean");
}