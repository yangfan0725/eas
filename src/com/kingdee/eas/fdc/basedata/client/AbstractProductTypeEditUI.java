...
public abstract class AbstractProductTypeEditUI extends com.kingdee.eas.fdc.basedata.client.FDCBaseDataEditUI
{
    ...
    private void jbInit() throws Exception
    {
        ...
        this.prmtGeneralAsstActType.setRequired(true);
        // prmtBgItem		
    ...
    public void initUIContentLayout()
    {
        ...
        bizDescription.setBounds(new Rectangle(10, 145, 270, 70));
    ...
    public SelectorItemCollection getSelectors()
    {
		...
		if(selectorAll.equalsIgnoreCase("true"))
		{
			sic.add(new SelectorItemInfo("bgItem.*"));
		}
		else{
        	sic.add(new SelectorItemInfo("bgItem.id"));
