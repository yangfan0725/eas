...
public class ContractWFEntry extends CoreBillEntryBase implements IContractWFEntry
{
    public ContractWFEntry()
    {
        super();
        registerInterface(IContractWFEntry.class, this);
    }
    public ContractWFEntry(Context ctx)
    {
        super(ctx);
        registerInterface(IContractWFEntry.class, this);
    }
    ...
    private ContractWFEntryController getController() throws BOSException
    {
        return (ContractWFEntryController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getContractWFEntryInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getContractWFEntryInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getContractWFEntryInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getContractWFEntryCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getContractWFEntryCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getContractWFEntryCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
