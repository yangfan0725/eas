...
public class FDCScheduleTaskDepend extends ScheduleTaskDepend implements IFDCScheduleTaskDepend
{
    public FDCScheduleTaskDepend()
    {
        super();
        registerInterface(IFDCScheduleTaskDepend.class, this);
    }
    public FDCScheduleTaskDepend(Context ctx)
    {
        super(ctx);
        registerInterface(IFDCScheduleTaskDepend.class, this);
    }
    ...
    private FDCScheduleTaskDependController getController() throws BOSException
    {
        return (FDCScheduleTaskDependController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getFDCScheduleTaskDependInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getFDCScheduleTaskDependInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getFDCScheduleTaskDependInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getFDCScheduleTaskDependCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getFDCScheduleTaskDependCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getFDCScheduleTaskDependCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
