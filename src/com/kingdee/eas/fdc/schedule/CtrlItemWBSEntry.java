...
public class CtrlItemWBSEntry extends CoreBillEntryBase implements ICtrlItemWBSEntry
{
    public CtrlItemWBSEntry()
    {
        super();
        registerInterface(ICtrlItemWBSEntry.class, this);
    }
    public CtrlItemWBSEntry(Context ctx)
    {
        super(ctx);
        registerInterface(ICtrlItemWBSEntry.class, this);
    }
    ...
    private CtrlItemWBSEntryController getController() throws BOSException
    {
        return (CtrlItemWBSEntryController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getCtrlItemWBSEntryInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getCtrlItemWBSEntryInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getCtrlItemWBSEntryInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getCtrlItemWBSEntryCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getCtrlItemWBSEntryCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getCtrlItemWBSEntryCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
