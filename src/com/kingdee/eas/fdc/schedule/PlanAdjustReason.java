...
public class PlanAdjustReason extends FDCDataBase implements IPlanAdjustReason
{
    public PlanAdjustReason()
    {
        super();
        registerInterface(IPlanAdjustReason.class, this);
    }
    public PlanAdjustReason(Context ctx)
    {
        super(ctx);
        registerInterface(IPlanAdjustReason.class, this);
    }
    ...
    private PlanAdjustReasonController getController() throws BOSException
    {
        return (PlanAdjustReasonController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getPlanAdjustReasonInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getPlanAdjustReasonInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getPlanAdjustReasonInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getPlanAdjustReasonCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getPlanAdjustReasonCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getPlanAdjustReasonCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
