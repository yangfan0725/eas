...
public class HolidayEntry extends CoreBase implements IHolidayEntry
{
    public HolidayEntry()
    {
        super();
        registerInterface(IHolidayEntry.class, this);
    }
    public HolidayEntry(Context ctx)
    {
        super(ctx);
        registerInterface(IHolidayEntry.class, this);
    }
    ...
    private HolidayEntryController getController() throws BOSException
    {
        return (HolidayEntryController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getHolidayEntryInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getHolidayEntryInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getHolidayEntryInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getHolidayEntryCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getHolidayEntryCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getHolidayEntryCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
