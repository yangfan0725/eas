...
public class ScheduleTaskBaseControllerBean extends AbstractScheduleTaskBaseControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.fdc.schedule.framework.app.ScheduleTaskBaseControllerBean");
}