...
public class DefaultWeekendEntryControllerBean extends AbstractDefaultWeekendEntryControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.fdc.schedule.framework.app.DefaultWeekendEntryControllerBean");
}