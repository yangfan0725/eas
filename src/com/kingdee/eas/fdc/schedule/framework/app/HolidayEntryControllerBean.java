...
public class HolidayEntryControllerBean extends AbstractHolidayEntryControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.fdc.schedule.framework.app.HolidayEntryControllerBean");
}