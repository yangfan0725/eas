...
public class ScheduleTaskDependControllerBean extends AbstractScheduleTaskDependControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.fdc.schedule.framework.app.ScheduleTaskDependControllerBean");
}