...
public class ScheduleBaseControllerBean extends AbstractScheduleBaseControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.fdc.schedule.framework.app.ScheduleBaseControllerBean");
}