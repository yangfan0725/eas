 ...
 * @author bard
 */
public class KDUndoManagerImpl implements GPUndoManager {
    ...
    private KDUndoableEditImpl swingEditImpl;

    public KDUndoManagerImpl(IGanttProject project, ParserFactory parserFactory,
    ...
    public void undoableEdit(String localizedName, Runnable editImpl) {
        ...
        try {
            swingEditImpl = new KDUndoableEditImpl(localizedName, editImpl, this);
    ...
    private void fireUndoableEditHappened(KDUndoableEditImpl swingEditImpl) {
    ...
    public void addKDUnDoabledListener(){
