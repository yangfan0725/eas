...
public class ScheduleNewTaskEntryControllerBean extends AbstractScheduleNewTaskEntryControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.fdc.schedule.app.ScheduleNewTaskEntryControllerBean");
}