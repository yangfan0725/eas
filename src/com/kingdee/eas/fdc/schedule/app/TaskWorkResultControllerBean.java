...
public class TaskWorkResultControllerBean extends AbstractTaskWorkResultControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.fdc.schedule.app.TaskWorkResultControllerBean");
}