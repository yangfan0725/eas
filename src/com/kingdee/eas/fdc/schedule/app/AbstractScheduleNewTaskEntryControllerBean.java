...
public abstract class AbstractScheduleNewTaskEntryControllerBean extends ScheduleTaskBaseControllerBean implements ScheduleNewTaskEntryController
{
    protected AbstractScheduleNewTaskEntryControllerBean()
    {
    }
    ...
    public ScheduleNewTaskEntryInfo getScheduleNewTaskEntryInfo(Context ctx, IObjectPK pk) throws BOSException, EASBizException
    {
        try {
            ServiceContext svcCtx = createServiceContext(new MetaDataPK("8e7ffcda-d71f-4bf1-b608-e67708e823a3"), new Object[]{ctx, pk});
            invokeServiceBefore(svcCtx);
            ScheduleNewTaskEntryInfo retValue = (ScheduleNewTaskEntryInfo)_getValue(ctx, pk);
    ...
    public ScheduleNewTaskEntryInfo getScheduleNewTaskEntryInfo(Context ctx, IObjectPK pk, SelectorItemCollection selector) throws BOSException, EASBizException
    {
        try {
            ...
            invokeServiceBefore(svcCtx);
            ScheduleNewTaskEntryInfo retValue = (ScheduleNewTaskEntryInfo)_getValue(ctx, pk, selector);
            svcCtx.setMethodReturnValue(retValue);
            invokeServiceAfter(svcCtx);
            return retValue;
        } catch (BOSException ex) {
    ...
    public ScheduleNewTaskEntryInfo getScheduleNewTaskEntryInfo(Context ctx, String oql) throws BOSException, EASBizException
    {
        try {
            ServiceContext svcCtx = createServiceContext(new MetaDataPK("7fd7db21-2c55-40c0-8c53-7084d4181cac"), new Object[]{ctx, oql});
            invokeServiceBefore(svcCtx);
            ScheduleNewTaskEntryInfo retValue = (ScheduleNewTaskEntryInfo)_getValue(ctx, oql);
            svcCtx.setMethodReturnValue(retValue);
            invokeServiceAfter(svcCtx);
            return retValue;
        } catch (BOSException ex) {
    ...
    public IObjectPK addnew(Context ctx, ScheduleNewTaskEntryInfo model) throws BOSException, EASBizException
    {
        try {
    ...
    public void addnew(Context ctx, IObjectPK pk, ScheduleNewTaskEntryInfo model) throws BOSException, EASBizException
    {
        try {
    ...
    public void update(Context ctx, IObjectPK pk, ScheduleNewTaskEntryInfo model) throws BOSException, EASBizException
    {
        try {
    ...
    public void updatePartial(Context ctx, ScheduleNewTaskEntryInfo model, SelectorItemCollection selector) throws BOSException, EASBizException
    {
        try {
    ...
    public void updateBigObject(Context ctx, IObjectPK pk, ScheduleNewTaskEntryInfo model) throws BOSException
    {
        try {
    ...
    public ScheduleNewTaskEntryCollection getScheduleNewTaskEntryCollection(Context ctx) throws BOSException
    {
        try {
            ServiceContext svcCtx = createServiceContext(new MetaDataPK("fdf16f09-a7ef-4ae5-a65e-6098b7c6eae8"), new Object[]{ctx});
            invokeServiceBefore(svcCtx);
            ScheduleNewTaskEntryCollection retValue = (ScheduleNewTaskEntryCollection)_getCollection(ctx, svcCtx);
            svcCtx.setMethodReturnValue(retValue);
            invokeServiceAfter(svcCtx);
            return retValue;
        } catch (BOSException ex) {
    ...
    public ScheduleNewTaskEntryCollection getScheduleNewTaskEntryCollection(Context ctx, EntityViewInfo view) throws BOSException
    {
        try {
            ServiceContext svcCtx = createServiceContext(new MetaDataPK("2aa377e4-e7ad-47cd-ae59-551f6d6894ab"), new Object[]{ctx, view});
            invokeServiceBefore(svcCtx);
            ScheduleNewTaskEntryCollection retValue = (ScheduleNewTaskEntryCollection)_getCollection(ctx, svcCtx, view);
            svcCtx.setMethodReturnValue(retValue);
            invokeServiceAfter(svcCtx);
            return retValue;
        } catch (BOSException ex) {
    ...
    public ScheduleNewTaskEntryCollection getScheduleNewTaskEntryCollection(Context ctx, String oql) throws BOSException
    {
        try {
            ServiceContext svcCtx = createServiceContext(new MetaDataPK("16fdb04b-60ed-49ad-b7ec-1a80f7d318a7"), new Object[]{ctx, oql});
            invokeServiceBefore(svcCtx);
            ScheduleNewTaskEntryCollection retValue = (ScheduleNewTaskEntryCollection)_getCollection(ctx, svcCtx, oql);
            svcCtx.setMethodReturnValue(retValue);
            invokeServiceAfter(svcCtx);
            return retValue;
        } catch (BOSException ex) {
    ...
    {
    	return (ScheduleTaskBaseCollection)(getScheduleNewTaskEntryCollection(ctx).cast(ScheduleTaskBaseCollection.class));
    }
    public ScheduleTaskBaseCollection getScheduleTaskBaseCollection (Context ctx, EntityViewInfo view) throws BOSException
    {
    	return (ScheduleTaskBaseCollection)(getScheduleNewTaskEntryCollection(ctx, view).cast(ScheduleTaskBaseCollection.class));
    }
    public ScheduleTaskBaseCollection getScheduleTaskBaseCollection (Context ctx, String oql) throws BOSException
    {
    	return (ScheduleTaskBaseCollection)(getScheduleNewTaskEntryCollection(ctx, oql).cast(ScheduleTaskBaseCollection.class));
    }
    public TreeBaseCollection getTreeBaseCollection (Context ctx) throws BOSException
    {
    	return (TreeBaseCollection)(getScheduleNewTaskEntryCollection(ctx).cast(TreeBaseCollection.class));
    }
    public TreeBaseCollection getTreeBaseCollection (Context ctx, EntityViewInfo view) throws BOSException
    {
    	return (TreeBaseCollection)(getScheduleNewTaskEntryCollection(ctx, view).cast(TreeBaseCollection.class));
    }
    public TreeBaseCollection getTreeBaseCollection (Context ctx, String oql) throws BOSException
    {
    	return (TreeBaseCollection)(getScheduleNewTaskEntryCollection(ctx, oql).cast(TreeBaseCollection.class));
    }
    public DataBaseCollection getDataBaseCollection (Context ctx) throws BOSException
    {
    	return (DataBaseCollection)(getScheduleNewTaskEntryCollection(ctx).cast(DataBaseCollection.class));
    }
    public DataBaseCollection getDataBaseCollection (Context ctx, EntityViewInfo view) throws BOSException
    {
    	return (DataBaseCollection)(getScheduleNewTaskEntryCollection(ctx, view).cast(DataBaseCollection.class));
    }
    public DataBaseCollection getDataBaseCollection (Context ctx, String oql) throws BOSException
    {
    	return (DataBaseCollection)(getScheduleNewTaskEntryCollection(ctx, oql).cast(DataBaseCollection.class));
    }
    public ObjectBaseCollection getObjectBaseCollection (Context ctx) throws BOSException
    {
    	return (ObjectBaseCollection)(getScheduleNewTaskEntryCollection(ctx).cast(ObjectBaseCollection.class));
    }
    public ObjectBaseCollection getObjectBaseCollection (Context ctx, EntityViewInfo view) throws BOSException
    {
    	return (ObjectBaseCollection)(getScheduleNewTaskEntryCollection(ctx, view).cast(ObjectBaseCollection.class));
    }
    public ObjectBaseCollection getObjectBaseCollection (Context ctx, String oql) throws BOSException
    {
    	return (ObjectBaseCollection)(getScheduleNewTaskEntryCollection(ctx, oql).cast(ObjectBaseCollection.class));
    }
    public CoreBaseCollection getCoreBaseCollection (Context ctx) throws BOSException
    {
    	return (CoreBaseCollection)(getScheduleNewTaskEntryCollection(ctx).cast(CoreBaseCollection.class));
    }
    public CoreBaseCollection getCoreBaseCollection (Context ctx, EntityViewInfo view) throws BOSException
    {
    	return (CoreBaseCollection)(getScheduleNewTaskEntryCollection(ctx, view).cast(CoreBaseCollection.class));
    }
    public CoreBaseCollection getCoreBaseCollection (Context ctx, String oql) throws BOSException
    {
    	return (CoreBaseCollection)(getScheduleNewTaskEntryCollection(ctx, oql).cast(CoreBaseCollection.class));
    }
}