...
public class ProjectMonthReportEntryControllerBean extends AbstractProjectMonthReportEntryControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.fdc.schedule.app.ProjectMonthReportEntryControllerBean");
}