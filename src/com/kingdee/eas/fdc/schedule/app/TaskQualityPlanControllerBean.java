...
public class TaskQualityPlanControllerBean extends AbstractTaskQualityPlanControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.fdc.schedule.app.TaskQualityPlanControllerBean");
}