...
public class TaskCostInfoControllerBean extends AbstractTaskCostInfoControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.fdc.schedule.app.TaskCostInfoControllerBean");
}