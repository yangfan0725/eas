...
public class ScheduleCodingTypeControllerBean extends AbstractScheduleCodingTypeControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.fdc.schedule.app.ScheduleCodingTypeControllerBean");
}