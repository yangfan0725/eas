...
public class ProjectWeekReportEntryControllerBean extends AbstractProjectWeekReportEntryControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.fdc.schedule.app.ProjectWeekReportEntryControllerBean");
}