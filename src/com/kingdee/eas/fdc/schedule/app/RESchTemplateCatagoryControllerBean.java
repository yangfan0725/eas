...
public class RESchTemplateCatagoryControllerBean extends AbstractRESchTemplateCatagoryControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.fdc.schedule.app.RESchTemplateCatagoryControllerBean");
}