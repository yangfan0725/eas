...
public class TaskWorkloadLogControllerBean extends AbstractTaskWorkloadLogControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.fdc.schedule.app.TaskWorkloadLogControllerBean");
