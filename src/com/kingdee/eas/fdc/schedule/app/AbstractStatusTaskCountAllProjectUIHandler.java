 ...
 * output class name
 */
public abstract class AbstractStatusTaskCountAllProjectUIHandler extends com.kingdee.eas.framework.app.CoreUIHandler

{
	...
	abstract protected void _handleSerchAction(RequestContext request,ResponseContext response, Context context)
		throws Exception;
	...
	abstract protected void _handleExportExcelAction(RequestContext request,ResponseContext response, Context context)
		throws Exception;
	...
	abstract protected void _handleActionPrint(RequestContext request,ResponseContext response, Context context)
		throws Exception;
	...
	abstract protected void _handleActionPreview(RequestContext request,ResponseContext response, Context context)
		throws Exception;
}