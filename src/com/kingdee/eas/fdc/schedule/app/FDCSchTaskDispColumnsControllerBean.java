...
public class FDCSchTaskDispColumnsControllerBean extends AbstractFDCSchTaskDispColumnsControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.fdc.schedule.app.FDCSchTaskDispColumnsControllerBean");
}