 ...
 * output class name
 */
public abstract class AbstractScheduleCheckNodeRateUI extends com.kingdee.eas.fdc.schedule.report.client.ScheduleReportBaseUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractScheduleCheckNodeRateUI.class);
    /**
     * output class constructor
     */
    public AbstractScheduleCheckNodeRateUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractScheduleCheckNodeRateUI.class.getName());
    ...
    public void initUIContentLayout()
    {
        ...
        tblMain.setBounds(new Rectangle(259, 620, 992, 8));
        this.add(tblMain, new KDLayout.Constraints(259, 620, 992, 8, 0));
        chartSplitPanel.setBounds(new Rectangle(1, 1, 1012, 628));
        this.add(chartSplitPanel, new KDLayout.Constraints(1, 1, 1012, 628, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_BOTTOM | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT));
        //chartSplitPanel
        ...
        chartContainer.getContentPane().putClientProperty("OriginalBounds", new Rectangle(0, 0, 1011, 539));        chartPanel.setBounds(new Rectangle(-1, -1, 1014, 541));
        chartContainer.getContentPane().add(chartPanel, new KDLayout.Constraints(-1, -1, 1014, 541, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_BOTTOM | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT));
...
tableContainer.getContentPane().setLayout(new BorderLayout(0, 0));        tableContainer.getContentPane().add(chartTable, BorderLayout.CENTER);
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.schedule.report.app.ScheduleCheckNodeRateUIHandler";
	}
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.schedule.report.client", "ScheduleCheckNodeRateUI");
    }
