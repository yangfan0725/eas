 ...
 * output class name
 */
public abstract class AbstractScheduleMainPlanCompRateUI extends com.kingdee.eas.fdc.schedule.report.client.ScheduleReportBaseUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractScheduleMainPlanCompRateUI.class);
    /**
     * output class constructor
     */
    public AbstractScheduleMainPlanCompRateUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractScheduleMainPlanCompRateUI.class.getName());
...
tableContainer.getContentPane().setLayout(new BorderLayout(0, 0));        tableContainer.getContentPane().add(chartTable, BorderLayout.CENTER);
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.schedule.report.app.ScheduleMainPlanCompRateUIHandler";
	}
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.schedule.report.client", "ScheduleMainPlanCompRateUI");
    }
