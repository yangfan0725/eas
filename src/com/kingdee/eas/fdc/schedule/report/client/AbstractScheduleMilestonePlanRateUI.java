 ...
 * output class name
 */
public abstract class AbstractScheduleMilestonePlanRateUI extends com.kingdee.eas.fdc.schedule.report.client.ScheduleReportBaseUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractScheduleMilestonePlanRateUI.class);
    /**
     * output class constructor
     */
    public AbstractScheduleMilestonePlanRateUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractScheduleMilestonePlanRateUI.class.getName());
...
tableContainer.getContentPane().setLayout(new BorderLayout(0, 0));        tableContainer.getContentPane().add(chartTable, BorderLayout.CENTER);
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.schedule.report.app.ScheduleMilestonePlanRateUIHandler";
	}
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.schedule.report.client", "ScheduleMilestonePlanRateUI");
    }
