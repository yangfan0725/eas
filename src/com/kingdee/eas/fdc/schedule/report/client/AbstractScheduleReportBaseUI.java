 ...
 * output class name
 */
public abstract class AbstractScheduleReportBaseUI extends com.kingdee.eas.framework.client.ListUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractScheduleReportBaseUI.class);
    protected com.kingdee.bos.ctrl.swing.KDSplitPane chartSplitPanel;
     ...
     */
    public AbstractScheduleReportBaseUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractScheduleReportBaseUI.class.getName());
        ...
        this.chartSplitPanel = new com.kingdee.bos.ctrl.swing.KDSplitPane();
        ...
        this.chartSplitPanel.setName("chartSplitPanel");
    ...
    public void initUIContentLayout()
    {
        ...
        tblMain.setBounds(new Rectangle(11, 610, 992, 11));
        this.add(tblMain, new KDLayout.Constraints(11, 610, 992, 11, 0));
        chartSplitPanel.setBounds(new Rectangle(1, 0, 1011, 628));
        this.add(chartSplitPanel, new KDLayout.Constraints(1, 0, 1011, 628, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_BOTTOM | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT));
        //chartSplitPanel
        chartSplitPanel.add(chartContainer, "top");
        chartSplitPanel.add(tableContainer, "bottom");
        //chartContainer
        chartContainer.getContentPane().setLayout(new KDLayout());
        chartContainer.getContentPane().putClientProperty("OriginalBounds", new Rectangle(0, 0, 1010, 539));        chartPanel.setBounds(new Rectangle(0, 0, 1013, 539));
        chartContainer.getContentPane().add(chartPanel, new KDLayout.Constraints(0, 0, 1013, 539, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_BOTTOM | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT));
chartPanel.setLayout(new BorderLayout(0, 0));        //tableContainer
tableContainer.getContentPane().setLayout(new BorderLayout(0, 0));        tableContainer.getContentPane().add(chartTable, BorderLayout.CENTER);
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.schedule.report.app.ScheduleReportBaseUIHandler";
	}
    ...
    protected class actionExportToExcel extends ItemAction {     
        ...
        public void actionPerformed(ActionEvent e)
        {
            ...
            innerActionPerformed("eas", AbstractScheduleReportBaseUI.this, "actionExportToExcel", "actionExportToExcel_actionPerformed", e);
        }
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.schedule.report.client", "ScheduleReportBaseUI");
    }
