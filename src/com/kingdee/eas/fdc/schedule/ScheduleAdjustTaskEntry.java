...
public class ScheduleAdjustTaskEntry extends CoreBillEntryBase implements IScheduleAdjustTaskEntry
{
    public ScheduleAdjustTaskEntry()
    {
        super();
        registerInterface(IScheduleAdjustTaskEntry.class, this);
    }
    public ScheduleAdjustTaskEntry(Context ctx)
    {
        super(ctx);
        registerInterface(IScheduleAdjustTaskEntry.class, this);
    }
    ...
    private ScheduleAdjustTaskEntryController getController() throws BOSException
    {
        return (ScheduleAdjustTaskEntryController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getScheduleAdjustTaskEntryInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getScheduleAdjustTaskEntryInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getScheduleAdjustTaskEntryInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getScheduleAdjustTaskEntryCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getScheduleAdjustTaskEntryCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getScheduleAdjustTaskEntryCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
