...
public class PlanTaskScheduleLogHelper {
	...
	public PlanTaskScheduleLogHelper(PlanTaskExtProPanelHelper helper) {
	...
	private void initTableBtn(){
		...
		this.btnDelLine.setVisible(false);
		this.btnEditLine.setVisible(false);
