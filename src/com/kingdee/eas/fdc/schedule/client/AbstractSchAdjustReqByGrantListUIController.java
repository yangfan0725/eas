 ...
 * output class name
 */
public class AbstractSchAdjustReqByGrantListUIController extends ControllerBase {
    private static final Logger logger = CoreUIObject.getLogger(AbstractSchAdjustReqByGrantListUIController.class);
    
    /**
     * output class constructor
     */
    public AbstractSchAdjustReqByGrantListUIController(Navigator navigator) {
        super(navigator);
    }
    ...
    public void actionSave() throws Exception {
        ...
        this.getNavigator().setUIContext(((AbstractSchAdjustReqByGrantListUI)this.getNavigator().getOwner()).getUIContext());
