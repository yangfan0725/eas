 ...
 * output class name
 */
public abstract class AbstractScheduleExecEditUI extends com.kingdee.eas.fdc.schedule.client.ProjectScheduleUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractScheduleExecEditUI.class);
    protected com.kingdee.eas.fdc.schedule.FDCScheduleInfo editData = null;
    /**
     * output class constructor
     */
    public AbstractScheduleExecEditUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractScheduleExecEditUI.class.getName());
...
kDPanel1.setLayout(new BorderLayout(0, 0));        kDPanel1.add(kDTable1, BorderLayout.CENTER);
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.schedule.app.ScheduleExecEditUIHandler";
	}
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.schedule.client", "ScheduleExecEditUI");
    }
