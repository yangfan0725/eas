 ...
 * output class name
 */
public abstract class AbstractAchievementStageEditUI extends com.kingdee.eas.fdc.basedata.client.FDCBaseDataEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractAchievementStageEditUI.class);
    ...
    protected com.kingdee.eas.fdc.schedule.AchievementStageInfo editData = null;
    /**
     * output class constructor
     */
    public AbstractAchievementStageEditUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractAchievementStageEditUI.class.getName());
        ...
        // CoreUI		
        this.setPreferredSize(new Dimension(580,171));
        // contName		
    ...
    {
        this.setBounds(new Rectangle(10, 10, 580, 171));
        this.setLayout(null);
        ...
        kDScrollPane1.setBounds(new Rectangle(10, 60, 560, 101));
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.schedule.app.AchievementStageEditUIHandler";
	}
    ...
    public void setDataObject(IObjectValue dataObject)
    {
        ...
        this.editData = (com.kingdee.eas.fdc.schedule.AchievementStageInfo)ov;
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.schedule.client", "AchievementStageEditUI");
    }
