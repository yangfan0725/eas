 ...
 * output class name
 */
public abstract class AbstractTaskMaterialPlanEditUI extends com.kingdee.eas.framework.client.CoreUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractTaskMaterialPlanEditUI.class);
    ...
    protected com.kingdee.eas.fdc.schedule.TaskMaterialPlanInfo entityTaskMaterialPlan = null;
    protected ActionSave actionSave = null;
    /**
     * output class constructor
     */
    public AbstractTaskMaterialPlanEditUI() throws Exception
    {
        super();
        this.defaultObjectName = "entityTaskMaterialPlan";
        jbInit();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractTaskMaterialPlanEditUI.class.getName());
    ...
    public void initUIContentLayout()
    {
        ...
        this.setLayout(null);
        contName.setBounds(new Rectangle(10, 10, 220, 19));
        this.add(contName, null);
        contDate.setBounds(new Rectangle(260, 10, 220, 19));
        this.add(contDate, null);
        kDLabel1.setBounds(new Rectangle(10, 45, 100, 19));
        this.add(kDLabel1, null);
        conDescription.setBounds(new Rectangle(10, 65, 480, 120));
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.schedule.app.TaskMaterialPlanEditUIHandler";
	}
    ...
    public void setDataObject(IObjectValue dataObject)
    {
        ...
        this.entityTaskMaterialPlan = (com.kingdee.eas.fdc.schedule.TaskMaterialPlanInfo)ov;
    }
    ...
    protected class ActionSave extends ItemAction {     
        ...
        public void actionPerformed(ActionEvent e)
        {
            ...
            innerActionPerformed("eas", AbstractTaskMaterialPlanEditUI.this, "ActionSave", "actionSave_actionPerformed", e);
        }
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.schedule.client", "TaskMaterialPlanEditUI");
    }
