 ...
 * output class name
 */
public abstract class AbstractTotalScheduleEditUI extends com.kingdee.eas.fdc.schedule.client.FDCScheduleBaseEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractTotalScheduleEditUI.class);
     ...
     */
    public AbstractTotalScheduleEditUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractTotalScheduleEditUI.class.getName());
        ...
        this.btnProperty.setVisible(false);		
    ...
    public void initUIContentLayout()
    {
        ...
        mainPanel.setBounds(new Rectangle(12, 42, 878, 506));
        this.add(mainPanel, new KDLayout.Constraints(12, 42, 878, 506, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_BOTTOM | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT));
        ...
        paySubway.setBounds(new Rectangle(11, 575, 386, 19));
        this.add(paySubway, new KDLayout.Constraints(11, 575, 386, 19, KDLayout.Constraints.ANCHOR_TOP_SCALE | KDLayout.Constraints.ANCHOR_BOTTOM_SCALE));
        //contCreator
...
kDPanel1.setLayout(new BorderLayout(0, 0));        kDPanel1.add(kDTable1, BorderLayout.CENTER);
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.schedule.app.TotalScheduleEditUIHandler";
	}
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.schedule.client", "TotalScheduleEditUI");
    }
