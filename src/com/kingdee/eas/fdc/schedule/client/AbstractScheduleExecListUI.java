 ...
 * output class name
 */
public abstract class AbstractScheduleExecListUI extends com.kingdee.eas.fdc.schedule.client.ProjectScheduleListUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractScheduleExecListUI.class);
    /**
     * output class constructor
     */
    public AbstractScheduleExecListUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractScheduleExecListUI.class.getName());
...
contRight.getContentPane().setLayout(new BorderLayout(0, 0));        contRight.getContentPane().add(tblMain, BorderLayout.CENTER);
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.schedule.app.ScheduleExecListUIHandler";
	}
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.schedule.client", "ScheduleExecListUI");
    }
