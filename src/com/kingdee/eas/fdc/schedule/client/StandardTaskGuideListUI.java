 ...
 * output class name
 */
public class StandardTaskGuideListUI extends AbstractStandardTaskGuideListUI
{
    private static final Logger logger = CoreUIObject.getLogger(StandardTaskGuideListUI.class);
    
    /**
     * output class constructor
     */
    public StandardTaskGuideListUI() throws Exception
    {
        super();
    }
