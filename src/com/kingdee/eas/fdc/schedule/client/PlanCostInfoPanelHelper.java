...
public class PlanCostInfoPanelHelper {
	private final PlanTaskExtProPanelHelper taskPropHelper;
	...
	public PlanCostInfoPanelHelper(PlanTaskExtProPanelHelper helper) {
