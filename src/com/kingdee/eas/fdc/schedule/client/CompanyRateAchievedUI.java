...
//							endDate = fdcsinfo.getEndDate();
	...
	protected void initTree() throws Exception {
		super.initTree();
		// 展示公司级以上成本中心组织，默认展开到最末级，默认定位到当前用户上一次访问的组织
		buildCostCenterTree();
	...
	private void buildCostCenterTree() throws Exception {
		...
		set2.add("00000000-0000-0000-0000-00000000000262824988");// 公司
		// 集团(公司级以上，所以应该包含集团)
    ...
    /**
	 * @discription <移除部门级，只显示公司及公司以上的层次关系>
	 * @author <Xiaolong Luo>
	...
	protected JFreeChart createChart(Dataset dataset) {
		...
		// rangeAxis.setTickUnit(new NumberTickUnit(1));// 0.5为一个间隔单位
		// rangeAxis.setTickUnit(new NumberTickUnit(5));// 1为一个间隔单位
