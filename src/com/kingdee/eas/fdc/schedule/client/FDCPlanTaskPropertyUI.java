 ...
 * output class name
 */
public class FDCPlanTaskPropertyUI extends AbstractFDCPlanTaskPropertyUI
{
    private static final Logger logger = CoreUIObject.getLogger(FDCPlanTaskPropertyUI.class);
     ...
     */
    public FDCPlanTaskPropertyUI() throws Exception
    {
        super();
    }
...
//    	}
    	...
    	if(mainPanelHelper==null){
    		mainPanelHelper=new PlanTaskMainPanelHelper(this);
    	...
    	if(predecessorsPanelHelper==null){
    		if(getUIContext().get("selectTask")!=null){
    			this.predecessorsPanelHelper=new PlanPredecessorsExtPanelHelper(this);
    		}else{
    			this.predecessorsPanelHelper=new PlanPredecessorsExtPanelHelper(this);
    		}
    	...
    	if(extPanelHelper == null){
    		extPanelHelper = new PlanTaskExtProPanelHelper(this);
...
//    	}
    ...
    private FDCScheduleTaskInfo selectTask=null;
    public FDCScheduleTaskInfo getSelectTask(){
    	if(selectTask==null){
    		//直接传入的任务节点最优先
    		selectTask=(FDCScheduleTaskInfo)getUIContext().get("selectTask");
    	}
    	return selectTask;
    }
