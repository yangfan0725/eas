 ...
 * output class name
 */
public abstract class AbstractProjectImageNewEditUI extends com.kingdee.eas.framework.client.BillEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractProjectImageNewEditUI.class);
     ...
     */
    public AbstractProjectImageNewEditUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractProjectImageNewEditUI.class.getName());
        ...
        // relationTask		
        this.relationTask.setQueryInfo("com.kingdee.eas.fdc.schedule.app.F7ScheduleTaskQuery");		
    ...
    public void initUIContentLayout()
    {
        ...
        contSchedule.setBounds(new Rectangle(10, 10, 270, 19));
        this.add(contSchedule, new KDLayout.Constraints(10, 10, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT));
        contPerson.setBounds(new Rectangle(10, 40, 270, 19));
        this.add(contPerson, new KDLayout.Constraints(10, 40, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contRelateTask.setBounds(new Rectangle(520, 10, 270, 19));
        this.add(contRelateTask, new KDLayout.Constraints(520, 10, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT));
        contSubmitTime.setBounds(new Rectangle(520, 40, 270, 19));
        this.add(contSubmitTime, new KDLayout.Constraints(520, 40, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT));
        contIsKeyCert.setBounds(new Rectangle(10, 70, 100, 19));
        this.add(contIsKeyCert, new KDLayout.Constraints(10, 70, 100, 19, 0));
        noKeyCert.setBounds(new Rectangle(203, 71, 38, 19));
        this.add(noKeyCert, new KDLayout.Constraints(203, 71, 38, 19, 0));
        KeyCert.setBounds(new Rectangle(113, 70, 34, 19));
        this.add(KeyCert, new KDLayout.Constraints(113, 70, 34, 19, 0));
        kDLabelContainer1.setBounds(new Rectangle(10, 110, 780, 80));
        this.add(kDLabelContainer1, new KDLayout.Constraints(10, 110, 780, 80, 0));
        kDSplitPane1.setBounds(new Rectangle(11, 198, 780, 406));
        this.add(kDSplitPane1, new KDLayout.Constraints(11, 198, 780, 406, 0));
        //contSchedule
        ...
        //kDLabelContainer1
        kDLabelContainer1.setBoundEditor(txtDescription);
        //kDSplitPane1
...
pnlIMG.setLayout(new BorderLayout(0, 0));
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.schedule.app.ProjectImageNewEditUIHandler";
	}
...
//        sic.add(new SelectorItemInfo("entries.number"));
    ...
    protected class ActionAddImage extends ItemAction {     
        ...
        public void actionPerformed(ActionEvent e)
        {
            ...
            innerActionPerformed("eas", AbstractProjectImageNewEditUI.this, "ActionAddImage", "actionAddImage_actionPerformed", e);
        }
    }
    ...
    protected class ActionDeleteImage extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractProjectImageNewEditUI.this, "ActionDeleteImage", "actionDeleteImage_actionPerformed", e);
        }
    }
    ...
    protected class ActionSavePic extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractProjectImageNewEditUI.this, "ActionSavePic", "actionSavePic_actionPerformed", e);
        }
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.schedule.client", "ProjectImageNewEditUI");
    }
