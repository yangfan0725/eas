 ...
 * output class name
 */
public class DempPlanEditUI extends AbstractDempPlanEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(DempPlanEditUI.class);
    
    /**
     * output class constructor
     */
    public DempPlanEditUI() throws Exception
    {
        super();
    }
