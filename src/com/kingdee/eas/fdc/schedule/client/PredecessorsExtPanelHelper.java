 ...
 *
 */
public class PredecessorsExtPanelHelper  implements ITaskPanelHelper{
	private final FDCScheduleTaskPropertiesUI taskPropertiesUI;
    private final KDTask myTask;
    private final KDTable table;
	public PredecessorsExtPanelHelper(FDCScheduleTaskPropertiesUI ui){
		taskPropertiesUI=ui;
	...
	private void loadRow(IRow row){
		...
		row.getCell("linkType").setValue(scheduleAdjustPrefixTaskInfo.getType()==null?TaskLinkTypeEnum.FINISH_START:scheduleAdjustPrefixTaskInfo.getType());
