 ...
 * output class name
 */
public abstract class AbstractRESchTemplateEditOldUI extends com.kingdee.eas.fdc.basedata.client.FDCTreeBaseDataEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractRESchTemplateEditOldUI.class);
     ...
     */
    public AbstractRESchTemplateEditOldUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractRESchTemplateEditOldUI.class.getName());
        ...
        this.prmtParent.setCommitFormat("$name$");
        this.prmtParent.addDataChangeListener(new com.kingdee.bos.ctrl.swing.event.DataChangeListener() {
            public void dataChanged(com.kingdee.bos.ctrl.swing.event.DataChangeEvent e) {
                try {
                    prmtParent_dataChanged(e);
                } catch (Exception exc) {
                    handUIException(exc);
                } finally {
                }
    ...
    public void initUIContentLayout()
    {
        ...
        this.setLayout(null);
        contName.setBounds(new Rectangle(19, 16, 270, 19));
        this.add(contName, null);
        contNumber.setBounds(new Rectangle(19, 53, 270, 19));
        this.add(contNumber, null);
        contDescription.setBounds(new Rectangle(19, 100, 560, 82));
        this.add(contDescription, null);
        contParent.setBounds(new Rectangle(306, 53, 270, 19));
        this.add(contParent, null);
        kDLabelContainer1.setBounds(new Rectangle(307, 17, 270, 19));
	...
	private void registerBindings(){
		...
		dataBinder.registerBinding("catagory", com.kingdee.eas.fdc.schedule.RESchTemplateCatagoryInfo.class, this.prmtParent, "data");
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.schedule.app.RESchTemplateEditOldUIHandler";
	}
	...
	protected void registerValidator() {
		...
		getValidateHelper().registerBindProperty("catagory", ValidateHelper.ON_SAVE);    
    ...
    /**
     * output prmtParent_dataChanged method
     */
    ...
    public SelectorItemCollection getSelectors()
    {
		...
		{
			sic.add(new SelectorItemInfo("catagory.*"));
		}
		else{
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.schedule.client", "RESchTemplateEditOldUI");
    }
