 ...
 * output class name
 */
public abstract class AbstractScheduleVersionCompareUI extends com.kingdee.eas.fdc.schedule.client.FDCScheduleBaseEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractScheduleVersionCompareUI.class);
    protected com.kingdee.eas.fdc.schedule.FDCScheduleInfo editData = null;
    /**
     * output class constructor
     */
    public AbstractScheduleVersionCompareUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractScheduleVersionCompareUI.class.getName());
    ...
    public void initUIContentLayout()
    {
        ...
        mainPanel.setBounds(new Rectangle(12, 6, 878, 587));
        this.add(mainPanel, new KDLayout.Constraints(12, 6, 878, 587, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_BOTTOM | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT));
...
kDPanel1.setLayout(new BorderLayout(0, 0));        kDPanel1.add(kDTable1, BorderLayout.CENTER);
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.schedule.app.ScheduleVersionCompareUIHandler";
	}
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.schedule.client", "ScheduleVersionCompareUI");
    }
