 ...
 * output class name
 */
public abstract class AbstractRESchTemplateTreeNewListUI extends com.kingdee.eas.framework.client.ListUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractRESchTemplateTreeNewListUI.class);
    ...
    protected ActionON actionON = null;
    /**
     * output class constructor
     */
    public AbstractRESchTemplateTreeNewListUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractRESchTemplateTreeNewListUI.class.getName());
        ...
        //actionON
        this.actionON = new ActionON(this);
        getActionManager().registerAction("actionON", actionON);
         this.actionON.addService(new com.kingdee.eas.framework.client.service.PermissionService());
    ...
    {
        this.setBounds(new Rectangle(10, 10, 330, 360));
        this.setLayout(null);
        tblMain.setBounds(new Rectangle(10, 10, 8, 8));
        this.add(tblMain, null);
        kDContainer1.setBounds(new Rectangle(10, 10, 310, 310));
        this.add(kDContainer1, null);
        btnOk.setBounds(new Rectangle(145, 328, 73, 21));
        this.add(btnOk, null);
        btnNo.setBounds(new Rectangle(234, 328, 73, 21));
        this.add(btnNo, null);
        //kDContainer1
kDContainer1.getContentPane().setLayout(new BorderLayout(0, 0));        kDContainer1.getContentPane().add(treeView, BorderLayout.CENTER);
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.schedule.app.RESchTemplateTreeNewListUIHandler";
	}
    ...
    /**
     * output actionON_actionPerformed method
     */
    public void actionON_actionPerformed(ActionEvent e) throws Exception
    {
    }
	...
	public RequestContext prepareActionON(IItemAction itemAction) throws Exception {
			RequestContext request = new RequestContext();		
		if (request != null) {
    		request.setClassName(getUIHandlerClassName());
		}
	...
	public boolean isPrepareActionON() {
    	return false;
    }
    ...
    protected class ActionOK extends ItemAction {     
        ...
        public void actionPerformed(ActionEvent e)
        {
            ...
            innerActionPerformed("eas", AbstractRESchTemplateTreeNewListUI.this, "ActionOK", "actionOK_actionPerformed", e);
        }
    }

    /**
     * output ActionON class
     */     
    protected class ActionON extends ItemAction {     
        ...
        public ActionON(IUIObject uiObject)
        {     
		super(uiObject);     
        
            String _tempStr = null;
            this.setEnabled(false);
            _tempStr = resHelper.getString("ActionON.SHORT_DESCRIPTION");
            this.putValue(ItemAction.SHORT_DESCRIPTION, _tempStr);
            _tempStr = resHelper.getString("ActionON.LONG_DESCRIPTION");
            this.putValue(ItemAction.LONG_DESCRIPTION, _tempStr);
            _tempStr = resHelper.getString("ActionON.NAME");
            this.putValue(ItemAction.NAME, _tempStr);
        }
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractRESchTemplateTreeNewListUI.this, "ActionON", "actionON_actionPerformed", e);
        }
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.schedule.client", "RESchTemplateTreeNewListUI");
    }
