 ...
 * output class name
 */
public abstract class AbstractTaskStatusQueryUI extends com.kingdee.eas.framework.client.CoreUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractTaskStatusQueryUI.class);
     ...
     */
    public AbstractTaskStatusQueryUI() throws Exception
    {
        super();
        jbInit();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractTaskStatusQueryUI.class.getName());
        ...
        this.prmtAdminDept.setQueryInfo("com.kingdee.eas.fdc.schedule.F7FullOrgUnitQuery");
        ...
        // cmbStatus		
        this.cmbStatus.addItems(EnumUtils.getEnumList("com.kingdee.eas.fdc.schedule.TaskExecuteStatusEnum").toArray());
        // kDMenu1		
    ...
    public void initUIContentLayout()
    {
        ...
        conAdminPerson.setBounds(new Rectangle(370, 35, 270, 19));
        this.add(conAdminPerson, new KDLayout.Constraints(370, 35, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        btnSearch.setBounds(new Rectangle(730, 35, 60, 19));
        this.add(btnSearch, new KDLayout.Constraints(730, 35, 60, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT));
        ...
        conStatus.setBounds(new Rectangle(10, 35, 270, 19));
        this.add(conStatus, new KDLayout.Constraints(10, 35, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        ...
        this.add(conSchedule, new KDLayout.Constraints(370, 10, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        //conAdminDept
        ...
        //conStatus
        conStatus.setBoundEditor(cmbStatus);
        //conProject
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.schedule.app.TaskStatusQueryUIHandler";
	}
    ...
    protected class SerchAction extends ItemAction {     
        ...
        public void actionPerformed(ActionEvent e)
        {
            ...
            innerActionPerformed("eas", AbstractTaskStatusQueryUI.this, "SerchAction", "serchAction_actionPerformed", e);
        }
    }
    ...
    protected class ExportExcelAction extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractTaskStatusQueryUI.this, "ExportExcelAction", "exportExcelAction_actionPerformed", e);
        }
    }
    ...
    protected class ActionPrint extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractTaskStatusQueryUI.this, "ActionPrint", "actionPrint_actionPerformed", e);
        }
    }
    ...
    protected class ActionPreview extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractTaskStatusQueryUI.this, "ActionPreview", "actionPreview_actionPerformed", e);
        }
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.schedule.client", "TaskStatusQueryUI");
    }
