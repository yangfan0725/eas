 ...
 * output class name
 */
public abstract class AbstractTaskStatusAllInfosQueryUI extends com.kingdee.eas.framework.client.CoreUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractTaskStatusAllInfosQueryUI.class);
     ...
     */
    public AbstractTaskStatusAllInfosQueryUI() throws Exception
    {
        super();
        jbInit();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractTaskStatusAllInfosQueryUI.class.getName());
    ...
    public void initUIContentLayout()
    {
        ...
        conAdminDept.setBounds(new Rectangle(478, 10, 200, 19));
        this.add(conAdminDept, new KDLayout.Constraints(478, 10, 200, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        conAdminPerson.setBounds(new Rectangle(712, 10, 200, 19));
        this.add(conAdminPerson, new KDLayout.Constraints(712, 10, 200, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        btnSearch.setBounds(new Rectangle(949, 10, 60, 19));
        this.add(btnSearch, new KDLayout.Constraints(949, 10, 60, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT));
        tabReport.setBounds(new Rectangle(10, 39, 993, 570));
        this.add(tabReport, new KDLayout.Constraints(10, 39, 993, 570, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_BOTTOM | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT));
        conProject.setBounds(new Rectangle(10, 10, 200, 19));
        this.add(conProject, new KDLayout.Constraints(10, 10, 200, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        conSchedule.setBounds(new Rectangle(244, 10, 200, 19));
        this.add(conSchedule, new KDLayout.Constraints(244, 10, 200, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        //conAdminDept
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.schedule.app.TaskStatusAllInfosQueryUIHandler";
	}
    ...
    protected class SerchAction extends ItemAction {     
        ...
        public void actionPerformed(ActionEvent e)
        {
            ...
            innerActionPerformed("eas", AbstractTaskStatusAllInfosQueryUI.this, "SerchAction", "serchAction_actionPerformed", e);
        }
    }
    ...
    protected class ExportExcelAction extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractTaskStatusAllInfosQueryUI.this, "ExportExcelAction", "exportExcelAction_actionPerformed", e);
        }
    }
    ...
    protected class ActionPrint extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractTaskStatusAllInfosQueryUI.this, "ActionPrint", "actionPrint_actionPerformed", e);
        }
    }
    ...
    protected class ActionPreview extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractTaskStatusAllInfosQueryUI.this, "ActionPreview", "actionPreview_actionPerformed", e);
        }
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.schedule.client", "TaskStatusAllInfosQueryUI");
    }
