...
public abstract class AbstractMainScheduleEditUI extends com.kingdee.eas.fdc.schedule.client.FDCScheduleBaseEditUI
{
    ...
    public void initUIContentLayout()
    {
        ...
        mainPanel.setBounds(new Rectangle(12, 116, 878, 477));
        this.add(mainPanel, new KDLayout.Constraints(12, 116, 878, 477, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_BOTTOM | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT));
        ...
        contVersion.setBounds(new Rectangle(11, 35, 498, 19));
        this.add(contVersion, new KDLayout.Constraints(11, 35, 498, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contState.setBounds(new Rectangle(574, 35, 316, 19));
        this.add(contState, new KDLayout.Constraints(574, 35, 316, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT));
        ...
        contDescription.setBounds(new Rectangle(11, 58, 880, 47));
        this.add(contDescription, new KDLayout.Constraints(11, 58, 880, 47, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT));
