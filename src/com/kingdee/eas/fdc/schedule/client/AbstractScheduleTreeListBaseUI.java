 ...
 * output class name
 */
public abstract class AbstractScheduleTreeListBaseUI extends com.kingdee.eas.framework.client.ListUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractScheduleTreeListBaseUI.class);
    ...
    protected com.kingdee.bos.ctrl.swing.KDContainer contRight;
    protected com.kingdee.bos.ctrl.swing.KDTree treeMain;
    /**
     * output class constructor
     */
    public AbstractScheduleTreeListBaseUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractScheduleTreeListBaseUI.class.getName());
        ...
        // contRight		
        this.contRight.setEnableActive(false);
        // treeMain
...
contRight.getContentPane().setLayout(new BorderLayout(0, 0));        contRight.getContentPane().add(tblMain, BorderLayout.CENTER);
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.schedule.app.ScheduleTreeListBaseUIHandler";
	}
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.schedule.client", "ScheduleTreeListBaseUI");
    }
