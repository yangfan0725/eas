 ...
 * output class name
 */
public abstract class AbstractScheduleBizTypeEditUI extends com.kingdee.eas.fdc.basedata.client.FDCBaseDataEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractScheduleBizTypeEditUI.class);
    ...
    protected com.kingdee.eas.fdc.schedule.ScheduleBizTypeInfo editData = null;
    /**
     * output class constructor
     */
    public AbstractScheduleBizTypeEditUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractScheduleBizTypeEditUI.class.getName());
        ...
        // kDTextArea1		
        this.kDTextArea1.setMaxLength(200);
    ...
    {
        this.setBounds(new Rectangle(10, 10, 580, 170));
        this.setLayout(null);
        contName.setBounds(new Rectangle(10, 10, 270, 19));
        this.add(contName, null);
        contNumber.setBounds(new Rectangle(300, 10, 270, 19));
        this.add(contNumber, null);
        contDescription.setBounds(new Rectangle(10, 40, 103, 19));
        this.add(contDescription, null);
        kDScrollPane1.setBounds(new Rectangle(10, 60, 560, 100));
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.schedule.app.ScheduleBizTypeEditUIHandler";
	}
    ...
    public void setDataObject(IObjectValue dataObject)
    {
        ...
        this.editData = (com.kingdee.eas.fdc.schedule.ScheduleBizTypeInfo)ov;
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.schedule.client", "ScheduleBizTypeEditUI");
    }
