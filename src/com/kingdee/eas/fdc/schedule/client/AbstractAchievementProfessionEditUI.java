 ...
 * output class name
 */
public abstract class AbstractAchievementProfessionEditUI extends com.kingdee.eas.fdc.basedata.client.FDCBaseDataEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractAchievementProfessionEditUI.class);
    ...
    protected com.kingdee.eas.fdc.schedule.AchievementProfessionInfo editData = null;
    /**
     * output class constructor
     */
    public AbstractAchievementProfessionEditUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractAchievementProfessionEditUI.class.getName());
    ...
    public void initUIContentLayout()
    {
        ...
        kDScrollPane1.setBounds(new Rectangle(10, 61, 560, 100));
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.schedule.app.AchievementProfessionEditUIHandler";
	}
    ...
    public void setDataObject(IObjectValue dataObject)
    {
        ...
        this.editData = (com.kingdee.eas.fdc.schedule.AchievementProfessionInfo)ov;
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.schedule.client", "AchievementProfessionEditUI");
    }
