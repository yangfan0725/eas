 ...
 * output class name
 */
public abstract class AbstractStandardTaskGuideListUI extends com.kingdee.eas.framework.client.CoreBillListUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractStandardTaskGuideListUI.class);
     ...
     */
    public AbstractStandardTaskGuideListUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractStandardTaskGuideListUI.class.getName());
        this.setUITitle(resHelper.getString("this.title"));
        mainQueryPK = new MetaDataPK("com.kingdee.eas.fdc.schedule.app", "StandardTaskGuideQuery");
        //actionRemove
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.schedule.app.StandardTaskGuideListUIHandler";
	}
    ...
    protected class ActionTDPrint extends ItemAction {     
        ...
        public void actionPerformed(ActionEvent e)
        {
            ...
            innerActionPerformed("eas", AbstractStandardTaskGuideListUI.this, "ActionTDPrint", "actionTDPrint_actionPerformed", e);
        }
    }
    ...
    protected class ActionTDPrintPreview extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractStandardTaskGuideListUI.this, "ActionTDPrintPreview", "actionTDPrintPreview_actionPerformed", e);
        }
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.schedule.client", "StandardTaskGuideListUI");
    }
    /**
    ...
    {
        return com.kingdee.eas.fdc.schedule.client.StandardTaskGuideEditUI.class.getName();
    }
    ...
    {
        return com.kingdee.eas.fdc.schedule.StandardTaskGuideFactory.getRemoteInstance();
    }
    ...
    {
        com.kingdee.eas.fdc.schedule.StandardTaskGuideInfo objectValue = new com.kingdee.eas.fdc.schedule.StandardTaskGuideInfo();		
        return objectValue;
    }
    ...
    {
        return new String[] {"id","number","description","createTime","lastUpdateTime","creator.number","creator.name","lastUpdateUser.number","lastUpdateUser.name","taskType","standardDuration"};
    }



	protected String getTDFileName() {
    	return "/bim/fdc/schedule/StandardTaskGuide";
	}
    protected IMetaDataPK getTDQueryPK() {
    	return new MetaDataPK("com.kingdee.eas.fdc.schedule.app.StandardTaskGuideQuery");
	}
