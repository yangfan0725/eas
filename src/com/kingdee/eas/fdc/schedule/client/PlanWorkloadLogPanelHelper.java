...
public class PlanWorkloadLogPanelHelper {
	private final PlanTaskExtProPanelHelper taskExtPropHelper;
	...
	public PlanWorkloadLogPanelHelper(PlanTaskExtProPanelHelper helper) {
...
//		table.getColumn("completePercent").getStyleAttributes().setNumberFormat("0.00%");
	...
	public void setExecutingStatus() {
		if(table.getRowCount()<1){
			...
			FDCScheduleTaskInfo task = (FDCScheduleTaskInfo) taskExtPropHelper.getFDCSCHTaskPropUI().getSelectTask();
