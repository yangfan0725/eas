 ...
 * output class name
 */
public abstract class AbstractMainTaskEvaluationBillEditUI extends com.kingdee.eas.fdc.schedule.client.TaskEvaluationBillEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractMainTaskEvaluationBillEditUI.class);
    protected com.kingdee.eas.fdc.schedule.TaskEvaluationBillInfo editData = null;
    /**
     * output class constructor
     */
    public AbstractMainTaskEvaluationBillEditUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractMainTaskEvaluationBillEditUI.class.getName());
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.schedule.app.MainTaskEvaluationBillEditUIHandler";
	}
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.schedule.client", "MainTaskEvaluationBillEditUI");
    }
