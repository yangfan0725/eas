 ...
 * output class name
 */
public abstract class AbstractProjectScheduleUI extends com.kingdee.eas.fdc.schedule.client.FDCScheduleBaseEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractProjectScheduleUI.class);
    protected com.kingdee.eas.fdc.schedule.FDCScheduleInfo editData = null;
    /**
     * output class constructor
     */
    public AbstractProjectScheduleUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractProjectScheduleUI.class.getName());
        ...
        this.menuItemCritical.setVisible(false);		
        ...
        this.menuItemDisplayAll.setVisible(false);		
        this.menuItemHideOther.setVisible(false);		
        this.menuItemAudit.setVisible(false);		
        this.menuItemUnAduit.setIcon(com.kingdee.eas.util.client.EASResource.getIcon("imgTbtn_unaudit"));		
    ...
    public void initUIContentLayout()
    {
        ...
        mainPanel.setBounds(new Rectangle(12, 5, 878, 588));
        this.add(mainPanel, new KDLayout.Constraints(12, 5, 878, 588, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_BOTTOM | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT));
...
kDPanel1.setLayout(new BorderLayout(0, 0));        kDPanel1.add(kDTable1, BorderLayout.CENTER);
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.schedule.app.ProjectScheduleUIHandler";
	}
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.schedule.client", "ProjectScheduleUI");
    }
    /**
