 ...
 * output class name
 */
public abstract class AbstractScheduleImplementQueryUI extends com.kingdee.eas.framework.client.CoreUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractScheduleImplementQueryUI.class);
     ...
     */
    public AbstractScheduleImplementQueryUI() throws Exception
    {
        super();
        jbInit();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractScheduleImplementQueryUI.class.getName());
        ...
        // cmbStatus		
        this.cmbStatus.addItems(EnumUtils.getEnumList("com.kingdee.eas.fdc.schedule.framework.ScheduleStateEnum").toArray());
        // kDMenu1		
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.schedule.app.ScheduleImplementQueryUIHandler";
	}
    ...
    protected class SerchAction extends ItemAction
    {
        ...
        public void actionPerformed(ActionEvent e)
        {
            ...
            innerActionPerformed("eas", AbstractScheduleImplementQueryUI.this, "SerchAction", "serchAction_actionPerformed", e);
        }
    }
    ...
    protected class ExportExcelAction extends ItemAction
    {
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractScheduleImplementQueryUI.this, "ExportExcelAction", "exportExcelAction_actionPerformed", e);
        }
    }
    ...
    protected class ActionPrint extends ItemAction
    {
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractScheduleImplementQueryUI.this, "ActionPrint", "actionPrint_actionPerformed", e);
        }
    }
    ...
    protected class ActionPreview extends ItemAction
    {
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractScheduleImplementQueryUI.this, "ActionPreview", "actionPreview_actionPerformed", e);
        }
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.schedule.client", "ScheduleImplementQueryUI");
    }
