...
public abstract class AbstractViewProjectMonthReportUI extends com.kingdee.eas.fdc.schedule.client.ViewProjectReportBaseUI
{
    ...
    protected com.kingdee.bos.ctrl.swing.KDTabbedPane kdtPanel;
    protected com.kingdee.bos.ctrl.swing.KDWorkButton btnExportExcel;
    protected com.kingdee.bos.ctrl.swing.KDWorkButton btnSearach;
    ...
    private void jbInit() throws Exception
    {
        ...
        this.kdtPanel = new com.kingdee.bos.ctrl.swing.KDTabbedPane();
        this.btnExportExcel = new com.kingdee.bos.ctrl.swing.KDWorkButton();
        this.btnSearach = new com.kingdee.bos.ctrl.swing.KDWorkButton();
        ...
        this.btnSearach.setName("btnSearach");
        // CoreUI		
        ...
        // kdtPanel		
        this.kdtPanel.setAutoscrolls(true);
        // btnExportExcel
        ...
        // btnSearach
        this.btnSearach.setAction((IItemAction)ActionProxyFactory.getProxy(actionSearch, new Class[] { IItemAction.class }, getServiceContext()));		
        this.btnSearach.setText(resHelper.getString("btnSearach.text"));		
        this.btnSearach.setIcon(com.kingdee.eas.util.client.EASResource.getIcon("imgTbtn_filter"));
    ...
    public void initUIContentLayout()
    {
        ...
        sptLeft.setBounds(new Rectangle(10, 10, 965, 609));
        this.add(sptLeft, new KDLayout.Constraints(10, 10, 965, 609, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_BOTTOM | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT));
        //sptLeft
        ...
        ctChart1.putClientProperty("OriginalBounds", new Rectangle(0, 0, 703, 298));        contYear.setBounds(new Rectangle(10, 10, 158, 19));
...
pnlChart.setLayout(new BorderLayout(0, 0));        //kDLabelContainer1
        ...
        //sptDown
        sptDown.add(kdtPanel, "bottom");
        //kdtPanel
        kdtPanel.add(contThis, resHelper.getString("contThis.constraints"));
        kdtPanel.add(contNext, resHelper.getString("contNext.constraints"));
        //contThis
...
contNext.getContentPane().setLayout(new BorderLayout(0, 0));        contNext.getContentPane().add(nextTable, BorderLayout.CENTER);
    ...
    protected class ActionSearch extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractViewProjectMonthReportUI.this, "ActionSearch", "actionSearch_actionPerformed", e);
        }
    }
