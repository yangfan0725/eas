 ...
 * output class name
 */
public abstract class AbstractScheduleTimePeriodQueryUI extends com.kingdee.eas.framework.client.CoreUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractScheduleTimePeriodQueryUI.class);
     ...
     */
    public AbstractScheduleTimePeriodQueryUI() throws Exception
    {
        super();
        jbInit();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractScheduleTimePeriodQueryUI.class.getName());
    ...
    public void initUIContentLayout()
    {
        ...
        this.add(conStartDate, new KDLayout.Constraints(320, 35, 270, 19, 0));
        conEndDate.setBounds(new Rectangle(630, 35, 270, 19));
        this.add(conEndDate, new KDLayout.Constraints(630, 35, 270, 19, 0));
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.schedule.app.ScheduleTimePeriodQueryUIHandler";
	}
    ...
    protected class SerchAction extends ItemAction
    {
        ...
        public void actionPerformed(ActionEvent e)
        {
            ...
            innerActionPerformed("eas", AbstractScheduleTimePeriodQueryUI.this, "SerchAction", "serchAction_actionPerformed", e);
        }
    }
    ...
    protected class ExportExcelAction extends ItemAction
    {
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractScheduleTimePeriodQueryUI.this, "ExportExcelAction", "exportExcelAction_actionPerformed", e);
        }
    }
    ...
    protected class ActionPrint extends ItemAction
    {
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractScheduleTimePeriodQueryUI.this, "ActionPrint", "actionPrint_actionPerformed", e);
        }
    }
    ...
    protected class ActionPreview extends ItemAction
    {
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractScheduleTimePeriodQueryUI.this, "ActionPreview", "actionPreview_actionPerformed", e);
        }
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.schedule.client", "ScheduleTimePeriodQueryUI");
    }
    /**
