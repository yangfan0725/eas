 ...
 * output class name
 */
public abstract class AbstractFDCWBSBatchChangeProUI extends com.kingdee.eas.framework.client.CoreUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractFDCWBSBatchChangeProUI.class);
    protected com.kingdee.bos.ctrl.swing.KDLabelContainer conTaskPro;
    protected com.kingdee.bos.ctrl.extendcontrols.KDBizPromptBox prmtTaskPro;
     ...
     */
    public AbstractFDCWBSBatchChangeProUI() throws Exception
    {
        super();
        jbInit();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractFDCWBSBatchChangeProUI.class.getName());
        ...
        this.conTaskPro = new com.kingdee.bos.ctrl.swing.KDLabelContainer();
        this.prmtTaskPro = new com.kingdee.bos.ctrl.extendcontrols.KDBizPromptBox();
        this.btnOK = new com.kingdee.bos.ctrl.swing.KDButton();
        this.btnCancel = new com.kingdee.bos.ctrl.swing.KDButton();
        this.conTaskPro.setName("conTaskPro");
        this.prmtTaskPro.setName("prmtTaskPro");
        this.btnOK.setName("btnOK");
        this.btnCancel.setName("btnCancel");
        // CoreUI
        // conTaskPro		
        this.conTaskPro.setBoundLabelText(resHelper.getString("conTaskPro.boundLabelText"));		
        this.conTaskPro.setBoundLabelLength(100);		
        this.conTaskPro.setBoundLabelUnderline(true);
        // prmtTaskPro
        // btnOK
    ...
    {
        this.setBounds(new Rectangle(10, 10, 300, 75));
        this.setLayout(null);
        conTaskPro.setBounds(new Rectangle(10, 10, 270, 19));
        this.add(conTaskPro, null);
        btnOK.setBounds(new Rectangle(122, 43, 73, 21));
        this.add(btnOK, null);
        btnCancel.setBounds(new Rectangle(209, 43, 73, 21));
        this.add(btnCancel, null);
        //conTaskPro
        conTaskPro.setBoundEditor(prmtTaskPro);
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.schedule.app.FDCWBSBatchChangeProUIHandler";
	}
    ...
    protected class ActionOK extends ItemAction {     
        ...
        public void actionPerformed(ActionEvent e)
        {
            ...
            innerActionPerformed("eas", AbstractFDCWBSBatchChangeProUI.this, "ActionOK", "actionOK_actionPerformed", e);
        }
    }
    ...
    protected class ActionCancel extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractFDCWBSBatchChangeProUI.this, "ActionCancel", "actionCancel_actionPerformed", e);
        }
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.schedule.client", "FDCWBSBatchChangeProUI");
    }
