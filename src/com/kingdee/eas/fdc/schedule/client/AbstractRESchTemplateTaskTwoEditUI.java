 ...
 * output class name
 */
public abstract class AbstractRESchTemplateTaskTwoEditUI extends com.kingdee.eas.fdc.basedata.client.FDCTreeBaseDataEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractRESchTemplateTaskTwoEditUI.class);
     ...
     */
    public AbstractRESchTemplateTaskTwoEditUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractRESchTemplateTaskTwoEditUI.class.getName());
        ...
        this.contStandardTask.setBoundLabelLength(100);		
    ...
    {
        this.setBounds(new Rectangle(10, 10, 1000, 359));
        this.setLayout(new KDLayout());
        this.putClientProperty("OriginalBounds", new Rectangle(10, 10, 1000, 359));
        contName.setBounds(new Rectangle(10, 9, 270, 19));
        this.add(contName, new KDLayout.Constraints(10, 9, 270, 19, 0));
        contNumber.setBounds(new Rectangle(371, 9, 270, 19));
        this.add(contNumber, new KDLayout.Constraints(371, 9, 270, 19, 0));
        contDescription.setBounds(new Rectangle(12, 90, 971, 69));
        this.add(contDescription, new KDLayout.Constraints(12, 90, 971, 69, 0));
        contStandardTask.setBounds(new Rectangle(711, 9, 270, 19));
        this.add(contStandardTask, new KDLayout.Constraints(711, 9, 270, 19, 0));
        contTaskType.setBounds(new Rectangle(10, 43, 270, 19));
        this.add(contTaskType, new KDLayout.Constraints(10, 43, 270, 19, 0));
        contAchievementType.setBounds(new Rectangle(713, 43, 270, 19));
        this.add(contAchievementType, new KDLayout.Constraints(713, 43, 270, 19, 0));
        kDLabelContainer1.setBounds(new Rectangle(373, 43, 270, 19));
        this.add(kDLabelContainer1, new KDLayout.Constraints(373, 43, 270, 19, 0));
        //contName
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.schedule.app.RESchTemplateTaskTwoEditUIHandler";
	}
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.schedule.client", "RESchTemplateTaskTwoEditUI");
    }
