 ...
 * output class name
 */
public class PersonalPlanEditUI extends AbstractPersonalPlanEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(PersonalPlanEditUI.class);
    
    /**
     * output class constructor
     */
    public PersonalPlanEditUI() throws Exception
    {
        super();
    }
    ...
    {
        super.prmtState_actionPerformed(e);
    }
    ...
    /**
     * output actionSearch_actionPerformed
     */
