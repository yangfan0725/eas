 ...
 * output class name
 */
public abstract class AbstractPersonalPlanEditUI extends com.kingdee.eas.fdc.schedule.client.PlanEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractPersonalPlanEditUI.class);
    protected com.kingdee.eas.framework.CoreBaseInfo editData = null;
    /**
     * output class constructor
     */
    public AbstractPersonalPlanEditUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractPersonalPlanEditUI.class.getName());
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.schedule.app.PersonalPlanEditUIHandler";
	}
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.schedule.client", "PersonalPlanEditUI");
    }
