 ...
 * output class name
 */
public abstract class AbstractBatchModifyTaskType extends com.kingdee.eas.framework.client.CoreUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractBatchModifyTaskType.class);
    ...
    protected com.kingdee.bos.ctrl.swing.KDComboBox cmbTaskType;
     ...
     */
    public AbstractBatchModifyTaskType() throws Exception
    {
        super();
        jbInit();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractBatchModifyTaskType.class.getName());
        ...
        this.cmbTaskType = new com.kingdee.bos.ctrl.swing.KDComboBox();
        ...
        this.cmbTaskType.setName("cmbTaskType");
        // CoreUI		
        ...
        this.cboPanelPoint.setVisible(false);
    ...
    public void initUIContentLayout()
    {
        ...
        btnLeftMove.setBounds(new Rectangle(472, 282, 96, 22));
        this.add(btnLeftMove, new KDLayout.Constraints(472, 282, 96, 22, 0));
        btnAllLeftMove.setBounds(new Rectangle(472, 319, 96, 22));
        this.add(btnAllLeftMove, new KDLayout.Constraints(472, 319, 96, 22, 0));
        btnRightMove.setBounds(new Rectangle(472, 246, 96, 22));
        this.add(btnRightMove, new KDLayout.Constraints(472, 246, 96, 22, 0));
        btnAllRightMove.setBounds(new Rectangle(472, 210, 96, 22));
        this.add(btnAllRightMove, new KDLayout.Constraints(472, 210, 96, 22, 0));
        ...
        contBizType.setBounds(new Rectangle(14, 15, 270, 19));
        this.add(contBizType, new KDLayout.Constraints(14, 15, 270, 19, 0));
        contTaskType.setBounds(new Rectangle(668, 15, 270, 19));
        this.add(contTaskType, new KDLayout.Constraints(668, 15, 270, 19, 0));
        //kDContainer1
...
kDContainer2.getContentPane().setLayout(new BorderLayout(0, 0));        kDContainer2.getContentPane().add(kDRightTable, BorderLayout.CENTER);
        ...
        //contTaskType
        contTaskType.setBoundEditor(cmbTaskType);
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.schedule.app.BatchModifyTaskTypeHandler";
	}
    ...
    protected class ActionLeftMove extends ItemAction {     
        ...
        public void actionPerformed(ActionEvent e)
        {
            ...
            innerActionPerformed("eas", AbstractBatchModifyTaskType.this, "ActionLeftMove", "actionLeftMove_actionPerformed", e);
        }
    }
    ...
    protected class ActionAllLeftMove extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractBatchModifyTaskType.this, "ActionAllLeftMove", "actionAllLeftMove_actionPerformed", e);
        }
    }
    ...
    protected class ActionAllRightMove extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractBatchModifyTaskType.this, "ActionAllRightMove", "actionAllRightMove_actionPerformed", e);
        }
    }
    ...
    protected class ActionRightMove extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractBatchModifyTaskType.this, "ActionRightMove", "actionRightMove_actionPerformed", e);
        }
    }
    ...
    protected class ActionMakeSure extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractBatchModifyTaskType.this, "ActionMakeSure", "actionMakeSure_actionPerformed", e);
        }
    }
    ...
    protected class ActionSaveAndClose extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractBatchModifyTaskType.this, "ActionSaveAndClose", "actionSaveAndClose_actionPerformed", e);
        }
    }
    ...
    protected class ActionClose extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractBatchModifyTaskType.this, "ActionClose", "actionClose_actionPerformed", e);
        }
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.schedule.client", "BatchModifyTaskType");
    }
