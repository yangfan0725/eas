 ...
 * output class name
 */
public abstract class AbstractF7WorkAmountTaskUI extends com.kingdee.eas.framework.client.CoreUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractF7WorkAmountTaskUI.class);
     ...
     */
    public AbstractF7WorkAmountTaskUI() throws Exception
    {
        super();
        jbInit();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractF7WorkAmountTaskUI.class.getName());
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.schedule.app.F7WorkAmountTaskUIHandler";
	}
    ...
    protected class ActionBtnOk extends ItemAction {     
        ...
        public void actionPerformed(ActionEvent e)
        {
            ...
            innerActionPerformed("eas", AbstractF7WorkAmountTaskUI.this, "ActionBtnOk", "actionBtnOk_actionPerformed", e);
        }
    }
    ...
    protected class ActionBtnCancel extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractF7WorkAmountTaskUI.this, "ActionBtnCancel", "actionBtnCancel_actionPerformed", e);
        }
    }
    ...
    protected class ActionBtnFilter extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractF7WorkAmountTaskUI.this, "ActionBtnFilter", "actionBtnFilter_actionPerformed", e);
        }
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.schedule.client", "F7WorkAmountTaskUI");
    }
