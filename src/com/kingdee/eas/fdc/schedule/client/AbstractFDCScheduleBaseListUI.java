 ...
 * output class name
 */
public abstract class AbstractFDCScheduleBaseListUI extends com.kingdee.eas.framework.client.CoreBillListUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractFDCScheduleBaseListUI.class);
     ...
     */
    public AbstractFDCScheduleBaseListUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractFDCScheduleBaseListUI.class.getName());
        ...
        // splitPaneMain		
        this.splitPaneMain.setDividerLocation(250);		
        this.splitPaneMain.setResizeWeight(0.3);
        // treeView		
        this.treeView.setTitle(resHelper.getString("treeView.title"));
        // contMain		
        this.contMain.setTitle(resHelper.getString("contMain.title"));		
        this.contMain.setEnableActive(false);		
        this.contMain.setAutoscrolls(true);
        // treeMain
...
contMain.getContentPane().setLayout(new BorderLayout(0, 0));        contMain.getContentPane().add(tblMain, BorderLayout.CENTER);
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.schedule.app.FDCScheduleBaseListUIHandler";
	}
    ...
    protected class ActionAudit extends ItemAction {     
        ...
        public void actionPerformed(ActionEvent e)
        {
            ...
            innerActionPerformed("eas", AbstractFDCScheduleBaseListUI.this, "ActionAudit", "actionAudit_actionPerformed", e);
        }
    }
    ...
    protected class ActionUnAudit extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractFDCScheduleBaseListUI.this, "ActionUnAudit", "actionUnAudit_actionPerformed", e);
        }
    }
    ...
    protected class ActionClose extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractFDCScheduleBaseListUI.this, "ActionClose", "actionClose_actionPerformed", e);
        }
    }
    ...
    protected class ActionUnClose extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractFDCScheduleBaseListUI.this, "ActionUnClose", "actionUnClose_actionPerformed", e);
        }
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.schedule.client", "FDCScheduleBaseListUI");
    }
