 ...
 * output class name
 */
public abstract class AbstractViewProjectReportBaseUI extends com.kingdee.eas.fdc.schedule.framework.client.ScheduleChartBaseUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractViewProjectReportBaseUI.class);
     ...
     */
    public AbstractViewProjectReportBaseUI() throws Exception
    {
        super();
        jbInit();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractViewProjectReportBaseUI.class.getName());
        ...
        // CoreUI		
        this.sptTop.setDividerLocation(-1);		
        this.sptTop.setResizeWeight(0.5);		
        this.sptTop.setPreferredSize(new Dimension(800,600));		
        this.sptTop.setContinuousLayout(true);		
        this.sptTop.setLastDividerLocation(-1);
        // sptDown		
    ...
    public void initUIContentLayout()
    {
        ...
        ctChart1.putClientProperty("OriginalBounds", new Rectangle(0, 0, 731, 298));        contYear.setBounds(new Rectangle(10, 10, 220, 19));
...
pnlChart.setLayout(new BorderLayout(0, 0));        //sptDown
...
contNext.getContentPane().setLayout(new BorderLayout(0, 0));        contNext.getContentPane().add(nextTable, BorderLayout.CENTER);
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.schedule.app.ViewProjectReportBaseUIHandler";
	}
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.schedule.client", "ViewProjectReportBaseUI");
    }
