...
public class ScheduleAdjustPrefixTask extends ScheduleTaskDepend implements IScheduleAdjustPrefixTask
{
    public ScheduleAdjustPrefixTask()
    {
        super();
        registerInterface(IScheduleAdjustPrefixTask.class, this);
    }
    public ScheduleAdjustPrefixTask(Context ctx)
    {
        super(ctx);
        registerInterface(IScheduleAdjustPrefixTask.class, this);
    }
    ...
    private ScheduleAdjustPrefixTaskController getController() throws BOSException
    {
        return (ScheduleAdjustPrefixTaskController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getScheduleAdjustPrefixTaskInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getScheduleAdjustPrefixTaskInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getScheduleAdjustPrefixTaskInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getScheduleAdjustPrefixTaskCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getScheduleAdjustPrefixTaskCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getScheduleAdjustPrefixTaskCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
