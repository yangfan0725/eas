...
public class RESchTemplateTask extends FDCTreeBaseData implements IRESchTemplateTask
{
    public RESchTemplateTask()
    {
        super();
        registerInterface(IRESchTemplateTask.class, this);
    }
    public RESchTemplateTask(Context ctx)
    {
        super(ctx);
        registerInterface(IRESchTemplateTask.class, this);
    }
    ...
    private RESchTemplateTaskController getController() throws BOSException
    {
        return (RESchTemplateTaskController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getRESchTemplateTaskInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getRESchTemplateTaskInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getRESchTemplateTaskInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getRESchTemplateTaskCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getRESchTemplateTaskCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getRESchTemplateTaskCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    /**
     *模板任务多行删除-User defined method
     *@param list list
     */
    public void templateTaskDel(List list) throws BOSException, EASBizException
    {
        try {
            getController().templateTaskDel(getContext(), list);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    /**
     *project导入-User defined method
     *@param coreBaseCollection 待导入project集合
     *@param currentTemplateTaskCollection 现有任务
     */
    ...
    {
        try {
            getController().importTasks(getContext(), coreBaseCollection, currentTemplateTaskCollection);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
