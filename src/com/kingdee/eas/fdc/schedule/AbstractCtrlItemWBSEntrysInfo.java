...
public class AbstractCtrlItemWBSEntrysInfo extends com.kingdee.eas.framework.CoreBillEntryBaseInfo implements Serializable 
{
    public AbstractCtrlItemWBSEntrysInfo()
    {
        this("id");
    }
    protected AbstractCtrlItemWBSEntrysInfo(String pkField)
    {
        super(pkField);
    }
    /**
