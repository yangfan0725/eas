...
public class TemplateTaskWithBizType extends CoreBase implements ITemplateTaskWithBizType
{
    public TemplateTaskWithBizType()
    {
        super();
        registerInterface(ITemplateTaskWithBizType.class, this);
    }
    public TemplateTaskWithBizType(Context ctx)
    {
        super(ctx);
        registerInterface(ITemplateTaskWithBizType.class, this);
    }
    ...
    private TemplateTaskWithBizTypeController getController() throws BOSException
    {
        return (TemplateTaskWithBizTypeController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getTemplateTaskWithBizTypeInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getTemplateTaskWithBizTypeInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getTemplateTaskWithBizTypeInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getTemplateTaskWithBizTypeCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getTemplateTaskWithBizTypeCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getTemplateTaskWithBizTypeCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
