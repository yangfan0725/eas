...
public class ScheduleNewTaskEntry extends ScheduleTaskBase implements IScheduleNewTaskEntry
{
    public ScheduleNewTaskEntry()
    {
        super();
        registerInterface(IScheduleNewTaskEntry.class, this);
    }
    public ScheduleNewTaskEntry(Context ctx)
    {
        super(ctx);
        registerInterface(IScheduleNewTaskEntry.class, this);
    }
    ...
    private ScheduleNewTaskEntryController getController() throws BOSException
    {
        return (ScheduleNewTaskEntryController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getScheduleNewTaskEntryInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getScheduleNewTaskEntryInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getScheduleNewTaskEntryInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getScheduleNewTaskEntryCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getScheduleNewTaskEntryCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getScheduleNewTaskEntryCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
