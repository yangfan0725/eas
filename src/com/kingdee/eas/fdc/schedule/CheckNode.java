...
public class CheckNode extends FDCDataBase implements ICheckNode
{
    public CheckNode()
    {
        super();
        registerInterface(ICheckNode.class, this);
    }
    public CheckNode(Context ctx)
    {
        super(ctx);
        registerInterface(ICheckNode.class, this);
    }
    ...
    private CheckNodeController getController() throws BOSException
    {
        return (CheckNodeController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getCheckNodeInfo(getContext(), pk);
        }
    ...
    {
        try {
            return getController().getCheckNodeInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getCheckNodeInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getCheckNodeCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getCheckNodeCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getCheckNodeCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
