...
public class TaskWorkResultEntry extends CoreBillEntryBase implements ITaskWorkResultEntry
{
    public TaskWorkResultEntry()
    {
        super();
        registerInterface(ITaskWorkResultEntry.class, this);
    }
    public TaskWorkResultEntry(Context ctx)
    {
        super(ctx);
        registerInterface(ITaskWorkResultEntry.class, this);
    }
    ...
    private TaskWorkResultEntryController getController() throws BOSException
    {
        return (TaskWorkResultEntryController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getTaskWorkResultEntryInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getTaskWorkResultEntryInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getTaskWorkResultEntryInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getTaskWorkResultEntryCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getTaskWorkResultEntryCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getTaskWorkResultEntryCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
