...
public class ScheduleCodingType extends ObjectBase implements IScheduleCodingType
{
    public ScheduleCodingType()
    {
        super();
        registerInterface(IScheduleCodingType.class, this);
    }
    public ScheduleCodingType(Context ctx)
    {
        super(ctx);
        registerInterface(IScheduleCodingType.class, this);
    }
    ...
    private ScheduleCodingTypeController getController() throws BOSException
    {
        return (ScheduleCodingTypeController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getScheduleCodingTypeInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getScheduleCodingTypeInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getScheduleCodingTypeInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getScheduleCodingTypeCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getScheduleCodingTypeCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getScheduleCodingTypeCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
