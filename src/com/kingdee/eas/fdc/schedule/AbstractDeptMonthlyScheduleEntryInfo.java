...
public class AbstractDeptMonthlyScheduleEntryInfo extends com.kingdee.eas.framework.CoreBillEntryBaseInfo implements Serializable 
{
    public AbstractDeptMonthlyScheduleEntryInfo()
    {
        this("id");
    }
    protected AbstractDeptMonthlyScheduleEntryInfo(String pkField)
    {
        super(pkField);
    }
    /**
     ...
     */
    public com.kingdee.eas.fdc.schedule.FDCScheduleTaskExtInfo getRelatedTask()
    {
        return (com.kingdee.eas.fdc.schedule.FDCScheduleTaskExtInfo)get("relatedTask");
    }
    public void setRelatedTask(com.kingdee.eas.fdc.schedule.FDCScheduleTaskExtInfo item)
    {
