...
public class WBSTemplate extends FDCDataBase implements IWBSTemplate
{
    public WBSTemplate()
    {
        super();
        registerInterface(IWBSTemplate.class, this);
    }
    public WBSTemplate(Context ctx)
    {
        super(ctx);
        registerInterface(IWBSTemplate.class, this);
    }
    ...
    private WBSTemplateController getController() throws BOSException
    {
        return (WBSTemplateController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getWBSTemplateInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getWBSTemplateInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getWBSTemplateInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getWBSTemplateCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getWBSTemplateCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getWBSTemplateCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
