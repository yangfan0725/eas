...
public class WBSTemplateType extends FDCDataBase implements IWBSTemplateType
{
    public WBSTemplateType()
    {
        super();
        registerInterface(IWBSTemplateType.class, this);
    }
    public WBSTemplateType(Context ctx)
    {
        super(ctx);
        registerInterface(IWBSTemplateType.class, this);
    }
    ...
    private WBSTemplateTypeController getController() throws BOSException
    {
        return (WBSTemplateTypeController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getWBSTemplateTypeInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getWBSTemplateTypeInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getWBSTemplateTypeInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getWBSTemplateTypeCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getWBSTemplateTypeCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getWBSTemplateTypeCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
