...
public class ScheduleVerManagerEntry extends CoreBillEntryBase implements IScheduleVerManagerEntry
{
    public ScheduleVerManagerEntry()
    {
        super();
        registerInterface(IScheduleVerManagerEntry.class, this);
    }
    public ScheduleVerManagerEntry(Context ctx)
    {
        super(ctx);
        registerInterface(IScheduleVerManagerEntry.class, this);
    }
    ...
    private ScheduleVerManagerEntryController getController() throws BOSException
    {
        return (ScheduleVerManagerEntryController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getScheduleVerManagerEntryInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getScheduleVerManagerEntryInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getScheduleVerManagerEntryInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getScheduleVerManagerEntryCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getScheduleVerManagerEntryCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getScheduleVerManagerEntryCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
