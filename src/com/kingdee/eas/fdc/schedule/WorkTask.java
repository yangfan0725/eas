...
public class WorkTask extends TreeBase implements IWorkTask
{
    public WorkTask()
    {
        super();
        registerInterface(IWorkTask.class, this);
    }
    public WorkTask(Context ctx)
    {
        super(ctx);
        registerInterface(IWorkTask.class, this);
    }
    ...
    private WorkTaskController getController() throws BOSException
    {
        return (WorkTaskController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getWorkTaskInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getWorkTaskInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getWorkTaskInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getWorkTaskCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getWorkTaskCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getWorkTaskCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
