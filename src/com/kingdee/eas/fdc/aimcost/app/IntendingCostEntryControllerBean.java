...
public class IntendingCostEntryControllerBean extends AbstractIntendingCostEntryControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.fdc.aimcost.app.IntendingCostEntryControllerBean");
}