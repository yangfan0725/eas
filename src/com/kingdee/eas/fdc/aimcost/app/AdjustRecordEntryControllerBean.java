...
public class AdjustRecordEntryControllerBean extends AbstractAdjustRecordEntryControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.fdc.aimcost.app.AdjustRecordEntryControllerBean");
}