...
public class FDCCostLogControllerBean extends AbstractFDCCostLogControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.fdc.aimcost.app.FDCCostLogControllerBean");
