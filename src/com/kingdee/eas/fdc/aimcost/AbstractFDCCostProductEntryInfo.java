...
public class AbstractFDCCostProductEntryInfo extends com.kingdee.eas.framework.CoreBaseInfo implements Serializable 
{
    public AbstractFDCCostProductEntryInfo()
    {
        this("id");
    }
    protected AbstractFDCCostProductEntryInfo(String pkField)
    {
        super(pkField);
    }
    /**
     * Object:成本报表中间表产品类型分录's FDCCost头property 
     */
    ...
    /**
     * Object:成本报表中间表产品类型分录's 产品类型Idproperty 
     */
    ...
    /**
     * Object:成本报表中间表产品类型分录's 目标可售单方property 
     */
    ...
    /**
     * Object:成本报表中间表产品类型分录's 目标property 
     */
    ...
    /**
     * Object:成本报表中间表产品类型分录's 已发生property 
     */
    ...
    /**
     * Object:成本报表中间表产品类型分录's 未发生property 
     */
    ...
    /**
     * Object:成本报表中间表产品类型分录's 动态可售单方property 
     */
    ...
    /**
     * Object:成本报表中间表产品类型分录's 动态property 
     */
    ...
    /**
     * Object:成本报表中间表产品类型分录's 已实现成本property 
     */
    ...
    /**
     * Object:成本报表中间表产品类型分录's 已付款金额property 
     */
    ...
    /**
     * Object:成本报表中间表产品类型分录's 已发生直接金额property 
     */
    ...
    /**
     * Object:成本报表中间表产品类型分录's 已实现直接金额property 
     */
    ...
    /**
     * Object:成本报表中间表产品类型分录's 已付款直接金额property 
     */
    ...
    /**
     * Object:成本报表中间表产品类型分录's 目标成本直接金额property 
     */
    ...
    /**
     * Object:成本报表中间表产品类型分录's 动态成本直接金额property 
     */
