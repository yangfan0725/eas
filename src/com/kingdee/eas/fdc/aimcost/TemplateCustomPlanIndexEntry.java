...
public class TemplateCustomPlanIndexEntry extends CoreBase implements ITemplateCustomPlanIndexEntry
{
    public TemplateCustomPlanIndexEntry()
    {
        super();
        registerInterface(ITemplateCustomPlanIndexEntry.class, this);
    }
    public TemplateCustomPlanIndexEntry(Context ctx)
    {
        super(ctx);
        registerInterface(ITemplateCustomPlanIndexEntry.class, this);
    }
    ...
    private TemplateCustomPlanIndexEntryController getController() throws BOSException
    {
        return (TemplateCustomPlanIndexEntryController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getTemplateCustomPlanIndexEntryInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getTemplateCustomPlanIndexEntryInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getTemplateCustomPlanIndexEntryInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getTemplateCustomPlanIndexEntryCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getTemplateCustomPlanIndexEntryCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getTemplateCustomPlanIndexEntryCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
