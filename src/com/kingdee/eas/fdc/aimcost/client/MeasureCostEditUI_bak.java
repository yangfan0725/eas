 ...
 * output class name
 */
public class MeasureCostEditUI_bak extends AbstractMeasureCostEditUI_bak
{
    private static final Logger logger = CoreUIObject.getLogger(MeasureCostEditUI_bak.class);
    
    /**
     * output class constructor
     */
    public MeasureCostEditUI_bak() throws Exception
    {
        super();
    }
    ...
    /**
     * output actionImportApportion_actionPerformed
     */
    public void actionImportApportion_actionPerformed(ActionEvent e) throws Exception
    {
        super.actionImportApportion_actionPerformed(e);
    }
