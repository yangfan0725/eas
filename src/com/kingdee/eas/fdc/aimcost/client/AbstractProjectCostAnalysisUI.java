...
public abstract class AbstractProjectCostAnalysisUI extends com.kingdee.eas.fdc.basedata.client.FDCRptBaseUI
{
    ...
    protected com.kingdee.bos.ctrl.swing.KDPanel pnlDesc;
    /**
    ...
    private void jbInit() throws Exception
    {
        ...
        this.pnlDesc = new com.kingdee.bos.ctrl.swing.KDPanel();
        this.kDPanel1.setName("kDPanel1");
        this.pnlDesc.setName("pnlDesc");
        // CoreUI
        ...
        // kDPanel1
        // pnlDesc		
        this.pnlDesc.setBorder(BorderFactory.createEtchedBorder(new Color(255,255,255),new Color(148,145,140)));
...
kDPanel1.setLayout(new BorderLayout(0, 0));        kDPanel1.add(tblMain, BorderLayout.CENTER);
        kDPanel1.add(pnlDesc, BorderLayout.SOUTH);
