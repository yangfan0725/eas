 ...
 * output class name
 */
public class MeasureCostListUI_bak extends AbstractMeasureCostListUI_bak
{
    private static final Logger logger = CoreUIObject.getLogger(MeasureCostListUI_bak.class);
    
    /**
     * output class constructor
     */
    public MeasureCostListUI_bak() throws Exception
    {
        super();
    }
