 ...
 * output class name
 */
public class MeasureCostEditUI extends AbstractMeasureCostEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(MeasureCostEditUI.class);
    
    /**
     * output class constructor
     */
    public MeasureCostEditUI() throws Exception
    {
        super();
    }
