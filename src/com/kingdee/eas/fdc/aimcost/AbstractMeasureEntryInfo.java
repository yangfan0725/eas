...
public class AbstractMeasureEntryInfo extends com.kingdee.eas.framework.DataBaseInfo implements Serializable 
{
    ...
    /**
     * Object:测算分录's 不含税金额property 
     */
    public java.math.BigDecimal getAmountNoTax()
    {
        return getBigDecimal("amountNoTax");
    }
    public void setAmountNoTax(java.math.BigDecimal item)
    {
        setBigDecimal("amountNoTax", item);
    }
