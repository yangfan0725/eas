...
public class EvaluationType extends TreeBase implements IEvaluationType
{
    public EvaluationType()
    {
        super();
        registerInterface(IEvaluationType.class, this);
    }
    public EvaluationType(Context ctx)
    {
        super(ctx);
        registerInterface(IEvaluationType.class, this);
    }
    ...
    private EvaluationTypeController getController() throws BOSException
    {
        return (EvaluationTypeController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getEvaluationTypeInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getEvaluationTypeInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getEvaluationTypeInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getEvaluationTypeCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getEvaluationTypeCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getEvaluationTypeCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
