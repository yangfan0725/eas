 ...
 * output class name
 */
public abstract class AbstractPayContentTypeEditUI extends com.kingdee.eas.framework.client.TreeEditUI
{
    ...
    protected com.kingdee.bos.ctrl.swing.KDLabelContainer contPayOaTId;
    protected com.kingdee.bos.ctrl.swing.KDLabelContainer contWtOaTId;
    ...
    protected com.kingdee.bos.ctrl.swing.KDTextField txtPayOaTId;
    protected com.kingdee.bos.ctrl.swing.KDTextField txtWtOaTId;
    protected com.kingdee.eas.fdc.contract.PayContentTypeInfo editData = null;
    /**
    ...
    private void jbInit() throws Exception
    {
        ...
        this.contPayOaTId = new com.kingdee.bos.ctrl.swing.KDLabelContainer();
        this.contWtOaTId = new com.kingdee.bos.ctrl.swing.KDLabelContainer();
        ...
        this.txtPayOaTId = new com.kingdee.bos.ctrl.swing.KDTextField();
        this.txtWtOaTId = new com.kingdee.bos.ctrl.swing.KDTextField();
        ...
        this.contPayOaTId.setName("contPayOaTId");
        this.contWtOaTId.setName("contWtOaTId");
        this.bizName.setName("bizName");
        this.txtLongNumber.setName("txtLongNumber");
        this.txtPayOaTId.setName("txtPayOaTId");
        this.txtWtOaTId.setName("txtWtOaTId");
        // CoreUI		
        ...
        // contPayOaTId		
        this.contPayOaTId.setBoundLabelText(resHelper.getString("contPayOaTId.boundLabelText"));		
        this.contPayOaTId.setBoundLabelLength(100);		
        this.contPayOaTId.setBoundLabelUnderline(true);
        // contWtOaTId		
        this.contWtOaTId.setBoundLabelText(resHelper.getString("contWtOaTId.boundLabelText"));		
        this.contWtOaTId.setBoundLabelLength(100);		
        this.contWtOaTId.setBoundLabelUnderline(true);
        // bizName		
    ...
    public void initUIContentLayout()
    {
        ...
        kDLabel1.setBounds(new Rectangle(10, 126, 100, 19));
        this.add(kDLabel1, null);
        bizDescription.setBounds(new Rectangle(10, 151, 270, 77));
        this.add(bizDescription, null);
        contPayOaTId.setBounds(new Rectangle(10, 72, 270, 19));
        this.add(contPayOaTId, null);
        contWtOaTId.setBounds(new Rectangle(10, 104, 270, 19));
        this.add(contWtOaTId, null);
        //contName
        contName.setBoundEditor(bizName);
        //contLongNumber
        contLongNumber.setBoundEditor(txtLongNumber);
        //contPayOaTId
        contPayOaTId.setBoundEditor(txtPayOaTId);
        //contWtOaTId
        contWtOaTId.setBoundEditor(txtWtOaTId);
	...
	private void registerBindings(){
		...
		dataBinder.registerBinding("payOaTId", String.class, this.txtPayOaTId, "text");
		dataBinder.registerBinding("wtOaTId", String.class, this.txtWtOaTId, "text");		
	}
	//Regiester UI State
	private void registerUIState(){		
	}
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.contract.app.PayContentTypeEditUIHandler";
	}
    ...
    public void setDataObject(IObjectValue dataObject)
    {
        ...
        this.editData = (com.kingdee.eas.fdc.contract.PayContentTypeInfo)ov;
    }
	...
	protected void registerValidator() {
		...
		getValidateHelper().registerBindProperty("payOaTId", ValidateHelper.ON_SAVE);    
		getValidateHelper().registerBindProperty("wtOaTId", ValidateHelper.ON_SAVE);    		
	}
    ...
    public SelectorItemCollection getSelectors()
    {
        ...
        sic.add(new SelectorItemInfo("payOaTId"));
        sic.add(new SelectorItemInfo("wtOaTId"));
        return sic;
    }        
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.contract.client", "PayContentTypeEditUI");
    }
