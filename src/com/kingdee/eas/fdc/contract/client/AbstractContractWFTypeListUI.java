 ...
 * output class name
 */
public abstract class AbstractContractWFTypeListUI extends com.kingdee.eas.framework.client.TreeListUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractContractWFTypeListUI.class);
     ...
     */
    public AbstractContractWFTypeListUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractContractWFTypeListUI.class.getName());
        this.setUITitle(resHelper.getString("this.title"));
        mainQueryPK = new MetaDataPK("com.kingdee.eas.fdc.contract.app", "ContractWFQuery");
        //actionMoveTree
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.contract.app.ContractWFTypeListUIHandler";
	}
    ...
    protected class ActionEnabled extends ItemAction {     
        ...
        public void actionPerformed(ActionEvent e)
        {
            ...
            innerActionPerformed("eas", AbstractContractWFTypeListUI.this, "ActionEnabled", "actionEnabled_actionPerformed", e);
        }
    }
    ...
    protected class ActionDisEnabled extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractContractWFTypeListUI.this, "ActionDisEnabled", "actionDisEnabled_actionPerformed", e);
        }
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.contract.client", "ContractWFTypeListUI");
    }
