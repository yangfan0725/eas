 ...
 * output class name
 */
public abstract class AbstractSettleWFTypeListUI extends com.kingdee.eas.framework.client.TreeListUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractSettleWFTypeListUI.class);
     ...
     */
    public AbstractSettleWFTypeListUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractSettleWFTypeListUI.class.getName());
        this.setUITitle(resHelper.getString("this.title"));
        mainQueryPK = new MetaDataPK("com.kingdee.eas.fdc.contract.app", "SettleWFTypeQuery");
        //actionMoveTree
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.contract.app.SettleWFTypeListUIHandler";
	}
    ...
    protected class ActionEnabled extends ItemAction {     
        ...
        public void actionPerformed(ActionEvent e)
        {
            ...
            innerActionPerformed("eas", AbstractSettleWFTypeListUI.this, "ActionEnabled", "actionEnabled_actionPerformed", e);
        }
    }
    ...
    protected class ActionDisEnabled extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractSettleWFTypeListUI.this, "ActionDisEnabled", "actionDisEnabled_actionPerformed", e);
        }
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.contract.client", "SettleWFTypeListUI");
    }
