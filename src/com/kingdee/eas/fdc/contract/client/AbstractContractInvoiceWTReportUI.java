 ...
 * output class name
 */
public abstract class AbstractContractInvoiceWTReportUI extends com.kingdee.eas.framework.report.client.CommRptBaseUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractContractInvoiceWTReportUI.class);
    ...
    protected com.kingdee.bos.ctrl.swing.KDWorkButton btnValid;
    /**
     * output class constructor
     */
    public AbstractContractInvoiceWTReportUI() throws Exception
    {
        super();
        jbInit();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractContractInvoiceWTReportUI.class.getName());
        ...
        this.btnValid = new com.kingdee.bos.ctrl.swing.KDWorkButton();
        this.kDSplitPane1.setName("kDSplitPane1");
        this.tblMain.setName("tblMain");
        this.kDTreeView1.setName("kDTreeView1");
        this.treeMain.setName("treeMain");
        this.btnValid.setName("btnValid");
        // CoreUI
        // kDSplitPane1		
        ...
        // btnValid		
        this.btnValid.setText(resHelper.getString("btnValid.text"));
        this.btnValid.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent e) {
                beforeActionPerformed(e);
                try {
                    btnValid_actionPerformed(e);
                } catch (Exception exc) {
                    handUIException(exc);
                } finally {
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.contract.app.ContractInvoiceWTReportUIHandler";
	}
    ...
    /**
     * output btnValid_actionPerformed method
     */
    protected void btnValid_actionPerformed(java.awt.event.ActionEvent e) throws Exception
    {
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.contract.client", "ContractInvoiceWTReportUI");
    }
