 ...
 * output class name
 */
public abstract class AbstractSettleWFTypeEditUI extends com.kingdee.eas.framework.client.TreeEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractSettleWFTypeEditUI.class);
    ...
    protected com.kingdee.eas.fdc.contract.SettleWFTypeInfo editData = null;
    /**
     * output class constructor
     */
    public AbstractSettleWFTypeEditUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractSettleWFTypeEditUI.class.getName());
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.contract.app.SettleWFTypeEditUIHandler";
	}
    ...
    public void setDataObject(IObjectValue dataObject)
    {
        ...
        this.editData = (com.kingdee.eas.fdc.contract.SettleWFTypeInfo)ov;
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.contract.client", "SettleWFTypeEditUI");
    }
