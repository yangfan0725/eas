 ...
 * output class name
 */
public class BankNumEditUI extends AbstractBankNumEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(BankNumEditUI.class);
    
    /**
     * output class constructor
     */
    public BankNumEditUI() throws Exception
    {
        super();
    }
	...
	protected IObjectValue createNewData() {
		BankNumInfo info=new BankNumInfo();
