 ...
 * output class name
 */
public abstract class AbstractContractEvaluationListUI extends com.kingdee.eas.fdc.contract.client.ContractListBaseUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractContractEvaluationListUI.class);
     ...
     */
    public AbstractContractEvaluationListUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractContractEvaluationListUI.class.getName());
    ...
    public void initUIContentLayout()
    {
        ...
        pnlSplit.setBounds(new Rectangle(10, 8, 993, 614));
        this.add(pnlSplit, new KDLayout.Constraints(10, 8, 993, 614, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_BOTTOM | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT));
        ...
        pnlLeftTree.putClientProperty("OriginalBounds", new Rectangle(0, 0, 249, 613));        kDSplitPane1.setBounds(new Rectangle(-1, 3, 250, 606));
...
contContrType.getContentPane().setLayout(new BorderLayout(0, 0));        contContrType.getContentPane().add(kDScrollPane2, BorderLayout.CENTER);
        ...
        pnlRight.putClientProperty("OriginalBounds", new Rectangle(0, 0, 732, 613));        kDSplitPane2.setBounds(new Rectangle(0, 1, 733, 608));
...
contBillList.getContentPane().setLayout(new BorderLayout(0, 0));        contBillList.getContentPane().add(tblPayRequestBill, BorderLayout.CENTER);
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.contract.app.ContractEvaluationListUIHandler";
	}
    ...
    protected class ActionModify extends ItemAction {     
        ...
        public void actionPerformed(ActionEvent e)
        {
            ...
            innerActionPerformed("eas", AbstractContractEvaluationListUI.this, "ActionModify", "actionModify_actionPerformed", e);
        }
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.contract.client", "ContractEvaluationListUI");
    }
    /**
