 ...
 * output class name
 */
public class ThirdPartyExpenseBillListUI extends AbstractThirdPartyExpenseBillListUI
{
    private static final Logger logger = CoreUIObject.getLogger(ThirdPartyExpenseBillListUI.class);
    
    public ThirdPartyExpenseBillListUI() throws Exception
    {
        super();
    }
    @Override
	...
	protected String getEditUIName() {
		// TODO Auto-generated method stub
		return ThirdPartyExpenseBillEditUI.class.getName();
	}
	...
	public void actionAudit_actionPerformed(ActionEvent e) throws Exception {
		...
		for(int i = 0; i < id.size(); i++){
			...
			ThirdPartyExpenseBillFactory.getRemoteInstance().audit(BOSUuid.read(id.get(i).toString()));
		}
	...
	public void actionUnAudit_actionPerformed(ActionEvent e) throws Exception {
		...
		for(int i = 0; i < id.size(); i++){
			...
			ThirdPartyExpenseBillFactory.getRemoteInstance().unAudit(BOSUuid.read(id.get(i).toString()));
		}
		FDCClientUtils.showOprtOK(this);
		this.refresh(null);
	}
	 public void checkBeforeAuditOrUnAudit(FDCBillStateEnum state,
		...
		ThirdPartyExpenseBillInfo info = ThirdPartyExpenseBillFactory
				.getRemoteInstance().getThirdPartyExpenseBillInfo(
	 ...
	 public void actionEdit_actionPerformed(ActionEvent e) throws Exception {
		...
		protected void checkBeforeEditOrRemove(String warning,String id) throws EASBizException, BOSException, Exception {
			...
			sels.add("state");
			sels.add("creator.id");
			ThirdPartyExpenseBillInfo info=(ThirdPartyExpenseBillInfo)getBizInterface().getValue(new ObjectUuidPK(id),sels);
