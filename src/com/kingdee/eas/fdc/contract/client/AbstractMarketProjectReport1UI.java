 ...
 * output class name
 */
public abstract class AbstractMarketProjectReport1UI extends com.kingdee.eas.framework.report.client.CommRptBaseUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractMarketProjectReport1UI.class);
     ...
     */
    public AbstractMarketProjectReport1UI() throws Exception
    {
        super();
        jbInit();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractMarketProjectReport1UI.class.getName());
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.contract.app.MarketProjectReport1UIHandler";
	}
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.contract.client", "MarketProjectReport1UI");
    }
