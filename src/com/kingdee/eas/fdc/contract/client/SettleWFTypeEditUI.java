 ...
 * output class name
 */
public class SettleWFTypeEditUI extends AbstractSettleWFTypeEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(SettleWFTypeEditUI.class);
    public SettleWFTypeEditUI() throws Exception
    {
        super();
    }
    private SettleWFTypeInfo parentInfo;
	...
	public void loadFields() {
		super.loadFields();
		parentInfo = (SettleWFTypeInfo) getUIContext().get(UIContext.PARENTNODE);
...
//			FDCBaseTypeValidator.validate(((SettleWFTypeListUI) getUIContext().get(UIContext.OWNER)).getMainTable(), txtLongNumber, bizName, getSelectBOID());
	...
	public void onLoad() throws Exception {
		...
		txtLongNumber.addKeyListener(new KeyListener() {
			...
			public void keyReleased(KeyEvent e) {
				SettleWFTypeInfo parent = (SettleWFTypeInfo) getUIContext().get(UIContext.PARENTNODE);
	...
	protected void initOldData(IObjectValue dataObject) {
		...
		if (getUIContext().get(UIContext.PARENTNODE) != null) {
			if ((STATUS_ADDNEW.equals(getOprtState()))) {// 新增状态
				...
				strTemp = strTemp.replace('!', '.');
				((SettleWFTypeInfo) dataObject).setLongNumber(strTemp + ".");
			} else if (STATUS_EDIT.equals(getOprtState())) {
				String strTemp = ((SettleWFTypeInfo) dataObject).getLongNumber();
				strTemp = strTemp.replace('!', '.');
				((SettleWFTypeInfo) dataObject).setLongNumber(strTemp);
			}
		}
	...
	public void actionCancel_actionPerformed(ActionEvent e) throws Exception {
		if (this.editData != null && this.editData.getId() != null) {
			...
			if (((ISettleWFType) getBizInterface()).disEnabled(pk)) {
	...
	public void actionCancelCancel_actionPerformed(ActionEvent e) throws Exception {
		if (this.editData != null && this.editData.getId() != null) {
			IObjectPK pk = new ObjectStringPK(this.editData.getId().toString());
			if (((ISettleWFType) getBizInterface()).enabled(pk)) {
