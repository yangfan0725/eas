 ...
 * output class name
 */
public abstract class AbstractContractInvoiceReportFilterUI extends com.kingdee.eas.framework.report.client.CommRptBaseConditionUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractContractInvoiceReportFilterUI.class);
    protected com.kingdee.bos.ctrl.swing.KDLabelContainer kDLabelContainer1;
    protected com.kingdee.bos.ctrl.swing.KDLabelContainer kDLabelContainer2;
    protected com.kingdee.bos.ctrl.swing.KDLabelContainer contInvoiceType;
    protected com.kingdee.bos.ctrl.swing.KDLabelContainer contSaleBuyName;
    ...
    protected com.kingdee.bos.ctrl.swing.KDTextField txtSaleBuyName;
    /**
     * output class constructor
     */
    public AbstractContractInvoiceReportFilterUI() throws Exception
    {
        super();
        jbInit();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractContractInvoiceReportFilterUI.class.getName());
        this.setUITitle(resHelper.getString("this.title"));
        this.kDLabelContainer1 = new com.kingdee.bos.ctrl.swing.KDLabelContainer();
        this.kDLabelContainer2 = new com.kingdee.bos.ctrl.swing.KDLabelContainer();
        this.contInvoiceType = new com.kingdee.bos.ctrl.swing.KDLabelContainer();
        this.contSaleBuyName = new com.kingdee.bos.ctrl.swing.KDLabelContainer();
        ...
        // contSaleBuyName		
        this.contSaleBuyName.setBoundLabelText(resHelper.getString("contSaleBuyName.boundLabelText"));		
        this.contSaleBuyName.setBoundLabelLength(100);		
        this.contSaleBuyName.setBoundLabelUnderline(true);
        // pkFromDate
        // pkToDate
        // cbInvoiceType		
    ...
    public void initUIContentLayout()
    {
        ...
        contSaleBuyName.setBounds(new Rectangle(312, 53, 270, 19));
        this.add(contSaleBuyName, null);
        //kDLabelContainer1
        ...
        //contSaleBuyName
        contSaleBuyName.setBoundEditor(txtSaleBuyName);
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.contract.app.ContractInvoiceReportFilterUIHandler";
	}
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.contract.client", "ContractInvoiceReportFilterUI");
    }
