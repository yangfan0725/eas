 ...
 * output class name
 */
public abstract class AbstractContractRecBillListUI extends com.kingdee.eas.fdc.contract.client.ContractListBaseUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractContractRecBillListUI.class);
     ...
     */
    public AbstractContractRecBillListUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractContractRecBillListUI.class.getName());
...
contBillList.getContentPane().setLayout(new BorderLayout(0, 0));        contBillList.getContentPane().add(tblSettlementList, BorderLayout.CENTER);
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.contract.app.ContractRecBillListUIHandler";
	}
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.contract.client", "ContractRecBillListUI");
    }
    /**
