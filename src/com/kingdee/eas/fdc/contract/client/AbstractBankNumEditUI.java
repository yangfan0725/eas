 ...
 * output class name
 */
public abstract class AbstractBankNumEditUI extends com.kingdee.eas.fdc.basedata.client.FDCBaseDataEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractBankNumEditUI.class);
    ...
    protected com.kingdee.eas.fdc.contract.BankNumInfo editData = null;
    /**
     * output class constructor
     */
    public AbstractBankNumEditUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractBankNumEditUI.class.getName());
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.contract.app.BankNumEditUIHandler";
	}
    ...
    public void setDataObject(IObjectValue dataObject)
    {
        ...
        this.editData = (com.kingdee.eas.fdc.contract.BankNumInfo)ov;
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.contract.client", "BankNumEditUI");
    }
