 ...
 * output class name
 */
public abstract class AbstractContractBillReceiveLinkContractBillEditUI extends com.kingdee.eas.framework.client.CoreUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractContractBillReceiveLinkContractBillEditUI.class);
     ...
     */
    public AbstractContractBillReceiveLinkContractBillEditUI() throws Exception
    {
        super();
        jbInit();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractContractBillReceiveLinkContractBillEditUI.class.getName());
    ...
    public void initUIContentLayout()
    {
        ...
        this.setLayout(null);
        kDPanel1.setBounds(new Rectangle(4, 6, 665, 43));
        ...
        //kDPanel1
        kDPanel1.setLayout(null);        kDLabelContainer3.setBounds(new Rectangle(5, 40, 300, 20));
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.contract.app.ContractBillReceiveLinkContractBillEditUIHandler";
	}
    ...
    protected class ActionConfirm extends ItemAction {     
        ...
        public void actionPerformed(ActionEvent e)
        {
            ...
            innerActionPerformed("eas", AbstractContractBillReceiveLinkContractBillEditUI.this, "ActionConfirm", "actionConfirm_actionPerformed", e);
        }
    }
    ...
    protected class ActionCancel extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractContractBillReceiveLinkContractBillEditUI.this, "ActionCancel", "actionCancel_actionPerformed", e);
        }
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.contract.client", "ContractBillReceiveLinkContractBillEditUI");
    }
