 ...
 * output class name
 */
public abstract class AbstractRecommendTypeEditUI extends com.kingdee.eas.fdc.basedata.client.FDCBaseDataEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractRecommendTypeEditUI.class);
    ...
    protected com.kingdee.eas.fdc.contract.RecommendTypeInfo editData = null;
    /**
     * output class constructor
     */
    public AbstractRecommendTypeEditUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractRecommendTypeEditUI.class.getName());
        ...
        // prmtCostAccount		
        this.prmtCostAccount.setQueryInfo("com.kingdee.eas.fdc.basedata.app.F7CostAccountQuery");		
        this.prmtCostAccount.setCommitFormat("$longNumber$;$name$");		
        this.prmtCostAccount.setEditFormat("$longNumber$;$name$");		
        this.prmtCostAccount.setDisplayFormat("$longNumber$;$name$");		
        this.prmtCostAccount.setRequired(true);
    ...
    public void initUIContentLayout()
    {
        ...
        chkIsEnabled.setBounds(new Rectangle(235, 106, 140, 19));
        this.add(chkIsEnabled, null);
        kDLabel1.setBounds(new Rectangle(10, 106, 100, 19));
        this.add(kDLabel1, null);
        bizDescription.setBounds(new Rectangle(10, 130, 270, 40));
        this.add(bizDescription, null);
        contCostAccount.setBounds(new Rectangle(9, 72, 270, 19));
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.contract.app.RecommendTypeEditUIHandler";
	}
    ...
    public void setDataObject(IObjectValue dataObject)
    {
        ...
        this.editData = (com.kingdee.eas.fdc.contract.RecommendTypeInfo)ov;
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.contract.client", "RecommendTypeEditUI");
    }
    ...
    {
        return com.kingdee.eas.fdc.contract.RecommendTypeFactory.getRemoteInstance();
    }
