 ...
 * output class name
 */
public class MarketMonthProjectListUI extends AbstractMarketMonthProjectListUI
{
    private static final Logger logger = CoreUIObject.getLogger(MarketMonthProjectListUI.class);
	...
	protected static final String CANTREMOVE = "cantRemove";
     public MarketMonthProjectListUI() throws Exception
    {
        super();
    }
	...
	public void actionAudit_actionPerformed(ActionEvent e) throws Exception {
		...
		for(int i = 0; i < id.size(); i++){
			...
			if (!FDCBillStateEnum.SUBMITTED.equals(MarketMonthProjectFactory.getRemoteInstance().getMarketMonthProjectInfo(new ObjectUuidPK(id.get(i).toString())).getState())) {
	...
	public void actionUnAudit_actionPerformed(ActionEvent e) throws Exception {
		...
		for(int i = 0; i < id.size(); i++){
			FDCClientUtils.checkBillInWorkflow(this, id.get(i).toString());
			if (!FDCBillStateEnum.AUDITTED.equals(MarketMonthProjectFactory.getRemoteInstance().getMarketMonthProjectInfo(new ObjectUuidPK(id.get(i).toString())).getState())) {
	...
	protected String getEditUIName() {
		return MarketMonthProjectEditUI.class.getName();
	}
