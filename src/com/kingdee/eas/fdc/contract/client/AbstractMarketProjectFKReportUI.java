 ...
 * output class name
 */
public abstract class AbstractMarketProjectFKReportUI extends com.kingdee.eas.framework.report.client.CommRptBaseUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractMarketProjectFKReportUI.class);
     ...
     */
    public AbstractMarketProjectFKReportUI() throws Exception
    {
        super();
        jbInit();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractMarketProjectFKReportUI.class.getName());
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.contract.app.MarketProjectFKReportUIHandler";
	}
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.contract.client", "MarketProjectFKReportUI");
    }
