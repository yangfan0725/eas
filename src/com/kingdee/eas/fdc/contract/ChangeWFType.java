...
public class ChangeWFType extends FDCDataBase implements IChangeWFType
{
    public ChangeWFType()
    {
        super();
        registerInterface(IChangeWFType.class, this);
    }
    public ChangeWFType(Context ctx)
    {
        super(ctx);
        registerInterface(IChangeWFType.class, this);
    }
    ...
    private ChangeWFTypeController getController() throws BOSException
    {
        return (ChangeWFTypeController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getChangeWFTypeInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getChangeWFTypeInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getChangeWFTypeInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getChangeWFTypeCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getChangeWFTypeCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getChangeWFTypeCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
