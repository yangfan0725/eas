...
public class ContractRecBillEntry extends CoreBillEntryBase implements IContractRecBillEntry
{
    public ContractRecBillEntry()
    {
        super();
        registerInterface(IContractRecBillEntry.class, this);
    }
    public ContractRecBillEntry(Context ctx)
    {
        super(ctx);
        registerInterface(IContractRecBillEntry.class, this);
    }
    ...
    private ContractRecBillEntryController getController() throws BOSException
    {
        return (ContractRecBillEntryController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getContractRecBillEntryInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getContractRecBillEntryInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getContractRecBillEntryInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getContractRecBillEntryCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getContractRecBillEntryCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getContractRecBillEntryCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
