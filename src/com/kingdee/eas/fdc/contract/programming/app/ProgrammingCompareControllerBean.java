...
public class ProgrammingCompareControllerBean extends AbstractProgrammingCompareControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.fdc.contract.programming.app.ProgrammingCompareControllerBean");
}