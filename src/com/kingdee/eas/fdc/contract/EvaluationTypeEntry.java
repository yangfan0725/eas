...
public class EvaluationTypeEntry extends CoreBillEntryBase implements IEvaluationTypeEntry
{
    public EvaluationTypeEntry()
    {
        super();
        registerInterface(IEvaluationTypeEntry.class, this);
    }
    public EvaluationTypeEntry(Context ctx)
    {
        super(ctx);
        registerInterface(IEvaluationTypeEntry.class, this);
    }
    ...
    private EvaluationTypeEntryController getController() throws BOSException
    {
        return (EvaluationTypeEntryController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getEvaluationTypeEntryInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getEvaluationTypeEntryInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getEvaluationTypeEntryInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getEvaluationTypeEntryCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getEvaluationTypeEntryCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getEvaluationTypeEntryCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
