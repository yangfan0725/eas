...
public class AbstractChangeAuditBillInfo extends com.kingdee.eas.fdc.basedata.FDCBillInfo implements Serializable 
{
    ...
    /**
     * Object:变更审批单's 是否已执行property 
     */
    public boolean isIsAlreadyExecuted()
    {
        return getBoolean("isAlreadyExecuted");
    }
    public void setIsAlreadyExecuted(boolean item)
    {
        setBoolean("isAlreadyExecuted", item);
    }
    /**
     * Object:变更审批单's 施工方报审金额汇总property 
     */
    public java.math.BigDecimal getTotalConstructPrice()
    {
        return getBigDecimal("totalConstructPrice");
    }
    public void setTotalConstructPrice(java.math.BigDecimal item)
    {
        setBigDecimal("totalConstructPrice", item);
    }
    /**
     * Object:变更审批单's oa职位property 
     */
