...
public class ZHMarketProjectEntry extends CoreBillEntryBase implements IZHMarketProjectEntry
{
    public ZHMarketProjectEntry()
    {
        super();
        registerInterface(IZHMarketProjectEntry.class, this);
    }
    public ZHMarketProjectEntry(Context ctx)
    {
        super(ctx);
        registerInterface(IZHMarketProjectEntry.class, this);
    }
    ...
    private ZHMarketProjectEntryController getController() throws BOSException
    {
        return (ZHMarketProjectEntryController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getZHMarketProjectEntryInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getZHMarketProjectEntryInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getZHMarketProjectEntryInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getZHMarketProjectEntryCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getZHMarketProjectEntryCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getZHMarketProjectEntryCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
