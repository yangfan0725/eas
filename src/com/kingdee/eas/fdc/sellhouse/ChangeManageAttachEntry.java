...
public class ChangeManageAttachEntry extends CoreBillEntryBase implements IChangeManageAttachEntry
{
    public ChangeManageAttachEntry()
    {
        super();
        registerInterface(IChangeManageAttachEntry.class, this);
    }
    public ChangeManageAttachEntry(Context ctx)
    {
        super(ctx);
        registerInterface(IChangeManageAttachEntry.class, this);
    }
    ...
    private ChangeManageAttachEntryController getController() throws BOSException
    {
        return (ChangeManageAttachEntryController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getChangeManageAttachEntryInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getChangeManageAttachEntryInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getChangeManageAttachEntryInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getChangeManageAttachEntryCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getChangeManageAttachEntryCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getChangeManageAttachEntryCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
