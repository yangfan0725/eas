...
public class NoTradingSellBillEntry extends CoreBillEntryBase implements INoTradingSellBillEntry
{
    public NoTradingSellBillEntry()
    {
        super();
        registerInterface(INoTradingSellBillEntry.class, this);
    }
    public NoTradingSellBillEntry(Context ctx)
    {
        super(ctx);
        registerInterface(INoTradingSellBillEntry.class, this);
    }
    ...
    private NoTradingSellBillEntryController getController() throws BOSException
    {
        return (NoTradingSellBillEntryController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getNoTradingSellBillEntryInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getNoTradingSellBillEntryInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getNoTradingSellBillEntryInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getNoTradingSellBillEntryCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getNoTradingSellBillEntryCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getNoTradingSellBillEntryCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
