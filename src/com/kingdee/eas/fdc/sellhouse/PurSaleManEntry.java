...
public class PurSaleManEntry extends TranSaleManEntry implements IPurSaleManEntry
{
    public PurSaleManEntry()
    {
        super();
        registerInterface(IPurSaleManEntry.class, this);
    }
    public PurSaleManEntry(Context ctx)
    {
        super(ctx);
        registerInterface(IPurSaleManEntry.class, this);
    }
    ...
    private PurSaleManEntryController getController() throws BOSException
    {
        return (PurSaleManEntryController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getPurSaleManEntryInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getPurSaleManEntryInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getPurSaleManEntryInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getPurSaleManEntryCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getPurSaleManEntryCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getPurSaleManEntryCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
