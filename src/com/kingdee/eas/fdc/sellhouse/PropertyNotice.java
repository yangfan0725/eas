...
public class PropertyNotice extends BillBase implements IPropertyNotice
{
    public PropertyNotice()
    {
        super();
        registerInterface(IPropertyNotice.class, this);
    }
    public PropertyNotice(Context ctx)
    {
        super(ctx);
        registerInterface(IPropertyNotice.class, this);
    }
    ...
    private PropertyNoticeController getController() throws BOSException
    {
        return (PropertyNoticeController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getPropertyNoticeInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getPropertyNoticeInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getPropertyNoticeInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getPropertyNoticeCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getPropertyNoticeCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getPropertyNoticeCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
