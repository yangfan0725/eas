...
public class PropertyDoSchemeEntry extends BillEntryBase implements IPropertyDoSchemeEntry
{
    public PropertyDoSchemeEntry()
    {
        super();
        registerInterface(IPropertyDoSchemeEntry.class, this);
    }
    public PropertyDoSchemeEntry(Context ctx)
    {
        super(ctx);
        registerInterface(IPropertyDoSchemeEntry.class, this);
    }
    ...
    private PropertyDoSchemeEntryController getController() throws BOSException
    {
        return (PropertyDoSchemeEntryController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getPropertyDoSchemeEntryInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getPropertyDoSchemeEntryInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getPropertyDoSchemeEntryInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getPropertyDoSchemeEntryCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getPropertyDoSchemeEntryCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getPropertyDoSchemeEntryCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
