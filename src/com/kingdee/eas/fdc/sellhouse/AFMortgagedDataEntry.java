...
public class AFMortgagedDataEntry extends BillEntryBase implements IAFMortgagedDataEntry
{
    public AFMortgagedDataEntry()
    {
        super();
        registerInterface(IAFMortgagedDataEntry.class, this);
    }
    public AFMortgagedDataEntry(Context ctx)
    {
        super(ctx);
        registerInterface(IAFMortgagedDataEntry.class, this);
    }
    ...
    private AFMortgagedDataEntryController getController() throws BOSException
    {
        return (AFMortgagedDataEntryController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getAFMortgagedDataEntryInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getAFMortgagedDataEntryInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getAFMortgagedDataEntryInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getAFMortgagedDataEntryCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getAFMortgagedDataEntryCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getAFMortgagedDataEntryCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
