...
public class WebMarkFunction extends CoreBase implements IWebMarkFunction
{
    public WebMarkFunction()
    {
        super();
        registerInterface(IWebMarkFunction.class, this);
    }
    public WebMarkFunction(Context ctx)
    {
        super(ctx);
        registerInterface(IWebMarkFunction.class, this);
    }
    ...
    private WebMarkFunctionController getController() throws BOSException
    {
        return (WebMarkFunctionController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getWebMarkFunctionInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getWebMarkFunctionInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getWebMarkFunctionInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getWebMarkFunctionCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getWebMarkFunctionCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getWebMarkFunctionCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
