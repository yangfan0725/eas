...
public class MonthCommissionEntry extends CoreBillEntryBase implements IMonthCommissionEntry
{
    public MonthCommissionEntry()
    {
        super();
        registerInterface(IMonthCommissionEntry.class, this);
    }
    public MonthCommissionEntry(Context ctx)
    {
        super(ctx);
        registerInterface(IMonthCommissionEntry.class, this);
    }
    ...
    private MonthCommissionEntryController getController() throws BOSException
    {
        return (MonthCommissionEntryController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getMonthCommissionEntryInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getMonthCommissionEntryInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getMonthCommissionEntryInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getMonthCommissionEntryCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getMonthCommissionEntryCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getMonthCommissionEntryCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
