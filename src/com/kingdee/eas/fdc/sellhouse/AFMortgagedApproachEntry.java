...
public class AFMortgagedApproachEntry extends BillEntryBase implements IAFMortgagedApproachEntry
{
    public AFMortgagedApproachEntry()
    {
        super();
        registerInterface(IAFMortgagedApproachEntry.class, this);
    }
    public AFMortgagedApproachEntry(Context ctx)
    {
        super(ctx);
        registerInterface(IAFMortgagedApproachEntry.class, this);
    }
    ...
    private AFMortgagedApproachEntryController getController() throws BOSException
    {
        return (AFMortgagedApproachEntryController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getAFMortgagedApproachEntryInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getAFMortgagedApproachEntryInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getAFMortgagedApproachEntryInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getAFMortgagedApproachEntryCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getAFMortgagedApproachEntryCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getAFMortgagedApproachEntryCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
