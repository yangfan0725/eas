...
public class CustomerBusinessScopeEntry extends AbstractBizCtrl implements ICustomerBusinessScopeEntry
{
    public CustomerBusinessScopeEntry()
    {
        super();
        registerInterface(ICustomerBusinessScopeEntry.class, this);
    }
    public CustomerBusinessScopeEntry(Context ctx)
    {
        super(ctx);
        registerInterface(ICustomerBusinessScopeEntry.class, this);
    }
    ...
    private CustomerBusinessScopeEntryController getController() throws BOSException
    {
        return (CustomerBusinessScopeEntryController)getBizController();
    }
    /**
