...
public class AfterService extends CoreBillBase implements IAfterService
{
    public AfterService()
    {
        super();
        registerInterface(IAfterService.class, this);
    }
    public AfterService(Context ctx)
    {
        super(ctx);
        registerInterface(IAfterService.class, this);
    }
    ...
    private AfterServiceController getController() throws BOSException
    {
        return (AfterServiceController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getAfterServiceInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getAfterServiceInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getAfterServiceInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getAfterServiceCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getAfterServiceCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getAfterServiceCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
