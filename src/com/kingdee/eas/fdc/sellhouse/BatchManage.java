...
public class BatchManage extends FDCBill implements IBatchManage
{
    public BatchManage()
    {
        super();
        registerInterface(IBatchManage.class, this);
    }
    public BatchManage(Context ctx)
    {
        super(ctx);
        registerInterface(IBatchManage.class, this);
    }
    ...
    private BatchManageController getController() throws BOSException
    {
        return (BatchManageController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getBatchManageInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getBatchManageInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getBatchManageCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getBatchManageCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
