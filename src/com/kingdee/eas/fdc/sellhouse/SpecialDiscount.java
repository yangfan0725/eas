...
public class SpecialDiscount extends CoreBillBase implements ISpecialDiscount
{
    public SpecialDiscount()
    {
        super();
        registerInterface(ISpecialDiscount.class, this);
    }
    public SpecialDiscount(Context ctx)
    {
        super(ctx);
        registerInterface(ISpecialDiscount.class, this);
    }
    ...
    private SpecialDiscountController getController() throws BOSException
    {
        return (SpecialDiscountController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getSpecialDiscountCollection(getContext());
        }
    ...
    {
        try {
            return getController().getSpecialDiscountCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getSpecialDiscountCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getSpecialDiscountInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getSpecialDiscountInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getSpecialDiscountInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
