...
public class ChangeAgioEntry extends AgioEntry implements IChangeAgioEntry
{
    public ChangeAgioEntry()
    {
        super();
        registerInterface(IChangeAgioEntry.class, this);
    }
    public ChangeAgioEntry(Context ctx)
    {
        super(ctx);
        registerInterface(IChangeAgioEntry.class, this);
    }
    ...
    private ChangeAgioEntryController getController() throws BOSException
    {
        return (ChangeAgioEntryController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getChangeAgioEntryInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getChangeAgioEntryInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getChangeAgioEntryInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getChangeAgioEntryCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getChangeAgioEntryCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getChangeAgioEntryCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
