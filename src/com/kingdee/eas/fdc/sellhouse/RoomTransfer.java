...
public class RoomTransfer extends FDCBill implements IRoomTransfer
{
    public RoomTransfer()
    {
        super();
        registerInterface(IRoomTransfer.class, this);
    }
    public RoomTransfer(Context ctx)
    {
        super(ctx);
        registerInterface(IRoomTransfer.class, this);
    }
    ...
    private RoomTransferController getController() throws BOSException
    {
        return (RoomTransferController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getRoomTransferInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getRoomTransferInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getRoomTransferInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getRoomTransferCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getRoomTransferCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getRoomTransferCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            getController().transfer(getContext(), value);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
