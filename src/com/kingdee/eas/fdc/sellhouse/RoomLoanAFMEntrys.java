...
public class RoomLoanAFMEntrys extends BillEntryBase implements IRoomLoanAFMEntrys
{
    public RoomLoanAFMEntrys()
    {
        super();
        registerInterface(IRoomLoanAFMEntrys.class, this);
    }
    public RoomLoanAFMEntrys(Context ctx)
    {
        super(ctx);
        registerInterface(IRoomLoanAFMEntrys.class, this);
    }
    ...
    private RoomLoanAFMEntrysController getController() throws BOSException
    {
        return (RoomLoanAFMEntrysController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getRoomLoanAFMEntrysInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getRoomLoanAFMEntrysInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getRoomLoanAFMEntrysInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getRoomLoanAFMEntrysCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getRoomLoanAFMEntrysCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getRoomLoanAFMEntrysCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
