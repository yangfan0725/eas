...
public class SHEAttachBillEntry extends CoreBillEntryBase implements ISHEAttachBillEntry
{
    public SHEAttachBillEntry()
    {
        super();
        registerInterface(ISHEAttachBillEntry.class, this);
    }
    public SHEAttachBillEntry(Context ctx)
    {
        super(ctx);
        registerInterface(ISHEAttachBillEntry.class, this);
    }
    ...
    private SHEAttachBillEntryController getController() throws BOSException
    {
        return (SHEAttachBillEntryController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getSHEAttachBillEntryInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getSHEAttachBillEntryInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getSHEAttachBillEntryInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getSHEAttachBillEntryCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getSHEAttachBillEntryCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getSHEAttachBillEntryCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
