...
public class EffectImage extends FDCBill implements IEffectImage
{
    public EffectImage()
    {
        super();
        registerInterface(IEffectImage.class, this);
    }
    public EffectImage(Context ctx)
    {
        super(ctx);
        registerInterface(IEffectImage.class, this);
    }
    ...
    private EffectImageController getController() throws BOSException
    {
        return (EffectImageController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getEffectImageInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getEffectImageInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getEffectImageInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getEffectImageCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getEffectImageCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getEffectImageCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
