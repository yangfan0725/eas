...
public class DefaultAmountManger extends FDCBill implements IDefaultAmountManger
{
    public DefaultAmountManger()
    {
        super();
        registerInterface(IDefaultAmountManger.class, this);
    }
    public DefaultAmountManger(Context ctx)
    {
        super(ctx);
        registerInterface(IDefaultAmountManger.class, this);
    }
    ...
    private DefaultAmountMangerController getController() throws BOSException
    {
        return (DefaultAmountMangerController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getDefaultAmountMangerInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getDefaultAmountMangerInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getDefaultAmountMangerInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getDefaultAmountMangerCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getDefaultAmountMangerCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getDefaultAmountMangerCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
