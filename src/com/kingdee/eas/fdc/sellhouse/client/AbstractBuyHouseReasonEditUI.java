 ...
 * output class name
 */
public abstract class AbstractBuyHouseReasonEditUI extends com.kingdee.eas.fdc.basedata.client.FDCBaseDataEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractBuyHouseReasonEditUI.class);
    ...
    protected com.kingdee.eas.fdc.sellhouse.BuyHouseReasonInfo editData = null;
    /**
     * output class constructor
     */
    public AbstractBuyHouseReasonEditUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractBuyHouseReasonEditUI.class.getName());
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.sellhouse.app.BuyHouseReasonEditUIHandler";
	}
    ...
    public void setDataObject(IObjectValue dataObject)
    {
        ...
        this.editData = (com.kingdee.eas.fdc.sellhouse.BuyHouseReasonInfo)ov;
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.sellhouse.client", "BuyHouseReasonEditUI");
    }
