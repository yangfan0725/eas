 ...
 * output class name
 */
public abstract class AbstractMackOutInvoiceUI extends com.kingdee.eas.framework.client.CoreUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractMackOutInvoiceUI.class);
     ...
     */
    public AbstractMackOutInvoiceUI() throws Exception
    {
        super();
        jbInit();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractMackOutInvoiceUI.class.getName());
        ...
        // prmtNewInvoice		
        this.prmtNewInvoice.setQueryInfo("com.kingdee.eas.fdc.sellhouse.app.ChequeQuery");		
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.sellhouse.app.MackOutInvoiceUIHandler";
	}
    ...
    protected class ActionConfirm extends ItemAction {     
        ...
        public void actionPerformed(ActionEvent e)
        {
            ...
            innerActionPerformed("eas", AbstractMackOutInvoiceUI.this, "ActionConfirm", "actionConfirm_actionPerformed", e);
        }
    }
    ...
    protected class ActionCancel extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractMackOutInvoiceUI.this, "ActionCancel", "actionCancel_actionPerformed", e);
        }
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.sellhouse.client", "MackOutInvoiceUI");
    }
