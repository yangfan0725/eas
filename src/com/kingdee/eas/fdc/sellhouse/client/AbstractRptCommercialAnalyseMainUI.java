 ...
 * output class name
 */
public abstract class AbstractRptCommercialAnalyseMainUI extends com.kingdee.eas.framework.bireport.client.BireportBaseMainUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractRptCommercialAnalyseMainUI.class);
    protected com.kingdee.bos.ctrl.kdf.table.KDTable kDTable1;
    /**
     * output class constructor
     */
    public AbstractRptCommercialAnalyseMainUI() throws Exception
    {
        super();
        jbInit();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractRptCommercialAnalyseMainUI.class.getName());
    ...
    public void initUIContentLayout()
    {
        ...
        kDTable1.setBounds(new Rectangle(6, 39, 1002, 583));
        this.add(kDTable1, new KDLayout.Constraints(6, 39, 1002, 583, 0));
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.sellhouse.app.RptCommercialAnalyseMainUIHandler";
	}
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.sellhouse.client", "RptCommercialAnalyseMainUI");
    }
