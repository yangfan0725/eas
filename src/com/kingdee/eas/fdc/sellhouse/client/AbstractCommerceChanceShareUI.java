 ...
 * output class name
 */
public abstract class AbstractCommerceChanceShareUI extends com.kingdee.eas.framework.client.EditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractCommerceChanceShareUI.class);
     ...
     */
    public AbstractCommerceChanceShareUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractCommerceChanceShareUI.class.getName());
    ...
    {
        this.setBounds(new Rectangle(10, 10, 450, 250));
        this.setLayout(null);
        kDLabelContainer1.setBounds(new Rectangle(92, 65, 270, 19));
        this.add(kDLabelContainer1, null);
        btnConfirm.setBounds(new Rectangle(114, 161, 85, 25));
        this.add(btnConfirm, null);
        btnQuit.setBounds(new Rectangle(237, 161, 85, 25));
        this.add(btnQuit, null);
        //kDLabelContainer1
        kDLabelContainer1.setBoundEditor(prmtSaleMan);
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.sellhouse.app.CommerceChanceShareUIHandler";
	}
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.sellhouse.client", "CommerceChanceShareUI");
    }
