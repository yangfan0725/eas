 ...
 * output class name
 */
public abstract class AbstractSellProjectEditEndDateUI extends com.kingdee.eas.framework.client.CoreUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractSellProjectEditEndDateUI.class);
     ...
     */
    public AbstractSellProjectEditEndDateUI() throws Exception
    {
        super();
        jbInit();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractSellProjectEditEndDateUI.class.getName());
    ...
    public void initUIContentLayout()
    {
        ...
        contAuditDate.setBounds(new Rectangle(41, 29, 223, 19));
        this.add(contAuditDate, null);
        //contAuditDate
        contAuditDate.setBoundEditor(pkEndDate);
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.sellhouse.app.SellProjectEditEndDateUIHandler";
	}
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.sellhouse.client", "SellProjectEditEndDateUI");
    }
