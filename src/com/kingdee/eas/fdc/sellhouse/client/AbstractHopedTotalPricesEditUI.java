 ...
 * output class name
 */
public abstract class AbstractHopedTotalPricesEditUI extends com.kingdee.eas.fdc.basedata.client.FDCBaseDataEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractHopedTotalPricesEditUI.class);
    ...
    protected com.kingdee.eas.fdc.sellhouse.HopedTotalPricesInfo editData = null;
    /**
     * output class constructor
     */
    public AbstractHopedTotalPricesEditUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractHopedTotalPricesEditUI.class.getName());
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.sellhouse.app.HopedTotalPricesEditUIHandler";
	}
    ...
    public void setDataObject(IObjectValue dataObject)
    {
        ...
        this.editData = (com.kingdee.eas.fdc.sellhouse.HopedTotalPricesInfo)ov;
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.sellhouse.client", "HopedTotalPricesEditUI");
    }
