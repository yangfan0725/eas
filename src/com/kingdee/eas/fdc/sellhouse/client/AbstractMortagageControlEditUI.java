 ...
 * output class name
 */
public abstract class AbstractMortagageControlEditUI extends com.kingdee.eas.fdc.basedata.client.FDCBillEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractMortagageControlEditUI.class);
    ...
    protected com.kingdee.bos.ctrl.swing.KDCheckBox chkIsSell;
    protected com.kingdee.bos.ctrl.swing.KDLabelContainer contDescription;
    protected com.kingdee.bos.ctrl.swing.KDTextField txtNumber;
    protected com.kingdee.bos.ctrl.extendcontrols.KDBizPromptBox prmtRoomEntry;
    ...
    protected com.kingdee.eas.fdc.sellhouse.MortagageControlInfo editData = null;
    protected ActionAntiMortagage actionAntiMortagage = null;
    /**
     * output class constructor
     */
    public AbstractMortagageControlEditUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractMortagageControlEditUI.class.getName());
        ...
        this.chkIsSell = new com.kingdee.bos.ctrl.swing.KDCheckBox();
        this.contDescription = new com.kingdee.bos.ctrl.swing.KDLabelContainer();
        this.txtNumber = new com.kingdee.bos.ctrl.swing.KDTextField();
        this.prmtRoomEntry = new com.kingdee.bos.ctrl.extendcontrols.KDBizPromptBox();
        ...
        this.chkIsSell.setName("chkIsSell");
        this.contDescription.setName("contDescription");
        this.txtNumber.setName("txtNumber");
        this.prmtRoomEntry.setName("prmtRoomEntry");
        ...
        // chkIsSell		
        this.chkIsSell.setText(resHelper.getString("chkIsSell.text"));
        // contDescription		
        ...
        // prmtRoomEntry		
        this.prmtRoomEntry.setEnabledMultiSelection(true);		
        this.prmtRoomEntry.setCommitFormat("$number$");		
        this.prmtRoomEntry.setEditFormat("$number$");		
        this.prmtRoomEntry.setDisplayFormat("$name$");		
        this.prmtRoomEntry.setRequired(true);
        this.prmtRoomEntry.addDataChangeListener(new com.kingdee.bos.ctrl.swing.event.DataChangeListener() {
            public void dataChanged(com.kingdee.bos.ctrl.swing.event.DataChangeEvent e) {
                try {
                    prmtRoomEntry_dataChanged(e);
                } catch (Exception exc) {
                    handUIException(exc);
                } finally {
                }
        ...
        // prmtHandler		
        this.prmtHandler.setRequired(true);		
        this.prmtHandler.setQueryInfo("com.kingdee.eas.base.permission.app.F7UserQuery");		
        this.prmtHandler.setCommitFormat("$number$");		
        this.prmtHandler.setEditFormat("$number$");		
    ...
    public void initUIContentLayout()
    {
        ...
        contHandler.setBounds(new Rectangle(10, 40, 270, 19));
        this.add(contHandler, null);
        contBizDate.setBounds(new Rectangle(300, 40, 270, 19));
        this.add(contBizDate, null);
        contAuditor.setBounds(new Rectangle(10, 70, 270, 19));
        this.add(contAuditor, null);
        contAuditTime.setBounds(new Rectangle(300, 70, 270, 19));
        this.add(contAuditTime, null);
        chkIsSell.setBounds(new Rectangle(10, 100, 203, 19));
        this.add(chkIsSell, null);
        contDescription.setBounds(new Rectangle(10, 130, 560, 94));
        this.add(contDescription, null);
        //contNumber
        contNumber.setBoundEditor(txtNumber);
        //contRoom
        contRoom.setBoundEditor(prmtRoomEntry);
        //contHandler
        ...
        //contDescription
        contDescription.setBoundEditor(kDScrollPane);
        //kDScrollPane
        kDScrollPane.getViewport().add(txtDescription, null);
	...
	private void registerBindings(){
		dataBinder.registerBinding("isSell", boolean.class, this.chkIsSell, "selected");
		dataBinder.registerBinding("number", String.class, this.txtNumber, "text");
		dataBinder.registerBinding("room", com.kingdee.eas.fdc.sellhouse.RoomInfo.class, this.prmtRoomEntry, "data");
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.sellhouse.app.MortagageControlEditUIHandler";
	}
    ...
    public void setDataObject(IObjectValue dataObject)
    {
        ...
        this.editData = (com.kingdee.eas.fdc.sellhouse.MortagageControlInfo)ov;
    }
	...
	protected void registerValidator() {
		...
		getValidateHelper().registerBindProperty("isSell", ValidateHelper.ON_SAVE);    
    ...
    /**
     * output prmtRoomEntry_dataChanged method
     */
    protected void prmtRoomEntry_dataChanged(com.kingdee.bos.ctrl.swing.event.DataChangeEvent e) throws Exception
    {
    }
    ...
    protected class ActionAntiMortagage extends ItemAction {     
        ...
        public void actionPerformed(ActionEvent e)
        {
            ...
            innerActionPerformed("eas", AbstractMortagageControlEditUI.this, "ActionAntiMortagage", "actionAntiMortagage_actionPerformed", e);
        }
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.sellhouse.client", "MortagageControlEditUI");
    }
    /**
