 ...
 * output class name
 */
public abstract class AbstractGatheringTrendFilterUI extends com.kingdee.eas.base.commonquery.client.CustomerQueryPanel
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractGatheringTrendFilterUI.class);
     ...
     */
    public AbstractGatheringTrendFilterUI() throws Exception
    {
        super();
        jbInit();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractGatheringTrendFilterUI.class.getName());
    ...
    {
        this.setBounds(new Rectangle(10, 10, 400, 130));
        this.setLayout(new KDLayout());
        this.putClientProperty("OriginalBounds", new Rectangle(10, 10, 400, 130));
        ...
        this.add(plDateType, new KDLayout.Constraints(9, 63, 361, 55, 0));
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.sellhouse.app.GatheringTrendFilterUIHandler";
	}
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.sellhouse.client", "GatheringTrendFilterUI");
    }
