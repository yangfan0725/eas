 ...
 * output class name
 */
public abstract class AbstractTransferDateUI extends com.kingdee.eas.framework.client.CoreUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractTransferDateUI.class);
     ...
     */
    public AbstractTransferDateUI() throws Exception
    {
        super();
        jbInit();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractTransferDateUI.class.getName());
        ...
        this.contTransferDate.setBoundLabelLength(100);		
        this.contTransferDate.setBoundLabelUnderline(true);
        // pkTransferDate		
        this.pkTransferDate.setRequired(true);
    ...
    public void initUIContentLayout()
    {
        ...
        contTransferDate.setBounds(new Rectangle(41, 29, 223, 19));
        this.add(contTransferDate, null);
        //contTransferDate
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.sellhouse.app.TransferDateUIHandler";
	}
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.sellhouse.client", "TransferDateUI");
    }
