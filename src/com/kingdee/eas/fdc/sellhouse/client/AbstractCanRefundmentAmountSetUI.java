 ...
 * output class name
 */
public abstract class AbstractCanRefundmentAmountSetUI extends com.kingdee.eas.framework.client.CoreUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractCanRefundmentAmountSetUI.class);
     ...
     */
    public AbstractCanRefundmentAmountSetUI() throws Exception
    {
        super();
        jbInit();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractCanRefundmentAmountSetUI.class.getName());
        ...
        // CoreUI		
        this.setPreferredSize(new Dimension(540,340));
        // tblSet
    ...
    {
        this.setBounds(new Rectangle(10, 10, 540, 340));
        this.setLayout(new KDLayout());
        this.putClientProperty("OriginalBounds", new Rectangle(10, 10, 540, 340));
        tblSet.setBounds(new Rectangle(5, 5, 528, 287));
        this.add(tblSet, new KDLayout.Constraints(5, 5, 528, 287, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_BOTTOM | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT));
        btnOK.setBounds(new Rectangle(342, 306, 73, 21));
        this.add(btnOK, new KDLayout.Constraints(342, 306, 73, 21, KDLayout.Constraints.ANCHOR_BOTTOM | KDLayout.Constraints.ANCHOR_RIGHT));
        btnCancel.setBounds(new Rectangle(447, 306, 73, 21));
        this.add(btnCancel, new KDLayout.Constraints(447, 306, 73, 21, KDLayout.Constraints.ANCHOR_BOTTOM | KDLayout.Constraints.ANCHOR_RIGHT));
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.sellhouse.app.CanRefundmentAmountSetUIHandler";
	}
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.sellhouse.client", "CanRefundmentAmountSetUI");
    }
