 ...
 * output class name
 */
public class ChooseRoomUI extends AbstractChooseRoomUI
{
    private static final Logger logger = CoreUIObject.getLogger(ChooseRoomUI.class);
    
    /**
     * output class constructor
     */
    public ChooseRoomUI() throws Exception
    {
        super();
    }
