 ...
 * output class name
 */
public abstract class AbstractRptRoomMainUI extends com.kingdee.eas.framework.bireport.client.BireportBaseMainUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractRptRoomMainUI.class);
    protected com.kingdee.bos.ctrl.kdf.table.KDTable kDTable1;
    /**
     * output class constructor
     */
    public AbstractRptRoomMainUI() throws Exception
    {
        super();
        jbInit();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractRptRoomMainUI.class.getName());
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.sellhouse.app.RptRoomMainUIHandler";
	}
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.sellhouse.client", "RptRoomMainUI");
    }
