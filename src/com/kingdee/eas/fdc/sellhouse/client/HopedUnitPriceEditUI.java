 ...
 * output class name
 */
public class HopedUnitPriceEditUI extends AbstractHopedUnitPriceEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(HopedUnitPriceEditUI.class);
    
    /**
     * output class constructor
     */
    public HopedUnitPriceEditUI() throws Exception
    {
        super();
    }
	...
	protected IObjectValue createNewData() {
		HopedUnitPriceInfo value = new HopedUnitPriceInfo();
		return value;
	}
	...
	protected void verifyInput(ActionEvent e) throws Exception {
		...
		if(HopedUnitPriceFactory.getRemoteInstance().exists(filter)){
