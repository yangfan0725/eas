 ...
 * output class name
 */
public abstract class AbstractSalemanAchievementStatRptFilterUI extends com.kingdee.eas.base.commonquery.client.CustomerQueryPanel
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractSalemanAchievementStatRptFilterUI.class);
     ...
     */
    public AbstractSalemanAchievementStatRptFilterUI() throws Exception
    {
        super();
        jbInit();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractSalemanAchievementStatRptFilterUI.class.getName());
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.sellhouse.app.SalemanAchievementStatRptFilterUIHandler";
	}
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.sellhouse.client", "SalemanAchievementStatRptFilterUI");
    }
