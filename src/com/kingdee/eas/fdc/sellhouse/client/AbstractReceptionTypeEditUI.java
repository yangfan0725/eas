 ...
 * output class name
 */
public abstract class AbstractReceptionTypeEditUI extends com.kingdee.eas.fdc.basedata.client.FDCBaseDataEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractReceptionTypeEditUI.class);
    ...
    protected com.kingdee.eas.fdc.sellhouse.ReceptionTypeInfo editData = null;
    /**
     * output class constructor
     */
    public AbstractReceptionTypeEditUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractReceptionTypeEditUI.class.getName());
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.sellhouse.app.ReceptionTypeEditUIHandler";
	}
    ...
    public void setDataObject(IObjectValue dataObject)
    {
        ...
        this.editData = (com.kingdee.eas.fdc.sellhouse.ReceptionTypeInfo)ov;
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.sellhouse.client", "ReceptionTypeEditUI");
    }
