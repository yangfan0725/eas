 ...
 * output class name
 */
public abstract class AbstractHopePitchEditUI extends com.kingdee.eas.fdc.basedata.client.FDCBaseDataEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractHopePitchEditUI.class);
    ...
    protected com.kingdee.eas.fdc.sellhouse.HopePitchInfo editData = null;
    /**
     * output class constructor
     */
    public AbstractHopePitchEditUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractHopePitchEditUI.class.getName());
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.sellhouse.app.HopePitchEditUIHandler";
	}
    ...
    public void setDataObject(IObjectValue dataObject)
    {
        ...
        this.editData = (com.kingdee.eas.fdc.sellhouse.HopePitchInfo)ov;
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.sellhouse.client", "HopePitchEditUI");
    }
