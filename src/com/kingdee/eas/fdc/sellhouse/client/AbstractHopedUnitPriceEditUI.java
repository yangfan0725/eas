 ...
 * output class name
 */
public abstract class AbstractHopedUnitPriceEditUI extends com.kingdee.eas.fdc.basedata.client.FDCBaseDataEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractHopedUnitPriceEditUI.class);
    ...
    protected com.kingdee.eas.fdc.sellhouse.HopedUnitPriceInfo editData = null;
    /**
     * output class constructor
     */
    public AbstractHopedUnitPriceEditUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractHopedUnitPriceEditUI.class.getName());
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.sellhouse.app.HopedUnitPriceEditUIHandler";
	}
    ...
    public void setDataObject(IObjectValue dataObject)
    {
        ...
        this.editData = (com.kingdee.eas.fdc.sellhouse.HopedUnitPriceInfo)ov;
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.sellhouse.client", "HopedUnitPriceEditUI");
    }
