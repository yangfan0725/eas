 ...
 * output class name
 */
public abstract class AbstractSellStatRptFilterUI extends com.kingdee.eas.base.commonquery.client.CustomerQueryPanel
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractSellStatRptFilterUI.class);
    ...
    protected com.kingdee.bos.ctrl.swing.KDCheckBox chkIsSpecialBizIntoSaleStat;
    /**
     * output class constructor
     */
    public AbstractSellStatRptFilterUI() throws Exception
    {
        super();
        jbInit();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractSellStatRptFilterUI.class.getName());
        ...
        this.chkIsSpecialBizIntoSaleStat = new com.kingdee.bos.ctrl.swing.KDCheckBox();
        ...
        this.chkIsSpecialBizIntoSaleStat.setName("chkIsSpecialBizIntoSaleStat");
        // CustomerQueryPanel
        // contDateFrom		
        ...
        // chkIsSpecialBizIntoSaleStat		
        this.chkIsSpecialBizIntoSaleStat.setText(resHelper.getString("chkIsSpecialBizIntoSaleStat.text"));
    ...
    public void initUIContentLayout()
    {
        ...
        kDPanel1.setBounds(new Rectangle(10, 149, 359, 129));
        ...
        chkIsSpecialBizIntoSaleStat.setBounds(new Rectangle(23, 85, 270, 19));
        kDPanel1.add(chkIsSpecialBizIntoSaleStat, null);
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.sellhouse.app.SellStatRptFilterUIHandler";
	}
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.sellhouse.client", "SellStatRptFilterUI");
    }
