 ...
 * output class name
 */
public class EnrollmentFilterUI extends AbstractEnrollmentFilterUI
{
    private static final Logger logger = CoreUIObject.getLogger(EnrollmentFilterUI.class);
    
    public EnrollmentFilterUI() throws Exception
    {
        super();
    }
