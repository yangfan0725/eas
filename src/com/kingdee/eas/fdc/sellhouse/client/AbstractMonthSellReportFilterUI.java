...
public abstract class AbstractMonthSellReportFilterUI extends com.kingdee.eas.base.commonquery.client.CustomerQueryPanel
{
    ...
    private void jbInit() throws Exception
    {
        ...
        this.chkIsShowSpecial.setVisible(false);
        // radioProductType		
    ...
    public void initUIContentLayout()
    {
        ...
        kDPanel1.setBounds(new Rectangle(14, 154, 359, 95));
        ...
        chkIsShowSpecial.setBounds(new Rectangle(21, 66, 220, 19));
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.sellhouse.app.MonthSellReportFilterUIHandler";
	}
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.sellhouse.client", "MonthSellReportFilterUI");
    }
