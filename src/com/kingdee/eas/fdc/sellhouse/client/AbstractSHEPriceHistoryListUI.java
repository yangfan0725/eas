 ...
 * output class name
 */
public abstract class AbstractSHEPriceHistoryListUI extends com.kingdee.eas.framework.client.ListUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractSHEPriceHistoryListUI.class);
     ...
     */
    public AbstractSHEPriceHistoryListUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractSHEPriceHistoryListUI.class.getName());
        this.setUITitle(resHelper.getString("this.title"));
        mainQueryPK = new MetaDataPK("com.kingdee.eas.fdc.sellhouse.app", "SHEPriceHistoryQuery");
        ...
        // CoreUI
		String tblMainStrXML = "<?xml version=\"1.0\" encoding=\"UTF-8\"?> <DocRoot xmlns:c=\"http://www.kingdee.com/Common\" xmlns:f=\"http://www.kingdee.com/Form\" xmlns:t=\"http://www.kingdee.com/Table\" xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" xsi:schemaLocation=\"http://www.kingdee.com/KDF KDFSchema.xsd\" version=\"0.0\"><Styles><c:Style id=\"sCol0\"><c:Protection hidden=\"true\" /></c:Style><c:Style id=\"sCol7\"><c:Protection hidden=\"true\" /></c:Style><c:Style id=\"sCol8\"><c:Protection hidden=\"true\" /></c:Style><c:Style id=\"sCol9\"><c:Protection hidden=\"true\" /></c:Style><c:Style id=\"sCol10\"><c:Protection hidden=\"true\" /></c:Style><c:Style id=\"sCol11\"><c:Protection hidden=\"true\" /></c:Style></Styles><Table id=\"KDTable\"><t:Sheet name=\"sheet1\"><t:Table t:selectMode=\"15\" t:mergeMode=\"0\" t:dataRequestMode=\"0\" t:pageRowCount=\"100\"><t:ColumnGroup><t:Column t:key=\"id\" t:width=\"-1\" t:mergeable=\"true\" t:resizeable=\"true\" t:moveable=\"true\" t:group=\"false\" t:required=\"false\" t:index=\"-1\" t:styleID=\"sCol0\" /><t:Column t:key=\"priceType\" t:width=\"-1\" t:mergeable=\"true\" t:resizeable=\"true\" t:moveable=\"true\" t:group=\"false\" t:required=\"false\" t:index=\"1\" /><t:Column t:key=\"bizDate\" t:width=\"-1\" t:mergeable=\"true\" t:resizeable=\"true\" t:moveable=\"true\" t:group=\"false\" t:required=\"false\" t:index=\"2\" /><t:Column t:key=\"head.standardTotalAmount\" t:width=\"-1\" t:mergeable=\"true\" t:resizeable=\"true\" t:moveable=\"true\" t:group=\"false\" t:required=\"false\" t:index=\"3\" /><t:Column t:key=\"roomPrice\" t:width=\"-1\" t:mergeable=\"true\" t:resizeable=\"true\" t:moveable=\"true\" t:group=\"false\" t:required=\"false\" t:index=\"4\" /><t:Column t:key=\"buildPrice\" t:width=\"-1\" t:mergeable=\"true\" t:resizeable=\"true\" t:moveable=\"true\" t:group=\"false\" t:required=\"false\" t:index=\"5\" /><t:Column t:key=\"isCalByRoomArea\" t:width=\"150\" t:mergeable=\"true\" t:resizeable=\"true\" t:moveable=\"true\" t:group=\"false\" t:required=\"false\" t:index=\"6\" /><t:Column t:key=\"buildingArea\" t:width=\"-1\" t:mergeable=\"true\" t:resizeable=\"true\" t:moveable=\"true\" t:group=\"false\" t:required=\"false\" t:index=\"7\" t:styleID=\"sCol7\" /><t:Column t:key=\"roomArea\" t:width=\"-1\" t:mergeable=\"true\" t:resizeable=\"true\" t:moveable=\"true\" t:group=\"false\" t:required=\"false\" t:index=\"8\" t:styleID=\"sCol8\" /><t:Column t:key=\"head.id\" t:width=\"-1\" t:mergeable=\"true\" t:resizeable=\"true\" t:moveable=\"true\" t:group=\"false\" t:required=\"false\" t:index=\"9\" t:styleID=\"sCol9\" /><t:Column t:key=\"roomPriceBill.id\" t:width=\"-1\" t:mergeable=\"true\" t:resizeable=\"true\" t:moveable=\"true\" t:group=\"false\" t:required=\"false\" t:index=\"10\" t:styleID=\"sCol10\" /><t:Column t:key=\"priceAdjustBill.id\" t:width=\"-1\" t:mergeable=\"true\" t:resizeable=\"true\" t:moveable=\"true\" t:group=\"false\" t:required=\"false\" t:index=\"11\" t:styleID=\"sCol11\" /></t:ColumnGroup><t:Head><t:Row t:name=\"header\" t:height=\"-1\" t:mergeable=\"true\" t:resizeable=\"true\"><t:Cell>$Resource{id}</t:Cell><t:Cell>$Resource{priceType}</t:Cell><t:Cell>$Resource{bizDate}</t:Cell><t:Cell>$Resource{head.standardTotalAmount}</t:Cell><t:Cell>$Resource{roomPrice}</t:Cell><t:Cell>$Resource{buildPrice}</t:Cell><t:Cell>$Resource{isCalByRoomArea}</t:Cell><t:Cell>$Resource{buildingArea}</t:Cell><t:Cell>$Resource{roomArea}</t:Cell><t:Cell>$Resource{head.id}</t:Cell><t:Cell>$Resource{roomPriceBill.id}</t:Cell><t:Cell>$Resource{priceAdjustBill.id}</t:Cell></t:Row></t:Head></t:Table><t:SheetOptions><t:MergeBlocks><t:Head /></t:MergeBlocks></t:SheetOptions></t:Sheet></Table></DocRoot> ";
		
        this.tblMain.setFormatXml(resHelper.translateString("tblMain",tblMainStrXML));
                this.tblMain.putBindContents("mainQuery",new String[] {"id","priceType","bizDate","standardTotalPrice","roomPrice","buildPrice","isCalByRoomArea","buildingArea","roomArea","head.id","roomPriceBill.id","priceAdjustBill.id"});
    ...
    public void initUIContentLayout()
    {
        ...
        this.setLayout(null);
        tblMain.setBounds(new Rectangle(10, 231, 995, 389));
        this.add(tblMain, null);
        kDLabelContainer1.setBounds(new Rectangle(16, 52, 270, 19));
        ...
        kDLabelContainer5.setBounds(new Rectangle(16, 87, 270, 19));
        this.add(kDLabelContainer5, null);
        kDLabelContainer6.setBounds(new Rectangle(370, 89, 270, 19));
        this.add(kDLabelContainer6, null);
        kDLabelContainer7.setBounds(new Rectangle(16, 122, 270, 19));
        this.add(kDLabelContainer7, null);
        kDLabelContainer8.setBounds(new Rectangle(370, 125, 270, 19));
        this.add(kDLabelContainer8, null);
        kDLabelContainer9.setBounds(new Rectangle(370, 161, 270, 19));
        this.add(kDLabelContainer9, null);
        kDLabelContainer10.setBounds(new Rectangle(725, 196, 270, 19));
        this.add(kDLabelContainer10, null);
        kDLabelContainer11.setBounds(new Rectangle(370, 197, 270, 19));
        this.add(kDLabelContainer11, null);
        kDLabelContainer12.setBounds(new Rectangle(370, 17, 270, 19));
        this.add(kDLabelContainer12, null);
        kDLabelContainer13.setBounds(new Rectangle(16, 196, 270, 19));
        this.add(kDLabelContainer13, null);
        kDLabelContainer14.setBounds(new Rectangle(725, 157, 270, 19));
        this.add(kDLabelContainer14, null);
        kDLabelContainer15.setBounds(new Rectangle(16, 157, 270, 19));
        this.add(kDLabelContainer15, null);
        kDLabelContainer16.setBounds(new Rectangle(725, 122, 270, 19));
        this.add(kDLabelContainer16, null);
        kDLabelContainer17.setBounds(new Rectangle(725, 87, 270, 19));
        this.add(kDLabelContainer17, null);
        kDLabelContainer18.setBounds(new Rectangle(16, 17, 270, 19));
        ...
        //kDLabelContainer5
        kDLabelContainer5.setBoundEditor(txtApportionArea);
        //kDLabelContainer6
        kDLabelContainer6.setBoundEditor(txtBalconyArea);
        //kDLabelContainer7
        ...
        //kDLabelContainer10
        kDLabelContainer10.setBoundEditor(txtStandardTotalAmount);
        //kDLabelContainer11
        kDLabelContainer11.setBoundEditor(txtDealTotalAmount);
        //kDLabelContainer12
        kDLabelContainer12.setBoundEditor(comboRoomState);
        //kDLabelContainer13
        kDLabelContainer13.setBoundEditor(txtDealPrice);
        //kDLabelContainer14
        kDLabelContainer14.setBoundEditor(txtStandardPrice);
        //kDLabelContainer15
        kDLabelContainer15.setBoundEditor(f7BuildingProperty);
        //kDLabelContainer16
        kDLabelContainer16.setBoundEditor(f7Sight);
        //kDLabelContainer17
        kDLabelContainer17.setBoundEditor(txtFloorHeight);
        //kDLabelContainer18
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.sellhouse.app.SHEPriceHistoryListUIHandler";
	}
    ...
    public SelectorItemCollection getSelectors()
    {
        ...
        sic.add(new SelectorItemInfo("roomPriceBill.id"));
        sic.add(new SelectorItemInfo("priceAdjustBill.id"));
        sic.add(new SelectorItemInfo("standardTotalPrice"));
        return sic;
    }        
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.sellhouse.client", "SHEPriceHistoryListUI");
    }
