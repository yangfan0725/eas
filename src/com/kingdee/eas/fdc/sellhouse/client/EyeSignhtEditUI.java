 ...
 * output class name
 */
public class EyeSignhtEditUI extends AbstractEyeSignhtEditUI {
	private static final Logger logger = CoreUIObject.getLogger(EyeSignhtEditUI.class);

	/**
	 * output class constructor
	 */
	public EyeSignhtEditUI() throws Exception {
		super();
	}
	...
	private void checkNullAndDump() throws Exception {
		EyeSignhtInfo info = (EyeSignhtInfo) this.editData;
		if (info == null) {
			SysUtil.abort();
		}
		...
		if (this.oprtState.equals(OprtState.ADDNEW)) {
			...
			if (EyeSignhtFactory.getRemoteInstance().exists(filter)) {
	...
	protected IObjectValue createNewData() {
		EyeSignhtInfo info = new EyeSignhtInfo();
		return info;
	}
