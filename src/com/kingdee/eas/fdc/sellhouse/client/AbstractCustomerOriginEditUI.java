 ...
 * output class name
 */
public abstract class AbstractCustomerOriginEditUI extends com.kingdee.eas.fdc.basedata.client.FDCBaseDataEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractCustomerOriginEditUI.class);
    ...
    protected com.kingdee.bos.ctrl.extendcontrols.KDBizPromptBox f7Group;
    protected com.kingdee.eas.fdc.sellhouse.CustomerOriginInfo editData = null;
    /**
     * output class constructor
     */
    public AbstractCustomerOriginEditUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractCustomerOriginEditUI.class.getName());
        ...
        this.f7Group = new com.kingdee.bos.ctrl.extendcontrols.KDBizPromptBox();
        ...
        // f7Group		
        this.f7Group.setQueryInfo("com.kingdee.eas.fdc.sellhouse.app.CustomerOriginGroupQuery");		
        this.f7Group.setDisplayFormat("$name$");		
        this.f7Group.setEditFormat("$number$");		
        this.f7Group.setCommitFormat("$number$");
    ...
    public void initUIContentLayout()
    {
        ...
        contDescription.setBounds(new Rectangle(10, 70, 560, 19));
        this.add(contDescription, null);
        contSimpleName.setBounds(new Rectangle(10, 40, 270, 19));
        this.add(contSimpleName, null);
        contGroup.setBounds(new Rectangle(300, 40, 270, 19));
        this.add(contGroup, null);
        //contName
        ...
        //contGroup
        contGroup.setBoundEditor(f7Group);
	...
	private void registerBindings(){
		...
		dataBinder.registerBinding("group", com.kingdee.eas.fdc.sellhouse.CustomerOriginGroupInfo.class, this.f7Group, "data");		
	}
	//Regiester UI State
	private void registerUIState(){		
	}
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.sellhouse.app.CustomerOriginEditUIHandler";
	}
    ...
    public void setDataObject(IObjectValue dataObject)
    {
        ...
        this.editData = (com.kingdee.eas.fdc.sellhouse.CustomerOriginInfo)ov;
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.sellhouse.client", "CustomerOriginEditUI");
    }
