 ...
 * output class name
 */
public class FinanceSubscribeFilterUI extends AbstractFinanceSubscribeFilterUI
{
    private static final Logger logger = CoreUIObject.getLogger(FinanceSubscribeFilterUI.class);

    public FinanceSubscribeFilterUI() throws Exception
    {
        super();
    }
