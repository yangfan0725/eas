 ...
 * output class name
 */
public abstract class AbstractOverdueCauseEditUI extends com.kingdee.eas.fdc.basedata.client.FDCBaseDataEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractOverdueCauseEditUI.class);
    ...
    protected com.kingdee.eas.fdc.sellhouse.OverdueCauseInfo editData = null;
    /**
     * output class constructor
     */
    public AbstractOverdueCauseEditUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractOverdueCauseEditUI.class.getName());
        ...
        // cbType		
        this.cbType.addItems(EnumUtils.getEnumList("com.kingdee.eas.fdc.sellhouse.OverdueCauseTypeEnum").toArray());
    ...
    public void initUIContentLayout()
    {
        ...
        contName.setBounds(new Rectangle(78, 85, 270, 19));
        this.add(contName, new KDLayout.Constraints(78, 85, 270, 19, 0));
        contNumber.setBounds(new Rectangle(78, 39, 270, 19));
        this.add(contNumber, new KDLayout.Constraints(78, 39, 270, 19, 0));
        contDescription.setBounds(new Rectangle(78, 178, 270, 19));
        this.add(contDescription, new KDLayout.Constraints(78, 178, 270, 19, 0));
        contSimpleName.setBounds(new Rectangle(78, 131, 270, 19));
        this.add(contSimpleName, new KDLayout.Constraints(78, 131, 270, 19, 0));
        chkIsEnabled.setBounds(new Rectangle(454, 192, 140, 19));
        this.add(chkIsEnabled, new KDLayout.Constraints(454, 192, 140, 19, 0));
        contType.setBounds(new Rectangle(78, 227, 270, 19));
        this.add(contType, new KDLayout.Constraints(78, 227, 270, 19, 0));
        //contName
	...
	private void registerBindings(){
		...
		dataBinder.registerBinding("type", com.kingdee.eas.fdc.sellhouse.OverdueCauseTypeEnum.class, this.cbType, "selectedItem");		
	}
	//Regiester UI State
	private void registerUIState(){		
	}
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.sellhouse.app.OverdueCauseEditUIHandler";
	}
    ...
    public void setDataObject(IObjectValue dataObject)
    {
        ...
        this.editData = (com.kingdee.eas.fdc.sellhouse.OverdueCauseInfo)ov;
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.sellhouse.client", "OverdueCauseEditUI");
    }
