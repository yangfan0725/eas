 ...
 * output class name
 */
public abstract class AbstractCluesCustomerDeliverEditUI extends com.kingdee.eas.framework.client.EditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractCluesCustomerDeliverEditUI.class);
     ...
     */
    public AbstractCluesCustomerDeliverEditUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractCluesCustomerDeliverEditUI.class.getName());
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.sellhouse.app.CluesCustomerDeliverEditUIHandler";
	}
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.sellhouse.client", "CluesCustomerDeliverEditUI");
    }
