 ...
 * output class name
 */
public abstract class AbstractCustomerSwitchToEditUI extends com.kingdee.eas.framework.client.EditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractCustomerSwitchToEditUI.class);
     ...
     */
    public AbstractCustomerSwitchToEditUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractCustomerSwitchToEditUI.class.getName());
    ...
    public void initUIContentLayout()
    {
        ...
        this.setLayout(null);
        contSalesman.setBounds(new Rectangle(10, 10, 290, 19));
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.sellhouse.app.CustomerSwitchToEditUIHandler";
	}
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.sellhouse.client", "CustomerSwitchToEditUI");
    }
