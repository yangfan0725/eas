 ...
 * output class name
 */
public abstract class AbstractNoTradingSellBillEditUI extends com.kingdee.eas.fdc.basedata.client.FDCBillEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractNoTradingSellBillEditUI.class);
    ...
    protected com.kingdee.eas.fdc.sellhouse.NoTradingSellBillInfo editData = null;
     ...
     */
    public AbstractNoTradingSellBillEditUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractNoTradingSellBillEditUI.class.getName());
    ...
    public void initUIContentLayout()
    {
        ...
        contDescription.setBounds(new Rectangle(6, 31, 1000, 68));
        this.add(contDescription, new KDLayout.Constraints(6, 31, 1000, 68, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT));
        contEntry.setBounds(new Rectangle(5, 104, 999, 468));
        this.add(contEntry, new KDLayout.Constraints(5, 104, 999, 468, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_BOTTOM_SCALE | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT));
        contCreator.setBounds(new Rectangle(7, 580, 270, 19));
        this.add(contCreator, new KDLayout.Constraints(7, 580, 270, 19, KDLayout.Constraints.ANCHOR_BOTTOM | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contCreateTime.setBounds(new Rectangle(7, 601, 270, 19));
        this.add(contCreateTime, new KDLayout.Constraints(7, 601, 270, 19, KDLayout.Constraints.ANCHOR_BOTTOM | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contAuditor.setBounds(new Rectangle(372, 580, 270, 19));
        this.add(contAuditor, new KDLayout.Constraints(372, 580, 270, 19, KDLayout.Constraints.ANCHOR_BOTTOM | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contAuditTime.setBounds(new Rectangle(372, 601, 270, 19));
        this.add(contAuditTime, new KDLayout.Constraints(372, 601, 270, 19, KDLayout.Constraints.ANCHOR_BOTTOM | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contNumber.setBounds(new Rectangle(6, 9, 270, 19));
        this.add(contNumber, new KDLayout.Constraints(6, 9, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contName.setBounds(new Rectangle(371, 9, 270, 19));
        this.add(contName, new KDLayout.Constraints(371, 9, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT_SCALE));
        contBizDate.setBounds(new Rectangle(736, 9, 270, 19));
        this.add(contBizDate, new KDLayout.Constraints(736, 9, 270, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_LEFT_SCALE | KDLayout.Constraints.ANCHOR_RIGHT));
        //contDescription
...
contEntry.getContentPane().setLayout(new BorderLayout(0, 0));        contEntry.getContentPane().add(kdtEntry, BorderLayout.CENTER);
	...
	private void registerBindings(){
		...
		dataBinder.registerBinding("entry.sellProject", com.kingdee.eas.fdc.sellhouse.SellProjectInfo.class, this.kdtEntry, "sellProject.text");
		dataBinder.registerBinding("entry.customer", com.kingdee.eas.fdc.sellhouse.SHECustomerInfo.class, this.kdtEntry, "customer.text");
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.sellhouse.app.NoTradingSellBillEditUIHandler";
	}
    ...
    public void setDataObject(IObjectValue dataObject)
    {
        ...
        this.editData = (com.kingdee.eas.fdc.sellhouse.NoTradingSellBillInfo)ov;
    }
    ...
    public SelectorItemCollection getSelectors()
    {
		...
		if(selectorAll.equalsIgnoreCase("true"))
		{
	    	...
	    	sic.add(new SelectorItemInfo("entry.sellProject.id"));
			sic.add(new SelectorItemInfo("entry.sellProject.name"));
        	sic.add(new SelectorItemInfo("entry.sellProject.number"));
		}
		if(selectorAll.equalsIgnoreCase("true"))
		{
		...
		if(selectorAll.equalsIgnoreCase("true"))
		{
	    	...
	    	sic.add(new SelectorItemInfo("entry.room.id"));
			sic.add(new SelectorItemInfo("entry.room.name"));
        	sic.add(new SelectorItemInfo("entry.room.number"));
		}
    ...
    protected class ActionALine extends ItemAction {     
        ...
        public void actionPerformed(ActionEvent e)
        {
            ...
            innerActionPerformed("eas", AbstractNoTradingSellBillEditUI.this, "ActionALine", "actionALine_actionPerformed", e);
        }
    }
    ...
    protected class ActionILine extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractNoTradingSellBillEditUI.this, "ActionILine", "actionILine_actionPerformed", e);
        }
    }
    ...
    protected class ActionRLine extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractNoTradingSellBillEditUI.this, "ActionRLine", "actionRLine_actionPerformed", e);
        }
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.sellhouse.client", "NoTradingSellBillEditUI");
    }
    /**
