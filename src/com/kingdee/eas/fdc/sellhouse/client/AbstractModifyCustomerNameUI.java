 ...
 * output class name
 */
public abstract class AbstractModifyCustomerNameUI extends com.kingdee.eas.framework.client.EditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractModifyCustomerNameUI.class);
     ...
     */
    public AbstractModifyCustomerNameUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractModifyCustomerNameUI.class.getName());
    ...
    public void initUIContentLayout()
    {
        ...
        this.setLayout(null);
        contName.setBounds(new Rectangle(10, 21, 270, 19));
        this.add(contName, null);
        contPhone.setBounds(new Rectangle(10, 21, 270, 19));
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.sellhouse.app.ModifyCustomerNameUIHandler";
	}
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.sellhouse.client", "ModifyCustomerNameUI");
    }
