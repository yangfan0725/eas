 ...
 * output class name
 */
public class SalemanAchievementStatRptFilterUI extends AbstractSalemanAchievementStatRptFilterUI
{

	/**
	 * 
	 */
	private static final long serialVersionUID = 3309410269161681153L;
	 ...
	 */
	public SalemanAchievementStatRptFilterUI(ListUI listUI, ItemAction actionListOnLoad)
			throws Exception {
		super();
		this.listUI = listUI;
