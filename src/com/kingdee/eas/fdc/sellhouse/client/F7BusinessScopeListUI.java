...
import com.kingdee.eas.fdc.tenancy.client.BusinessScopeListUI;
...
public class F7BusinessScopeListUI extends BusinessScopeListUI implements
IF7Provider, TreeSelectionListener{

	public F7BusinessScopeListUI() throws Exception {
		super();
	}
