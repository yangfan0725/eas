 ...
 * output class name
 */
public abstract class AbstractCluesCustomerShareEditUI extends com.kingdee.eas.framework.client.EditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractCluesCustomerShareEditUI.class);
     ...
     */
    public AbstractCluesCustomerShareEditUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractCluesCustomerShareEditUI.class.getName());
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.sellhouse.app.CluesCustomerShareEditUIHandler";
	}
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.sellhouse.client", "CluesCustomerShareEditUI");
    }
