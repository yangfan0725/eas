 ...
 * output class name
 */
public abstract class AbstractRptFDCCustomerMainUI extends com.kingdee.eas.framework.bireport.client.BireportBaseMainUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractRptFDCCustomerMainUI.class);
    protected com.kingdee.bos.ctrl.kdf.table.KDTable kDTable1;
    /**
     * output class constructor
     */
    public AbstractRptFDCCustomerMainUI() throws Exception
    {
        super();
        jbInit();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractRptFDCCustomerMainUI.class.getName());
    ...
    public void initUIContentLayout()
    {
        ...
        kDTable1.setBounds(new Rectangle(6, 5, 1002, 619));
        this.add(kDTable1, new KDLayout.Constraints(6, 5, 1002, 619, 0));
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.sellhouse.app.RptFDCCustomerMainUIHandler";
	}
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.sellhouse.client", "RptFDCCustomerMainUI");
    }
