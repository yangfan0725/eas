 ...
 * output class name
 */
public abstract class AbstractQuitOrderEditUI extends com.kingdee.eas.framework.client.EditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractQuitOrderEditUI.class);
    protected com.kingdee.bos.ctrl.kdf.table.KDTable tblRoom;
    protected com.kingdee.bos.ctrl.swing.KDWorkButton btnAddRoom;
    protected com.kingdee.bos.ctrl.swing.KDWorkButton btnRmRoom;
    protected com.kingdee.eas.framework.CoreBaseInfo editData = null;
    /**
     * output class constructor
     */
    public AbstractQuitOrderEditUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractQuitOrderEditUI.class.getName());
        ...
        this.btnRmRoom = new com.kingdee.bos.ctrl.swing.KDWorkButton();
        this.tblRoom.setName("tblRoom");
        this.btnAddRoom.setName("btnAddRoom");
        this.btnRmRoom.setName("btnRmRoom");
        // CoreUI
        ...
        // btnRmRoom		
        this.btnRmRoom.setText(resHelper.getString("btnRmRoom.text"));
        this.btnRmRoom.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent e) {
                beforeActionPerformed(e);
                try {
                    btnRmRoom_actionPerformed(e);
                } catch (Exception exc) {
                    handUIException(exc);
                } finally {
                    afterActionPerformed(e);
    ...
    public void initUIContentLayout()
    {
        ...
        tblRoom.setBounds(new Rectangle(10, 37, 535, 310));
        this.add(tblRoom, new KDLayout.Constraints(10, 37, 535, 310, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_BOTTOM | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT));
        btnAddRoom.setBounds(new Rectangle(363, 13, 85, 19));
        this.add(btnAddRoom, new KDLayout.Constraints(363, 13, 85, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_RIGHT));
        btnRmRoom.setBounds(new Rectangle(457, 13, 85, 19));
        this.add(btnRmRoom, new KDLayout.Constraints(457, 13, 85, 19, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_RIGHT));
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.sellhouse.app.QuitOrderEditUIHandler";
	}
    ...
    /**
     * output btnRmRoom_actionPerformed method
     */
    protected void btnRmRoom_actionPerformed(java.awt.event.ActionEvent e) throws Exception
    {
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.sellhouse.client", "QuitOrderEditUI");
    }
