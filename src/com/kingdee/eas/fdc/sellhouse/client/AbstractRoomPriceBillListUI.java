 ...
 * output class name
 */
public abstract class AbstractRoomPriceBillListUI extends com.kingdee.eas.fdc.basedata.client.FDCBillListUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractRoomPriceBillListUI.class);
     ...
     */
    public AbstractRoomPriceBillListUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractRoomPriceBillListUI.class.getName());
        this.setUITitle(resHelper.getString("this.title"));
        mainQueryPK = new MetaDataPK("com.kingdee.eas.fdc.sellhouse.app", "RoomPriceBillQuery");
        //actionAudit
    ...
    public void initUIContentLayout()
    {
        ...
        kDSplitPane1.setBounds(new Rectangle(10, 10, 979, 611));
        this.add(kDSplitPane1, new KDLayout.Constraints(10, 10, 979, 611, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_BOTTOM | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT));
        //kDSplitPane1
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.sellhouse.app.RoomPriceBillListUIHandler";
	}
    ...
    public SelectorItemCollection getSelectors()
    {
        ...
        sic.add(new SelectorItemInfo("buildings"));
    ...
    protected class ActionAudit extends ItemAction {     
        ...
        public void actionPerformed(ActionEvent e)
        {
            ...
            innerActionPerformed("eas", AbstractRoomPriceBillListUI.this, "ActionAudit", "actionAudit_actionPerformed", e);
        }
    }
    ...
    protected class ActionUnAudit extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractRoomPriceBillListUI.this, "ActionUnAudit", "actionUnAudit_actionPerformed", e);
        }
    }
    ...
    protected class ActionExecute extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractRoomPriceBillListUI.this, "ActionExecute", "actionExecute_actionPerformed", e);
        }
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.sellhouse.client", "RoomPriceBillListUI");
    }
    /**
