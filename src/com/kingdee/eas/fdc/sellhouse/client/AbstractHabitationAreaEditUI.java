 ...
 * output class name
 */
public abstract class AbstractHabitationAreaEditUI extends com.kingdee.eas.framework.client.TreeEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractHabitationAreaEditUI.class);
    ...
    protected com.kingdee.eas.fdc.sellhouse.HabitationAreaInfo editData = null;
    /**
     * output class constructor
     */
    public AbstractHabitationAreaEditUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractHabitationAreaEditUI.class.getName());
    ...
    public void initUIContentLayout()
    {
        ...
        this.setLayout(null);
        contName.setBounds(new Rectangle(29, 97, 270, 19));
        this.add(contName, null);
        contNumber.setBounds(new Rectangle(29, 64, 270, 19));
        this.add(contNumber, null);
        contDescription.setBounds(new Rectangle(29, 163, 270, 19));
        this.add(contDescription, null);
        contSimpleName.setBounds(new Rectangle(29, 130, 270, 19));
        this.add(contSimpleName, null);
        contParent.setBounds(new Rectangle(29, 31, 270, 19));
	...
	private void registerBindings(){
		...
		dataBinder.registerBinding("parent", com.kingdee.eas.fdc.sellhouse.HabitationAreaInfo.class, this.prmtParent, "data");		
	}
	//Regiester UI State
	private void registerUIState(){		
	}
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.sellhouse.app.HabitationAreaEditUIHandler";
	}
    ...
    public void setDataObject(IObjectValue dataObject)
    {
        ...
        this.editData = (com.kingdee.eas.fdc.sellhouse.HabitationAreaInfo)ov;
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.sellhouse.client", "HabitationAreaEditUI");
    }
