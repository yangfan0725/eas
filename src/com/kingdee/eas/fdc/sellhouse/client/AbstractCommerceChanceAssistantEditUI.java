 ...
 * output class name
 */
public abstract class AbstractCommerceChanceAssistantEditUI extends com.kingdee.eas.framework.client.EditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractCommerceChanceAssistantEditUI.class);
    ...
    protected com.kingdee.eas.fdc.sellhouse.CommerceChanceAssistantInfo editData = null;
    /**
     * output class constructor
     */
    public AbstractCommerceChanceAssistantEditUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractCommerceChanceAssistantEditUI.class.getName());
        ...
        this.prmtType.setQueryInfo("com.kingdee.eas.fdc.sellhouse.app.F7CommerceChanceDataTypeQuery");
        // prmtSellProject		
    ...
    public void initUIContentLayout()
    {
        ...
        this.putClientProperty("OriginalBounds", new Rectangle(10, 10, 300, 250));
        contName.setBounds(new Rectangle(10, 70, 270, 19));
        this.add(contName, new KDLayout.Constraints(10, 70, 270, 19, 0));
        contNumber.setBounds(new Rectangle(10, 40, 270, 19));
        this.add(contNumber, new KDLayout.Constraints(10, 40, 270, 19, 0));
        contDescription.setBounds(new Rectangle(10, 130, 270, 94));
        this.add(contDescription, new KDLayout.Constraints(10, 130, 270, 94, 0));
        contType.setBounds(new Rectangle(10, 100, 270, 19));
        this.add(contType, new KDLayout.Constraints(10, 100, 270, 19, 0));
        contSellProject.setBounds(new Rectangle(10, 10, 270, 19));
        this.add(contSellProject, new KDLayout.Constraints(10, 10, 270, 19, 0));
        //contName
	...
	private void registerBindings(){
		...
		dataBinder.registerBinding("type", com.kingdee.eas.fdc.sellhouse.CommerceChanceDataTypeInfo.class, this.prmtType, "data");
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.sellhouse.app.CommerceChanceAssistantEditUIHandler";
	}
    ...
    public void setDataObject(IObjectValue dataObject)
    {
        ...
        this.editData = (com.kingdee.eas.fdc.sellhouse.CommerceChanceAssistantInfo)ov;
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.sellhouse.client", "CommerceChanceAssistantEditUI");
    }
