 ...
 * output class name
 */
public abstract class AbstractWorkAreaEditUI extends com.kingdee.eas.framework.client.TreeEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractWorkAreaEditUI.class);
    ...
    protected com.kingdee.eas.fdc.sellhouse.WorkAreaInfo editData = null;
    /**
     * output class constructor
     */
    public AbstractWorkAreaEditUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractWorkAreaEditUI.class.getName());
    ...
    public void initUIContentLayout()
    {
        ...
        this.setLayout(null);
        contName.setBounds(new Rectangle(80, 97, 270, 19));
        this.add(contName, null);
        contNumber.setBounds(new Rectangle(82, 62, 270, 19));
        this.add(contNumber, null);
        contDescription.setBounds(new Rectangle(81, 177, 270, 19));
        this.add(contDescription, null);
        contSimpleName.setBounds(new Rectangle(80, 136, 270, 19));
        this.add(contSimpleName, null);
        contParent.setBounds(new Rectangle(81, 29, 270, 19));
	...
	private void registerBindings(){
		...
		dataBinder.registerBinding("parent", com.kingdee.eas.fdc.sellhouse.WorkAreaInfo.class, this.prmtParent, "data");		
	}
	//Regiester UI State
	private void registerUIState(){		
	}
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.sellhouse.app.WorkAreaEditUIHandler";
	}
    ...
    public void setDataObject(IObjectValue dataObject)
    {
        ...
        this.editData = (com.kingdee.eas.fdc.sellhouse.WorkAreaInfo)ov;
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.sellhouse.client", "WorkAreaEditUI");
    }
