 ...
 * output class name
 */
public class PossessionStandardEditUI extends AbstractPossessionStandardEditUI {
	private static final Logger logger = CoreUIObject.getLogger(PossessionStandardEditUI.class);

	/**
	 * output class constructor
	 */
	public PossessionStandardEditUI() throws Exception {
		super();
	}
	...
	private void checkNullAndDump() throws Exception {
		PossessionStandardInfo info = (PossessionStandardInfo) this.editData;
		if (info == null) {
			SysUtil.abort();
		}
		...
		if (this.oprtState.equals(OprtState.ADDNEW)) {
			...
			if (PossessionStandardFactory.getRemoteInstance().exists(filter)) {
	...
	protected IObjectValue createNewData() {
		PossessionStandardInfo info = new PossessionStandardInfo();
