 ...
 * output class name
 */
public abstract class AbstractImportExcelRoomUI extends com.kingdee.eas.framework.client.ListUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractImportExcelRoomUI.class);
     ...
     */
    public AbstractImportExcelRoomUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractImportExcelRoomUI.class.getName());
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.sellhouse.app.ImportExcelRoomUIHandler";
	}
    ...
    protected class ActionDoImport extends ItemAction {     
        ...
        public void actionPerformed(ActionEvent e)
        {
            ...
            innerActionPerformed("eas", AbstractImportExcelRoomUI.this, "ActionDoImport", "actionDoImport_actionPerformed", e);
        }
    }
    ...
    protected class ActionImport extends ItemAction {     
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractImportExcelRoomUI.this, "ActionImport", "actionImport_actionPerformed", e);
        }
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.sellhouse.client", "ImportExcelRoomUI");
    }
