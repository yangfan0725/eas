 ...
 * output class name
 */
public abstract class AbstractMarketTargetRptFilterUI extends com.kingdee.eas.base.commonquery.client.CustomerQueryPanel
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractMarketTargetRptFilterUI.class);
    ...
    protected com.kingdee.bos.ctrl.swing.KDCheckBox chkIsPreIntoSale;
    /**
     * output class constructor
     */
    public AbstractMarketTargetRptFilterUI() throws Exception
    {
        super();
        jbInit();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractMarketTargetRptFilterUI.class.getName());
        ...
        this.chkIsPreIntoSale = new com.kingdee.bos.ctrl.swing.KDCheckBox();
        ...
        this.chkIsPreIntoSale.setName("chkIsPreIntoSale");
        // CustomerQueryPanel
        // contDateFrom		
        ...
        // chkIsPreIntoSale		
        this.chkIsPreIntoSale.setText(resHelper.getString("chkIsPreIntoSale.text"));
    ...
    public void initUIContentLayout()
    {
        ...
        plDateType.setBounds(new Rectangle(7, 68, 167, 86));
        ...
        chkIsShowAll.setBounds(new Rectangle(13, 159, 162, 19));
        this.add(chkIsShowAll, null);
        chkIsPreIntoSale.setBounds(new Rectangle(14, 187, 153, 19));
        this.add(chkIsPreIntoSale, null);
        //contDateFrom
        contDateFrom.setBoundEditor(pkDateFrom);
        //contDateTo
        contDateTo.setBoundEditor(pkDateTo);
        //plDateType
        plDateType.setLayout(null);        radioByDay.setBounds(new Rectangle(32, 18, 61, 19));
        plDateType.add(radioByDay, null);
        radioByMonth.setBounds(new Rectangle(32, 46, 61, 19));
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.sellhouse.app.MarketTargetRptFilterUIHandler";
	}
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.sellhouse.client", "MarketTargetRptFilterUI");
    }
