 ...
 * output class name
 */
public abstract class AbstractSightRequirementEditUI extends com.kingdee.eas.fdc.basedata.client.FDCBaseDataEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractSightRequirementEditUI.class);
    ...
    protected com.kingdee.eas.fdc.sellhouse.SightRequirementInfo editData = null;
    /**
     * output class constructor
     */
    public AbstractSightRequirementEditUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractSightRequirementEditUI.class.getName());
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.sellhouse.app.SightRequirementEditUIHandler";
	}
    ...
    public void setDataObject(IObjectValue dataObject)
    {
        ...
        this.editData = (com.kingdee.eas.fdc.sellhouse.SightRequirementInfo)ov;
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.sellhouse.client", "SightRequirementEditUI");
    }
