 ...
 * output class name
 */
public abstract class AbstractBanBaseDataUI extends com.kingdee.eas.framework.client.CoreUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractBanBaseDataUI.class);
     ...
     */
    public AbstractBanBaseDataUI() throws Exception
    {
        super();
        jbInit();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractBanBaseDataUI.class.getName());
    ...
    public void initUIContentLayout()
    {
        ...
        this.setLayout(null);
        btnConfirm.setBounds(new Rectangle(41, 73, 76, 19));
        this.add(btnConfirm, null);
        btnCancel.setBounds(new Rectangle(187, 73, 77, 19));
        this.add(btnCancel, null);
        contBanBasedataEntry.setBounds(new Rectangle(26, 28, 270, 19));
        this.add(contBanBasedataEntry, null);
        //contBanBasedataEntry
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.sellhouse.app.BanBaseDataUIHandler";
	}
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.sellhouse.client", "BanBaseDataUI");
    }
