 ...
 * output class name
 */
public abstract class AbstractRoomJoinNoticeUI extends com.kingdee.eas.framework.client.BillEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractRoomJoinNoticeUI.class);
    ...
    protected com.kingdee.eas.fdc.sellhouse.RoomJoinNoticeInfo editData = null;
    /**
     * output class constructor
     */
    public AbstractRoomJoinNoticeUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractRoomJoinNoticeUI.class.getName());
        ...
        // txtPaper		
        this.txtPaper.setMaxLength(499);
        // txtDescOne		
        this.txtDescOne.setMaxLength(499);
        // txtDescTwo		
        this.txtDescTwo.setMaxLength(499);
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.sellhouse.app.RoomJoinNoticeUIHandler";
	}
    ...
    public void setDataObject(IObjectValue dataObject)
    {
        ...
        this.editData = (com.kingdee.eas.fdc.sellhouse.RoomJoinNoticeInfo)ov;
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.sellhouse.client", "RoomJoinNoticeUI");
    }
