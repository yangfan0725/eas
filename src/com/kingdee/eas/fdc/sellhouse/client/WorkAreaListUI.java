 ...
 * output class name
 */
public class WorkAreaListUI extends AbstractWorkAreaListUI
{
    private static final Logger logger = CoreUIObject.getLogger(WorkAreaListUI.class);
    
    /**
     * output class constructor
     */
    public WorkAreaListUI() throws Exception
    {
        super();
    }
    ...
    public void actionRemove_actionPerformed(ActionEvent e) throws Exception
    {
		...
		if(idStr!=null) {
			...
			filter.getFilterItems().add(new FilterItemInfo("workArea.id",idStr));
	...
	protected String getEditUIName() {
		return WorkAreaEditUI.class.getName();
	}
