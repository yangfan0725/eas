 ...
 * output class name
 */
public abstract class AbstractCommerceChanceJoinUI extends com.kingdee.eas.framework.client.EditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractCommerceChanceJoinUI.class);
     ...
     */
    public AbstractCommerceChanceJoinUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractCommerceChanceJoinUI.class.getName());
    ...
    public void initUIContentLayout()
    {
        ...
        this.setLayout(null);
        btnConfirm.setBounds(new Rectangle(100, 150, 95, 25));
        this.add(btnConfirm, null);
        btnQuit.setBounds(new Rectangle(240, 150, 95, 25));
        this.add(btnQuit, null);
        kDLabelContainer1.setBounds(new Rectangle(80, 65, 270, 19));
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.sellhouse.app.CommerceChanceJoinUIHandler";
	}
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.sellhouse.client", "CommerceChanceJoinUI");
    }
