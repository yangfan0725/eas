 ...
 * output class name
 */
public abstract class AbstractAccountReportUI extends com.kingdee.eas.framework.report.client.CommRptBaseUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractAccountReportUI.class);
    ...
    protected com.kingdee.bos.ctrl.swing.KDWorkButton btnGenDefault;
    protected ActionOverdue actionOverdue = null;
    protected ActionGenDefault actionGenDefault = null;
    /**
     * output class constructor
     */
    public AbstractAccountReportUI() throws Exception
    {
        super();
        jbInit();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractAccountReportUI.class.getName());
        ...
        //actionGenDefault
        this.actionGenDefault = new ActionGenDefault(this);
        getActionManager().registerAction("actionGenDefault", actionGenDefault);
         this.actionGenDefault.addService(new com.kingdee.eas.framework.client.service.PermissionService());
        ...
        this.btnGenDefault = new com.kingdee.bos.ctrl.swing.KDWorkButton();
        this.kDSplitPane1.setName("kDSplitPane1");
        this.tblMain.setName("tblMain");
        this.treeView.setName("treeView");
        this.treeMain.setName("treeMain");
        this.btnOverdue.setName("btnOverdue");
        this.btnGenDefault.setName("btnGenDefault");
        // CoreUI
        // kDSplitPane1		
        ...
        // btnGenDefault
        this.btnGenDefault.setAction((IItemAction)ActionProxyFactory.getProxy(actionGenDefault, new Class[] { IItemAction.class }, getServiceContext()));		
        this.btnGenDefault.setText(resHelper.getString("btnGenDefault.text"));
    ...
    public void initUIContentLayout()
    {
        ...
        this.add(kDSplitPane1, new KDLayout.Constraints(7, 9, 999, 586, KDLayout.Constraints.ANCHOR_TOP | KDLayout.Constraints.ANCHOR_BOTTOM | KDLayout.Constraints.ANCHOR_LEFT | KDLayout.Constraints.ANCHOR_RIGHT));
        //kDSplitPane1
    ...
    public void initUIToolBarLayout()
    {
        ...
        this.toolBar.add(btnGenDefault);
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.sellhouse.app.AccountReportUIHandler";
	}
    ...
    /**
     * output actionGenDefault_actionPerformed method
     */
	...
	public RequestContext prepareActionGenDefault(IItemAction itemAction) throws Exception {
			RequestContext request = new RequestContext();		
		if (request != null) {
    		request.setClassName(getUIHandlerClassName());
		}
	...
	public boolean isPrepareActionGenDefault() {
    	return false;
    }
    ...
    protected class ActionOverdue extends ItemAction {     
        ...
        public void actionPerformed(ActionEvent e)
        {
            ...
            innerActionPerformed("eas", AbstractAccountReportUI.this, "ActionOverdue", "actionOverdue_actionPerformed", e);
        }
    }

    /**
     * output ActionGenDefault class
     */     
    protected class ActionGenDefault extends ItemAction {     
    
        public ActionGenDefault()
        {
            this(null);
        }

        public ActionGenDefault(IUIObject uiObject)
        {     
		super(uiObject);     
        
            String _tempStr = null;
            _tempStr = resHelper.getString("ActionGenDefault.SHORT_DESCRIPTION");
            this.putValue(ItemAction.SHORT_DESCRIPTION, _tempStr);
            _tempStr = resHelper.getString("ActionGenDefault.LONG_DESCRIPTION");
            this.putValue(ItemAction.LONG_DESCRIPTION, _tempStr);
            _tempStr = resHelper.getString("ActionGenDefault.NAME");
            this.putValue(ItemAction.NAME, _tempStr);
        }
        ...
        {
        	getUIContext().put("ORG.PK", getOrgPK(this));
            innerActionPerformed("eas", AbstractAccountReportUI.this, "ActionGenDefault", "actionGenDefault_actionPerformed", e);
        }
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.sellhouse.client", "AccountReportUI");
    }
