 ...
 * output class name
 */
public class HopedTotalPricesEditUI extends AbstractHopedTotalPricesEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(HopedTotalPricesEditUI.class);
    
    /**
     * output class constructor
     */
    public HopedTotalPricesEditUI() throws Exception
    {
        super();
    }
	...
	protected IObjectValue createNewData() {
		HopedTotalPricesInfo value = new HopedTotalPricesInfo();
		return value;
	}
	...
	protected void verifyInput(ActionEvent e) throws Exception {
		...
		if(HopedTotalPricesFactory.getRemoteInstance().exists(filter)){
