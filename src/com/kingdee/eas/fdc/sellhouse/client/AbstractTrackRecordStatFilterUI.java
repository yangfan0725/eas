 ...
 * output class name
 */
public abstract class AbstractTrackRecordStatFilterUI extends com.kingdee.eas.base.commonquery.client.CustomerQueryPanel
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractTrackRecordStatFilterUI.class);
     ...
     */
    public AbstractTrackRecordStatFilterUI() throws Exception
    {
        super();
        jbInit();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractTrackRecordStatFilterUI.class.getName());
    ...
    public void initUIContentLayout()
    {
        ...
        plDateType.setBounds(new Rectangle(7, 68, 167, 141));
        ...
        chkIsShowAll.setBounds(new Rectangle(13, 218, 162, 19));
        ...
        radioByQuarter.setBounds(new Rectangle(32, 72, 61, 19));
        plDateType.add(radioByQuarter, null);
        radioByYear.setBounds(new Rectangle(32, 99, 61, 19));
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.sellhouse.app.TrackRecordStatFilterUIHandler";
	}
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.sellhouse.client", "TrackRecordStatFilterUI");
    }
