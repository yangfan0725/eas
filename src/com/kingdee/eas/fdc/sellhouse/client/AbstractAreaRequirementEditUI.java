 ...
 * output class name
 */
public abstract class AbstractAreaRequirementEditUI extends com.kingdee.eas.fdc.basedata.client.FDCBaseDataEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractAreaRequirementEditUI.class);
    ...
    protected com.kingdee.eas.fdc.sellhouse.AreaRequirementInfo editData = null;
    /**
     * output class constructor
     */
    public AbstractAreaRequirementEditUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractAreaRequirementEditUI.class.getName());
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.sellhouse.app.AreaRequirementEditUIHandler";
	}
    ...
    public void setDataObject(IObjectValue dataObject)
    {
        ...
        this.editData = (com.kingdee.eas.fdc.sellhouse.AreaRequirementInfo)ov;
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.sellhouse.client", "AreaRequirementEditUI");
    }
