 ...
 * output class name
 */
public abstract class AbstractReceiveBillEntryEidtUI extends com.kingdee.eas.fdc.basedata.client.FDCBillEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractReceiveBillEntryEidtUI.class);
     ...
     */
    public AbstractReceiveBillEntryEidtUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractReceiveBillEntryEidtUI.class.getName());
    ...
    public void initUIContentLayout()
    {
        ...
        contAuditor.setBounds(new Rectangle(381, 245, 270, 19));
        this.add(contAuditor, new KDLayout.Constraints(381, 245, 270, 19, 0));
        contAuditTime.setBounds(new Rectangle(10, 245, 270, 19));
        this.add(contAuditTime, new KDLayout.Constraints(10, 245, 270, 19, 0));
        contCreateTime.setBounds(new Rectangle(10, 279, 270, 19));
        this.add(contCreateTime, new KDLayout.Constraints(10, 279, 270, 19, 0));
        contBillDate.setBounds(new Rectangle(381, 13, 270, 19));
        this.add(contBillDate, new KDLayout.Constraints(381, 13, 270, 19, 0));
        contCreator.setBounds(new Rectangle(381, 278, 270, 19));
        this.add(contCreator, new KDLayout.Constraints(381, 278, 270, 19, 0));
        ...
        contPayQuomodo.setBounds(new Rectangle(676, 245, 270, 19));
        this.add(contPayQuomodo, new KDLayout.Constraints(676, 245, 270, 19, 0));
        kDTable1.setBounds(new Rectangle(13, 312, 932, 164));
        this.add(kDTable1, new KDLayout.Constraints(13, 312, 932, 164, 0));
        btnAdd.setBounds(new Rectangle(786, 278, 70, 19));
        this.add(btnAdd, new KDLayout.Constraints(786, 278, 70, 19, 0));
        btnDelete.setBounds(new Rectangle(874, 278, 70, 19));
        this.add(btnDelete, new KDLayout.Constraints(874, 278, 70, 19, 0));
        //contPurchase
    ...
    protected class ActionRec extends ItemAction
    {
        ...
        public void actionPerformed(ActionEvent e)
        {
            ...
            innerActionPerformed("eas", AbstractReceiveBillEntryEidtUI.this, "ActionRec", "actionRec_actionPerformed", e);
        }
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.sellhouse.client", "ReceiveBillEntryEidtUI");
    }
