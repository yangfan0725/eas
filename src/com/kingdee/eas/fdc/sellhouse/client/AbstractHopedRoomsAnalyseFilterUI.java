 ...
 * output class name
 */
public abstract class AbstractHopedRoomsAnalyseFilterUI extends com.kingdee.eas.base.commonquery.client.CustomerQueryPanel
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractHopedRoomsAnalyseFilterUI.class);
    ...
    protected com.kingdee.bos.ctrl.swing.KDCheckBox chkIsSellHouseSystem;
    protected com.kingdee.bos.ctrl.swing.KDPanel kDPanel1;
    protected com.kingdee.bos.ctrl.swing.KDCheckBox chkIsTenancySystem;
    protected com.kingdee.bos.ctrl.swing.KDCheckBox chkIsShowAll;
    /**
     * output class constructor
     */
    public AbstractHopedRoomsAnalyseFilterUI() throws Exception
    {
        super();
        jbInit();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractHopedRoomsAnalyseFilterUI.class.getName());
        ...
        this.chkIsSellHouseSystem = new com.kingdee.bos.ctrl.swing.KDCheckBox();
        this.kDPanel1 = new com.kingdee.bos.ctrl.swing.KDPanel();
        this.chkIsTenancySystem = new com.kingdee.bos.ctrl.swing.KDCheckBox();
        ...
        this.chkIsSellHouseSystem.setName("chkIsSellHouseSystem");
        this.kDPanel1.setName("kDPanel1");
        this.chkIsTenancySystem.setName("chkIsTenancySystem");
        ...
        // spiYearTo		
        this.spiYearTo.setToolTipText(resHelper.getString("spiYearTo.toolTipText"));
        // contYearTo		
        ...
        // chkIsSellHouseSystem		
        this.chkIsSellHouseSystem.setText(resHelper.getString("chkIsSellHouseSystem.text"));
        // kDPanel1		
        this.kDPanel1.setBorder(new TitledBorder(BorderFactory.createEtchedBorder(new Color(255,255,255),new Color(148,145,140)), resHelper.getString("kDPanel1.border.title")));		
        this.kDPanel1.setEnabled(false);		
        this.kDPanel1.setVisible(false);
        // chkIsTenancySystem		
        this.chkIsTenancySystem.setText(resHelper.getString("chkIsTenancySystem.text"));
        // chkIsShowAll		
    ...
    public void initUIContentLayout()
    {
        ...
        kDPanel1.setBounds(new Rectangle(10, 149, 359, 96));
        this.add(kDPanel1, new KDLayout.Constraints(10, 149, 359, 96, 0));
        chkIsShowAll.setBounds(new Rectangle(15, 121, 190, 19));
        this.add(chkIsShowAll, new KDLayout.Constraints(15, 121, 190, 19, 0));
        //contDateFrom
        ...
        //kDPanel1
        kDPanel1.setLayout(null);        chkIsSellHouseSystem.setBounds(new Rectangle(23, 20, 140, 19));
        kDPanel1.add(chkIsSellHouseSystem, null);
        chkIsTenancySystem.setBounds(new Rectangle(23, 52, 140, 19));
        kDPanel1.add(chkIsTenancySystem, null);
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.sellhouse.app.HopedRoomsAnalyseFilterUIHandler";
	}
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.sellhouse.client", "HopedRoomsAnalyseFilterUI");
    }
