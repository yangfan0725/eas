 ...
 * output class name
 */
public class SellStatRptFilterUI extends AbstractSellStatRptFilterUI {
	private static final String IS_SPECIAL_BIZ_INTO_SALE = "isSpecialBizIntoSale";
	 ...
	 */
	public SellStatRptFilterUI(ListUI listUI, ItemAction actionListOnLoad)
			throws Exception {
		this(listUI, actionListOnLoad, true);
	}

	//明细表和区间统计表公用该过滤界面,但明细表暂无法查询特殊业务
	public SellStatRptFilterUI(ListUI listUI, ItemAction actionListOnLoad, boolean isUseSpecialChk) throws Exception {
		super();
		this.listUI = listUI;
	...
	public void clear() {
		...
		this.chkIsSpecialBizIntoSaleStat.setSelected(true);
	...
	public FilterInfo getFilterInfo() {
		...
		filter.getFilterItems().add(new FilterItemInfo(IS_SPECIAL_BIZ_INTO_SALE, new Integer(para.getBoolean(IS_SPECIAL_BIZ_INTO_SALE)?1:0)));
	...
	public CustomerParams getCustomerParams() {
		...
		param.add(IS_SPECIAL_BIZ_INTO_SALE, this.chkIsSpecialBizIntoSaleStat.isSelected());
	...
	public void onLoad() throws Exception {
		...
		this.chkIsSpecialBizIntoSaleStat.setVisible(isUseSpecialChk);
	...
	public void setCustomerParams(CustomerParams cp) {
		...
		this.chkIsSpecialBizIntoSaleStat.setSelected(para.getBoolean(IS_SPECIAL_BIZ_INTO_SALE));
	...
	public boolean isSpecialBizIntoSale(FDCCustomerParams para){
		return para.getBoolean(IS_SPECIAL_BIZ_INTO_SALE);
	}
