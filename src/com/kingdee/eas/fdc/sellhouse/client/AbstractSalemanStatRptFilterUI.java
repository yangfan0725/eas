 ...
 * output class name
 */
public abstract class AbstractSalemanStatRptFilterUI extends com.kingdee.eas.base.commonquery.client.CustomerQueryPanel
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractSalemanStatRptFilterUI.class);
     ...
     */
    public AbstractSalemanStatRptFilterUI() throws Exception
    {
        super();
        jbInit();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractSalemanStatRptFilterUI.class.getName());
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.sellhouse.app.SalemanStatRptFilterUIHandler";
	}
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.sellhouse.client", "SalemanStatRptFilterUI");
    }
