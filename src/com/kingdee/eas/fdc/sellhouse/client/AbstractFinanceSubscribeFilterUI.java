 ...
 * output class name
 */
public abstract class AbstractFinanceSubscribeFilterUI extends com.kingdee.eas.base.commonquery.client.CustomerQueryPanel
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractFinanceSubscribeFilterUI.class);
     ...
     */
    public AbstractFinanceSubscribeFilterUI() throws Exception
    {
        super();
        jbInit();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractFinanceSubscribeFilterUI.class.getName());
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.sellhouse.app.FinanceSubscribeFilterUIHandler";
	}
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.sellhouse.client", "FinanceSubscribeFilterUI");
    }
