 ...
 * output class name
 */
public abstract class AbstractHopedFloorEditUI extends com.kingdee.eas.fdc.basedata.client.FDCBaseDataEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractHopedFloorEditUI.class);
    ...
    protected com.kingdee.eas.fdc.sellhouse.HopedFloorInfo editData = null;
    /**
     * output class constructor
     */
    public AbstractHopedFloorEditUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractHopedFloorEditUI.class.getName());
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.sellhouse.app.HopedFloorEditUIHandler";
	}
    ...
    public void setDataObject(IObjectValue dataObject)
    {
        ...
        this.editData = (com.kingdee.eas.fdc.sellhouse.HopedFloorInfo)ov;
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.sellhouse.client", "HopedFloorEditUI");
    }
