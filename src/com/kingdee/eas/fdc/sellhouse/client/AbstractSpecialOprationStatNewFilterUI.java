 ...
 * output class name
 */
public abstract class AbstractSpecialOprationStatNewFilterUI extends com.kingdee.eas.base.commonquery.client.CustomerQueryPanel
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractSpecialOprationStatNewFilterUI.class);
     ...
     */
    public AbstractSpecialOprationStatNewFilterUI() throws Exception
    {
        super();
        jbInit();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractSpecialOprationStatNewFilterUI.class.getName());
    ...
    {
        this.setBounds(new Rectangle(10, 10, 420, 300));
        this.setLayout(new KDLayout());
        this.putClientProperty("OriginalBounds", new Rectangle(10, 10, 420, 300));
        plDateType.setBounds(new Rectangle(10, 10, 400, 137));
        this.add(plDateType, new KDLayout.Constraints(10, 10, 400, 137, 0));
        kDPanel1.setBounds(new Rectangle(10, 183, 400, 56));
        this.add(kDPanel1, new KDLayout.Constraints(10, 183, 400, 56, 0));
        chkIsShowAll.setBounds(new Rectangle(14, 152, 174, 19));
        this.add(chkIsShowAll, new KDLayout.Constraints(14, 152, 174, 19, 0));
        //plDateType
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.sellhouse.app.SpecialOprationStatNewFilterUIHandler";
	}
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.sellhouse.client", "SpecialOprationStatNewFilterUI");
    }
