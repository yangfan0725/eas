 ...
 * output class name
 */
public class MonthCommissionListUI extends AbstractMonthCommissionListUI
{
    private static final Logger logger = CoreUIObject.getLogger(MonthCommissionListUI.class);
    
    public MonthCommissionListUI() throws Exception
    {
        super();
    }
    @Override
	...
	protected String getEditUIName() {
		// TODO Auto-generated method stub
		return MonthCommissionEditUI.class.getName();
	}
	...
	public void actionAudit_actionPerformed(ActionEvent e) throws Exception {
		...
		MonthCommissionFactory.getRemoteInstance().audit(BOSUuid.read(id));
		this.refresh(e);
	}
	public void actionUnAudit_actionPerformed(ActionEvent e) throws Exception {
		...
		MonthCommissionFactory.getRemoteInstance().unAudit(BOSUuid.read(id));
		this.refresh(e);
	}
	 public void checkBeforeAuditOrUnAudit(FDCBillStateEnum state,
			String warning, String id) throws Exception {
		FDCClientUtils.checkBillInWorkflow(this, id);
		MonthCommissionInfo info = MonthCommissionFactory
				.getRemoteInstance().getMonthCommissionInfo(
	 ...
	 public void actionEdit_actionPerformed(ActionEvent e) throws Exception {
		...
		protected void checkBeforeEditOrRemove(String warning,String id) throws EASBizException, BOSException, Exception {
			...
			sels.add("state");
			sels.add("creator.id");
			MonthCommissionInfo info=(MonthCommissionInfo)getBizInterface().getValue(new ObjectUuidPK(id),sels);
