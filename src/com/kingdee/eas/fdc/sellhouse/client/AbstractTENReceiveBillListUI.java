 ...
 * output class name
 */
public abstract class AbstractTENReceiveBillListUI extends com.kingdee.eas.fdc.sellhouse.client.ReceiveBillListUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractTENReceiveBillListUI.class);
    /**
     * output class constructor
     */
    public AbstractTENReceiveBillListUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractTENReceiveBillListUI.class.getName());
        ...
        this.tblMain.setFormatXml(resHelper.getString("tblMain.formatXml"));
                this.tblMain.putBindContents("mainQuery",new String[] {"id","billStatus","number","bizDate","building.name","room.unit","room.number","purchase.number","tenancyContract.number","moneyDefine.name","fdcReceiveBillEntry.amount","payerName","fdcReceiveBill.receiptNumber","invoice.number","invoice.amount","settlementType.name","fdcReceiveBill.id","salesman.name","tenancyAdviser.name","description"});
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.sellhouse.app.TENReceiveBillListUIHandler";
	}
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.sellhouse.client", "TENReceiveBillListUI");
    }
