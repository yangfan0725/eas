 ...
 * output class name
 */
public abstract class AbstractPropertyDoSchemeListUI extends com.kingdee.eas.framework.client.TreeListUI implements KDPromptSelector
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractPropertyDoSchemeListUI.class);
				private boolean isF7Use;
		private com.kingdee.eas.framework.client.F7Render f7Delegate;
		public AbstractPropertyDoSchemeListUI(HashMap ctx) throws Exception {
			super();
			isF7Use = true;
     ...
     */
    public AbstractPropertyDoSchemeListUI() throws Exception
    {
        super();
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.sellhouse.app.PropertyDoSchemeListUIHandler";
	}
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.sellhouse.client", "PropertyDoSchemeListUI");
    }
