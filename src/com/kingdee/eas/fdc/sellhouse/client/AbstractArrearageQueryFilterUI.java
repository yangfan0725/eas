...
public abstract class AbstractArrearageQueryFilterUI extends com.kingdee.eas.base.commonquery.client.CustomerQueryPanel
{
    ...
    protected com.kingdee.bos.ctrl.swing.KDButton chackAll;
    protected com.kingdee.bos.ctrl.swing.KDButton canotAll;
    ...
    protected com.kingdee.bos.ctrl.swing.KDRadioButton checkYuQiArage;
    protected com.kingdee.bos.ctrl.swing.KDRadioButton checkUnYuQiArage;
    protected com.kingdee.bos.ctrl.swing.KDRadioButton checkYuQiPay;
    protected com.kingdee.bos.ctrl.swing.KDRadioButton checkPayOnTime;
    protected com.kingdee.bos.ctrl.swing.KDButtonGroup arrGroup;
    ...
    private void jbInit() throws Exception
    {
        ...
        this.chackAll = new com.kingdee.bos.ctrl.swing.KDButton();
        this.canotAll = new com.kingdee.bos.ctrl.swing.KDButton();
        ...
        this.checkYuQiArage = new com.kingdee.bos.ctrl.swing.KDRadioButton();
        this.checkUnYuQiArage = new com.kingdee.bos.ctrl.swing.KDRadioButton();
        this.checkYuQiPay = new com.kingdee.bos.ctrl.swing.KDRadioButton();
        this.checkPayOnTime = new com.kingdee.bos.ctrl.swing.KDRadioButton();
        this.arrGroup = new com.kingdee.bos.ctrl.swing.KDButtonGroup();
        ...
        this.chackAll.setName("chackAll");
        this.canotAll.setName("canotAll");
        ...
        // purEndDate
        // tblMoneyType
		String tblMoneyTypeStrXML = "<?xml version=\"1.0\" encoding=\"UTF-8\"?> <DocRoot xmlns:c=\"http://www.kingdee.com/Common\" xmlns:f=\"http://www.kingdee.com/Form\" xmlns:t=\"http://www.kingdee.com/Table\" xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" xsi:schemaLocation=\"http://www.kingdee.com/KDF KDFSchema.xsd\" version=\"0.0\"><Styles /><Table id=\"KDTable\"><t:Sheet name=\"sheet1\"><t:Table t:selectMode=\"15\" t:mergeMode=\"0\" t:dataRequestMode=\"0\" t:pageRowCount=\"100\"><t:ColumnGroup><t:Column t:key=\"moneyTypeA\" t:width=\"100\" t:mergeable=\"true\" t:resizeable=\"true\" t:moveable=\"true\" t:group=\"false\" t:required=\"false\" t:index=\"-1\" /><t:Column t:key=\"selectA\" t:width=\"40\" t:mergeable=\"true\" t:resizeable=\"true\" t:moveable=\"true\" t:group=\"false\" t:required=\"false\" t:index=\"-1\" /><t:Column t:key=\"moneyTypeB\" t:width=\"100\" t:mergeable=\"true\" t:resizeable=\"true\" t:moveable=\"true\" t:group=\"false\" t:required=\"false\" t:index=\"-1\" /><t:Column t:key=\"selectB\" t:width=\"40\" t:mergeable=\"true\" t:resizeable=\"true\" t:moveable=\"true\" t:group=\"false\" t:required=\"false\" t:index=\"-1\" /><t:Column t:key=\"moneyTypeC\" t:width=\"100\" t:mergeable=\"true\" t:resizeable=\"true\" t:moveable=\"true\" t:group=\"false\" t:required=\"false\" t:index=\"-1\" /><t:Column t:key=\"selectC\" t:width=\"40\" t:mergeable=\"true\" t:resizeable=\"true\" t:moveable=\"true\" t:group=\"false\" t:required=\"false\" t:index=\"-1\" /></t:ColumnGroup><t:Head><t:Row t:name=\"header1\" t:height=\"-1\" t:mergeable=\"true\" t:resizeable=\"true\"><t:Cell>$Resource{moneyTypeA}</t:Cell><t:Cell>$Resource{selectA}</t:Cell><t:Cell>$Resource{moneyTypeB}</t:Cell><t:Cell>$Resource{selectB}</t:Cell><t:Cell>$Resource{moneyTypeC}</t:Cell><t:Cell>$Resource{selectC}</t:Cell></t:Row></t:Head></t:Table><t:SheetOptions><t:MergeBlocks><t:Head /></t:MergeBlocks></t:SheetOptions></t:Sheet></Table></DocRoot> ";
		
        this.tblMoneyType.setFormatXml(resHelper.translateString("tblMoneyType",tblMoneyTypeStrXML));
        ...
        // chackAll		
        this.chackAll.setText(resHelper.getString("chackAll.text"));
        this.chackAll.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent e) {
                beforeActionPerformed(e);
                try {
                    chackAll_actionPerformed(e);
                } catch (Exception exc) {
                    handUIException(exc);
                } finally {
        ...
        // canotAll		
        this.canotAll.setText(resHelper.getString("canotAll.text"));
        this.canotAll.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent e) {
                beforeActionPerformed(e);
                try {
                    canotAll_actionPerformed(e);
                } catch (Exception exc) {
                    handUIException(exc);
                } finally {
                    afterActionPerformed(e);
        ...
        // dpAppBeginDate
        this.dpAppBeginDate.addDataChangeListener(new com.kingdee.bos.ctrl.swing.event.DataChangeListener() {
            public void dataChanged(com.kingdee.bos.ctrl.swing.event.DataChangeEvent e) {
                try {
                    dpAppBeginDate_dataChanged(e);
                } catch (Exception exc) {
                    handUIException(exc);
                } finally {
                }
        ...
        // arrGroup
        this.arrGroup.add(this.checkYuQiArage);
        this.arrGroup.add(this.checkUnYuQiArage);
        this.arrGroup.add(this.checkYuQiPay);
        this.arrGroup.add(this.checkPayOnTime);
        // chkPrePur		
        this.chkPrePur.setText(resHelper.getString("chkPrePur.text"));		
        this.chkPrePur.setSelectState(1);
        this.chkPrePur.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent e) {
                beforeActionPerformed(e);
                try {
                    chkPrePur_actionPerformed(e);
                } catch (Exception exc) {
                    handUIException(exc);
                } finally {
                    afterActionPerformed(e);
    ...
    public void initUIContentLayout()
    {
        ...
        this.setLayout(null);
        kDPanel1.setBounds(new Rectangle(1, 238, 499, 47));
        this.add(kDPanel1, null);
        kDPanel2.setBounds(new Rectangle(1, 114, 498, 125));
        this.add(kDPanel2, null);
        kDPanel4.setBounds(new Rectangle(1, 284, 498, 50));
        this.add(kDPanel4, null);
        kDLabelContainer1.setBounds(new Rectangle(20, 47, 171, 19));
        this.add(kDLabelContainer1, null);
        kDPanel5.setBounds(new Rectangle(1, 333, 498, 41));
        this.add(kDPanel5, null);
        kDPanel3.setBounds(new Rectangle(1, 71, 499, 44));
        this.add(kDPanel3, null);
        kDPanel6.setBounds(new Rectangle(1, 1, 500, 41));
        this.add(kDPanel6, null);
        kDLabelContainer2.setBounds(new Rectangle(305, 45, 169, 21));
        this.add(kDLabelContainer2, null);
        //kDPanel1
        kDPanel1.setLayout(new KDLayout());
        kDPanel1.putClientProperty("OriginalBounds", new Rectangle(1, 238, 499, 47));        contDateFrom.setBounds(new Rectangle(20, 16, 170, 19));
        ...
        kDPanel2.putClientProperty("OriginalBounds", new Rectangle(1, 114, 498, 125));        tblMoneyType.setBounds(new Rectangle(13, 32, 466, 82));
        kDPanel2.add(tblMoneyType, new KDLayout.Constraints(13, 32, 466, 82, 0));
        chackAll.setBounds(new Rectangle(283, 10, 84, 21));
        kDPanel2.add(chackAll, new KDLayout.Constraints(283, 10, 84, 21, 0));
        canotAll.setBounds(new Rectangle(382, 10, 85, 21));
        kDPanel2.add(canotAll, new KDLayout.Constraints(382, 10, 85, 21, 0));
        //kDPanel4
        kDPanel4.setLayout(null);        kDLabelContainer3.setBounds(new Rectangle(19, 16, 170, 19));
        kDPanel4.add(kDLabelContainer3, null);
        kDLabelContainer4.setBounds(new Rectangle(303, 16, 170, 19));
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.sellhouse.app.ArrearageQueryFilterUIHandler";
	}
    ...
    /**
     * output chackAll_actionPerformed method
     */
    ...
    /**
     * output canotAll_actionPerformed method
     */
    ...
    /**
     * output dpAppBeginDate_dataChanged method
     */
    protected void dpAppBeginDate_dataChanged(com.kingdee.bos.ctrl.swing.event.DataChangeEvent e) throws Exception
    {
    }
    ...
    /**
     * output chkPrePur_actionPerformed method
     */
    protected void chkPrePur_actionPerformed(java.awt.event.ActionEvent e) throws Exception
    {
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.sellhouse.client", "ArrearageQueryFilterUI");
    }
