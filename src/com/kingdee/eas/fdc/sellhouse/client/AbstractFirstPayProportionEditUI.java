 ...
 * output class name
 */
public abstract class AbstractFirstPayProportionEditUI extends com.kingdee.eas.fdc.basedata.client.FDCBaseDataEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractFirstPayProportionEditUI.class);
    ...
    protected com.kingdee.eas.fdc.sellhouse.FirstPayProportionInfo editData = null;
    /**
     * output class constructor
     */
    public AbstractFirstPayProportionEditUI() throws Exception
    {
        super();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractFirstPayProportionEditUI.class.getName());
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.sellhouse.app.FirstPayProportionEditUIHandler";
	}
    ...
    public void setDataObject(IObjectValue dataObject)
    {
        ...
        this.editData = (com.kingdee.eas.fdc.sellhouse.FirstPayProportionInfo)ov;
    }
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.sellhouse.client", "FirstPayProportionEditUI");
    }
