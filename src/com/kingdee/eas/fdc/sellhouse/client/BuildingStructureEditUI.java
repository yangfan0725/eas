 ...
 * @date 20110613
 */
public class BuildingStructureEditUI extends AbstractBuildingStructureEditUI
{
    private static final Logger logger = CoreUIObject.getLogger(BuildingStructureEditUI.class);
    SaleOrgUnitInfo saleOrg = SHEHelper.getCurrentSaleOrg();
    /**
     * output class constructor
     */
    public BuildingStructureEditUI() throws Exception
    {
        super();
    }
	...
	protected IObjectValue createNewData(){
		BuildingStructureInfo buildingStructureInfo = new BuildingStructureInfo();
		buildingStructureInfo.setIsEnabled(true);
		return buildingStructureInfo;
	}
...
//					new FilterItemInfo("buildingStructure.id", selectID));
...
//			filter.getFilterItems().add(
//					new FilterItemInfo("builStruct.id", selectID));
