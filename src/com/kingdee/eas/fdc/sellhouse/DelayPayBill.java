...
public class DelayPayBill extends CoreBillBase implements IDelayPayBill
{
    public DelayPayBill()
    {
        super();
        registerInterface(IDelayPayBill.class, this);
    }
    public DelayPayBill(Context ctx)
    {
        super(ctx);
        registerInterface(IDelayPayBill.class, this);
    }
    ...
    private DelayPayBillController getController() throws BOSException
    {
        return (DelayPayBillController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getDelayPayBillInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getDelayPayBillInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getDelayPayBillInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getDelayPayBillCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getDelayPayBillCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getDelayPayBillCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
