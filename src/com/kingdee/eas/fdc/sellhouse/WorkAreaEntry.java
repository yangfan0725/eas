...
public class WorkAreaEntry extends AbstractBizCtrl implements IWorkAreaEntry
{
    public WorkAreaEntry()
    {
        super();
        registerInterface(IWorkAreaEntry.class, this);
    }
    public WorkAreaEntry(Context ctx)
    {
        super(ctx);
        registerInterface(IWorkAreaEntry.class, this);
    }
    ...
    private WorkAreaEntryController getController() throws BOSException
    {
        return (WorkAreaEntryController)getBizController();
    }
    /**
