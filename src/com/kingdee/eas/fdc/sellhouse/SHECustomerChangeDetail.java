...
public class SHECustomerChangeDetail extends CoreBillBase implements ISHECustomerChangeDetail
{
    public SHECustomerChangeDetail()
    {
        super();
        registerInterface(ISHECustomerChangeDetail.class, this);
    }
    public SHECustomerChangeDetail(Context ctx)
    {
        super(ctx);
        registerInterface(ISHECustomerChangeDetail.class, this);
    }
    ...
    private SHECustomerChangeDetailController getController() throws BOSException
    {
        return (SHECustomerChangeDetailController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getSHECustomerChangeDetailInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getSHECustomerChangeDetailInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getSHECustomerChangeDetailInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getSHECustomerChangeDetailCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getSHECustomerChangeDetailCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getSHECustomerChangeDetailCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
