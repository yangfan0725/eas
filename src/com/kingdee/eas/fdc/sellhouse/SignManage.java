...
public class SignManage extends BaseTransaction implements ISignManage
{
    public SignManage()
    {
        super();
        registerInterface(ISignManage.class, this);
    }
    public SignManage(Context ctx)
    {
        super(ctx);
        registerInterface(ISignManage.class, this);
    }
    ...
    private SignManageController getController() throws BOSException
    {
        return (SignManageController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getSignManageInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getSignManageInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getSignManageInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getSignManageCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getSignManageCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getSignManageCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            getController().onRecord(getContext(), id, date, contractNumber);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            getController().unOnRecord(getContext(), id);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
