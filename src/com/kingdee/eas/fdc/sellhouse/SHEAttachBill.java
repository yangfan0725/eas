...
public class SHEAttachBill extends FDCBill implements ISHEAttachBill
{
    public SHEAttachBill()
    {
        super();
        registerInterface(ISHEAttachBill.class, this);
    }
    public SHEAttachBill(Context ctx)
    {
        super(ctx);
        registerInterface(ISHEAttachBill.class, this);
    }
    ...
    private SHEAttachBillController getController() throws BOSException
    {
        return (SHEAttachBillController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getSHEAttachBillInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getSHEAttachBillInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getSHEAttachBillInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getSHEAttachBillCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getSHEAttachBillCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getSHEAttachBillCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
