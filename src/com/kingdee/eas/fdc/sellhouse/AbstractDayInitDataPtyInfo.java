...
public class AbstractDayInitDataPtyInfo extends com.kingdee.eas.framework.CoreBaseInfo implements Serializable 
{
    public AbstractDayInitDataPtyInfo()
    {
        this("id");
    }
    protected AbstractDayInitDataPtyInfo(String pkField)
    {
        super(pkField);
    }
    /**
     * Object:月结项目产品初始's (已售套数)年初值property 
     */
    ...
    /**
     * Object:月结项目产品初始's (已售套数)累计初值property 
     */
    ...
    /**
     * Object:月结项目产品初始's (已售面积)年初值property 
     */
    ...
    /**
     * Object:月结项目产品初始's (已售面积)累计初值property 
     */
    ...
    /**
     * Object:月结项目产品初始's (合同总价)年初值property 
     */
    ...
    /**
     * Object:月结项目产品初始's (合同总价)累计初值property 
     */
    ...
    /**
     * Object:月结项目产品初始's (销售回款)年初值property 
     */
    ...
    /**
     * Object:月结项目产品初始's (销售回款)累计初值property 
     */
    ...
    /**
     * Object:月结项目产品初始's (按揭回款)年初值property 
     */
    ...
    /**
     * Object:月结项目产品初始's (按揭回款)累计初值property 
     */
    ...
    /**
     * Object:月结项目产品初始's (应收/退面积差额)年初值property 
     */
    ...
    /**
     * Object:月结项目产品初始's (应收/退面积差额)累计初值property 
     */
    ...
    /**
     * Object:月结项目产品初始's (已收/退面积差额)年初值property 
     */
    ...
    /**
     * Object:月结项目产品初始's (已收/退面积差额)累计初值property 
     */
    ...
    /**
     * Object: 月结项目产品初始 's 产品类型 property 
     */
