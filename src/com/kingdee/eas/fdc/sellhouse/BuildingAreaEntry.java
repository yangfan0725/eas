...
public class BuildingAreaEntry extends CoreBillEntryBase implements IBuildingAreaEntry
{
    public BuildingAreaEntry()
    {
        super();
        registerInterface(IBuildingAreaEntry.class, this);
    }
    public BuildingAreaEntry(Context ctx)
    {
        super(ctx);
        registerInterface(IBuildingAreaEntry.class, this);
    }
    ...
    private BuildingAreaEntryController getController() throws BOSException
    {
        return (BuildingAreaEntryController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getBuildingAreaEntryInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getBuildingAreaEntryInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getBuildingAreaEntryInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getBuildingAreaEntryCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getBuildingAreaEntryCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getBuildingAreaEntryCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
