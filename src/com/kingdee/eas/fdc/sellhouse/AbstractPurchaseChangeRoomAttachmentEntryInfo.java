...
public class AbstractPurchaseChangeRoomAttachmentEntryInfo extends com.kingdee.eas.framework.DataBaseInfo implements Serializable 
{
    public AbstractPurchaseChangeRoomAttachmentEntryInfo()
    {
        this("id");
    }
    protected AbstractPurchaseChangeRoomAttachmentEntryInfo(String pkField)
    {
        super(pkField);
    }
    /**
