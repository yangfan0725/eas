...
public class DefaultCollection extends FDCDataBase implements IDefaultCollection
{
    public DefaultCollection()
    {
        super();
        registerInterface(IDefaultCollection.class, this);
    }
    public DefaultCollection(Context ctx)
    {
        super(ctx);
        registerInterface(IDefaultCollection.class, this);
    }
    ...
    private DefaultCollectionController getController() throws BOSException
    {
        return (DefaultCollectionController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getDefaultCollectionInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getDefaultCollectionInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getDefaultCollectionInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getDefaultCollectionCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getDefaultCollectionCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getDefaultCollectionCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
