...
public class ChequeSellProjectEntry extends CoreBase implements IChequeSellProjectEntry
{
    public ChequeSellProjectEntry()
    {
        super();
        registerInterface(IChequeSellProjectEntry.class, this);
    }
    public ChequeSellProjectEntry(Context ctx)
    {
        super(ctx);
        registerInterface(IChequeSellProjectEntry.class, this);
    }
    ...
    private ChequeSellProjectEntryController getController() throws BOSException
    {
        return (ChequeSellProjectEntryController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getChequeSellProjectEntryInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getChequeSellProjectEntryInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getChequeSellProjectEntryInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getChequeSellProjectEntryCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getChequeSellProjectEntryCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getChequeSellProjectEntryCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
