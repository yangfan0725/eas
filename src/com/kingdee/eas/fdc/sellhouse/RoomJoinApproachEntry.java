...
public class RoomJoinApproachEntry extends CoreBillEntryBase implements IRoomJoinApproachEntry
{
    public RoomJoinApproachEntry()
    {
        super();
        registerInterface(IRoomJoinApproachEntry.class, this);
    }
    public RoomJoinApproachEntry(Context ctx)
    {
        super(ctx);
        registerInterface(IRoomJoinApproachEntry.class, this);
    }
    ...
    private RoomJoinApproachEntryController getController() throws BOSException
    {
        return (RoomJoinApproachEntryController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getRoomJoinApproachEntryInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getRoomJoinApproachEntryInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getRoomJoinApproachEntryInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getRoomJoinApproachEntryCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getRoomJoinApproachEntryCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getRoomJoinApproachEntryCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
