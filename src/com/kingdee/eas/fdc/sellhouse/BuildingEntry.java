...
public class BuildingEntry extends DataBase implements IBuildingEntry
{
    public BuildingEntry()
    {
        super();
        registerInterface(IBuildingEntry.class, this);
    }
    public BuildingEntry(Context ctx)
    {
        super(ctx);
        registerInterface(IBuildingEntry.class, this);
    }
    ...
    private BuildingEntryController getController() throws BOSException
    {
        return (BuildingEntryController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getBuildingEntryInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getBuildingEntryInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getBuildingEntryInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getBuildingEntryCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getBuildingEntryCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getBuildingEntryCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
