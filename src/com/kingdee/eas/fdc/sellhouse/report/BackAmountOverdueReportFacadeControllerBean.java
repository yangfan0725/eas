...
public class BackAmountOverdueReportFacadeControllerBean extends AbstractBackAmountOverdueReportFacadeControllerBean
{
	    ...
	    header.setLabels(new Object[][]{
	    		{
	    			...
	    			,"逾期","逾期","逾期","逾期","逾期","逾期","逾期","逾期","逾期","逾期","逾期","逾期","逾期","逾期"
	    			,"未逾期","未逾期","未逾期","未逾期","未逾期","未逾期","未逾期","未逾期","未逾期","未逾期","未逾期","未逾期","未逾期","未逾期"
	    			,"合计","合计","合计","合计","合计","合计","合计","合计","合计","合计","合计","合计","合计","合计"
	    		}
	    		,
	    		{
	    			"orgUnitId","sellProjectId","typeNumber","公司","项目","类型"
    ...
    protected String getSql(Context ctx,RptParams params){
    	...
    	sb.append(" union all");
    	sb.append(getTypeSql("'7'","'首付未齐'",sellProjectId,fromSignDate,toSignDate,fromAppDate,toAppDate,fromActDate,toActDate));
    	sb.append(" union all");
    	sb.append(getTypeSql("'8'","'首付齐，未签贷款合同'",sellProjectId,fromSignDate,toSignDate,fromAppDate,toAppDate,fromActDate,toActDate));
    	sb.append(" union all");
    	sb.append(getTypeSql("'9'","'已签贷款合同，资料未齐'",sellProjectId,fromSignDate,toSignDate,fromAppDate,toAppDate,fromActDate,toActDate));
    	sb.append(" union all");
    	sb.append(getTypeSql("'10'","'资料齐，送审阶段'",sellProjectId,fromSignDate,toSignDate,fromAppDate,toAppDate,fromActDate,toActDate));
    	sb.append(" union all");
    	sb.append(getTypeSql("'11'","'审批通过，抵押中'",sellProjectId,fromSignDate,toSignDate,fromAppDate,toAppDate,fromActDate,toActDate));
    	sb.append(" union all");
    	sb.append(getTypeSql("'12'","'办理完成'",sellProjectId,fromSignDate,toSignDate,fromAppDate,toAppDate,fromActDate,toActDate));
