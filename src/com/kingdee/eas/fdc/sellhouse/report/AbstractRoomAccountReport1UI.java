 ...
 * output class name
 */
public abstract class AbstractRoomAccountReport1UI extends com.kingdee.eas.framework.report.client.CommRptBaseUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractRoomAccountReport1UI.class);
     ...
     */
    public AbstractRoomAccountReport1UI() throws Exception
    {
        super();
        jbInit();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractRoomAccountReport1UI.class.getName());
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.sellhouse.report.RoomAccountReport1UIHandler";
	}
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.sellhouse.report", "RoomAccountReport1UI");
    }
