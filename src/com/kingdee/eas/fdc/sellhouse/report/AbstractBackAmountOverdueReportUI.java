 ...
 * output class name
 */
public abstract class AbstractBackAmountOverdueReportUI extends com.kingdee.eas.framework.report.client.CommRptBaseUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractBackAmountOverdueReportUI.class);
     ...
     */
    public AbstractBackAmountOverdueReportUI() throws Exception
    {
        super();
        jbInit();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractBackAmountOverdueReportUI.class.getName());
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.sellhouse.report.BackAmountOverdueReportUIHandler";
	}
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.sellhouse.report", "BackAmountOverdueReportUI");
    }
