 ...
 * output class name
 */
public abstract class AbstractAppAmountStructureReportUI extends com.kingdee.eas.framework.report.client.CommRptBaseUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractAppAmountStructureReportUI.class);
     ...
     */
    public AbstractAppAmountStructureReportUI() throws Exception
    {
        super();
        jbInit();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractAppAmountStructureReportUI.class.getName());
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.sellhouse.report.AppAmountStructureReportUIHandler";
	}
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.sellhouse.report", "AppAmountStructureReportUI");
    }
