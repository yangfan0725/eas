 ...
 * output class name
 */
public class SignAccountReportFilterUI extends AbstractSignAccountReportFilterUI
{
    private static final Logger logger = CoreUIObject.getLogger(SignAccountReportFilterUI.class);
    ...
    public SignAccountReportFilterUI() throws Exception
    {
        super();
    }
