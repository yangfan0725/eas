 ...
 * output class name
 */
public abstract class AbstractRoomAccountReport1FilterUI extends com.kingdee.eas.framework.report.client.CommRptBaseConditionUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractRoomAccountReport1FilterUI.class);
     ...
     */
    public AbstractRoomAccountReport1FilterUI() throws Exception
    {
        super();
        jbInit();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractRoomAccountReport1FilterUI.class.getName());
    ...
    public void initUIContentLayout()
    {
        ...
        this.setLayout(null);
        contFromDate.setBounds(new Rectangle(17, 59, 270, 19));
        this.add(contFromDate, null);
        contToDate.setBounds(new Rectangle(317, 59, 270, 19));
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.sellhouse.report.RoomAccountReport1FilterUIHandler";
	}
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.sellhouse.report", "RoomAccountReport1FilterUI");
    }
