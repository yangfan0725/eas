 ...
 * output class name
 */
public abstract class AbstractQuestionPaperReportUI extends com.kingdee.eas.framework.bireport.client.BireportBaseMainUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractQuestionPaperReportUI.class);
    protected com.kingdee.bos.ctrl.kdf.table.KDTable tblMain;
    /**
     * output class constructor
     */
    public AbstractQuestionPaperReportUI() throws Exception
    {
        super();
        jbInit();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractQuestionPaperReportUI.class.getName());
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.sellhouse.report.QuestionPaperReportUIHandler";
	}
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.sellhouse.report", "QuestionPaperReportUI");
    }
