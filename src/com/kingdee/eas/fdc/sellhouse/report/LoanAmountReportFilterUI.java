 ...
 * output class name
 */
public class LoanAmountReportFilterUI extends AbstractLoanAmountReportFilterUI
{
    private static final Logger logger = CoreUIObject.getLogger(LoanAmountReportFilterUI.class);
    ...
    public LoanAmountReportFilterUI() throws Exception
    {
        super();
    }
    public void onLoad() throws Exception {
		...
		this.pkFromDate.setValue(FDCDateHelper.getFirstYearDate(now));
