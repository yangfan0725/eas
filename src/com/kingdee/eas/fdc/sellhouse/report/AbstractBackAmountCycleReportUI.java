 ...
 * output class name
 */
public abstract class AbstractBackAmountCycleReportUI extends com.kingdee.eas.framework.report.client.CommRptBaseUI
{
    private static final Logger logger = CoreUIObject.getLogger(AbstractBackAmountCycleReportUI.class);
     ...
     */
    public AbstractBackAmountCycleReportUI() throws Exception
    {
        super();
        jbInit();
    ...
    {
        this.resHelper = new ResourceBundleHelper(AbstractBackAmountCycleReportUI.class.getName());
	...
	public String getUIHandlerClassName() {
	    return "com.kingdee.eas.fdc.sellhouse.report.BackAmountCycleReportUIHandler";
	}
    ...
    {
        return new MetaDataPK("com.kingdee.eas.fdc.sellhouse.report", "BackAmountCycleReportUI");
    }
