 ...
 * output class name
 */
public class DealRoomReportFilterUI extends AbstractDealRoomReportFilterUI
{
    private static final Logger logger = CoreUIObject.getLogger(DealRoomReportFilterUI.class);
     ...
     */
    public DealRoomReportFilterUI() throws Exception
    {
        super();
    }
