...
public class TranSaleManEntry extends CoreBase implements ITranSaleManEntry
{
    public TranSaleManEntry()
    {
        super();
        registerInterface(ITranSaleManEntry.class, this);
    }
    public TranSaleManEntry(Context ctx)
    {
        super(ctx);
        registerInterface(ITranSaleManEntry.class, this);
    }
    ...
    private TranSaleManEntryController getController() throws BOSException
    {
        return (TranSaleManEntryController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getTranSaleManEntryInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getTranSaleManEntryInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getTranSaleManEntryInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getTranSaleManEntryCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getTranSaleManEntryCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getTranSaleManEntryCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
