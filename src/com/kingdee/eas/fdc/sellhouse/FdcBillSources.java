...
public class FdcBillSources extends DataBase implements IFdcBillSources
{
    public FdcBillSources()
    {
        super();
        registerInterface(IFdcBillSources.class, this);
    }
    public FdcBillSources(Context ctx)
    {
        super(ctx);
        registerInterface(IFdcBillSources.class, this);
    }
    ...
    private FdcBillSourcesController getController() throws BOSException
    {
        return (FdcBillSourcesController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getFdcBillSourcesInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getFdcBillSourcesInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getFdcBillSourcesInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getFdcBillSourcesCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getFdcBillSourcesCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getFdcBillSourcesCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
