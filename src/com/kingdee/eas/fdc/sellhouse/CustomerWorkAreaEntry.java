...
public class CustomerWorkAreaEntry extends AbstractBizCtrl implements ICustomerWorkAreaEntry
{
    public CustomerWorkAreaEntry()
    {
        super();
        registerInterface(ICustomerWorkAreaEntry.class, this);
    }
    public CustomerWorkAreaEntry(Context ctx)
    {
        super(ctx);
        registerInterface(ICustomerWorkAreaEntry.class, this);
    }
    ...
    private CustomerWorkAreaEntryController getController() throws BOSException
    {
        return (CustomerWorkAreaEntryController)getBizController();
    }
    /**
