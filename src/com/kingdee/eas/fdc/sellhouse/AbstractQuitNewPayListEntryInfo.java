...
public class AbstractQuitNewPayListEntryInfo extends com.kingdee.eas.framework.CoreBaseInfo implements Serializable 
{
    public AbstractQuitNewPayListEntryInfo()
    {
        this("id");
    }
    protected AbstractQuitNewPayListEntryInfo(String pkField)
    {
        super(pkField);
    }
    /**
     * Object:新的可退金额分录's 可退金额property 
     */
    ...
    /**
     * Object:新的可退金额分录's 应付金额property 
     */
    ...
    /**
     * Object:新的可退金额分录's 实付金额property 
     */
    ...
    /**
     * Object:新的可退金额分录's 最大可退金额property 
     */
    ...
    /**
     * Object:新的可退金额分录's 费用类型property 
     */
    ...
    /**
     * Object: 新的可退金额分录 's 款项类型 property 
     */
    ...
    /**
     * Object: 新的可退金额分录 's 退房变更单 property 
     */
