...
public class ChangeRoomAttachEntry extends TranRoomAttachmentEntry implements IChangeRoomAttachEntry
{
    public ChangeRoomAttachEntry()
    {
        super();
        registerInterface(IChangeRoomAttachEntry.class, this);
    }
    public ChangeRoomAttachEntry(Context ctx)
    {
        super(ctx);
        registerInterface(IChangeRoomAttachEntry.class, this);
    }
    ...
    private ChangeRoomAttachEntryController getController() throws BOSException
    {
        return (ChangeRoomAttachEntryController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getChangeRoomAttachEntryInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getChangeRoomAttachEntryInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getChangeRoomAttachEntryInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getChangeRoomAttachEntryCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getChangeRoomAttachEntryCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getChangeRoomAttachEntryCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
