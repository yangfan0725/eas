...
public class PurchaseManage extends BaseTransaction implements IPurchaseManage
{
    public PurchaseManage()
    {
        super();
        registerInterface(IPurchaseManage.class, this);
    }
    public PurchaseManage(Context ctx)
    {
        super(ctx);
        registerInterface(IPurchaseManage.class, this);
    }
    ...
    private PurchaseManageController getController() throws BOSException
    {
        return (PurchaseManageController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getPurchaseManageInfo(getContext(), pk);
        }
    ...
    {
        try {
            return getController().getPurchaseManageInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getPurchaseManageInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getPurchaseManageCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getPurchaseManageCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getPurchaseManageCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
