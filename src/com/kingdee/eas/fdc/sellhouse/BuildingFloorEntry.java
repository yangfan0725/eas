...
public class BuildingFloorEntry extends DataBase implements IBuildingFloorEntry
{
    public BuildingFloorEntry()
    {
        super();
        registerInterface(IBuildingFloorEntry.class, this);
    }
    public BuildingFloorEntry(Context ctx)
    {
        super(ctx);
        registerInterface(IBuildingFloorEntry.class, this);
    }
    ...
    private BuildingFloorEntryController getController() throws BOSException
    {
        return (BuildingFloorEntryController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getBuildingFloorEntryInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getBuildingFloorEntryInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getBuildingFloorEntryInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getBuildingFloorEntryCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getBuildingFloorEntryCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getBuildingFloorEntryCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
