...
public class PrePurchaseSaleManEntryControllerBean extends AbstractPrePurchaseSaleManEntryControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.fdc.sellhouse.app.PrePurchaseSaleManEntryControllerBean");
}