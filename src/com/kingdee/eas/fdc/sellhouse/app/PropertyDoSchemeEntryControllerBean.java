...
public class PropertyDoSchemeEntryControllerBean extends AbstractPropertyDoSchemeEntryControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.fdc.sellhouse.app.PropertyDoSchemeEntryControllerBean");
}