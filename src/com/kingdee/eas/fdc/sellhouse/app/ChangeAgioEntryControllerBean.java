...
public class ChangeAgioEntryControllerBean extends AbstractChangeAgioEntryControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.fdc.sellhouse.app.ChangeAgioEntryControllerBean");
}