...
public class ChangeCustomerEntryControllerBean extends AbstractChangeCustomerEntryControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.fdc.sellhouse.app.ChangeCustomerEntryControllerBean");
}