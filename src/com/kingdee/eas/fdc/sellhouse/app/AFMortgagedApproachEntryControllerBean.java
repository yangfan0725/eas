...
public class AFMortgagedApproachEntryControllerBean extends AbstractAFMortgagedApproachEntryControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.fdc.sellhouse.app.AFMortgagedApproachEntryControllerBean");
}