...
public class SignCustomerEntryControllerBean extends AbstractSignCustomerEntryControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.fdc.sellhouse.app.SignCustomerEntryControllerBean");
}