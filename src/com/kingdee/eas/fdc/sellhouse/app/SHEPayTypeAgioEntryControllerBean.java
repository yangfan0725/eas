...
public class SHEPayTypeAgioEntryControllerBean extends AbstractSHEPayTypeAgioEntryControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.fdc.sellhouse.app.SHEPayTypeAgioEntryControllerBean");
}