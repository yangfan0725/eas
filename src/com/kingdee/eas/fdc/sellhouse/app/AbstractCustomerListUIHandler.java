 ...
 * output class name
 */
public abstract class AbstractCustomerListUIHandler extends com.kingdee.eas.framework.app.ListUIHandler

{
	public void handleActionToSysCustomer(RequestContext request,ResponseContext response, Context context) throws Exception {
		_handleActionToSysCustomer(request,response,context);
	}
	protected void _handleActionToSysCustomer(RequestContext request,ResponseContext response, Context context) throws Exception {
	}
	...
	public void handleActionSwitchTo(RequestContext request,ResponseContext response, Context context) throws Exception {
		_handleActionSwitchTo(request,response,context);
	}
	protected void _handleActionSwitchTo(RequestContext request,ResponseContext response, Context context) throws Exception {
	}
	...
	public void handleActionModifyCustomer(RequestContext request,ResponseContext response, Context context) throws Exception {
		_handleActionModifyCustomer(request,response,context);
	}
	protected void _handleActionModifyCustomer(RequestContext request,ResponseContext response, Context context) throws Exception {
	}
	public void handleActionModifyPhone(RequestContext request,ResponseContext response, Context context) throws Exception {
		_handleActionModifyPhone(request,response,context);
	}
	protected void _handleActionModifyPhone(RequestContext request,ResponseContext response, Context context) throws Exception {
	}
	...
	protected void _handleActionClueQueryShow(RequestContext request,ResponseContext response, Context context) throws Exception {
	}
