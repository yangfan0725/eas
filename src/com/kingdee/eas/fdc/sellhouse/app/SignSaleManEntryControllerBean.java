...
public class SignSaleManEntryControllerBean extends AbstractSignSaleManEntryControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.fdc.sellhouse.app.SignSaleManEntryControllerBean");
}