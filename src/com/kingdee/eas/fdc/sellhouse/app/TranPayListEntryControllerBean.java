...
public class TranPayListEntryControllerBean extends AbstractTranPayListEntryControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.fdc.sellhouse.app.TranPayListEntryControllerBean");
}