 ...
 * output class name
 */
public class SignManageListUIHandler extends AbstractSignManageListUIHandler
{
	...
	protected void _handleActionStamp(RequestContext request,ResponseContext response, Context context) throws Exception {
	}
