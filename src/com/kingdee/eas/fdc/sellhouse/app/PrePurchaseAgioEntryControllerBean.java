...
public class PrePurchaseAgioEntryControllerBean extends AbstractPrePurchaseAgioEntryControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.fdc.sellhouse.app.PrePurchaseAgioEntryControllerBean");
}