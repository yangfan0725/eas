...
public class ChangeRoomAttachEntryControllerBean extends AbstractChangeRoomAttachEntryControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.fdc.sellhouse.app.ChangeRoomAttachEntryControllerBean");
}