...
public class PurCustomerEntryControllerBean extends AbstractPurCustomerEntryControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.fdc.sellhouse.app.PurCustomerEntryControllerBean");
}