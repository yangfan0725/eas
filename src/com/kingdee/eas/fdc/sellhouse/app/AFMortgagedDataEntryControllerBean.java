...
public class AFMortgagedDataEntryControllerBean extends AbstractAFMortgagedDataEntryControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.fdc.sellhouse.app.AFMortgagedDataEntryControllerBean");
}