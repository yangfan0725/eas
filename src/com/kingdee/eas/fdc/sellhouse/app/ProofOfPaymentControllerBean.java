...
public class ProofOfPaymentControllerBean extends AbstractProofOfPaymentControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.fdc.sellhouse.app.ProofOfPaymentControllerBean");
}