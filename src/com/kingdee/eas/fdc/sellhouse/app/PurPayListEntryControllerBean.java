...
public class PurPayListEntryControllerBean extends AbstractPurPayListEntryControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.fdc.sellhouse.app.PurPayListEntryControllerBean");
}