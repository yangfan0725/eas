...
public class PurRoomAttachmentEntryControllerBean extends AbstractPurRoomAttachmentEntryControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.fdc.sellhouse.app.PurRoomAttachmentEntryControllerBean");
}