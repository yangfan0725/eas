...
public class MoneyDefineSellProjectControllerBean extends AbstractMoneyDefineSellProjectControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.fdc.sellhouse.app.MoneyDefineSellProjectControllerBean");
