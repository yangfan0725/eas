...
public class JoinDataEntryControllerBean extends AbstractJoinDataEntryControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.fdc.sellhouse.app.JoinDataEntryControllerBean");
}