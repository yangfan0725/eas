...
public class AreaRequirementControllerBean extends AbstractAreaRequirementControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.fdc.sellhouse.app.AreaRequirementControllerBean");
