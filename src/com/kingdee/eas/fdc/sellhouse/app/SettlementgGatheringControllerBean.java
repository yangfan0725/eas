...
public class SettlementgGatheringControllerBean extends AbstractSettlementgGatheringControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.fdc.sellhouse.app.SettlementgGatheringControllerBean");
}