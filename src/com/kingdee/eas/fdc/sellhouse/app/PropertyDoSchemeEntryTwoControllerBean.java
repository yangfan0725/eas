...
public class PropertyDoSchemeEntryTwoControllerBean extends AbstractPropertyDoSchemeEntryTwoControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.fdc.sellhouse.app.PropertyDoSchemeEntryTwoControllerBean");
}