...
public class SHECustomerLinkManControllerBean extends AbstractSHECustomerLinkManControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.fdc.sellhouse.app.SHECustomerLinkManControllerBean");
}