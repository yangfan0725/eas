...
public class SignRoomAttachmentEntryControllerBean extends AbstractSignRoomAttachmentEntryControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.fdc.sellhouse.app.SignRoomAttachmentEntryControllerBean");
}