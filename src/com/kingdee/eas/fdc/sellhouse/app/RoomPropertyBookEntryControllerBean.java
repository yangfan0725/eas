...
public class RoomPropertyBookEntryControllerBean extends AbstractRoomPropertyBookEntryControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.fdc.sellhouse.app.RoomPropertyBookEntryControllerBean");
}