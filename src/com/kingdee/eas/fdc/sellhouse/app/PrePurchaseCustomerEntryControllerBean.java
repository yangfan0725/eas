...
public class PrePurchaseCustomerEntryControllerBean extends AbstractPrePurchaseCustomerEntryControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.fdc.sellhouse.app.PrePurchaseCustomerEntryControllerBean");
}