...
public class PrePurchseCustomerEntryControllerBean extends AbstractPrePurchseCustomerEntryControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.fdc.sellhouse.app.PrePurchseCustomerEntryControllerBean");
}