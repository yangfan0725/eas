...
public class HopedUnitPriceControllerBean extends AbstractHopedUnitPriceControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.fdc.sellhouse.app.HopedUnitPriceControllerBean");
