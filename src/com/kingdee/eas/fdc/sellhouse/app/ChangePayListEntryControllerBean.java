...
public class ChangePayListEntryControllerBean extends AbstractChangePayListEntryControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.fdc.sellhouse.app.ChangePayListEntryControllerBean");
}