...
public class MoneySubjectContrastControllerBean extends AbstractMoneySubjectContrastControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.fdc.sellhouse.app.MoneySubjectContrastControllerBean");
}