...
public class AreaCompensateRevListControllerBean extends AbstractAreaCompensateRevListControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.fdc.sellhouse.app.AreaCompensateRevListControllerBean");
}