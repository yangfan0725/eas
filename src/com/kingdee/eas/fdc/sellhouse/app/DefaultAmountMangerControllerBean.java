...
public class DefaultAmountMangerControllerBean extends AbstractDefaultAmountMangerControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.fdc.sellhouse.app.DefaultAmountMangerControllerBean");
