...
public class TranRoomAttachmentEntryControllerBean extends AbstractTranRoomAttachmentEntryControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.fdc.sellhouse.app.TranRoomAttachmentEntryControllerBean");
}