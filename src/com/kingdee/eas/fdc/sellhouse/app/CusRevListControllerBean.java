...
public class CusRevListControllerBean extends AbstractCusRevListControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.fdc.sellhouse.app.CusRevListControllerBean");
}