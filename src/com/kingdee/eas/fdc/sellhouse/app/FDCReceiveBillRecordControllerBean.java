...
public class FDCReceiveBillRecordControllerBean extends AbstractFDCReceiveBillRecordControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.fdc.sellhouse.app.FDCReceiveBillRecordControllerBean");
}