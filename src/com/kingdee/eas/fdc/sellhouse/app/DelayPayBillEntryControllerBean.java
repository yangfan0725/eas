...
public class DelayPayBillEntryControllerBean extends AbstractDelayPayBillEntryControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.fdc.sellhouse.app.DelayPayBillEntryControllerBean");
}