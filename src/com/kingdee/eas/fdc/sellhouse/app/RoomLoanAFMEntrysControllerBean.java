...
public class RoomLoanAFMEntrysControllerBean extends AbstractRoomLoanAFMEntrysControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.fdc.sellhouse.app.RoomLoanAFMEntrysControllerBean");
}