...
public class PrePurchasePayListEntryControllerBean extends AbstractPrePurchasePayListEntryControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.fdc.sellhouse.app.PrePurchasePayListEntryControllerBean");
}