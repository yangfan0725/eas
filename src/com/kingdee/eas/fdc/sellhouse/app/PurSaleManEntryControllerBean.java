...
public class PurSaleManEntryControllerBean extends AbstractPurSaleManEntryControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.fdc.sellhouse.app.PurSaleManEntryControllerBean");
}