...
public class RoomMortagageControllerBean extends
		AbstractRoomMortagageControllerBean {
	private static Logger logger = Logger
			.getLogger("com.kingdee.eas.fdc.sellhouse.app.RoomMortagageControllerBean");

	public void checkNumberDup(Context ctx, DataBaseInfo dataBaseInfo)
			throws BOSException, EASBizException {
		// super.checkNumberDup(ctx, dataBaseInfo);
	}
