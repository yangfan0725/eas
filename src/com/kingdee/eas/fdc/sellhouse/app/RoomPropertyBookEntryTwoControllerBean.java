...
public class RoomPropertyBookEntryTwoControllerBean extends AbstractRoomPropertyBookEntryTwoControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.fdc.sellhouse.app.RoomPropertyBookEntryTwoControllerBean");
}