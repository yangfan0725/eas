...
public class HopedTotalPricesControllerBean extends AbstractHopedTotalPricesControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.fdc.sellhouse.app.HopedTotalPricesControllerBean");
