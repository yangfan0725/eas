...
public class SinPurSaleMansEntryControllerBean extends AbstractSinPurSaleMansEntryControllerBean
{
    private static Logger logger =
        Logger.getLogger("com.kingdee.eas.fdc.sellhouse.app.SinPurSaleMansEntryControllerBean");
}