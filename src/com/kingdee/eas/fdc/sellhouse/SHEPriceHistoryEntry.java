...
public class SHEPriceHistoryEntry extends FDCBill implements ISHEPriceHistoryEntry
{
    public SHEPriceHistoryEntry()
    {
        super();
        registerInterface(ISHEPriceHistoryEntry.class, this);
    }
    public SHEPriceHistoryEntry(Context ctx)
    {
        super(ctx);
        registerInterface(ISHEPriceHistoryEntry.class, this);
    }
    ...
    private SHEPriceHistoryEntryController getController() throws BOSException
    {
        return (SHEPriceHistoryEntryController)getBizController();
    }
    /**
    ...
    {
        try {
            return getController().getSHEPriceHistoryEntryInfo(getContext(), pk);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getSHEPriceHistoryEntryInfo(getContext(), pk, selector);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getSHEPriceHistoryEntryInfo(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getSHEPriceHistoryEntryCollection(getContext());
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getSHEPriceHistoryEntryCollection(getContext(), view);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
    ...
    {
        try {
            return getController().getSHEPriceHistoryEntryCollection(getContext(), oql);
        }
        catch(RemoteException err) {
            throw new EJBRemoteException(err);
        }
